...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-bf50b1.js
        ...
        _createVNode($setup["FResizePane"], {
          ...
          default: _withCtx(() => [
            _createVNode($setup["ExamplePanel"], { name: $setup.name }, {
              default: _withCtx(({ item, close, content }) => [
...
exampleComponent.__scopeId = "data-v-bf50b1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-bf50b1"
});
export {
  render
};
