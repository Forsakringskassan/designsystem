...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-bd947e.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { name, panel, get FDetailsPanel() {
...
exampleComponent.__scopeId = "data-v-bd947e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-bd947e"
});
export {
  render
};
