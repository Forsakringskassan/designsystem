...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-8b8fd3.js
...
exampleComponent.__scopeId = "data-v-8b8fd3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8b8fd3"
});
export {
  render
};
