...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-4339f7.js
...
exampleComponent.__scopeId = "data-v-4339f7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4339f7"
});
export {
  render
};
