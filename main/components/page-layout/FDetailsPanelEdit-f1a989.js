...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-f1a989.js
...
exampleComponent.__scopeId = "data-v-f1a989";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f1a989"
});
export {
  render
};
