...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-a59be6.js
...
exampleComponent.__scopeId = "data-v-a59be6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a59be6"
});
export {
  render
};
