...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-9f2e7e.js
...
exampleComponent.__scopeId = "data-v-9f2e7e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9f2e7e"
});
export {
  render
};
