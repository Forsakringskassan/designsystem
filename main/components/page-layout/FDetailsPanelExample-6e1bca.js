...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-6e1bca.js
...
exampleComponent.__scopeId = "data-v-6e1bca";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6e1bca"
});
export {
  render
};
