...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-00b0fb.js
...
exampleComponent.__scopeId = "data-v-00b0fb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-00b0fb"
});
export {
  render
};
