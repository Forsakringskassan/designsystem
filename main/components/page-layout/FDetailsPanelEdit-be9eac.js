...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-be9eac.js
...
exampleComponent.__scopeId = "data-v-be9eac";
setup({
  rootComponent: exampleComponent,
  selector: "#example-be9eac"
});
export {
  render
};
