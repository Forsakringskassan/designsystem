...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-5db928.js
...
exampleComponent.__scopeId = "data-v-5db928";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5db928"
});
export {
  render
};
