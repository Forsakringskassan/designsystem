...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-2ac90f.js
...
exampleComponent.__scopeId = "data-v-2ac90f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2ac90f"
});
export {
  render
};
