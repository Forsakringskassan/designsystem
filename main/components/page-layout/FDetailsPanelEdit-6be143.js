...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-6be143.js
...
exampleComponent.__scopeId = "data-v-6be143";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6be143"
});
export {
  render
};
