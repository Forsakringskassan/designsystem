...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-ea58a9.js
...
exampleComponent.__scopeId = "data-v-ea58a9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ea58a9"
});
export {
  render
};
