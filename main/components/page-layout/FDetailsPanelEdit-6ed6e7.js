...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-6ed6e7.js
...
exampleComponent.__scopeId = "data-v-6ed6e7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6ed6e7"
});
export {
  render
};
