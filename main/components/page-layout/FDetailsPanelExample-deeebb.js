...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-deeebb.js
...
exampleComponent.__scopeId = "data-v-deeebb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-deeebb"
});
export {
  render
};
