...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-6a13fd.js
...
exampleComponent.__scopeId = "data-v-6a13fd";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6a13fd"
});
export {
  render
};
