...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-b2e7d9.js
...
exampleComponent.__scopeId = "data-v-b2e7d9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-b2e7d9"
});
export {
  render
};
