...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-aeafa6.js
...
exampleComponent.__scopeId = "data-v-aeafa6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-aeafa6"
});
export {
  render
};
