...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d2e1f0.js
...
exampleComponent.__scopeId = "data-v-d2e1f0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d2e1f0"
});
export {
  render
};
