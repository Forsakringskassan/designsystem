...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-2ac5a6.js
...
exampleComponent.__scopeId = "data-v-2ac5a6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2ac5a6"
});
export {
  render
};
