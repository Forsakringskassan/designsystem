...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-f3ee87.js
...
exampleComponent.__scopeId = "data-v-f3ee87";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f3ee87"
});
export {
  render
};
