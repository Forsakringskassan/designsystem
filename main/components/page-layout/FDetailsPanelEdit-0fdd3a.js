...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-0fdd3a.js
...
exampleComponent.__scopeId = "data-v-0fdd3a";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0fdd3a"
});
export {
  render
};
