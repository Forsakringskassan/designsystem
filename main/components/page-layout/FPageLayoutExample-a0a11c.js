...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-a0a11c.js
...
exampleComponent.__scopeId = "data-v-a0a11c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a0a11c"
});
export {
  render
};
