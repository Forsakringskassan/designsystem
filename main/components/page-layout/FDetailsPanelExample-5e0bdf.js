...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-5e0bdf.js
...
exampleComponent.__scopeId = "data-v-5e0bdf";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5e0bdf"
});
export {
  render
};
