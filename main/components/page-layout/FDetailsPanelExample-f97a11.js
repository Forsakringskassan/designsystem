...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-f97a11.js
...
exampleComponent.__scopeId = "data-v-f97a11";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f97a11"
});
export {
  render
};
