...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-a7cf09.js
...
exampleComponent.__scopeId = "data-v-a7cf09";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a7cf09"
});
export {
  render
};
