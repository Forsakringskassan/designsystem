...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-e6815f.js
...
exampleComponent.__scopeId = "data-v-e6815f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-e6815f"
});
export {
  render
};
