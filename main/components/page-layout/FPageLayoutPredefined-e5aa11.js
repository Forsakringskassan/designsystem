...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-e5aa11.js
...
exampleComponent.__scopeId = "data-v-e5aa11";
setup({
  rootComponent: exampleComponent,
  selector: "#example-e5aa11"
});
export {
  render
};
