...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-bad0a8.js
...
exampleComponent.__scopeId = "data-v-bad0a8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-bad0a8"
});
export {
  render
};
