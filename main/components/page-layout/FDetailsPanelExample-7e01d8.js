...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-7e01d8.js
...
exampleComponent.__scopeId = "data-v-7e01d8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-7e01d8"
});
export {
  render
};
