...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4254fc.js
...
exampleComponent.__scopeId = "data-v-4254fc";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4254fc"
});
export {
  render
};
