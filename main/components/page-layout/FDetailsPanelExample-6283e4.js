...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-6283e4.js
...
exampleComponent.__scopeId = "data-v-6283e4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6283e4"
});
export {
  render
};
