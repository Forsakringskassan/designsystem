...
// virtual-entry:virtual:packages/vue/src/components/FResizePane/examples/FResizePaneLiveExample.vue:FResizePaneLiveExample-02703f.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { CustomPanel, attachment, enabled, visible, overlay, offset, min, max, components, layout, slot, livedata, template, get LiveExample() {
      return LiveExample;
    }, get FCheckboxField() {
