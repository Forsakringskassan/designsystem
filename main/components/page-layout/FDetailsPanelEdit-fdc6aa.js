...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-fdc6aa.js
...
exampleComponent.__scopeId = "data-v-fdc6aa";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fdc6aa"
});
export {
  render
};
