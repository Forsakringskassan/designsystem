...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-d1b8b7.js
...
exampleComponent.__scopeId = "data-v-d1b8b7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d1b8b7"
});
export {
  render
};
