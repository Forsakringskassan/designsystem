...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-51f1ee.js
...
exampleComponent.__scopeId = "data-v-51f1ee";
setup({
  rootComponent: exampleComponent,
  selector: "#example-51f1ee"
});
export {
  render
};
