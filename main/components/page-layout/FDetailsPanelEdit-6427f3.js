...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-6427f3.js
...
exampleComponent.__scopeId = "data-v-6427f3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6427f3"
});
export {
  render
};
