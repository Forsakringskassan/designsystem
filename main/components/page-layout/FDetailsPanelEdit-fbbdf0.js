...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-fbbdf0.js
...
exampleComponent.__scopeId = "data-v-fbbdf0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fbbdf0"
});
export {
  render
};
