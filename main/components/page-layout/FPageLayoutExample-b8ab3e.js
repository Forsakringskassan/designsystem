...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-b8ab3e.js
...
exampleComponent.__scopeId = "data-v-b8ab3e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-b8ab3e"
});
export {
  render
};
