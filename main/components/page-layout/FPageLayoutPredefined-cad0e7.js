...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-cad0e7.js
...
exampleComponent.__scopeId = "data-v-cad0e7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-cad0e7"
});
export {
  render
};
