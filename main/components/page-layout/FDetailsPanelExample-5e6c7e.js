...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-5e6c7e.js
...
exampleComponent.__scopeId = "data-v-5e6c7e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5e6c7e"
});
export {
  render
};
