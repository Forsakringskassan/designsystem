...
// virtual-entry:virtual:docs/components/validation/examples/LessThanExample.vue:LessThanExample-681200.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => _cache[1] || (_cache[1] = [
      _createTextVNode(" Fyll i ett tal som \xE4r mindre \xE4n 100 ")
    ])),
    _: 1,
    __: [1]
  }, 8, ["modelValue"])), [
