...
// virtual-entry:virtual:packages/vue/src/components/FModal/examples/MyAwesomeModal.vue:MyAwesomeModal-398b3a.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    __expose();
    const emit = __emit;
    const __returned__ = { emit, get FButton() {
      return FButton;
    }, get FModal() {
      return FModal;
    } };
