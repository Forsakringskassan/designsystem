...
// virtual-entry:virtual:packages/vue/src/components/FTable/examples/FTableExpandableLiveExample.vue:FTableExpandableLiveExample-187a34.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { data, columns, rows, useCustom, components, livedata, customSlot, template, get LiveExample() {
      return LiveExample;
    }, get FCheckboxField() {
