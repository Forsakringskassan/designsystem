...
export class FInteractiveTablePageObject implements BasePageObject {
     ...
     *
     * @deprecated Use `header()` instead. Deprecated since 6.10.0.
     ...
     *
     * @deprecated Use `cell()` for body content and `header()` for header content instead. Deprecated since 6.10.0.
     * @param index - Row number (0-indexed).
     * @returns Page object for `FTableColumn`.
     */
