...
/**
 * @public
 * @deprecated Use methods on `FInteractiveTable` instead. Deprecated since 6.10.0.
 */
export class FTableColumnPageObject implements BasePageObject {
    ...
    /**
     * @deprecated Use ´FInteractiveTablePageObject.cell()´ instead. Deprecated since 6.10.0.
     */
    ...
    /**
     * @deprecated Use ´FInteractiveTablePageObject.header()´ instead. Deprecated since 6.10.0.
     */
    ...
    /**
     * @deprecated Use ´FInteractiveTablePageObject.checkbox()´ instead. Deprecated since 6.10.0.
     */
