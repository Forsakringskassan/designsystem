...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        const yearElements = useTemplateRef<HTMLElement>("yearElements");
        const yearSelector = useTemplateRef<HTMLElement>("yearSelector");
        const calendarNavbar = useTemplateRef<HTMLElement>("calendarNavbar");
        const {
            yearSelectorStyle,
            yearSelectorOpen,
            activeYear,
...
<template>
    <div class="calendar__wrapper">
        ...
        <div v-if="yearSelectorOpen" ref="yearSelector" class="calendar__year-selector" :style="yearSelectorStyle">
