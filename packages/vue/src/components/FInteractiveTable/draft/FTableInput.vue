...
<template>
    <f-interactive-table :rows="betalningar" key-attribute="id" :show-active="false">
        ...
        <template #default="{ row }">
            ...
            <f-table-column title="Utbetalningsdatum" type="text" shrink>
                <f-datepicker-field v-model="row.date" v-validation.required> Utbetalningsdatum </f-datepicker-field>
            </f-table-column>
