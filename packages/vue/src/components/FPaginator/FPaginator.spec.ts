...
describe("events", () => {
    it.todo(
        "should emit event 'pagination:previous' when clicking on 'Previous' button",
    );

    it.todo(
        "should emit event 'pagination:next' when clicking on 'Next' button",
    );

    it.todo(
        "should emit event 'pagination:page' when clicking on a page button",
    );
});
