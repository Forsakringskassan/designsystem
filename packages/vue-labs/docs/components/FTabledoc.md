...
Använd gärna de specialiserade inmatningsfälten (länk) eller dropplistan (länk) som tabellen stödjer.
...
Om användaren behöver ändra innehåll i rad, lägga till och/eller ta bort rader i tabellen kan du använda datamängdredigeraren (länk).
