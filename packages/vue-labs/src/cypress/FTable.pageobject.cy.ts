...
it("footerRow() should get row in table footer when footer slot is used", () => {
    cy.mount(FTable<(typeof rows)[number]>, {
        props: {
            columns,
            rows,
    ...
    table.footerRow().should("have.prop", "tagName", "TR");
    table.footerRow().should("contain.text", "Footer");
});

it("footerCell() should get cell in table footer when footer slot is used", () => {
    cy.mount(FTable<(typeof rows)[number]>, {
        props: {
            columns,
            rows,
    ...
    table.footerCell().should("have.prop", "tagName", "TD");
    table.footerCell().should("contain.text", "Footer");
});
