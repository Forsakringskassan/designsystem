...
export class FTablePageObject implements BasePageObject {
    ...
    /**
     * Get the row in table footer.
     *
     * Only applicable if footer slot is used.
     *
     * @internal
     * @returns The row in table footer.
     */
    public footerRow(): Cypress.Chainable<JQuery<HTMLTableRowElement>> {
        return cy.get([this.tfoot, "tr"].join(" "));
    }

    /**
     * Get the cell in table footer.
     *
     * Only applicable if footer slot is used.
     *
     * @internal
     * @returns The cell in table footer.
     */
    public footerCell(): Cypress.Chainable<JQuery<HTMLTableCellElement>> {
        return cy.get([this.tfoot, "td"].join(" "));
    }
