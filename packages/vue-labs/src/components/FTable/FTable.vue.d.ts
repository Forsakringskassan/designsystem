/* eslint-disable @typescript-eslint/no-unused-vars, @typescript-eslint/no-explicit-any, @typescript-eslint/no-empty-object-type, unicorn/filename-case -- generated file */
...
declare const value: typeof FTable;
