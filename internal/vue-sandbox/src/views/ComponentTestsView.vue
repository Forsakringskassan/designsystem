...
export default defineComponent({
    ...
    setup() {
        ...
        const calendarMonth = shallowRef(FDate.fromIso("2026-03-01"));
        const calendarMin = shallowRef(FDate.fromIso("2020-01-01"));
        const calendarMax = shallowRef(FDate.fromIso("2030-12-31"));

        function onCompleted(): void {
            done.value = true;
        }

        return { chips, current, done, labelField, onCompleted, Weekday, calendarMonth, calendarMin, calendarMax };
    },
    data() {
        return {
            modalResult: "",
                ...
                <div class="col col--md-9">
                    <f-wizard v-model="current" header-tag="h2" disable-initial-focus @completed="onCompleted">
                        ...
                        <f-wizard-step key="step4" :use-error-list="false" title="Etikett">
                            <f-text-field v-model="labelField" v-validation.required.maxLength input-width="md-6">
                        ...
                        <f-wizard-step key="step8" :use-error-list="false" title="Inmatningskomponenter">
                            <f-text-field v-validation.maxLength input-width="md-6">
                                <template #default>Inmatningsfält</template>
                            </f-text-field>
                            <div class="section-spacing-bottom">
                                <f-text-field v-validation.maxLength input-width="md-6" disabled>
                            ...
                            <div class="row">
                                <div class="col col--md-6 section-spacing-bottom">
                            ...
                            <f-text-field
                                v-model="inmatningCombobox"
                                v-validation.maxLength
                            ...
                            <div class="row">
                                <div class="col col--md-9 section-spacing-top">
                        ...
                        <f-wizard-step key="step10" :use-error-list="false" title="Knappar">
                            <div class="button-row-list">
                                ...
                                <div class="button-row button-row--inverted">
                                    <f-button
                                        size="medium"
                                        variant="tertiary"
                        ...
                        <f-wizard-step key="step14" :use-error-list="false" title="Modaler">
                            ...
                            <div class="section-spacing">
                                ...
                                >
                                <div v-if="modalResult && modalSelectedType === 'form'" class="result-spacing">
