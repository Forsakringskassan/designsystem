...
Använd tertiär knapp om en sekundär knapp blir för framträdande. Tertiär knapp passar bra när flera knappar ska grupperas, till exmepel om ett kort ska ha knappar för att ändra eller ta bort objekt som kortet representerar. Den kan användas som en tredje knapp tillsammans med en primär och en sekundär knapp i en grupp. Knapptexten är understruken om en tertiär knapp används utan en ikon.

### Linjera tertiär knapp med innehåll

Om du vill linjera den tertiära knappens text eller ikon med innehåll placerat ovanför eller under knappen så använd attributet `align-text`. Detta lägger på en negativ vänstermarginal. Observera att minimum bredd på knappen också tas bort.
...
Knappar (small & medium) är som standard inte fullbredd i mobil men kan aktiveras med attributet `mobile-full-width`.
...
- `<button>` ersätts av `<f-button>` komponenten.
