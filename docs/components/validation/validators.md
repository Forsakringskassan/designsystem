...
Validatorn kontrollerar att det ifyllda personnumret är äldre än eller samma ålder som personnumret i annat fält.
...
Validatorn kontrollerar att det ifyllda personnumret är yngre än eller samma ålder som personnumret i annat fält.
