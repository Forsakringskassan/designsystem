...
Kolumntypen textfält används när en kolumn ska visa eller redigera textbaserade värden i `FTable`.
Det är den mest flexibla kolumntypen och den fungerar både för enkel fritext och för specialiserade textformat med inbyggd formatering och validering.
