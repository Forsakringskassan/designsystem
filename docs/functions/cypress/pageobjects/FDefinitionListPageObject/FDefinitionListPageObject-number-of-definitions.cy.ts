...
it("should show the correct number of definitions in the definition list", () => {
    ...
    /* --- cut above --- */
    const myDefinitionListZeroDefinitions = new FDefinitionListPageObject(
        "[data-test=my-definition-list-zero-definitions]",
    );
    myDefinitionListZeroDefinitions.numberOfDefinitions().should("eq", 0);
