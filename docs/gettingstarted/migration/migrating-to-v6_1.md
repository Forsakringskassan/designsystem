---
title: Version 6 migreringsguide 1
name: migrating-to-v6_1
layout: article
---
...
- {@link migrating-to-v6_1#fcheckboxgroup_och_fcheckboxgroupfield `FCheckboxGroup`}
- {@link migrating-to-v6_1#fcheckboxgroup_och_fcheckboxgroupfield `FCheckboxGroupField`}
- {@link migrating-to-v6_1#fradiogroup_och_fradiogroupfield `FRadioGroup`}
- {@link migrating-to-v6_1#fradiogroup_och_fradiogroupfield `FRadioGroupField`}

### Ändrade

- {@link migrating-to-v6_1#fcalendar `FCalendar`}
- {@link migrating-to-v6_1#fformmodal_slots `FFormModal`}
- {@link migrating-to-v6_1#fmodal_deprekerade_css_klasser `FModal`}
- {@link migrating-to-v6_1#fpageheader_skiplink `FPageHeader`}
- {@link migrating-to-v6_1#ftextfield `FTextField`}

## @fkui/logic

I paketet {@link migrating-to-v6_1#paket_fkui_logic `@fkui/logic`} har allmän städning bla bla bla bla bla bla bla bla bla bla.

## Cypress pageobjekt

Borttag av deprekerade medtoder i {@link migrating-to-v6_1#cypress_pageobjects Cypress pageobjekt} bla bla bla bla bla bla bla bla bla bla.
