...
// virtual-entry:virtual:packages/vue/src/components/FTable/docs/FTableBulkLiveExample.vue:FTableBulkLiveExample-7c79cc.js
...
var actionsTemplate = (
  ...
  `
    <div class="button-group">
        ...
        <f-button size="medium" variant="secondary" @click="onRestoreRows"> \xC5terst\xE4ll </f-button>
    </div>
`
);
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const livemethods = {
      async onRemoveSelectedRows() {
        ...
        const confirmed = await confirmModal({
          ...
          content: `\xC4r du s\xE4ker att du vill ta bort ${selectedCount} ${selectedFruitText}?`,
          confirm: "Ja, ta bort",
    ...
    const __returned__ = { data, columns, sortableAttributes, itemsPerPage, rows, selectedRows, useSortFilter, usePagination, components, livedata, confirmModal, livemethods, actionsTemplate, tableTemplate, sortFilterTemplate, paginationTemplate, sortFilterPaginationTemplate, template, get LiveExample() {
      return LiveExample;
    }, get FCheckboxField() {
