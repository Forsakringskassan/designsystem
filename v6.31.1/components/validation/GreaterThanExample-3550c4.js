...
// virtual-entry:virtual:docs/components/validation/examples/GreaterThanExample.vue:GreaterThanExample-3550c4.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => [..._cache[1] || (_cache[1] = [
      _createTextVNode(
        " Fyll i ett tal som \xE4r st\xF6rre \xE4n 0.123 ",
        -1
        /* CACHED */
      )
    ])]),
