...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExpandableLiveExample.vue:FTableExpandableLiveExample-aace4f.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const useCustom = ref4(false);
    const components = {
      FTable: FTable_default
    };
    const livedata = {
      rows,
      columns
    };
    const customSlot = computed4(() => {
      if (!useCustom.value) {
        return [];
      }
      return [
