...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-fe3d8e.js
...
exampleComponent.__scopeId = "data-v-fe3d8e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fe3d8e"
});
export {
  render
};
