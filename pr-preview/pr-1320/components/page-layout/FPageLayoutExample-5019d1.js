...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-5019d1.js
...
exampleComponent.__scopeId = "data-v-5019d1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5019d1"
});
export {
  render
};
