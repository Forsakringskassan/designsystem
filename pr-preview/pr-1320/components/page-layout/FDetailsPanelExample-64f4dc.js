...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-64f4dc.js
...
exampleComponent.__scopeId = "data-v-64f4dc";
setup({
  rootComponent: exampleComponent,
  selector: "#example-64f4dc"
});
export {
  render
};
