...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-8b2d3a.js
...
exampleComponent.__scopeId = "data-v-8b2d3a";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8b2d3a"
});
export {
  render
};
