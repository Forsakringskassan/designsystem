...
const FCrudButton = /* @__PURE__ */ _export_sfc$1(_sfc_main$P, [["render", _sfc_render$q]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[42] || (_cache[42] = createBaseVNode("h1", null, "FKUI Sandbox", -1)),
        createBaseVNode("div", null, [
          _cache[38] || (_cache[38] = createBaseVNode("h2", null, "Ej expanderbar tabell med crud", -1)),
          createVNode(unref(_sfc_main$Q), {
            modelValue: rowsOne.value,
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => rowsOne.value = $event)
          }, {
            default: withCtx(() => [
              createVNode(unref(_sfc_main$j), { rows: rowsOne.value }, {
                caption: withCtx(() => _cache[4] || (_cache[4] = [
                  createBaseVNode("b", null, "Frukter", -1)
                ])),
                default: withCtx(({ row }) => [
            ...
            modify: withCtx(({ item }) => [
              ...
              withDirectives((openBlock(), createBlock(unref(FTextareaField), {
                modelValue: item.description,
                "onUpdate:modelValue": ($event) => item.description = $event
              }, {
                default: withCtx(() => _cache[7] || (_cache[7] = [
                  createTextVNode(" Beskrivning ")
                ])),
                _: 2
              }, 1032, ["modelValue", "onUpdate:modelValue"])), [
                [
              ...
              createTextVNode(" ID " + toDisplayString(item.id), 1)
            ]),
            add: withCtx(({ item }) => [
              withDirectives((openBlock(), createBlock(unref(FTextField), {
                modelValue: item.id,
            ...
            delete: withCtx(({ item }) => [
              createTextVNode(' Vill du verkligen radera fruken "' + toDisplayString(item.name) + '" med ID ' + toDisplayString(item.id), 1)
            ]),
            _: 1
          }, 8, ["modelValue"]),
          _cache[39] || (_cache[39] = createBaseVNode("h2", null, "Expanderbar tabell med crud", -1)),
          createVNode(unref(_sfc_main$Q), {
            modelValue: rowsTwo.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => rowsTwo.value = $event)
          }, {
            default: withCtx(() => [
              createVNode(unref(_sfc_main$j), {
                ...
                caption: withCtx(() => _cache[12] || (_cache[12] = [
                  createBaseVNode("b", null, "Frukter", -1)
                ])),
                default: withCtx(({ row }) => [
                  createVNode(unref(_sfc_main$O), {
          ...
          _cache[40] || (_cache[40] = createBaseVNode("h2", null, "Custom expanderbar tabell med crud och fokuserbart innehåll", -1)),
          createVNode(unref(_sfc_main$Q), {
            modelValue: rowsThree.value,
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => rowsThree.value = $event)
          }, {
            default: withCtx(() => [
              createVNode(unref(_sfc_main$j), {
                rows: rowsThree.value,
                "expandable-attribute": "expandable"
              }, {
                caption: withCtx(() => _cache[20] || (_cache[20] = [
                  createBaseVNode("b", null, "Frukter", -1)
                ])),
                default: withCtx(({ row }) => [
                  createVNode(unref(_sfc_main$O), {
                ...
                expandable: withCtx(({ expandableRow }) => [
                  expandableRow.id.endsWith("a") ? (openBlock(), createElementBlock("div", _hoisted_2, [
                    _cache[21] || (_cache[21] = createTextVNode(" Knapp ska få fokus: ")),
                    createBaseVNode("button", _hoisted_3, toDisplayString(expandableRow.name), 1)
                  ])) : (openBlock(), createElementBlock("div", _hoisted_4, "Denna rad kan inte fokuseras"))
                ]),
                _: 1
              }, 8, ["rows"])
            ]),
          ...
          _cache[41] || (_cache[41] = createBaseVNode("h2", null, "Custom expanderbar tabell med crud utan fokuserbart innehåll", -1)),
          createVNode(unref(_sfc_main$Q), {
            modelValue: rowsFour.value,
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => rowsFour.value = $event)
          }, {
            default: withCtx(() => [
              createVNode(unref(_sfc_main$j), {
                rows: rowsFour.value,
                ...
                caption: withCtx(() => _cache[29] || (_cache[29] = [
                  createBaseVNode("b", null, "Frukter", -1)
                ])),
                default: withCtx(({ row }) => [
                  createVNode(unref(_sfc_main$O), {
                ...
                expandable: withCtx(() => _cache[30] || (_cache[30] = [
                  createBaseVNode("div", null, "Denna rad kan inte fokuseras", -1)
                ])),
                _: 1
              }, 8, ["rows"])
            ]),
