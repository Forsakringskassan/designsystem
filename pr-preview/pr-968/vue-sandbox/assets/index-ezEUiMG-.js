...
const _hoisted_1$11 = ["type", "disabled"];
const _hoisted_2$M = {
  key: 1,
...
const _sfc_main$1n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", mergeProps({
      ...
      }, null, 8, ["name", "library"])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), !hasIcon.value ? (openBlock(), createElementBlock("span", _hoisted_2$M, [unref(inflight) ? (openBlock(), createBlock(unref(FIcon), {
        key: 0,
        name: "circle-notch-solid",
        class: "button__icon button__spinner"
        ...
        library: props.iconLibrary
      }, null, 8, ["name", "library"])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), _cache[3] || (_cache[3] = createTextVNode()), !hasIcon.value ? (openBlock(), createElementBlock("span", _hoisted_3$C)) : createCommentVNode("", true)], 16, _hoisted_1$11);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "DefaultView",
  setup(__props) {
    const checked = /* @__PURE__ */ ref(false);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("label", null, [
          _cache[1] || (_cache[1] = createTextVNode(" Klicka för att försöka disabla knappen ", -1)),
        ...
        createTextVNode(" disabled: " + toDisplayString(checked.value) + " ", 1),
        _cache[4] || (_cache[4] = createBaseVNode("br", null, null, -1)),
        createVNode(unref(_sfc_main$1n), { disabled: checked.value }, {
          default: withCtx(() => [..._cache[2] || (_cache[2] = [
            createTextVNode("hejsan", -1)
          ])]),
          _: 1
        }, 8, ["disabled"])
      ], 64);
...
const router = createRouter({
  ...
  routes: [{ path: "/", name: "", component: _sfc_main }]
});
