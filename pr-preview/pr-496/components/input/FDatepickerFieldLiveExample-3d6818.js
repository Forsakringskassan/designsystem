...
// virtual-entry:virtual:packages/vue/src/components/FDatepickerField/examples/FDatepickerFieldLiveExample.vue:FDatepickerFieldLiveExample-3d6818.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    yearSelector() {
      return this.showYearSelector ? "year-selector" : "";
    },
    description() {
      const template = (
        /* HTML */
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_checkbox_field, {
        modelValue: _ctx.showYearSelector,
        "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => _ctx.showYearSelector = $event),
        value: true
      }, {
        default: _withCtx(() => _cache[27] || (_cache[27] = [
          _createTextVNode(" Visa \xE5rsv\xE4ljare ")
        ])),
        _: 1,
        __: [27]
      }, 8, ["modelValue"]),
