...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("label", {
    key: 0,
    for: `${_ctx.id}`
  }, toDisplayString(_ctx.currentText), 9, _hoisted_3$w)) : (openBlock(), createElementBlock("span", _hoisted_4$r, toDisplayString(_ctx.currentText), 1)), _cache[4] || (_cache[4] = createTextVNode()), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 2,
    id: `${_ctx.id}`,
...
var _hoisted_3$u = ["aria-activedescendant"];
var _hoisted_4$p = ["id", "tabindex", "aria-selected", "aria-labelledby", "onClick"];
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_calendar_navbar, {
  ...
  }, null, 8, ["id", "model-value", "min-date", "max-date", "year-selector", "display-year-selector-as-open", "onUpdate:modelValue", "onUpdate:displayYearSelectorAsOpen"]), _cache[1] || (_cache[1] = createTextVNode()), _ctx.displayYearSelectorAsOpen ? (openBlock(), createElementBlock("div", _hoisted_2$D, [createElementVNode("ul", {
    role: "listbox",
    ...
    }, toDisplayString(year), 43, _hoisted_4$p);
