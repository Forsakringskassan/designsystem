...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [createElementVNode("label", _hoisted_3$w, toDisplayString(_ctx.currentText), 1), _cache[4] || (_cache[4] = createTextVNode()), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 0,
    id: "yearSelectorButton",
    class: "button button--tertiary button--tertiary--black button--small calendar-navbar__year-selector-button",
    type: "button",
...
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_calendar_navbar, {
    ...
    return openBlock(), createElementBlock("li", {
      ...
      class: normalizeClass(["combobox__listbox__option calendar__year-selector__year", {
  ...
  }), 128))], 8, _hoisted_3$u)])) : (openBlock(), createBlock(_component_i_calendar_month, {
    key: 1,
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
    "max-date": _ctx.maxDate,
