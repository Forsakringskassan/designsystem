...
import { defineComponent, computed, createElementBlock, openBlock, normalizeClass, renderSlot, mergeProps, createTextVNode, createElementVNode, createApp, resolveComponent, createCommentVNode, withKeys, createVNode, toDisplayString, createBlock, withCtx, Fragment, renderList, withModifiers, isVNode, Comment, getCurrentInstance, resolveDynamicComponent, capitalize, watch, getCurrentScope, onScopeDispose, onMounted, nextTick, hasInjectionContext, inject, toValue, shallowRef, unref, watchEffect, ref, useTemplateRef, onUnmounted, useSlots, normalizeProps, guardReactiveProps, Transition, Teleport, normalizeStyle, withDirectives, vShow, readonly, toRef, provide, createSlots, vModelSelect, vModelDynamic, toHandlers, defineCustomElement, effectScope, onUpdated, toRefs } from "vue";
...
function _sfc_render$Q(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps(_ctx.$attrs, {
    ...
    href: _ctx.spriteId
  }, null, 8, _hoisted_2$L)], 16, _hoisted_1$$);
}
...
var _hoisted_3$w = ["id", "aria-expanded", "aria-live"];
var _hoisted_4$r = {
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 0,
    id: `${_ctx.id}`,
  ...
  }, [createElementVNode("span", _hoisted_4$r, toDisplayString(_ctx.currentText), 1), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_5$l, toDisplayString(_ctx.yearSelectorOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1), _cache[4] || (_cache[4] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.yearSelectorOpen ? "calendar-navbar__arrow--up" : void 0),
    name: "arrow-down"
  }, null, 8, ["class"])], 8, _hoisted_3$w)) : (openBlock(), createElementBlock("span", _hoisted_6$g, toDisplayString(_ctx.currentText), 1))]), _cache[7] || (_cache[7] = createTextVNode()), !_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
    key: 0,
    ref: "previousButton",
  ...
  }, [createElementVNode("span", _hoisted_8$8, toDisplayString(_ctx.previousSrText), 1), _cache[5] || (_cache[5] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.previousIconClasses),
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_7$b)) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), !_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
    key: 1,
    ref: "nextButton",
  ...
  }, [createElementVNode("span", _hoisted_10$3, toDisplayString(_ctx.nextSrText), 1), _cache[6] || (_cache[6] = createTextVNode()), createVNode(_component_f_icon, {
