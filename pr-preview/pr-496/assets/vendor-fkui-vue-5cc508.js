...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [createElementVNode("label", {
    for: `${_ctx.id}`
  }, toDisplayString(_ctx.currentText), 9, _hoisted_3$w), _cache[4] || (_cache[4] = createTextVNode()), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 0,
    id: `${_ctx.id}`,
