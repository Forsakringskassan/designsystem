...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("label", {
    ...
    name: "arrow-down"
  }, null, 8, ["class"])], 8, _hoisted_5$l)) : createCommentVNode("", true)]), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("button", {
    ref: "previousButton",
    ...
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_7$c), _cache[8] || (_cache[8] = createTextVNode()), createElementVNode("button", {
    ref: "nextButton",
