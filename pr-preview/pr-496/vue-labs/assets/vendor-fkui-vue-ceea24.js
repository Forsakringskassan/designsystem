...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [createTextVNode(toDisplayString(_ctx.currentText) + " ", 1), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 0,
  ...
  }, [createElementVNode("span", _hoisted_4$r, toDisplayString(_ctx.previousSrText), 1), _cache[4] || (_cache[4] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.previousIconClasses),
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_3$w), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("button", {
    ref: "nextButton",
...
var _hoisted_4$p = ["tabindex", "onClick"];
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 8, ["model-value", "min-date", "max-date", "year-selector", "is-year-selector-open", "onUpdate:modelValue", "onUpdate:showYearSelector"]), _cache[1] || (_cache[1] = createTextVNode()), _ctx.isYearSelectorOpen ? (openBlock(), createElementBlock("div", _hoisted_2$D, [createElementVNode("ul", _hoisted_3$u, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.selectableYears, (year) => {
    return openBlock(), createElementBlock("li", {
      ref_for: true,
      ref: "yearElements",
      key: year,
      ...
      class: normalizeClass(["combobox__listbox__option", {
        "combobox__listbox__option--highlight": _ctx.activeYear === year
      }]),
  ...
  }), 128))])])) : (openBlock(), createBlock(_component_i_calendar_month, {
    key: 1,
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
    "max-date": _ctx.maxDate,
