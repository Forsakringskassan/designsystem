...
var _hoisted_5$l = ["id", "aria-expanded"];
var _hoisted_6$g = {
  class: "sr-only"
};
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("label", {
    ...
    name: "arrow-down"
  }, null, 8, ["class"]), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_6$g, toDisplayString(_ctx.displayYearSelectorAsOpen ? _ctx.openYearSelectorText : _ctx.closeYearSelectorText), 1)], 8, _hoisted_5$l)) : createCommentVNode("", true)]), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("button", {
    ref: "previousButton",
