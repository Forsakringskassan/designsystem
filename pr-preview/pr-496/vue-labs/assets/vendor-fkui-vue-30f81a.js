...
import { defineComponent, computed, createElementBlock, openBlock, normalizeClass, renderSlot, mergeProps, createTextVNode, createElementVNode, createApp, resolveComponent, createCommentVNode, withKeys, createVNode, toDisplayString, createBlock, withCtx, Fragment, renderList, withModifiers, isVNode, Comment, getCurrentInstance, resolveDynamicComponent, capitalize, ref, shallowRef, watchEffect, nextTick, useTemplateRef, watch, normalizeStyle, onMounted, toValue, onUnmounted, useSlots, normalizeProps, guardReactiveProps, unref, Transition, Teleport, withDirectives, vShow, readonly, inject, toRef, provide, createSlots, vModelSelect, vModelDynamic, toHandlers, getCurrentScope, onScopeDispose, hasInjectionContext, defineCustomElement, effectScope, onUpdated, toRefs } from "vue";
...
var _hoisted_5$l = ["id", "aria-expanded", "aria-live"];
var _hoisted_6$g = {
  class: "sr-only"
};
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("label", {
    key: 0,
    for: `${_ctx.id}`
  }, toDisplayString(_ctx.currentText), 9, _hoisted_3$w)) : (openBlock(), createElementBlock("span", _hoisted_4$q, toDisplayString(_ctx.currentText), 1)), _cache[4] || (_cache[4] = createTextVNode()), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 2,
    id: `${_ctx.id}`,
  ...
  }, [createElementVNode("span", _hoisted_6$g, toDisplayString(_ctx.yearSelectorOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1), _cache[3] || (_cache[3] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.yearSelectorOpen ? "calendar-navbar__arrow--up" : void 0),
    name: "arrow-down"
  }, null, 8, ["class"])], 8, _hoisted_5$l)) : createCommentVNode("", true)]), _cache[7] || (_cache[7] = createTextVNode()), !_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
    key: 0,
    ref: "previousButton",
    ...
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_7$c)) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), !_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
    key: 1,
    ref: "nextButton",
...
function useYearSelector(options) {
  ...
  const yearSelectorStyle = computed(() => {
    return {
      "--f-calendar-height": `${height.value}px`
    };
  });
  ...
  function updateYearSelectorFocus() {
    const index = selectableYears.value.findIndex((it) => it.equals(activeYear.value));
  ...
  function onYearSelectorKeyDown(event) {
  ...
  function selectYear() {
    const offset2 = activeYear.value.value - currentYear.value.value;
    const updatedDate = modelValue.value.addYears(offset2);
    onChangeDate(clamp$1(updatedDate, minDate.value, maxDate.value));
    closeYearSelector();
  }
...
var _hoisted_2$D = ["aria-activedescendant", "aria-label"];
var _hoisted_3$u = ["id", "tabindex", "aria-selected", "onClick"];
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_calendar_navbar, {
  ...
  }, null, 8, ["id", "year-selector-open", "model-value", "min-date", "max-date", "year-selector", "onUpdate:modelValue"]), _cache[2] || (_cache[2] = createTextVNode()), _ctx.yearSelectorOpen ? (openBlock(), createElementBlock("div", {
    key: 0,
    ref: "yearSelector",
    class: "calendar__year-selector",
    style: normalizeStyle(_ctx.yearSelectorStyle)
    ...
    return openBlock(), createElementBlock("li", {
      ...
      onKeydown: _cache[1] || (_cache[1] = (...args) => _ctx.onYearSelectorKeyDown && _ctx.onYearSelectorKeyDown(...args)),
      onClick: withModifiers(($event) => _ctx.onClickSelectYear(year), ["stop", "prevent"])
    }, toDisplayString(year), 43, _hoisted_3$u);
  }), 128))], 8, _hoisted_2$D)], 4)) : (openBlock(), createBlock(_component_i_calendar_month, {
    key: 1,
    ref: "calendar",
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
