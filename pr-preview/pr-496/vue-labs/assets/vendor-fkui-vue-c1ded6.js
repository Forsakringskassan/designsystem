...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createElementVNode("div", _hoisted_2$F, [_ctx.yearSelector ? (openBlock(), createElementBlock("label", {
  ...
  }, [createElementVNode("span", _hoisted_6$g, toDisplayString(_ctx.displayYearSelectorAsOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1), _cache[3] || (_cache[3] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.displayYearSelectorAsOpen ? "calendar-navbar__arrow--up" : void 0),
    name: "arrow-down"
  }, null, 8, ["class"])], 8, _hoisted_5$l)) : createCommentVNode("", true)]), _cache[7] || (_cache[7] = createTextVNode()), !_ctx.displayYearSelectorAsOpen ? (openBlock(), createElementBlock("button", {
    key: 0,
    ref: "previousButton",
    ...
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_7$c)) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), !_ctx.displayYearSelectorAsOpen ? (openBlock(), createElementBlock("button", {
    key: 1,
    ref: "nextButton",
...
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_calendar_navbar, {
    ...
    "onUpdate:displayYearSelectorAsOpen": _cache[0] || (_cache[0] = ($event) => _ctx.displayYearSelectorAsOpen = $event),
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
    "max-date": _ctx.maxDate,
    "year-selector": _ctx.yearSelector,
    "onUpdate:modelValue": _ctx.onChangeDate
  }, null, 8, ["id", "display-year-selector-as-open", "model-value", "min-date", "max-date", "year-selector", "onUpdate:modelValue"]), _cache[2] || (_cache[2] = createTextVNode()), _ctx.displayYearSelectorAsOpen ? (openBlock(), createElementBlock("div", {
    key: 0,
    ref: "yearSelector",
