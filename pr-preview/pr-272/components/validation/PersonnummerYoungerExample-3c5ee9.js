...
(() => {
  ...
  // virtual-entry:./docs/components/validation/examples/PersonnummerYoungerExample.vue
      ...
      (0, import_vue5.createElementVNode)("div", _hoisted_2, [
        (0, import_vue5.withDirectives)(((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_f_text_field, {
          ...
          default: (0, import_vue5.withCtx)(() => _cache[2] || (_cache[2] = [
            (0, import_vue5.createTextVNode)(" Fyll i ett personnummer (referens) ")
          ])),
          _: 1
          /* STABLE */
        }, 8, ["modelValue"])), [
      ...
      (0, import_vue5.createElementVNode)("div", _hoisted_3, [
        (0, import_vue5.withDirectives)(((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_f_text_field, {
          ...
          default: (0, import_vue5.withCtx)(() => _cache[3] || (_cache[3] = [
            (0, import_vue5.createTextVNode)(" Fyll i ett personnummer ")
          ])),
          _: 1
          /* STABLE */
        }, 8, ["modelValue"])), [
          [
            _directive_validation,
            {
              personnummerYounger: { otherField: _ctx.reference }
            },
            void 0,
            {
              personnummerFormat: true,
              personnummerYounger: true
            }
          ]
        ])
      ])
  ...
  setup({
    ...
    selector: "#PersonnummerYoungerExample"
  });
})();
