...
import { isEmpty, stripWhitespace, isSet, TranslationService, ValidationService, assertRef, assertSet, formatPostalCode, parsePlusgiro, parseNumber, formatNumber, parseOrganisationsnummer, parseClearingNumber, parseBankgiro, parseBankAccountNumber, parsePersonnummer, formatPersonnummer, ElementIdService } from "@fkui/logic";
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return __props.renderHeader ? (openBlock(), createElementBlock("tr", _hoisted_1$8, [__props.isTreegrid ? (openBlock(), createElementBlock("th", _hoisted_2$3)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default")])) : (openBlock(), createElementBlock("tr", {
        ...
        key: 0
      }, [__props.isExpandable ? (openBlock(), createElementBlock("td", {
        key: 0,
...
var specializedInputFieldConfig = {
  personnummer: {
    formatter: (value) => {
      var _formatPersonnummer;
      return (_formatPersonnummer = formatPersonnummer(parsePersonnummer(value))) !== null && _formatPersonnummer !== void 0 ? _formatPersonnummer : value;
    },
    parser: (value) => {
      var _parsePersonnummer;
      return (_parsePersonnummer = parsePersonnummer(value)) !== null && _parsePersonnummer !== void 0 ? _parsePersonnummer : value;
    },
    validationConfig: {
      maxLength: {
        length: 20
  ...
  bankAccountNumber: {
    formatter: (value) => {
      var _parseBankAccountNumb;
      return (_parseBankAccountNumb = parseBankAccountNumber(value)) !== null && _parseBankAccountNumb !== void 0 ? _parseBankAccountNumb : value;
    },
    parser: (value) => {
      var _parseBankAccountNumb2;
      return (_parseBankAccountNumb2 = parseBankAccountNumber(value)) !== null && _parseBankAccountNumb2 !== void 0 ? _parseBankAccountNumb2 : value;
    },
    validationConfig: {
      bankAccountNumber: {}
    },
  ...
  bankgiro: {
    formatter: (value) => {
      var _parseBankgiro;
      return (_parseBankgiro = parseBankgiro(value)) !== null && _parseBankgiro !== void 0 ? _parseBankgiro : value;
    },
    parser: (value) => {
      var _parseBankgiro2;
      return (_parseBankgiro2 = parseBankgiro(value)) !== null && _parseBankgiro2 !== void 0 ? _parseBankgiro2 : value;
    },
    validationConfig: {
      maxLength: {
        length: 9
  ...
  clearingNumber: {
    formatter: (value) => {
      var _parseClearingNumber;
      return (_parseClearingNumber = parseClearingNumber(value)) !== null && _parseClearingNumber !== void 0 ? _parseClearingNumber : value;
    },
    parser: (value) => {
      var _parseClearingNumber2;
      return (_parseClearingNumber2 = parseClearingNumber(value)) !== null && _parseClearingNumber2 !== void 0 ? _parseClearingNumber2 : value;
    },
    validationConfig: {
      clearingNumber: {}
    },
  ...
  currency: {
    formatter: (value) => {
      var _formatNumber;
      return (_formatNumber = formatNumber(value)) !== null && _formatNumber !== void 0 ? _formatNumber : value;
    },
    parser: (value) => {
  ...
  number: {
    formatter: (value, decimals) => {
      var _formatNumber2;
      return (_formatNumber2 = formatNumber(value, decimals)) !== null && _formatNumber2 !== void 0 ? _formatNumber2 : value;
    },
    parser: (value) => {
      const number = parseNumber(value);
      return isSet(number) ? `${number}` : value;
  ...
  organisationsnummer: {
    formatter: (value) => {
      ...
      return (_parseOrganisationsnu = parseOrganisationsnummer(value)) !== null && _parseOrganisationsnu !== void 0 ? _parseOrganisationsnu : value;
    },
    parser: (value) => {
      var _parseOrganisationsnu2;
      return (_parseOrganisationsnu2 = parseOrganisationsnummer(value)) !== null && _parseOrganisationsnu2 !== void 0 ? _parseOrganisationsnu2 : value;
    },
    validationConfig: {
      maxLength: {
        length: 11
  ...
  percent: {
    formatter: (value, decimals) => {
      var _formatNumber3;
      return (_formatNumber3 = formatNumber(value, decimals)) !== null && _formatNumber3 !== void 0 ? _formatNumber3 : value;
    },
    parser: (value) => {
      const number = parseNumber(value);
      return isSet(number) ? `${number}` : value;
  ...
  plusgiro: {
    formatter: (value) => {
      var _parsePlusgiro;
      return (_parsePlusgiro = parsePlusgiro(value)) !== null && _parsePlusgiro !== void 0 ? _parsePlusgiro : value;
    },
    parser: (value) => {
      var _parsePlusgiro2;
      return (_parsePlusgiro2 = parsePlusgiro(value)) !== null && _parsePlusgiro2 !== void 0 ? _parsePlusgiro2 : value;
    },
    validationConfig: {
      maxLength: {
        length: 11
  ...
  postalCode: {
    formatter: (value) => {
      var _formatPostalCode;
      return (_formatPostalCode = formatPostalCode(value)) !== null && _formatPostalCode !== void 0 ? _formatPostalCode : value;
    },
    parser: (value) => {
      return value;
    },
...
function addSubtypeValidators(inputElement, subtype, decimals) {
  ValidationService.addValidatorsToElement(inputElement, specializedInputFieldConfig[subtype].validationConfig, true);
  const options = void 0;
  specializedInputFieldConfig[subtype].attributes(options).forEach((attribute) => {
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formatedValue = computed(() => {
      ...
      return specializedInputFieldConfig[__props.column.subtype].formatter(value, __props.column.decimals);
    });
    const tdElement = useTemplateRef("td");
    ...
    onMounted(() => {
      if (inputElement.value) {
        addSubtypeValidators(inputElement.value, __props.column.subtype);
    ...
    function onEditingKeydown(event) {
      ...
      if (event.key === "Enter") {
        ...
        const newValue = specializedInputFieldConfig[__props.column.subtype].parser(model.value);
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
      ...
      }, toDisplayString(formatedValue.value), 513), _cache[1] || (_cache[1] = createTextVNode()), withDirectives(createElementVNode("input", {
        ref: "input",
        ...
        onTableActivateCell: onActivateCell
      }, toDisplayString(formatedValue.value), 545));
    };
  }
});
var _hoisted_1$2 = {
...
function normalizeTableColumn(column) {
  var _column$key, _column$key2, _column$subtype, _column$validation, _column$key3, _column$key4, _column$key5, _column$icon, _column$key6, _column$key7, _column$key8;
  if ("render" in column) {
    return {
      type: void 0,
  ...
  switch (column.type) {
    ...
    case "text":
      return {
        type: "text",
        subtype: (_column$subtype = column.subtype) !== null && _column$subtype !== void 0 ? _column$subtype : "text",
        header: column.header,
        decimals: column.subtype === "number" || column.subtype === "percent" ? column.decimals : void 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("td", {
        ...
        tabindex: "-1",
        onTableActivateCell: onActivateCell
      }, [renderSlot(_ctx.$slots, "default")], 40, _hoisted_1$1);
    };
  }
});
var _hoisted_1 = ["role"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createElementVNode("table", {
        ...
        return openBlock(), createBlock(_sfc_main$a, {
          ...
          default: withCtx(() => [level > 1 && hasExpandableSlot.value ? (openBlock(), createBlock(_sfc_main$1, {
            key: 0,
            ...
            key: 1
          }, [isMultiSelect.value ? (openBlock(), createBlock(_sfc_main$9, {
            key: 0,
            row,
      ...
      }), 128))])], 42, _hoisted_1), _cache[7] || (_cache[7] = createTextVNode()), renderSlot(_ctx.$slots, "footer")], 64);
    };
  }
});
...
import { assertRef as assertRef5, ValidationService as ValidationService3 } from "@fkui/logic";
...
// src/components/FTable/specialized-input-fields-config.ts
import {
...
var specializedInputFieldConfig2 = {
  personnummer: {
    formatter: (value) => {
      return formatPersonnummer2(parsePersonnummer2(value)) ?? value;
    },
    parser: (value) => {
      return parsePersonnummer2(value) ?? value;
    },
    validationConfig: {
      maxLength: { length: 20 },
      personnummerFormat: {},
  ...
  bankAccountNumber: {
    formatter: (value) => {
      return parseBankAccountNumber2(value) ?? value;
    },
    parser: (value) => {
      return parseBankAccountNumber2(value) ?? value;
    },
  ...
  bankgiro: {
    formatter: (value) => {
      return parseBankgiro2(value) ?? value;
    },
    parser: (value) => {
      return parseBankgiro2(value) ?? value;
    },
  ...
  clearingNumber: {
    formatter: (value) => {
      return parseClearingNumber2(value) ?? value;
    },
    parser: (value) => {
      return parseClearingNumber2(value) ?? value;
    },
  ...
  currency: {
    ...
    parser: (value) => {
      const number = parseNumber2(value);
      return isSet2(number) ? `${number}` : value;
    },
    validationConfig: {
      currency: {},
      integer: {}
  ...
  number: {
    formatter: (value, decimals) => {
      return formatNumber2(value, decimals) ?? value;
    },
    parser: (value) => {
      const number = parseNumber2(value);
      return isSet2(number) ? `${number}` : value;
  ...
  organisationsnummer: {
    formatter: (value) => {
      return parseOrganisationsnummer2(value) ?? value;
    },
    parser: (value) => {
      return parseOrganisationsnummer2(value) ?? value;
    },
  ...
  plusgiro: {
    formatter: (value) => {
      return parsePlusgiro2(value) ?? value;
    },
    parser: (value) => {
      return parsePlusgiro2(value) ?? value;
    },
  ...
  postalCode: {
    formatter: (value) => {
      return formatPostalCode2(value) ?? value;
    },
    parser: (value) => {
      return value;
    },
...
// src/components/FTable/input-validators.ts
function addSubtypeValidators2(inputElement, subtype, decimals) {
  ValidationService2.addValidatorsToElement(
    inputElement,
    specializedInputFieldConfig2[subtype].validationConfig,
    true
  );
  const options = decimals ? { decimals } : void 0;
  specializedInputFieldConfig2[subtype].attributes(options).forEach((attribute) => {
    inputElement.setAttribute(attribute.name, attribute.value);
  });
...
var ITableText_default = /* @__PURE__ */ _defineComponent5({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const formatedValue = computed4(() => {
      const value = __props.column.value(__props.row);
      return specializedInputFieldConfig2[__props.column.subtype].formatter(value, __props.column.decimals);
    });
    ...
    onMounted2(() => {
      if (inputElement.value) {
        addSubtypeValidators2(inputElement.value, __props.column.subtype);
    ...
    function onEditingKeydown(event) {
      ...
      if (event.key === "Enter") {
        event.preventDefault();
        const oldValue = formatedValue.value;
        const newValue = specializedInputFieldConfig2[__props.column.subtype].parser(model.value);
        __props.column.update(__props.row, newValue, oldValue);
        model.value = "";
    ...
    const __returned__ = { model, validity, hasError, wrapperClasses, inputClasses, formatedValue, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onActivateCell, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon3;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
    ...
    [
      _createElementVNode5("div", _hoisted_16, [
        _createElementVNode5(
          ...
          _toDisplayString3($setup.formatedValue),
          513
          /* TEXT, NEED_PATCH */
        ),
...
import { assertRef as assertRef7 } from "@fkui/logic";
import { useTemplateRef as useTemplateRef8 } from "vue";
var ITableRowheader_default = /* @__PURE__ */ _defineComponent7({
  __name: "ITableRowheader",
  props: {
    row: { type: null, required: true },
    column: { type: Object, required: true }
...
import { toDisplayString as _toDisplayString5, openBlock as _openBlock7, createElementBlock as _createElementBlock7 } from "vue";
...
ITableRowheader_default.render = render7;
