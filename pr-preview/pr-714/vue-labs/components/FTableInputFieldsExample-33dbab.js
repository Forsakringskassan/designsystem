...
// virtual-entry:virtual:src/components/FTable/examples/FTableInputFieldsExample.vue:FTableInputFieldsExample-33dbab.js
import { defineComponent as _defineComponent8 } from "vue";
import { computed as computed7, ref as ref5 } from "vue";
import { ValidationService as ValidationService4 } from "@fkui/logic";

// dist/esm/index.esm.js
import { isEmpty, stripWhitespace, isSet, TranslationService, ValidationService, assertRef, formatPostalCode, parsePlusgiro, parseNumber, formatNumber, parseOrganisationsnummer, parseClearingNumber, parseBankgiro, parseBankAccountNumber, parsePersonnummer, formatPersonnummer, assertSet, ElementIdService } from "@fkui/logic";
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", {
        ...
        _: 1
      }, 8, ["float"]), _cache[1] || (_cache[1] = createTextVNode()), __props.column.description.value ? (openBlock(), createElementBlock("div", _hoisted_1$6, toDisplayString(__props.column.description), 1)) : createCommentVNode("", true)], 544);
    };
  }
});
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("tr", {
        ...
        onTableActivateCell: onActivateCell
      }, null, 544))], 64)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 8, _hoisted_1$4);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return renderAnchor.value ? (openBlock(), createElementBlock("td", {
        ...
        tabindex: "-1"
      }, toDisplayString(__props.column.value(__props.row)), 9, _hoisted_1$3)], 32)) : (openBlock(), createElementBlock("td", {
        key: 1,
        ref: "target",
        tabindex: "-1",
        class: "table-ng__cell",
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_1$2, toDisplayString(__props.column.value(__props.row)), 1)], 512)], 32)) : (openBlock(), createElementBlock("td", {
        key: 1,
        ref: "td",
        tabindex: "-1",
        class: "table-ng__cell",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createElementVNode("table", {
        ...
        return openBlock(), createBlock(_sfc_main$6, {
          ...
          default: withCtx(() => [level > 1 && hasExpandableSlot.value ? (openBlock(), createBlock(_sfc_main$9, {
            key: 0,
...
import { ValidationService as ValidationService3, assertRef as assertRef7 } from "@fkui/logic";
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { model, inEdit, validity, hasError, divClasses, wrapperClasses, inputClasses, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onActivateCell, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon4;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
