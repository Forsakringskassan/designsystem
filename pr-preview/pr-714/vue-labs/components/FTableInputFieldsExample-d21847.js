...
// virtual-entry:virtual:src/components/FTable/examples/FTableInputFieldsExample.vue:FTableInputFieldsExample-d21847.js
import { defineComponent as _defineComponent8 } from "vue";
import { computed as computed8, ref as ref5 } from "vue";
import { ValidationService as ValidationService4 } from "@fkui/logic";
...
function addInputValidators2(inputElement, type, decimals) {
  ...
  const attributes = inputFieldConfig2[type].attributes(options);
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { model, inEdit, validity, hasError, divClasses, wrapperClasses, staticClasses, inputClasses, ariaLabel, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon4;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var exampleComponent = /* @__PURE__ */ _defineComponent8({
  ...
  setup(__props, { expose: __expose }) {
    ...
    function validataAll() {
      ValidationService4.validateAllElements("all");
    }
  ...
  return _openBlock8(), _createElementBlock8(
    ...
    [
      ...
      _createElementVNode7(
        "pre",
        null,
        "Summa: " + _toDisplayString6({ sum: $setup.sum }),
        1
        /* TEXT */
      ),
      _createElementVNode7(
