...
// virtual-entry:virtual:src/components/FTable/examples/FTableExample.vue:FTableExample-7a8d5a.js
import { defineComponent as _defineComponent8 } from "vue";
import { h as h2, ref as ref5, useTemplateRef as useTemplateRef8 } from "vue";
import { assertRef as assertRef6, formatNumber as formatNumber3 } from "@fkui/logic";
import { FSortFilterDataset } from "@fkui/vue";

// dist/esm/index.esm.js
import { isEmpty, stripWhitespace, isSet, TranslationService, ValidationService, assertRef, formatPostalCode, parsePlusgiro, parseNumber, formatNumber, parseOrganisationsnummer, parseClearingNumber, parseBankgiro, parseBankAccountNumber, parsePersonnummer, formatPersonnummer, ElementIdService, assertSet } from "@fkui/logic";
...
var _hoisted_4$2 = ["checked", "aria-label"];
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", _hoisted_1$a, [createElementVNode("input", {
        ...
        tabindex: "-1",
        onChange
      }, null, 40, _hoisted_2$6)])) : (openBlock(), createElementBlock("td", _hoisted_3$5, [createElementVNode("input", {
        checked: __props.column.value(__props.row),
        type: "checkbox",
        "aria-label": ariaLabel.value
      }, null, 8, _hoisted_4$2)], 512));
    };
  }
});
var _hoisted_1$9 = {
...
var _hoisted_2$5 = ["aria-label", "aria-expanded"];
var _hoisted_3$4 = {
  key: 1,
  ref: "expandable",
  tabindex: "-1",
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    __expose(expose);
    return (_ctx, _cache) => {
      return __props.isExpandable ? (openBlock(), createElementBlock("td", _hoisted_1$9, [createElementVNode("button", {
        ref: "expandable",
        tabindex: "-1",
      ...
      }, null, 8, ["name"])], 8, _hoisted_2$5)])) : (openBlock(), createElementBlock("td", _hoisted_3$4, null, 512));
    };
  }
});
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", {
        ...
        _: 1
      }, 8, ["float"]), _cache[1] || (_cache[1] = createTextVNode()), __props.column.description.value ? (openBlock(), createElementBlock("div", _hoisted_1$7, toDisplayString(__props.column.description), 1)) : createCommentVNode("", true)], 544);
    };
  }
});
var _hoisted_1$6 = {
...
var _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    __expose(expose);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", _hoisted_1$6, [createElementVNode("input", {
        ref: "selectAll",
        type: "checkbox",
...
var _hoisted_2$4 = ["checked", "aria-label"];
var _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    __expose(expose);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("td", _hoisted_1$5, [createElementVNode("input", {
        ref: "input",
        type: "radio",
        checked: __props.column.value(__props.row),
        "aria-label": ariaLabel.value,
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    __expose(expose);
    return (_ctx, _cache) => {
      return renderAnchor.value ? (openBlock(), createElementBlock("td", _hoisted_1$4, [createElementVNode("a", {
        ref: "target",
        class: "anchor anchor--block",
        target: "_blank",
        href: __props.column.href,
        tabindex: "-1"
      }, toDisplayString(__props.column.value(__props.row)), 9, _hoisted_2$3)])) : (openBlock(), createElementBlock("td", _hoisted_3$3, null, 512));
    };
  }
});
var _hoisted_1$3 = {
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    __expose(expose);
    return (_ctx, _cache) => {
      return renderButton.value ? (openBlock(), createElementBlock("td", _hoisted_1$3, [createElementVNode("button", {
        ref: "button",
        class: "icon-button",
        type: "button",
        tabindex: "-1",
      ...
      }, null, 8, ["name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_2$2, toDisplayString(__props.column.value(__props.row)), 1)], 512)])) : (openBlock(), createElementBlock("td", _hoisted_3$2, null, 512));
    };
  }
});
...
var _hoisted_3$1 = ["aria-controls", "aria-label"];
var _hoisted_4$1 = {
  key: 1,
  tabindex: "-1",
...
var _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["is-open", "options", "active-option", "active-option-id", "input-node"]), [[vShow, editing.value]])], 32)) : (openBlock(), createElementBlock("td", _hoisted_4$1, toDisplayString(__props.column.value(__props.row)), 1));
    };
  }
});
function addInputValidators(inputElement, type, decimals) {
  ...
  inputFieldConfig[type].attributes(options).forEach((attribute) => {
  ...
  setup(__props) {
    ...
    const divClasses = computed(() => {
      return {
        ...
        "table-ng__editable__align-right": __props.column.align === "right"
      };
    });
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
        ...
        onBlur,
        onValidity
      }, null, 42, _hoisted_1$1), [[vModelText, model.value]]), _cache[2] || (_cache[2] = createTextVNode()), hasError.value ? (openBlock(), createBlock(unref(FIcon), {
        key: 0,
        name: "error",
        class: "table-ng__editable__icon"
  ...
  switch (column.type) {
    ...
    case "text:percent": {
      ...
      return {
        ...
        label: getLabelFn(column.label),
        decimals,
        tnum: (_column$tnum = column.tnum) !== null && _column$tnum !== void 0 ? _column$tnum : isTnumType(type),
    ...
    case "text:postalCode": {
      var _column$type, _column$parser2, _column$formatter2, _column$tnum2, _column$align2, _column$validation2, _column$key4;
      const type = (_column$type = column.type) !== null && _column$type !== void 0 ? _column$type : "text";
      const config = inputFieldConfig[type];
      ...
      return {
        ...
        header: toRef(column.header),
        description,
        tnum: (_column$tnum2 = column.tnum) !== null && _column$tnum2 !== void 0 ? _column$tnum2 : isTnumType(type),
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createElementVNode("table", {
        ...
        onClick,
        onKeydown
      }, [createElementVNode("thead", null, [createElementVNode("tr", _hoisted_2, [isTreegrid.value ? (openBlock(), createElementBlock("th", _hoisted_3)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), isMultiSelect.value ? (openBlock(), createBlock(_sfc_main$7, {
        key: 1,
        ref: bindSelectableCellApiRef,
        onChange: onSelectAllChange
      })) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), isSingleSelect.value ? (openBlock(), createElementBlock("th", _hoisted_4, toDisplayString(singleSelectColumn.header), 1)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
      ...
      }), 128))])]), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("tbody", null, [isEmpty2.value ? (openBlock(), createElementBlock("tr", _hoisted_5, [createElementVNode("td", {
        colspan: columnCount.value,
        class: "table-ng__cell"
      }, [renderSlot(_ctx.$slots, "empty", {}, () => [_cache[3] || (_cache[3] = createTextVNode(" Tabellen \xE4r tom ", -1))])], 8, _hoisted_6)])) : (openBlock(true), createElementBlock(Fragment, {
        key: 1
        ...
        return openBlock(), createElementBlock("tr", {
        ...
        }, [isTreegrid.value ? (openBlock(), createBlock(_sfc_main$a, {
          key: 0,
          ref_for: true,
          ref: bindCellApiRef,
          ...
          key: 2
        }, [isMultiSelect.value ? (openBlock(), createBlock(_sfc_main$b, {
          key: 0,
          ref_for: true,
          ref: bindCellApiRef,
          row,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.renderAnchor ? (_openBlock(), _createElementBlock("td", _hoisted_12, [
    _createElementVNode("a", {
      ...
      tabindex: "-1"
    }, _toDisplayString($props.column.value($props.row)), 9, _hoisted_22)
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.renderButton ? (_openBlock2(), _createElementBlock2("td", _hoisted_13, [
...
var _hoisted_42 = ["checked", "aria-label"];
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.column.editable($props.row) ? (_openBlock3(), _createElementBlock3("td", _hoisted_14, [
...
var _hoisted_15 = { class: "table-ng__cell table-ng__cell--radio" };
var _hoisted_25 = ["checked", "aria-label"];
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4("td", _hoisted_15, [
...
import { computed as computed6, nextTick as nextTick2, ref as ref2, useTemplateRef as useTemplateRef6, watchEffect as watchEffect2 } from "vue";
import { ElementIdService as ElementIdService2, assertRef as assertRef4, assertSet as assertSet2 } from "@fkui/logic";
...
var ITableSelect_default = /* @__PURE__ */ _defineComponent6({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const editRef = useTemplateRef6("edit");
    ...
    const __returned__ = { editing, editRef, stopEdit: stopEdit2, viewValue, ariaLabel, onCellKeyDown, onCellClick, startEditing, onDropdownSelect, onDropdownClose, dropdownId, dropdownIsOpen, activeOptionId, activeOption, openSelected, close, setNextOption, setPreviousOption, onEditKeyDown, onEditBlur, submit, cancel, get FIcon() {
      return FIcon3;
...
var _hoisted_26 = { class: "table-ng__editable__text" };
var _hoisted_35 = ["aria-controls", "aria-label"];
var _hoisted_43 = {
  key: 1,
  tabindex: "-1",
  class: "table-ng__cell table-ng__cell--static"
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.column.editable($props.row) ? (_openBlock6(), _createElementBlock6(
    ...
    [
      ...
      }, _toDisplayString4($setup.viewValue), 41, _hoisted_35), [
        [_vShow, $setup.editing]
      ]),
...
import { computed as computed7, onMounted as onMounted2, ref as ref3, useTemplateRef as useTemplateRef7 } from "vue";
import { ValidationService as ValidationService3, assertRef as assertRef5 } from "@fkui/logic";
...
var inputFieldConfig2 = {
  "text:personnummer": {
    formatter(value) {
      return formatPersonnummer2(parsePersonnummer2(value));
    },
    parser(value) {
      return parsePersonnummer2(value);
    },
    validationConfig: {
      maxLength: { length: 20 },
      personnummerFormat: {},
  ...
  "text:bankAccountNumber": {
    ...
    parser(value) {
      return parseBankAccountNumber2(value);
    },
    validationConfig: {
      bankAccountNumber: {}
    },
  ...
  "text:clearingNumber": {
    formatter(value) {
      return parseClearingNumber2(value);
    },
    parser(value) {
      return parseClearingNumber2(value);
    },
  ...
  "text:number": {
    formatter(value) {
      return formatNumber2(value, this.decimals ?? 2);
    },
    parser(value) {
      return parseNumber2(value, this.decimals ?? 2);
    },
    validationConfig: {
      number: {}
    },
  ...
  "text:organisationsnummer": {
    formatter(value) {
      return parseOrganisationsnummer2(value);
    },
    parser(value) {
      return parseOrganisationsnummer2(value);
    },
  ...
  "text:postalCode": {
    formatter(value) {
      return formatPostalCode2(value);
    },
    parser(value) {
      return formatPostalCode2(value);
    },
...
// src/components/FTable/input-validators.ts
function addInputValidators2(inputElement, type, decimals) {
  ValidationService2.addValidatorsToElement(
    inputElement,
    inputFieldConfig2[type].validationConfig,
    true
  );
  const options = decimals ? { decimals } : void 0;
  inputFieldConfig2[type].attributes(options).forEach((attribute) => {
    inputElement.setAttribute(attribute.name, attribute.value);
  });
  ValidationService2.validateElement(inputElement);
}
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    onMounted2(() => {
      if (inputElement.value) {
        addInputValidators2(inputElement.value, __props.column.type);
        ValidationService3.addValidatorsToElement(inputElement.value, __props.column.validation);
      }
    });
    function onStartEdit(modelValue) {
      if (inEdit.value) {
    ...
    const __returned__ = { model, inEdit, validity, hasError, divClasses, wrapperClasses, inputClasses, ariaLabel, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon4;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var exampleComponent = /* @__PURE__ */ _defineComponent8({
  ...
  setup(__props, { expose: __expose }) {
    __expose();
    const tableRef = useTemplateRef8("table");
    ...
    const columns = defineTableColumns([
      ...
      },
      {
        ...
        value(row) {
          return formatNumber3(row.antal) ?? "";
        },
        editable: true
      },
      {
...
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock8(), _createElementBlock8(
    ...
    null,
    [
      _cache[2] || (_cache[2] = _createElementVNode7(
        "button",
        {
          type: "button",
      ...
      _createVNode2($setup["FSortFilterDataset"], {
        data: $setup.rows,
      ...
      _createElementVNode7(
        "h3",
        null,
        "Selected rows (" + _toDisplayString6($setup.mySelectedRows.length) + " items):",
        1
        /* TEXT */
      ),
      _createElementVNode7(
        "pre",
        null,
        _toDisplayString6($setup.mySelectedRows),
        1
        /* TEXT */
      ),
      _createElementVNode7(
        "h3",
        null,
        "Rows (" + _toDisplayString6($setup.rows.length) + " items):",
        1
        /* TEXT */
      ),
      _createElementVNode7(
      ...
      _cache[3] || (_cache[3] = _createElementVNode7(
        "button",
        {
          type: "button",
          class: "button button--secondary"
