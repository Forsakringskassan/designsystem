  ...
  computed: {
    preparedButtons() {
      return this.buttons.map((button) => {
        var _button$event, _ref, _button$reason, _button$type;
        return {
          label: button.label,
          screenreader: button.screenreader,
          event: (_button$event = button.event) !== null && _button$event !== void 0 ? _button$event : "dismiss",
          reason: (_ref = (_button$reason = button.reason) !== null && _button$reason !== void 0 ? _button$reason : button.event) !== null && _ref !== void 0 ? _ref : "dismiss",
          classlist: ["button", `button--${(_button$type = button.type) !== null && _button$type !== void 0 ? _button$type : "secondary"}`],
