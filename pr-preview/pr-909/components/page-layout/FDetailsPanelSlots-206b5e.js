...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-206b5e.js
...
exampleComponent.__scopeId = "data-v-206b5e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-206b5e"
});
export {
  render
};
