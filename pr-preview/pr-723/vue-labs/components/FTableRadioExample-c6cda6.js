...
import { defineComponent, useTemplateRef, computed, createElementBlock, openBlock, createCommentVNode, createTextVNode, renderSlot, Fragment, createElementVNode, createVNode, unref, toDisplayString, createBlock, nextTick, inject, ref, onMounted, withModifiers, normalizeClass, withDirectives, vModelText, watchEffect, vShow, toRef, withCtx, mergeModels, useModel, useSlots, provide, renderList, mergeProps, resolveDynamicComponent } from "vue";
...
var _hoisted_1$8 = ["aria-level"];
var _hoisted_2$3 = ["aria-label", "aria-expanded"];
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])], 8, _hoisted_2$3)], 32)) : (openBlock(), createElementBlock("td", {
        key: 1,
        ref: "expandable",
        class: "table-ng__cell",
        onTableActivateCell: onActivateCell
      }, null, 544))], 64)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 8, _hoisted_1$8);
    };
  }
});
...
var ITableCheckbox_default = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed2(() => __props.column.header.value);
    function onActivateCell(e) {
...
var ITableRadio_default = /* @__PURE__ */ _defineComponent2({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed3(() => __props.column.header.value);
    function onActivateCell(e) {
...
import { computed as computed5, nextTick as nextTick2, useTemplateRef as useTemplateRef5 } from "vue";
