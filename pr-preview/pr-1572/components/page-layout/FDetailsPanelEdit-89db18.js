...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-89db18.js
...
exampleComponent.__scopeId = "data-v-89db18";
setup({
  rootComponent: exampleComponent,
  selector: "#example-89db18"
});
export {
  render
};
