...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d6a418.js
...
exampleComponent.__scopeId = "data-v-d6a418";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d6a418"
});
export {
  render
};
