			...
			case "Enter":
				if (dropdownIsOpen.value) {
					if (activeOption.value) {
						inputRef.value?.dispatchEvent(new CustomEvent("select", {
							bubbles: false,
...
var DefaultView_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		...
		async onChangeCountry(value) {
			...
			this.valtLandsStader = this.kommuner[value];
		}
	}
});
//#endregion
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1, [
		_cache[4] || (_cache[4] = createBaseVNode("h1", null, "FKUI Sandbox", -1)),
		_cache[5] || (_cache[5] = createBaseVNode("p", null, " Ett internt paket som innehåller en avskalad Vue-applikation. Applikationen är konsument av övriga FKUI-paket och innehåller enbart ett tomt exempel. ", -1)),
		_cache[6] || (_cache[6] = createBaseVNode("p", null, [createBaseVNode("strong", null, "Ändra och labba gärna här men glöm inte återställa innan merge!")], -1)),
		_cache[7] || (_cache[7] = createBaseVNode("hr", null, null, -1)),
		withDirectives((openBlock(), createBlock(_component_f_text_field, {
			modelValue: _ctx.valtLand,
			"onUpdate:modelValue": [_cache[0] || (_cache[0] = ($event) => _ctx.valtLand = $event), _ctx.onUpdate],
			maxlength: "100",
			options: _ctx.land,
			onChange: _ctx.onChangeCountry
		}, {
			default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode(" Välj land ", -1)])]),
			_: 1
		}, 8, [
			"modelValue",
			"options",
			...
			{ allowList: { list: _ctx.land } },
			void 0,
			{ allowList: true }
		]]),
		createBaseVNode("div", null, "valtLand:" + toDisplayString(_ctx.valtLand), 1),
		withDirectives((openBlock(), createBlock(_component_f_text_field, {
			modelValue: _ctx.valdStad,
			"onUpdate:modelValue": [_cache[1] || (_cache[1] = ($event) => _ctx.valdStad = $event), _ctx.onUpdateCities],
			maxlength: "100",
			options: _ctx.valtLandsStader,
			onChange: _ctx.onChangeCities
		}, {
			default: withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode(" Välj stad ", -1)])]),
			_: 1
		}, 8, [
			"modelValue",
			"options",
			...
			_directive_validation,
			{ allowList: { list: _ctx.valtLandsStader } },
			void 0,
			{ allowList: true }
		]])
	]);
