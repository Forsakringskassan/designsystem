...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-b6e9b1.js
...
exampleComponent.__scopeId = "data-v-b6e9b1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-b6e9b1"
});
export {
  render
};
