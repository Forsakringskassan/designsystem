...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-0458db.js
...
exampleComponent.__scopeId = "data-v-0458db";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0458db"
});
export {
  render
};
