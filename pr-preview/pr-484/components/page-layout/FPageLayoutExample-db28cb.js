...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-db28cb.js
...
exampleComponent.__scopeId = "data-v-db28cb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db28cb"
});
export {
  render
};
