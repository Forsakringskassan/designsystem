...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-f7a292.js
...
exampleComponent.__scopeId = "data-v-f7a292";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f7a292"
});
export {
  render
};
