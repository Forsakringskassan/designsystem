...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-ef2ed6.js
...
exampleComponent.__scopeId = "data-v-ef2ed6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ef2ed6"
});
export {
  render
};
