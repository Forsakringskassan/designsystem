...
// virtual-entry:virtual:packages/vue/src/components/FCard/examples/FCardValidationExample.vue:FCardValidationExample-169bd4.js
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      _createVNode($setup["FValidationForm"], { "use-error-list": false }, {
        default: _withCtx(() => [
          _withDirectives((_openBlock(), _createBlock($setup["FCard"], { ref: "card" }, {
