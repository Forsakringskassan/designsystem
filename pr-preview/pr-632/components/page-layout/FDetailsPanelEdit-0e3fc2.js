...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-0e3fc2.js
...
exampleComponent.__scopeId = "data-v-0e3fc2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0e3fc2"
});
export {
  render
};
