...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-e6f3fe.js
...
exampleComponent.__scopeId = "data-v-e6f3fe";
setup({
  rootComponent: exampleComponent,
  selector: "#example-e6f3fe"
});
export {
  render
};
