...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-df3db9.js
...
exampleComponent.__scopeId = "data-v-df3db9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-df3db9"
});
export {
  render
};
