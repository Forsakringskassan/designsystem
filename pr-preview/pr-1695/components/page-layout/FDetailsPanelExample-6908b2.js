...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-6908b2.js
...
exampleComponent.__scopeId = "data-v-6908b2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6908b2"
});
export {
  render
};
