...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-5d1bdd.js
...
exampleComponent.__scopeId = "data-v-5d1bdd";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5d1bdd"
});
export {
  render
};
