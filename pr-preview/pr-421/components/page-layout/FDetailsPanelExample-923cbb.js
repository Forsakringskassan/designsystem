...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-923cbb.js
        ...
        _createVNode($setup["FResizePane"], {
          ...
          default: _withCtx(() => [
            _createVNode($setup["ExamplePanel"], { name: $setup.name }, {
              default: _withCtx(({ item, header, content }) => [
                _createElementVNode("h2", { slot: header }, "Detaljpanel", 8, _hoisted_2),
                _createElementVNode("p", { slot: content }, _toDisplayString(item.name), 9, _hoisted_3)
              ]),
              _: 1
              /* STABLE */
            })
...
exampleComponent.__scopeId = "data-v-923cbb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-923cbb"
});
export {
  render
};
