...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ef57b7.js
...
exampleComponent.__scopeId = "data-v-ef57b7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ef57b7"
});
export {
  render
};
