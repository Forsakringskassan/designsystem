...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-7957e2.js
...
exampleComponent.__scopeId = "data-v-7957e2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-7957e2"
});
export {
  render
};
