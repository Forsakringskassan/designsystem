...
(() => {
  ...
  // virtual-entry:./docs/functions/cypress/pageobjects/FBadgePageObject/FBadgePageObject-status.vue
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue5.withDirectives)(((0, import_vue5.openBlock)(), (0, import_vue5.createBlock)($setup["FBadge"], { status: "warning" }, {
      default: (0, import_vue5.withCtx)(() => _cache[0] || (_cache[0] = [
        (0, import_vue5.createTextVNode)(" MyBadge ")
      ])),
      _: 1
      /* STABLE */
    })), [
  ...
  setup({
    ...
    selector: "#FBadgePageObject-status"
  });
})();
