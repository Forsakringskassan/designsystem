...
var _sfc_main$5 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, toDisplayString(viewValue.value), 41, _hoisted_3$3), [[vShow, editing.value]]), _cache[5] || (_cache[5] = createTextVNode()), withDirectives(createVNode(unref3(IComboboxDropdown), {
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
      ...
      }, [__props.column.align === "right" ? (openBlock(), createElementBlock("div", _hoisted_1$3, [createVNode(unref3(FIcon), {
        name: "pen",
        class: "table-ng__editable__icon"
      })], 512)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("span", {
        ref: "view",
        class: "table-ng__editable__text"
      }, toDisplayString(__props.column.value(__props.row)), 513), _cache[2] || (_cache[2] = createTextVNode()), withDirectives(createElementVNode("input", {
        ref: "input",
        ...
        onBlur,
        onValidity
      }, null, 42, _hoisted_2$2), [[vModelText, model.value]]), _cache[3] || (_cache[3] = createTextVNode()), __props.column.align === "left" ? (openBlock(), createElementBlock("div", _hoisted_3$2, [createVNode(unref3(FIcon), {
        name: "pen",
        class: "table-ng__editable__icon"
      })], 512)) : createCommentVNode("", true)], 2), _cache[4] || (_cache[4] = createTextVNode()), createVNode(unref3(IPopupError), {
