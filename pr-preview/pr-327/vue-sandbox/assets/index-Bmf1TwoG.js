...
const _hoisted_10$2 = ["data-grid-column", "data-grid-locked"];
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(wrapperClasses.value)
      }, [createCommentVNode("", true), _cache[20] || (_cache[20] = createTextVNode()), createBaseVNode("table", mergeProps({
        class: ["table", tableClasses.value],
        role: tableRole.value
      }, _ctx.$attrs), [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2$d, [renderSlot(_ctx.$slots, "caption", {}, void 0, true)])) : createCommentVNode("", true), _cache[17] || (_cache[17] = createTextVNode()), createBaseVNode("colgroup", null, [unref(isExpandableTable) ? (openBlock(), createElementBlock("col", _hoisted_3$9)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("col", _hoisted_4$8)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
        return openBlock(), createElementBlock("col", {
          key: column.id,
          class: normalizeClass(column.size)
        }, null, 2);
      }), 128))]), _cache[18] || (_cache[18] = createTextVNode()), createBaseVNode("thead", null, [createBaseVNode("tr", _hoisted_5$6, [unref(isExpandableTable) ? (openBlock(), createElementBlock("th", _hoisted_6$4, [createBaseVNode("span", _hoisted_7$3, toDisplayString(unref($t2)("fkui.interactive-table.select", "Expandera")), 1)])) : createCommentVNode("", true), _cache[6] || (_cache[6] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("th", _hoisted_8$3, [createBaseVNode("div", _hoisted_9$3, [createVNode(unref(FCheckboxField), {
        ...
        _: 1
      }, 8, ["modelValue", "disabled"])])])) : createCommentVNode("", true), _cache[7] || (_cache[7] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(visibleColumns.value, (column, index) => {
        return openBlock(), createElementBlock("th", mergeProps({
          key: column.id,
          scope: "col",
          ...
          innerHTML: escapeNewlines(column.title)
        }, null, 8, _hoisted_11$1), _cache[4] || (_cache[4] = createTextVNode()), column.sortable ? (openBlock(), createBlock(unref(FIcon), {
          key: 0,
          class: normalizeClass(iconClasses2(column)),
          name: iconName(column)
        }, null, 8, ["class", "name"])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), column.description ? (openBlock(), createElementBlock("span", _hoisted_12$1, toDisplayString(column.description), 1)) : createCommentVNode("", true)], 16, _hoisted_10$2);
      }), 128))])]), _cache[19] || (_cache[19] = createTextVNode()), (openBlock(), createElementBlock("tbody", {
        ref: "tbodyElement",
        key: tbodyKey.value
        ...
        return openBlock(), createElementBlock(Fragment, {
        ...
        }, [unref(isExpandableTable) ? (openBlock(), createElementBlock("td", _hoisted_14, [unref(hasExpandableContent)(row) ? (openBlock(), createElementBlock("div", _hoisted_15, [createVNode(unref(FIcon), {
          name: "arrow-right",
          rotate: unref(isExpanded)(row) ? "270" : "90"
        }, null, 8, ["rotate"])])) : createCommentVNode("", true)])) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("td", _hoisted_16, [createBaseVNode("div", _hoisted_17, [createVNode(unref(FCheckboxField), {
          value: true,
          ...
          _: 2
        }, 1032, ["model-value", "onClick"])])])) : createCommentVNode("", true), _cache[9] || (_cache[9] = createTextVNode()), renderSlot(_ctx.$slots, "default", mergeProps({
          ref_for: true
        }, {
          row
        }), void 0, true)], 42, _hoisted_13), _cache[13] || (_cache[13] = createTextVNode()), unref(isExpandableTable) && unref(hasExpandableContent)(row) ? (openBlock(true), createElementBlock(Fragment, {
          key: 0
          ...
          return openBlock(), createElementBlock("tr", {
            ...
            class: "table__column--placeholder"
          }, null, -1)), _cache[11] || (_cache[11] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("td", _hoisted_19)) : createCommentVNode("", true), _cache[12] || (_cache[12] = createTextVNode()), !unref(hasExpandableSlot) ? renderSlot(_ctx.$slots, "default", mergeProps({
            key: 1,
            ref_for: true
          }, {
            row: expandableRow
          }), void 0, true) : (openBlock(), createElementBlock("td", {
            key: 2,
      ...
      }), 128)), _cache[15] || (_cache[15] = createTextVNode()), isEmpty2.value && columns.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_21, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
      })), void 0, true)])) : createCommentVNode("", true), _cache[16] || (_cache[16] = createTextVNode()), isEmpty2.value ? (openBlock(), createElementBlock("tr", _hoisted_22, [createBaseVNode("td", {
        class: "table__column table__column--action",
        colspan: nbOfColumns.value
      }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(toDisplayString(unref($t2)("fkui.interactive-table.empty", "Tabellen är tom")), 1)], true)], 8, _hoisted_23), _cache[14] || (_cache[14] = createTextVNode()), renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
      })), void 0, true)])) : createCommentVNode("", true)]))], 16, _hoisted_1$i)], 2);
    };
  }
});
