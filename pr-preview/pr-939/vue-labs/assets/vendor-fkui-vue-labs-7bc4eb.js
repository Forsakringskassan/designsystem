...
import { nextTick as nextTick3, toValue as toValue2, defineComponent as defineComponent2, useTemplateRef, computed as computed3, createElementBlock, openBlock, createElementVNode, createVNode, unref as unref3, renderSlot, withModifiers, normalizeClass, createTextVNode, createCommentVNode, withCtx, createBlock, toDisplayString, ref as ref3, inject as inject3, watchEffect as watchEffect3, withDirectives, vShow, onMounted as onMounted3, vModelText, toRef as toRef2, watch as watch3, onUpdated as onUpdated2, mergeModels, useModel, useSlots, provide as provide2, Fragment as Fragment2, renderList, mergeProps, resolveDynamicComponent, resolveDirective, normalizeProps, guardReactiveProps } from "vue";
...
import { getItemIdentifier, FIcon, IFlex, IFlexItem, useTranslate, IComboboxDropdown, dispatchComponentValidityEvent, findItemIdentifier, useSlotUtils, setItemIdentifiers, FSortFilterDatasetInjected, EventBus, FFileSelector, FFileItem, TranslationMixin, FTextField, useTextFieldSetup } from "@fkui/vue";
...
var baseTypes = ["anchor", "button", "checkbox", "radio", "render", "rowheader", "select"];
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", {
        ...
        _: 1
      }, 8, ["float"]), _cache[1] || (_cache[1] = createTextVNode()), __props.column.description.value ? (openBlock(), createElementBlock("div", _hoisted_2$8, toDisplayString(__props.column.description), 1)) : createCommentVNode("", true)], 42, _hoisted_1$b);
    };
  }
});
var _hoisted_1$a = {
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return renderAnchor.value ? (openBlock(), createElementBlock("td", _hoisted_1$6, [createElementVNode("a", {
        ...
        tabindex: "-1"
      }, toDisplayString(__props.column.text(__props.row)), 9, _hoisted_2$4)])) : (openBlock(), createElementBlock("td", _hoisted_3$4, null, 512));
    };
  }
});
var _hoisted_1$5 = {
...
var _sfc_main$7 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_2$3, toDisplayString(__props.column.text(__props.row)), 1)], 512)])) : (openBlock(), createElementBlock("td", _hoisted_3$3, null, 512));
    };
  }
});
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
      ...
      }, [withDirectives(createElementVNode("div", _hoisted_1$4, [createElementVNode("span", _hoisted_2$2, toDisplayString(viewValue.value), 1), _cache[2] || (_cache[2] = createTextVNode()), createVNode(unref3(FIcon), {
        name: "pen",
        ...
        tabindex: "-1",
        "aria-expanded": "",
        "aria-controls": unref3(dropdownId),
      ...
      }, toDisplayString(viewValue.value), 41, _hoisted_3$2), [[vShow, editing.value]]), _cache[4] || (_cache[4] = createTextVNode()), withDirectives(createVNode(unref3(IComboboxDropdown), {
        id: "dropdownId",
      ...
      }, null, 8, ["is-open", "options", "active-option", "active-option-id", "input-node"]), [[vShow, editing.value]])], 32)) : (openBlock(), createElementBlock("td", _hoisted_4$2, toDisplayString(__props.column.selected(__props.row)), 1));
    };
  }
});
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props) {
    ...
    function setUpValidation(el) {
      ...
      nextTick3().then(() => ValidationService.validateElement(el));
    }
        ...
        useEventListener(el, nativeEvent, () => {
          const fakeEvent = new CustomEvent("validity", {
            detail: {
              ...
              elementId: inputElement.value.id
            }
          });
    ...
    function onValidity(event) {
      const reason = pendingStopEditReason !== null && pendingStopEditReason !== void 0 ? pendingStopEditReason : event.detail.nativeEvent === "blur" ? "blur" : null;
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
        ...
        onValidity,
        onPendingValidity
      }, null, 42, _hoisted_1$3), [[vModelText, viewValue.value]]), _cache[2] || (_cache[2] = createTextVNode()), hasError.value ? (openBlock(), createBlock(unref3(FIcon), {
        key: 0,
        name: "error",
        class: "table-ng__editable__icon"
      })) : (openBlock(), createBlock(unref3(FIcon), {
        key: 1,
        name: "pen",
        class: "table-ng__editable__icon"
