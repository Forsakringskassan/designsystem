  ...
  setup(__props, { expose: __expose }) {
    ...
    function fromColumnValue() {
      ...
      if (validity.value.isValid) {
        return __props.column.formatter(value) ?? value;
      }
      return value;
    }
    function toColumnValue(value) {
      assertRef4(validity);
      if (validity.value.isValid) {
        return __props.column.parser(value) ?? value;
      }
      return value;
    }
    ...
    function onValidity(event) {
      const reason = pendingStopEditReason ?? (event.detail.nativeEvent === "blur" ? "blur" : null);
      pendingStopEditReason = null;
      const { isValid, validationMessage, validityMode, elementId } = event.detail;
    ...
    const __returned__ = { viewValue, inEdit, validity, hasError, divClasses, wrapperClasses, staticClasses, inputClasses, ariaLabel, tdElement, viewElement, inputElement, stopEdit, hasValidation, get initialViewValue() {
      ...
      pendingStopEditReason = v;
    }, setUpValidation, setUpFakeValidation, onStartEdit, onStopEdit, fromColumnValue, toColumnValue, updateColumnValue, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onValidity, onPendingValidity, get FIcon() {
      return FIcon3;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
      ...
      _createElementVNode6(
        ...
        [
          _createElementVNode6(
            ...
            _toDisplayString5($setup.fromColumnValue()),
            513
            /* TEXT, NEED_PATCH */
          ),
