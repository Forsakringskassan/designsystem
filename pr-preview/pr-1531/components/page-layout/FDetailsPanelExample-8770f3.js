...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-8770f3.js
...
exampleComponent.__scopeId = "data-v-8770f3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8770f3"
});
export {
  render
};
