...
// virtual-entry:virtual:docs/components/validation/examples/InvalidWeekdaysExample.vue:InvalidWeekdaysExample-246713.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => _cache[1] || (_cache[1] = [
      _createTextVNode(" Fyll i ett datum som inte \xE4r m\xE5ndag, tisdag, onsdag eller torsdag ")
    ])),
    _: 1
    /* STABLE */
  }, 8, ["modelValue"])), [
