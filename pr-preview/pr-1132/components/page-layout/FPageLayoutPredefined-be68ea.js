...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-be68ea.js
...
exampleComponent.__scopeId = "data-v-be68ea";
setup({
  rootComponent: exampleComponent,
  selector: "#example-be68ea"
});
export {
  render
};
