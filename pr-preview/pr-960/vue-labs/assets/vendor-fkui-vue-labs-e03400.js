...
var _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, [createElementVNode("span", _hoisted_4$2, toDisplayString(viewValue.value), 1), _cache[4] || (_cache[4] = createTextVNode()), createVNode(unref(FIcon), {
        name: "arrow-down",
        class: "table-ng__editable__icon--active"
      })], 40, _hoisted_3$2), [[vShow, editing.value]]), _cache[6] || (_cache[6] = createTextVNode()), withDirectives(createVNode(unref(IComboboxDropdown), {
        id: unref(dropdownId),
