...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-97b1e6.js
...
exampleComponent.__scopeId = "data-v-97b1e6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-97b1e6"
});
export {
  render
};
