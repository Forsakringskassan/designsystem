...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-38976f.js
...
exampleComponent.__scopeId = "data-v-38976f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-38976f"
});
export {
  render
};
