...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-08a3a1.js
...
exampleComponent.__scopeId = "data-v-08a3a1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-08a3a1"
});
export {
  render
};
