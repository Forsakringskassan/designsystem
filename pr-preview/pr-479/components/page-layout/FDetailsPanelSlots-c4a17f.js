...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-c4a17f.js
...
exampleComponent.__scopeId = "data-v-c4a17f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-c4a17f"
});
export {
  render
};
