	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("button", mergeProps({
				...
				hasIconLeft.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [inflight.value ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
				...
				_cache[0] || (_cache[0] = createTextVNode()),
				!hasIcon.value ? (openBlock(), createElementBlock("span", _hoisted_2$58, [inflight.value ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
					name: "circle-notch-solid",
					class: "button__icon button__spinner"
				...
				hasIconRight.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [inflight.value ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
					name: "circle-notch-solid",
					class: "button__icon button__spinner"
	...
	return {
		...
		actions: ((_column$actions = column.actions) !== null && _column$actions !== void 0 ? _column$actions : []).map((it) => {
			...
			return {
				...
				onClick: (_it$onClick = it.onClick) !== null && _it$onClick !== void 0 ? _it$onClick : noop$2
			};
		})
	};
}
