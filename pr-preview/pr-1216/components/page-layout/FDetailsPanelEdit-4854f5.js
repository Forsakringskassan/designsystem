...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-4854f5.js
...
exampleComponent.__scopeId = "data-v-4854f5";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4854f5"
});
export {
  render
};
