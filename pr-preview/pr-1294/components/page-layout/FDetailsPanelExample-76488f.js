...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-76488f.js
...
exampleComponent.__scopeId = "data-v-76488f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-76488f"
});
export {
  render
};
