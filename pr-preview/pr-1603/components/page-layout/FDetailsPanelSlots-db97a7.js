...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-db97a7.js
...
exampleComponent.__scopeId = "data-v-db97a7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db97a7"
});
export {
  render
};
