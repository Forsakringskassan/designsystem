...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-db1c9d.js
...
exampleComponent.__scopeId = "data-v-db1c9d";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db1c9d"
});
export {
  render
};
