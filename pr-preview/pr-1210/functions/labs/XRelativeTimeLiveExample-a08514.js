...
// virtual-entry:virtual:packages/vue-labs/src/components/XRelativeTime/examples/XRelativeTimeLiveExample.vue:XRelativeTimeLiveExample-a08514.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const timestamp = ref2(entries[0][1]);
    const components = {
      XRelativeTime: XRelativeTime_default
    };
    const template = computed2(() => {
