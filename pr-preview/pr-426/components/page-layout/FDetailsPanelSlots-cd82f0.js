...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-cd82f0.js
...
exampleComponent.__scopeId = "data-v-cd82f0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-cd82f0"
});
export {
  render
};
