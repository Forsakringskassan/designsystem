...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-26fa4e.js
...
exampleComponent.__scopeId = "data-v-26fa4e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-26fa4e"
});
export {
  render
};
