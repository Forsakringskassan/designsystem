...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-0802a2.js
...
exampleComponent.__scopeId = "data-v-0802a2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0802a2"
});
export {
  render
};
