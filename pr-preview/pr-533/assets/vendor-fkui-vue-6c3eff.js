...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createElementVNode("span", _hoisted_5$l, toDisplayString(_ctx.currentText), 1), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_6$g, toDisplayString(_ctx.yearSelectorOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1), _cache[4] || (_cache[4] = createTextVNode()), createVNode(_component_f_icon, {
