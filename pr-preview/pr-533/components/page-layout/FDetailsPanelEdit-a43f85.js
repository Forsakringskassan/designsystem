...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-a43f85.js
...
exampleComponent.__scopeId = "data-v-a43f85";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a43f85"
});
export {
  render
};
