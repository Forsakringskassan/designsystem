...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-ed92fe.js
...
exampleComponent.__scopeId = "data-v-ed92fe";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ed92fe"
});
export {
  render
};
