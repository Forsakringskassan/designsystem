...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-210cd4.js
...
exampleComponent.__scopeId = "data-v-210cd4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-210cd4"
});
export {
  render
};
