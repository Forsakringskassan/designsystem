...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-14b2d0.js
...
exampleComponent.__scopeId = "data-v-14b2d0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-14b2d0"
});
export {
  render
};
