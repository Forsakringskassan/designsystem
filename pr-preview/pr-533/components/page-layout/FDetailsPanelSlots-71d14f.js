...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-71d14f.js
...
exampleComponent.__scopeId = "data-v-71d14f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-71d14f"
});
export {
  render
};
