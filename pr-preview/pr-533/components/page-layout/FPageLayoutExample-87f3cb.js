...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-87f3cb.js
...
exampleComponent.__scopeId = "data-v-87f3cb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-87f3cb"
});
export {
  render
};
