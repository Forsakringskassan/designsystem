...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-6d2bba.js
...
exampleComponent.__scopeId = "data-v-6d2bba";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6d2bba"
});
export {
  render
};
