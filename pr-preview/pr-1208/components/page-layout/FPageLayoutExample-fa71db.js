...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-fa71db.js
...
exampleComponent.__scopeId = "data-v-fa71db";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fa71db"
});
export {
  render
};
