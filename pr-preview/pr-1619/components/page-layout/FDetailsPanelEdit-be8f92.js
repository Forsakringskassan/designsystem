...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-be8f92.js
...
exampleComponent.__scopeId = "data-v-be8f92";
setup({
  rootComponent: exampleComponent,
  selector: "#example-be8f92"
});
export {
  render
};
