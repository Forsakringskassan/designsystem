...
// virtual-entry:virtual:docs/components/validation/examples/DecimalExample.vue:DecimalExample-6a1ea4.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => _cache[1] || (_cache[1] = [
      _createTextVNode(" Fyll i ett decimaltal ")
    ])),
    _: 1,
    __: [1]
  }, 8, ["modelValue"])), [
