...
// virtual-entry:virtual:packages/vue/src/components/FModal/examples/FModalLiveExample.vue:FModalLiveExample-3c7c8e.js
  ...
  computed: {
    ...
    button() {
      return (
        /* HTML */
        `
                <f-button variant="secondary" @click="isOpen = !isOpen"> \xD6ppna modal </f-button>
            `
      );
    },
    footer() {
