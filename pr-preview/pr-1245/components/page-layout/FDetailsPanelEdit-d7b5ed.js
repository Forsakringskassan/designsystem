...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-d7b5ed.js
...
exampleComponent.__scopeId = "data-v-d7b5ed";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d7b5ed"
});
export {
  render
};
