...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExample.vue:FTableExample-634cc8.js
...
function isSortable(column) {
  return Boolean("key" in column && column.key) && column.sort !== false;
}
