...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-2154a0.js
...
exampleComponent.__scopeId = "data-v-2154a0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2154a0"
});
export {
  render
};
