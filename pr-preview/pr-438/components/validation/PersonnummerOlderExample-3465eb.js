...
// virtual-entry:virtual:docs/components/validation/examples/PersonnummerOlderExample.vue:PersonnummerOlderExample-3465eb.js
    ...
    _createElementVNode("div", _hoisted_3, [
      _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
        ...
        [
          _directive_validation,
          {
            personnummerOlder: { otherField: _ctx.reference }
          },
          void 0,
          {
            personnummerFormat: true,
            personnummerOlder: true
          }
        ]
      ])
    ])
