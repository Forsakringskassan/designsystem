...
// virtual-entry:virtual:docs/components/validation/examples/CurrencyExample.vue:CurrencyExample-9e6511.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => _cache[1] || (_cache[1] = [
      _createTextVNode(" Fyll i ett belopp ")
    ])),
    _: 1
    /* STABLE */
  }, 8, ["modelValue"])), [
