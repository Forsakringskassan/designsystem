...
// virtual-entry:virtual:docs/components/validation/examples/MaxValueExample.vue:MaxValueExample-98e1bd.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => _cache[1] || (_cache[1] = [
      _createTextVNode(" Fyll i ett tal som \xE4r h\xF6gst 50 ")
    ])),
    _: 1
    /* STABLE */
  }, 8, ["modelValue"])), [
