...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-fa8030.js
import { defineComponent as defineComponent3, h as h3 } from "vue";
import { formatNumber as formatNumber2 } from "@fkui/logic";
import { FCheckboxField, FFieldset, FRadioField, FSelectField, useDatasetRef } from "@fkui/vue";
...
var exampleComponent = defineComponent3({
  ...
  computed: {
    livedata() {
      const nestedAttribute = this.isExpandable ? this.hasCustomExpandContent ? "expandableContent" : "expandableRows" : void 0;
