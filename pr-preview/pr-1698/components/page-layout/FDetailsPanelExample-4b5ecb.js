...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4b5ecb.js
...
exampleComponent.__scopeId = "data-v-4b5ecb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4b5ecb"
});
export {
  render
};
