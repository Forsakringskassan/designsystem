...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-28fd6e.js
...
exampleComponent.__scopeId = "data-v-28fd6e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-28fd6e"
});
export {
  render
};
