...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-604bd0.js
...
exampleComponent.__scopeId = "data-v-604bd0";
setup({
  rootComponent: exampleComponent,
  selector: "#example-604bd0"
});
export {
  render
};
