...
// virtual-entry:virtual:docs/components/validation/examples/MinValueExample.vue:MinValueExample-aea4ec.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _withDirectives((_openBlock(), _createBlock(_component_f_text_field, {
    ...
    default: _withCtx(() => [..._cache[1] || (_cache[1] = [
      _createTextVNode(
        " Fyll i ett tal som \xE4r l\xE4gst 10 ",
        -1
        /* CACHED */
      )
    ])]),
