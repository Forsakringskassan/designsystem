...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-1163af.js
...
exampleComponent.__scopeId = "data-v-1163af";
setup({
  rootComponent: exampleComponent,
  selector: "#example-1163af"
});
export {
  render
};
