...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-08f3b2.js
...
exampleComponent.__scopeId = "data-v-08f3b2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-08f3b2"
});
export {
  render
};
