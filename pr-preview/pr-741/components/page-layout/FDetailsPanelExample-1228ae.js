...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-1228ae.js
...
exampleComponent.__scopeId = "data-v-1228ae";
setup({
  rootComponent: exampleComponent,
  selector: "#example-1228ae"
});
export {
  render
};
