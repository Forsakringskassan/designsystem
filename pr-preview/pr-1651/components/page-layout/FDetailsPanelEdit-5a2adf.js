...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-5a2adf.js
...
exampleComponent.__scopeId = "data-v-5a2adf";
setup({
  rootComponent: exampleComponent,
  selector: "#example-5a2adf"
});
export {
  render
};
