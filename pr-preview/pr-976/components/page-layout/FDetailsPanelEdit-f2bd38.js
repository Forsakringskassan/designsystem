...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-f2bd38.js
...
exampleComponent.__scopeId = "data-v-f2bd38";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f2bd38"
});
export {
  render
};
