...
// virtual-entry:virtual:packages/vue/src/design-component-tests/Button/examples/ButtonLiveExample2.vue:ButtonLiveExample2-b51ca6.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    template() {
      const { type, size, disabled, tertiaryColor, isAsync } = this;
