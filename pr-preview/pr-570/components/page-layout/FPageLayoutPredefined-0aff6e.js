...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-0aff6e.js
...
exampleComponent.__scopeId = "data-v-0aff6e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0aff6e"
});
export {
  render
};
