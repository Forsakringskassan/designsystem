...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-36d2e2.js
...
exampleComponent.__scopeId = "data-v-36d2e2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-36d2e2"
});
export {
  render
};
