...
// virtual-entry:virtual:packages/vue/src/components/FDataTable/examples/FDataTableLiveExample.vue:FDataTableLiveExample-4123db.js
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.forceHorizontalScroll = $event),
        value: true
      }, {
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.hasHiddenCaption = $event),
        value: true
      }, {
