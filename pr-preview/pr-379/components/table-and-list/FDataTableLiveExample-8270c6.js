...
// virtual-entry:virtual:packages/vue/src/components/FDataTable/examples/FDataTableLiveExample.vue:FDataTableLiveExample-8270c6.js
  ...
  computed: {
    ...
    template() {
      ...
      return ["vertical", "both"].includes(this.scroll) ? (
        /* HTML */
        `<div class="example-force-vertical-scroll">${template}</div>`
      ) : template;
    }
  }
});
