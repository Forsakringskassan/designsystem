...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-79f5ea.js
...
exampleComponent.__scopeId = "data-v-79f5ea";
setup({
  rootComponent: exampleComponent,
  selector: "#example-79f5ea"
});
export {
  render
};
