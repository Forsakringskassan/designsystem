...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-0288f2.js
...
exampleComponent.__scopeId = "data-v-0288f2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0288f2"
});
export {
  render
};
