...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-f0d18f.js
...
exampleComponent.__scopeId = "data-v-f0d18f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f0d18f"
});
export {
  render
};
