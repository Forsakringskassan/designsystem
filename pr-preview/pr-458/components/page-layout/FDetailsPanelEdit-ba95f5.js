...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ba95f5.js
...
exampleComponent.__scopeId = "data-v-ba95f5";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ba95f5"
});
export {
  render
};
