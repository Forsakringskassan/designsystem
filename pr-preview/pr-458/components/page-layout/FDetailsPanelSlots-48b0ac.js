...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-48b0ac.js
...
exampleComponent.__scopeId = "data-v-48b0ac";
setup({
  rootComponent: exampleComponent,
  selector: "#example-48b0ac"
});
export {
  render
};
