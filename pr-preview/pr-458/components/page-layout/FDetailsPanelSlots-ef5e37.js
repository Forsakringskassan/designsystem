...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-ef5e37.js
...
exampleComponent.__scopeId = "data-v-ef5e37";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ef5e37"
});
export {
  render
};
