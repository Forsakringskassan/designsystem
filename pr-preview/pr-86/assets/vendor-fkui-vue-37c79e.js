...
(() => {
  ...
  var _sfc_main$K = (0, import_vue.defineComponent)({ name: "FTooltip", components: { FExpand, FIcon, IFlex, IFlexItem }, props: {
    /**
    ...
    */
    ...
    (0, import_vue.watchEffect)(() => {
      ...
      wrapper.value.style.setProperty("--tooltip-offset", `${offset2.value}px`);
    });
  ...
  var _hoisted_4$h = { ref: "wrapper", class: "tooltip" };
  var _hoisted_5$d = { class: "tooltip__bubble", tabindex: "-1" };
  var _hoisted_6$b = { class: "tooltip__body" };
  function _sfc_render$A(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_f_icon = (0, import_vue.resolveComponent)("f-icon");
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      import_vue.Fragment,
      null,
      [_ctx.iconTarget ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(import_vue.Teleport, { key: 0, to: _ctx.iconTarget }, [(0, import_vue.createElementVNode)("button", { ref: "button", class: "tooltip__button", type: "button", "aria-expanded": _ctx.isOpen, onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickToggle && _ctx.onClickToggle(...args)) }, [(0, import_vue.createElementVNode)("span", _hoisted_2$q, [(0, import_vue.createVNode)(_component_f_icon, { name: "circle" }), _cache[1] || (_cache[1] = (0, import_vue.createTextVNode)()), (0, import_vue.createVNode)(_component_f_icon, { name: "i" }), _cache[2] || (_cache[2] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)(
        "span",
        _hoisted_3$l,
        (0, import_vue.toDisplayString)(_ctx.screenReaderText),
        1
        /* TEXT */
      )])], 8, _hoisted_1$x)], 8, ["to"])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[4] || (_cache[4] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)(
        "div",
        _hoisted_4$h,
        [(0, import_vue.createElementVNode)("div", _hoisted_5$d, [_ctx.hasHeader ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)((0, import_vue.resolveDynamicComponent)(_ctx.headerTag), { key: 0, class: "tooltip__header" }, {
          default: (0, import_vue.withCtx)(() => [(0, import_vue.renderSlot)(_ctx.$slots, "header")]),
          _: 3
          /* FORWARDED */
        })) : (0, import_vue.createCommentVNode)("v-if", true), _cache[3] || (_cache[3] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("div", _hoisted_6$b, [(0, import_vue.renderSlot)(_ctx.$slots, "body")])])],
        512
        /* NEED_PATCH */
      )],
      64
