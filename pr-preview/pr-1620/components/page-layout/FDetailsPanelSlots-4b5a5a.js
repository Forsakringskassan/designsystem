...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-4b5a5a.js
...
exampleComponent.__scopeId = "data-v-4b5a5a";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4b5a5a"
});
export {
  render
};
