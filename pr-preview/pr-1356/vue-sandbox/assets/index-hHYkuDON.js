...
function parsePlusgiro(value) {
	...
	*/
	...
	const startOffset = 4;
	let formattedString = value.slice(-4);
	const step = 2;
...
var FCheckboxField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	computed: {
		attrs() {
			let checked;
			if (Array.isArray(this.modelValue)) checked = this.modelValue.some((it) => (0, import_isEqual.default)(toValue(it), toValue(this.value)));
			else checked = this.value === this.modelValue;
			return {
				...this.$attrs,
				value: this.value,
				checked,
				onChange: (event) => {
					if (event.target instanceof HTMLInputElement) this.emitVModelEvent(event);
				},
				onInput: (event) => {
					event.target.focus();
				}
	...
	methods: {
		...
		emitVModelEvent(event) {
			...
			if (Array.isArray(this.modelValue)) {
				newModel = [...this.modelValue].filter((it) => !(0, import_isEqual.default)(toValue(it), toValue(this.value)));
				if (this.modelValue.length <= newModel.length) newModel.push(this.value);
			} else if (this.value === this.modelValue) newModel = typeof this.value === "boolean" ? false : void 0;
			else newModel = event.target.value === "true" ? true : this.value;
...
var _hoisted_1$57 = ["id", "disabled"];
var _hoisted_2$42 = ["for"];
var _hoisted_3$30 = {
	key: 0,
...
function _sfc_render$27(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("input", mergeProps({ id: _ctx.id }, _ctx.attrs, {
			ref: "checkboxInput",
			type: "checkbox",
		...
		createBaseVNode("label", {
			...
			_ctx.$slots.details ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
				_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$30, [renderSlot(_ctx.$slots, "details")])) : createCommentVNode("", true),
				_cache[3] || (_cache[3] = createTextVNode()),
				_ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, {
					...
					default: withCtx(() => [_ctx.expanded ? (openBlock(), createElementBlock("span", _hoisted_4$24, [renderSlot(_ctx.$slots, "details", { height: _ctx.height })])) : createCommentVNode("", true)]),
					_: 3
				}, 8, [
					"onEnter",
					"onAfterEnter",
...
var FTextareaField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	data() {
		return {
			...
			textareaWidth: void 0,
			windowResizeListener: void 0
		};
	},
	computed: {
		attrs() {
		...
		textareaClass() {
			...
			if (this.resizable && !this.autoResize) classes.push("textarea-field__resize--vertical");
	...
	methods: {
		...
		startAutoResize() {
			...
			this.stopAutoResize(false);
			const textarea = this.getTextareaElement();
			if (!textarea) return;
			this.textareaWidth = textarea.getBoundingClientRect().width;
			if (typeof ResizeObserver !== "undefined") {
				this.resizeObserver = new ResizeObserver((entries) => {
					this.onTextareaResizeObserved(entries);
				});
		...
		stopAutoResize(resetStyles = true) {
			...
			if (this.windowResizeListener) {
				...
				this.windowResizeListener = void 0;
			}
			this.textareaWidth = void 0;
		...
		onTextareaResizeObserved(entries) {
			const width = entries[0]?.contentRect.width;
			if (typeof width !== "number") return;
			if (width === this.textareaWidth) return;
		...
		resizeTextarea() {
			...
			const borderHeight = this.getVerticalBorderHeight(style);
			const minHeight = this.getRowsHeight(style, borderHeight, textarea.rows);
			const height = Math.max(textarea.scrollHeight + borderHeight, minHeight);
			const maxHeight = this.getMaxRowsHeight(style, borderHeight, textarea.rows);
		...
		getMaxRowsHeight(style, borderHeight, rows) {
			if (!this.maxRows || this.maxRows < 1) return;
			const maxRows = Math.max(this.maxRows, rows);
			return this.getRowsHeight(style, borderHeight, maxRows);
		},
		getRowsHeight(style, borderHeight, rows) {
			const lineHeight = this.getLineHeight(style);
			const padding = this.parsePixelValue(style.paddingTop) + this.parsePixelValue(style.paddingBottom);
			return lineHeight * rows + padding + borderHeight;
		},
		getLineHeight(style) {
			const lineHeight = this.parsePixelValue(style.lineHeight);
			if (lineHeight > 0) return lineHeight;
			return this.parsePixelValue(style.fontSize) * 1.2;
		},
		getVerticalBorderHeight(style) {
			return this.parsePixelValue(style.borderTopWidth) + this.parsePixelValue(style.borderBottomWidth);
		},
...
var FTextareaField_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FTextareaField_vue_vue_type_script_lang_default, [["render", _sfc_render$2]]);
...
var _hoisted_3$1 = { class: "wizard-step__icon-container" };
var _hoisted_4$1 = { class: "wizard-step__icon-container__circle" };
var _hoisted_5$1 = {
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", {
		...
		})), () => [createBaseVNode("span", _hoisted_2$1, toDisplayString(_ctx.defaultCurrentStepInformation), 1)]) : createCommentVNode("", true),
		...
		createBaseVNode("div", _hoisted_3$1, [
			createBaseVNode("div", _hoisted_4$1, [
				...
				_cache[3] || (_cache[3] = createTextVNode()),
				createBaseVNode("div", _hoisted_5$1, toDisplayString(_ctx.stepNumber), 1)
			]),
			_cache[4] || (_cache[4] = createTextVNode()),
			_cache[5] || (_cache[5] = createBaseVNode("div", { class: "wizard-step__icon-container__line-down" }, null, -1))
		]),
		_cache[12] || (_cache[12] = createTextVNode()),
		createBaseVNode("div", _hoisted_6$1, [(openBlock(), createBlock(resolveDynamicComponent(_ctx.inheritedProps.headerTag), { class: "wizard-step__header__title" }, {
			default: withCtx(() => [_ctx.showLink ? (openBlock(), createElementBlock("a", {
				...
				createBaseVNode("span", _hoisted_7$1, toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0", 1),
...
var FWizardStep_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FWizardStep_vue_vue_type_script_lang_default, [["render", _sfc_render$3]]);
//#endregion
...
var DefaultView_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FCheckboxField: FCheckboxField_default,
		FFieldset: FFieldset_default,
		FRadioField: FRadioField_default,
		FTextareaField: FTextareaField_default,
...
var _hoisted_1 = { class: "container sandbox-root" };
var _hoisted_2 = { class: "row sandbox-row" };
var _hoisted_3 = { class: "col col--md-4" };
var _hoisted_4 = { class: "sandbox-section" };
var _hoisted_5 = { class: "row sandbox-row" };
var _hoisted_6 = { class: "col col--md-4" };
var _hoisted_7 = { class: "sandbox-section" };
var _hoisted_8 = { class: "row sandbox-row" };
var _hoisted_9 = { class: "col col--md-4" };
var _hoisted_10 = { class: "sandbox-section" };
var _hoisted_11 = { class: "row sandbox-row" };
var _hoisted_12 = { class: "col col--md-4" };
var _hoisted_13 = { class: "sandbox-section" };
var _hoisted_14 = { class: "row sandbox-row" };
var _hoisted_15 = { class: "col col--md-4" };
var _hoisted_16 = { class: "sandbox-section" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_textarea_field = resolveComponent("f-textarea-field");
	...
	return openBlock(), createElementBlock("div", _hoisted_1, [
		_cache[26] || (_cache[26] = createBaseVNode("header", { class: "sandbox-header" }, [createBaseVNode("h1", null, "FTextareaField med auto-resize")], -1)),
		createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [createBaseVNode("section", _hoisted_4, [_cache[11] || (_cache[11] = createBaseVNode("code", { class: "sandbox-case" }, "auto-resize", -1)), createVNode(_component_f_textarea_field, {
			id: "auto-resize-field",
			modelValue: _ctx.autoResizeModel,
			"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.autoResizeModel = $event),
			"auto-resize": ""
		}, {
			default: withCtx(() => [..._cache[10] || (_cache[10] = [createTextVNode(" Automatisk höjd, standard 4 rader ", -1)])]),
			_: 1
		}, 8, ["modelValue"])])])]),
		createBaseVNode("div", _hoisted_5, [createBaseVNode("div", _hoisted_6, [createBaseVNode("section", _hoisted_7, [_cache[13] || (_cache[13] = createBaseVNode("code", { class: "sandbox-case" }, "auto-resize + rows=\"1\"", -1)), createVNode(_component_f_textarea_field, {
			id: "auto-resize-rows-field",
			modelValue: _ctx.autoRowsModel,
			"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.autoRowsModel = $event),
			"auto-resize": "",
			rows: "1"
		}, {
			default: withCtx(() => [..._cache[12] || (_cache[12] = [createTextVNode(" Automatisk höjd, minst 1 rad ", -1)])]),
			_: 1
		}, 8, ["modelValue"])])])]),
		createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createBaseVNode("section", _hoisted_10, [_cache[15] || (_cache[15] = createBaseVNode("code", { class: "sandbox-case" }, "auto-resize + rows=\"1\" + max-rows=\"3\"", -1)), createVNode(_component_f_textarea_field, {
			id: "max-rows-field",
			modelValue: _ctx.maxRowsModel,
			"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.maxRowsModel = $event),
			"auto-resize": "",
			rows: "1",
			"max-rows": 3
		}, {
			default: withCtx(() => [..._cache[14] || (_cache[14] = [createTextVNode(" Automatisk höjd, max 3 rader ", -1)])]),
			_: 1
		}, 8, ["modelValue"])])])]),
		createBaseVNode("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createBaseVNode("section", _hoisted_13, [_cache[17] || (_cache[17] = createBaseVNode("code", { class: "sandbox-case" }, "auto-resize + resizable", -1)), createVNode(_component_f_textarea_field, {
			id: "combined-field",
			modelValue: _ctx.combinedModel,
			"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.combinedModel = $event),
			"auto-resize": "",
			resizable: ""
		}, {
			default: withCtx(() => [..._cache[16] || (_cache[16] = [createTextVNode(" Automatisk höjd vinner över justerbar ", -1)])]),
			_: 1
		}, 8, ["modelValue"])])])]),
		createBaseVNode("div", _hoisted_14, [createBaseVNode("div", _hoisted_15, [createBaseVNode("section", _hoisted_16, [_cache[25] || (_cache[25] = createBaseVNode("h2", null, "Automatisk höjd i wizard", -1)), createVNode(_component_f_wizard, {
			modelValue: _ctx.wizardStep,
			"onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => _ctx.wizardStep = $event),
			"header-tag": "h2",
			"disable-initial-focus": ""
		}, {
			default: withCtx(() => [createVNode(_component_f_wizard_step, {
				key: "wizard-text",
				title: "Steg 1",
				"use-error-list": false
			}, {
				default: withCtx(() => [
					createVNode(_component_f_fieldset, { name: "wizard-choice" }, {
						label: withCtx(() => [..._cache[18] || (_cache[18] = [createTextVNode(" Välj alternativ ", -1)])]),
						default: withCtx(() => [createVNode(_component_f_radio_field, {
							modelValue: _ctx.wizardChoice,
							"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.wizardChoice = $event),
							value: "alternativ-1"
						}, {
							default: withCtx(() => [..._cache[19] || (_cache[19] = [createTextVNode(" Alternativ 1 ", -1)])]),
							_: 1
						}, 8, ["modelValue"]), createVNode(_component_f_radio_field, {
							modelValue: _ctx.wizardChoice,
							"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.wizardChoice = $event),
							value: "alternativ-2"
						}, {
							default: withCtx(() => [..._cache[20] || (_cache[20] = [createTextVNode(" Alternativ 2 ", -1)])]),
							_: 1
						}, 8, ["modelValue"])]),
						_: 1
					}),
					withDirectives((openBlock(), createBlock(_component_f_textarea_field, {
						id: "wizard-auto-resize-field",
						modelValue: _ctx.wizardModel,
						"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.wizardModel = $event),
						"auto-resize": "",
						rows: "3",
						"max-rows": 6
					}, {
						default: withCtx(() => [..._cache[21] || (_cache[21] = [createTextVNode(" Flerradigt inmatningsfält med auto-resize ", -1)])]),
						_: 1
					}, 8, ["modelValue"])), [[
					...
					createVNode(_component_f_checkbox_field, {
						modelValue: _ctx.wizardConfirmed,
						"onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => _ctx.wizardConfirmed = $event),
						value: true
					}, {
						default: withCtx(() => [..._cache[22] || (_cache[22] = [createTextVNode(" Ett alternativ ", -1)])]),
						_: 1
					}, 8, ["modelValue"])
				]),
				_: 1
				...
				"next-button-text": withCtx(() => [..._cache[24] || (_cache[24] = [createTextVNode(" Klar ", -1)])]),
				default: withCtx(() => [withDirectives((openBlock(), createBlock(_component_f_text_field, {
					id: "wizard-text-field",
					modelValue: _ctx.wizardInputModel,
					"onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => _ctx.wizardInputModel = $event)
				}, {
					default: withCtx(() => [..._cache[23] || (_cache[23] = [createTextVNode(" Vanligt inmatningsfält ", -1)])]),
					_: 1
				}, 8, ["modelValue"])), [[
					_directive_validation,
