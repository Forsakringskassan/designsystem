...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-a8d3e2.js
...
exampleComponent.__scopeId = "data-v-a8d3e2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a8d3e2"
});
export {
  render
};
