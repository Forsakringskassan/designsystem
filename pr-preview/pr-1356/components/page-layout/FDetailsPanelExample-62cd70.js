...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-62cd70.js
...
exampleComponent.__scopeId = "data-v-62cd70";
setup({
  rootComponent: exampleComponent,
  selector: "#example-62cd70"
});
export {
  render
};
