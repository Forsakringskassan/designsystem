...
// virtual-entry:virtual:packages/vue/src/components/FTextareaField/examples/FTextareaFieldLiveExample.vue:FTextareaFieldLiveExample-c2200f.js
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_fieldset, { name: "height-settings" }, {
        ...
        default: _withCtx(() => [
          ...
          _createVNode(_component_f_radio_field, {
            modelValue: _ctx.heightMode,
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.heightMode = $event),
            value: "resizable"
          }, {
          ...
          _createVNode(_component_f_radio_field, {
            modelValue: _ctx.heightMode,
            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.heightMode = $event),
            value: "auto"
          }, {
      ...
      _ctx.isAutoResize ? (_openBlock(), _createBlock(_component_f_select_field, {
        ...
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.maxRows = $event)
      }, {
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => _ctx.customWarning = $event),
        value: true
      }, {
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => _ctx.isDisabled = $event),
        value: true
      }, {
