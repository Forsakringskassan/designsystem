...
// virtual-entry:virtual:packages/vue/src/components/FList/examples/FListLiveExample.vue:FListLiveExample-ffc486.js
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.striped = $event),
        value: true
      }, {
      ...
      _createVNode(_component_f_checkbox_field, {
        ...
        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.isEmpty = $event),
        value: true
      }, {
      ...
      _ctx.isEmpty ? (_openBlock(), _createBlock(_component_f_fieldset, {
        ...
        default: _withCtx(() => [
          ...
          _createVNode(_component_f_radio_field, {
            modelValue: _ctx.hasCustomEmptyText,
            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.hasCustomEmptyText = $event),
            value: true
          }, {
