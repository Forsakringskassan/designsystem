...
(() => {
  ...
  __export(index_esm_exports, {
    ...
    FNumericTextField: () => _sfc_main$E,
    FOffline: () => FOffline,
    FOrganisationsnummerTextField: () => _sfc_main$z,
    FOutputField: () => FOutputField,
    FPageHeader: () => FPageHeader,
    FPercentTextField: () => _sfc_main$A,
    FPersonnummerTextField: () => _sfc_main$D,
    FPhoneTextField: () => FPhoneTextField,
    FPlusgiroTextField: () => _sfc_main$C,
    FPostalCodeTextField: () => _sfc_main$B,
    ...
    IFlex: () => IFlex,
    IFlexItem: () => IFlexItem,
    IOptionsPopup: () => _sfc_main$O,
    IPopup: () => IPopup,
    IPopupError: () => IPopupError,
    IPopupListbox: () => _sfc_main$P,
    IPopupMenu: () => IPopupMenu,
    ISkipLink: () => ISkipLink,
    IToggleOptionsButton: () => _sfc_main$N,
  ...
  var _sfc_main$1f = (0, import_vue.defineComponent)({ name: "FBadge", props: {
    /**
  ...
  var FBadge = /* @__PURE__ */ _export_sfc(_sfc_main$1f, [["render", _sfc_render$12]]);
  var Flip = ["horizontal", "vertical"];
  var Rotate = ["90", "180", "270"];
  var _sfc_main$1e = (0, import_vue.defineComponent)({ name: "FIcon", inheritAttrs: false, props: {
    /**
    * Icon name.
    */
  ...
  function _sfc_render$11(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("svg", (0, import_vue.mergeProps)(_ctx.$attrs, { focusable: "false", class: ["icon", [_ctx.spriteKey, ..._ctx.modifiers]], "aria-hidden": _ctx.ariaHidden }), [(0, import_vue.renderSlot)(_ctx.$slots, "default"), _cache[0] || (_cache[0] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("use", { "xlink:href": _ctx.spriteId }, null, 8, _hoisted_2$G)], 16, _hoisted_1$V);
  }
  var FIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1e, [["render", _sfc_render$11]]);
  ...
  var _sfc_main$1d = (0, import_vue.defineComponent)({ name: "FModal", components: { FIcon }, mixins: [TranslationMixin], inheritAttrs: true, props: {
    /**
  ...
  var _hoisted_7$f = { key: 0, ref: "modalTitle", class: "modal__title", tabindex: "-1" };
  var _hoisted_8$a = { ref: "modalContent", class: "modal__content", tabindex: "-1" };
  ...
  function _sfc_render$10(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return _ctx.isOpen ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", { key: 0, id: _ctx.id, class: (0, import_vue.normalizeClass)(["modal", _ctx.modalClass]) }, [(0, import_vue.createElementVNode)("div", _hoisted_2$F, [(0, import_vue.createElementVNode)(
      ...
      32
      /* NEED_HYDRATION */
    )])], 10, _hoisted_1$U)) : (0, import_vue.createCommentVNode)("v-if", true);
  }
  var FModal = /* @__PURE__ */ _export_sfc(_sfc_main$1d, [["render", _sfc_render$10]]);
  ...
  var _sfc_main$1c = (0, import_vue.defineComponent)({ name: "FConfirmModal", components: { FModal }, inheritAttrs: true, props: {
    /**
    * Enable fullscreen mode in mobile.
    */
    fullscreen: { type: Boolean, required: false, default: false },
  ...
  var _hoisted_1$T = { class: "button-group" };
  ...
  function _sfc_render$$(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_f_modal, { fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, "aria-close-text": _ctx.ariaCloseText, type: "warning", size: _ctx.size, onClose: _ctx.onClose }, {
      ...
      footer: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("div", _hoisted_1$T, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        import_vue.Fragment,
        null,
  ...
  var FConfirmModal = /* @__PURE__ */ _export_sfc(_sfc_main$1c, [["render", _sfc_render$$]]);
  var GAP = ["1x", "2x", "3x", "4x", "5x", "6x", "7x", "8x"];
  var ALIGNMENT = ["top", "center", "bottom"];
  var FLOAT = ["left", "center", "right"];
  var _sfc_main$1b = (0, import_vue.defineComponent)({ name: "IFlex", inheritAttrs: true, props: {
    /**
  ...
  var IFlex = /* @__PURE__ */ _export_sfc(_sfc_main$1b, [["render", _sfc_render$_]]);
  var _sfc_main$1a = (0, import_vue.defineComponent)({ name: "IFlexItem", inheritAttrs: true, props: {
    /**
  ...
  var IFlexItem = /* @__PURE__ */ _export_sfc(_sfc_main$1a, [["render", _sfc_render$Z]]);
  ...
  var _sfc_main$19 = (0, import_vue.defineComponent)({ name: "FErrorList", components: { FIcon, IFlex, IFlexItem }, props: {
    /**
  ...
  var _hoisted_1$S = { class: "error-list" };
  ...
  var FErrorList = /* @__PURE__ */ _export_sfc(_sfc_main$19, [["render", _sfc_render$Y]]);
  ...
  var _sfc_main$18 = (0, import_vue.defineComponent)({ name: "FValidationGroup", props: {
    /**
  ...
  var FValidationGroup = /* @__PURE__ */ _export_sfc(_sfc_main$18, [["render", _sfc_render$X]]);
  ...
  var _sfc_main$17 = (0, import_vue.defineComponent)({ name: "FValidationForm", components: { FValidationGroup, FErrorList }, inheritAttrs: false, props: {
    /**
  ...
  function _sfc_render$W(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_f_validation_group, { key: _ctx.groupKey, modelValue: _ctx.validity, "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.validity = $event), "stop-propagation": true }, {
      default: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("form", (0, import_vue.mergeProps)({ id: _ctx.id }, _ctx.$attrs, { novalidate: "", autocomplete: "off", onSubmit: _cache[0] || (_cache[0] = (0, import_vue.withModifiers)((...args) => _ctx.onSubmit && _ctx.onSubmit(...args), ["prevent"])) }), [_ctx.displayErrors ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
        ...
        512
        /* NEED_PATCH */
      )) : (0, import_vue.createCommentVNode)("v-if", true), _cache[2] || (_cache[2] = (0, import_vue.createTextVNode)()), (0, import_vue.renderSlot)(_ctx.$slots, "default")], 16, _hoisted_1$R)]),
      _: 3
      /* FORWARDED */
    }, 8, ["modelValue"]);
  }
  var FValidationForm = /* @__PURE__ */ _export_sfc(_sfc_main$17, [["render", _sfc_render$W]]);
  var _sfc_main$16 = (0, import_vue.defineComponent)({ name: "FFormModal", components: { FModal, FValidationForm }, mixins: [TranslationMixin], inheritAttrs: true, props: {
    /**
    * Enable fullscreen mode in mobile.
    */
  ...
  var _hoisted_1$Q = { class: "button-group" };
  ...
  function _sfc_render$V(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_f_modal, { "data-test": _ctx.dataTest, fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, size: _ctx.size, "aria-close-text": _ctx.ariaCloseText, onClose: _ctx.onClose }, {
      ...
      footer: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("div", _hoisted_1$Q, [!_ctx.hasDeprecatedSlots ? ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        import_vue.Fragment,
        { key: 0 },
        (0, import_vue.renderList)(_ctx.preparedButtons, (button) => {
  ...
  var FFormModal = /* @__PURE__ */ _export_sfc(_sfc_main$16, [["render", _sfc_render$V]]);
  ...
  var _sfc_main$15 = (0, import_vue.defineComponent)({ name: "FErrorPage", props: { payload: { type: Object, required: false, default: null } } });
  var _hoisted_1$P = { "data-test": "f-error-page" };
  function _sfc_render$U(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_1$P, _cache[0] || (_cache[0] = [(0, import_vue.createElementVNode)(
      "h1",
      null,
      "Fel",
      -1
  ...
  var FErrorPage = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["render", _sfc_render$U]]);
  var _sfc_main$14 = (0, import_vue.defineComponent)({ name: "FErrorHandlingApp", props: { defaultComponent: { type: [Function, Object], required: false, default: void 0 }, errorComponent: { type: [Function, Object], required: false, default: FErrorPage } }, data() {
  ...
  var FErrorHandlingApp = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["render", _sfc_render$T]]);
  ...
  var _sfc_main$13 = (0, import_vue.defineComponent)({ name: "ICalendarNavbar", components: { FIcon }, mixins: [TranslationMixin], props: {
    /**
    * Focused month.
    */
  ...
  var _hoisted_1$O = { class: "calendar-navbar" };
  ...
  function _sfc_render$S(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_f_icon = (0, import_vue.resolveComponent)("f-icon");
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_1$O, [(0, import_vue.createElementVNode)(
      "div",
      _hoisted_2$A,
  ...
  var ICalendarNavbar = /* @__PURE__ */ _export_sfc(_sfc_main$13, [["render", _sfc_render$S]]);
  ...
  var _sfc_main$12 = (0, import_vue.defineComponent)({ name: "ICalendarMonthGrid", props: {
    /**
    * Focused month.
    * @model
    */
  ...
  var _hoisted_1$N = { key: 0, class: "calendar-month__col--week" };
  ...
  var _hoisted_7$e = { key: 0, class: "calendar-month__cell calendar-month__cell--week-number", "aria-hidden": "true" };
  var _hoisted_8$9 = ["colspan"];
  var _hoisted_9$6 = ["colspan"];
  ...
  function _sfc_render$R(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [(0, import_vue.createElementVNode)("colgroup", null, [!_ctx.internalHideWeekNumbers ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("col", _hoisted_1$N)) : (0, import_vue.createCommentVNode)("v-if", true), _cache[2] || (_cache[2] = (0, import_vue.createTextVNode)()), _cache[3] || (_cache[3] = (0, import_vue.createElementVNode)(
        "col",
        ...
        (0, import_vue.renderList)(_ctx.weeks, (week) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("tr", { key: week.week, role: "presentation" }, [!_ctx.internalHideWeekNumbers ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
            ...
            128
            /* KEYED_FRAGMENT */
          )), _cache[19] || (_cache[19] = (0, import_vue.createTextVNode)()), _ctx.getDayEndOffset(week.days) ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("td", { key: 2, class: "calendar-month__cell", colspan: _ctx.getDayEndOffset(week.days), "aria-hidden": "true" }, null, 8, _hoisted_9$6)) : (0, import_vue.createCommentVNode)("v-if", true)]);
        }),
        128
        /* KEYED_FRAGMENT */
  ...
  var ICalendarMonthGrid = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["render", _sfc_render$R]]);
  ...
  var _sfc_main$11 = (0, import_vue.defineComponent)({ name: "ICalendarMonth", components: { ICalendarMonthGrid }, mixins: [TranslationMixin], props: {
    /**
    * Active month.
    * @model
    */
  ...
  function _sfc_render$Q(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_i_calendar_month_grid, { value: _ctx.modelValue }, {
      default: (0, import_vue.withCtx)(({ date }) => [(0, import_vue.createElementVNode)("button", { ref: date.toString(), class: "calendar-month__button", "data-test": "select-day-button", "data-date": date.toString(), tabindex: _ctx.getTabindex(date), type: "button", onClick: (0, import_vue.withModifiers)(($event) => _ctx.onClickDay(date), ["stop", "prevent"]), onKeydown: ($event) => _ctx.onKeydownDay(date, $event) }, [(0, import_vue.renderSlot)(_ctx.$slots, "default", { date, isFocused: _ctx.isDayFocused(date) })], 40, _hoisted_1$M)]),
      _: 3
      /* FORWARDED */
    }, 8, ["value"]);
  }
  var ICalendarMonth = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["render", _sfc_render$Q]]);
  var _sfc_main$10 = (0, import_vue.defineComponent)({ name: "FCalendar", components: { ICalendarNavbar, ICalendarMonth }, props: {
    /**
    * Active month.
    * @model
    */
  ...
  var _hoisted_1$L = { class: "calendar__wrapper" };
  function _sfc_render$P(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_1$L, [(0, import_vue.createVNode)(_component_i_calendar_navbar, { "model-value": _ctx.modelValue, "min-date": _ctx.minDate, "max-date": _ctx.maxDate, "onUpdate:modelValue": _ctx.onChangeMonth }, null, 8, ["model-value", "min-date", "max-date", "onUpdate:modelValue"]), _cache[0] || (_cache[0] = (0, import_vue.createTextVNode)()), (0, import_vue.createVNode)(_component_i_calendar_month, { "model-value": _ctx.modelValue, "min-date": _ctx.minDate, "max-date": _ctx.maxDate, "tab-date": _ctx.tabDate, onClick: _ctx.onClickDay, "onUpdate:modelValue": _ctx.onChangeMonth }, {
  ...
  var FCalendar = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["render", _sfc_render$P]]);
  ...
  var _sfc_main$$ = (0, import_vue.defineComponent)({ name: "FCalendarDay", mixins: [TranslationMixin], props: {
    /**
    * Day to render.
    */
  ...
  var _hoisted_1$K = { "aria-hidden": "true" };
  ...
  var FCalendarDay = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["render", _sfc_render$O]]);
  ...
  var _sfc_main$_ = (0, import_vue.defineComponent)({ name: "IPopup", inheritAttrs: false, props: {
    /**
  ...
  var IPopup = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["render", _sfc_render$N]]);
  ...
  var _sfc_main$Z = (0, import_vue.defineComponent)({ name: "FContextMenu", components: { IPopup, FIcon }, props: {
    /**
    * Toggle open/closed popup.
    */
    isOpen: { type: Boolean, required: true },
  ...
  var FContextMenu = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$M]]);
  ...
  var _sfc_main$Y = (0, import_vue.defineComponent)({ name: "FFieldset", components: { FIcon }, mixins: [TranslationMixin], props: {
    /**
  ...
  function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("fieldset", { id: _ctx.id, class: (0, import_vue.normalizeClass)(["fieldset", _ctx.classes]), onValidity: _cache[0] || (_cache[0] = (...args) => _ctx.onValidity && _ctx.onValidity(...args)) }, [((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      import_vue.Fragment,
      { key: 1 },
      [(0, import_vue.createElementVNode)("div", _hoisted_7$d, [(0, import_vue.createElementVNode)("div", _hoisted_8$8, [(0, import_vue.createElementVNode)("div", _hoisted_9$5, [(0, import_vue.renderSlot)(_ctx.$slots, "label")])]), _cache[4] || (_cache[4] = (0, import_vue.createTextVNode)()), (0, import_vue.renderSlot)(_ctx.$slots, "tooltip")]), _cache[6] || (_cache[6] = (0, import_vue.createTextVNode)()), _ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot || _ctx.hasError ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
        "div",
  ...
  var FFieldset = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["render", _sfc_render$L]]);
  var anyType$1 = [String, Object, Array, Number, Date, Boolean];
  var _sfc_main$X = (0, import_vue.defineComponent)({ name: "FCheckboxField", inheritAttrs: false, props: {
    /**
  ...
  function _sfc_render$K(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [(0, import_vue.createElementVNode)("input", (0, import_vue.mergeProps)({ id: _ctx.id }, _ctx.attrs, { ref: "checkboxInput", type: "checkbox", class: "checkbox__input", disabled: _ctx.disabled, onKeydown: _cache[0] || (_cache[0] = (0, import_vue.withKeys)((...args) => _ctx.onKeydown && _ctx.onKeydown(...args), ["space"])), onChange: _cache[1] || (_cache[1] = ($event) => _ctx.updateExpandedFlag()) }), null, 16, _hoisted_1$H), _cache[9] || (_cache[9] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("label", { class: (0, import_vue.normalizeClass)(_ctx.$slots.details ? "checkbox__label checkbox__width" : "checkbox__label"), for: _ctx.id }, [(0, import_vue.renderSlot)(_ctx.$slots, "default"), _cache[8] || (_cache[8] = (0, import_vue.createTextVNode)()), _ctx.$slots.details ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
        import_vue.Fragment,
        { key: 0 },
  ...
  var FCheckboxField = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["render", _sfc_render$K]]);
  var _sfc_main$W = (0, import_vue.defineComponent)({ name: "FCheckboxGroup", components: { FFieldset }, mixins: [TranslationMixin], inheritAttrs: false, props: {
    /**
    * The id for the fieldset id attribute.
  ...
  var FCheckboxGroup = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$J]]);
  ...
  var _sfc_main$V = (0, import_vue.defineComponent)({ name: "FCrudDataset", components: { FFormModal, FConfirmModal, FIcon }, mixins: [TranslationMixin], provide() {
    return { delete: (item) => {
  ...
  var _hoisted_1$G = { class: "crud-dataset" };
  ...
  var FCrudDataset = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["render", _sfc_render$I]]);
  function FCrudDatasetInjected() {
    return { delete: (0, import_vue.inject)("delete"), modify: (0, import_vue.inject)("modify") };
  }
  var _sfc_main$U = (0, import_vue.defineComponent)({ name: "FCrudButton", components: { FIcon }, mixins: [TranslationMixin], props: { action: { type: String, required: true, validator(value) {
  ...
  var _hoisted_1$F = { key: 1, class: "sr-only" };
  function _sfc_render$H(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_f_icon = (0, import_vue.resolveComponent)("f-icon");
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("button", { type: "button", class: "button button--small button--tertiary", onClick: _cache[0] || (_cache[0] = (...args) => _ctx.executeAction && _ctx.executeAction(...args)) }, [_ctx.icon ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_f_icon, { key: 0, class: "button__icon", name: _ctx.iconName }, null, 8, ["name"])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[1] || (_cache[1] = (0, import_vue.createTextVNode)()), !_ctx.label ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("span", _hoisted_1$F, [(0, import_vue.renderSlot)(_ctx.$slots, "default", {}, () => [(0, import_vue.createTextVNode)(
  ...
  var FCrudButton = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["render", _sfc_render$H]]);
  ...
  var _sfc_main$T = (0, import_vue.defineComponent)({ name: "FTableColumn", inheritAttrs: false, props: {
    /**
  ...
  var FTableColumn = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["render", _sfc_render$G]]);
  ...
  var _sfc_main$S = (0, import_vue.defineComponent)({ name: "FLabel", components: { FIcon }, props: {
    /**
  ...
  function _sfc_render$E(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [(0, import_vue.createElementVNode)(
        ...
        [(0, import_vue.withDirectives)((0, import_vue.createElementVNode)("select", (0, import_vue.mergeProps)({ id: _ctx.id, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.vModel = $event), class: "select-field__select" }, _ctx.attrs), [(0, import_vue.renderSlot)(_ctx.$slots, "default")], 16, _hoisted_1$D), [[import_vue.vModelSelect, _ctx.vModel]]), _cache[5] || (_cache[5] = (0, import_vue.createTextVNode)()), _ctx.hasError && _ctx.textFieldTableMode ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(
          _component_f_icon,
  ...
  var FSelectField = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["render", _sfc_render$E]]);
  ...
  var _sfc_main$Q = (0, import_vue.defineComponent)({ name: "IPopupError", components: { FIcon }, inheritAttrs: false, props: {
    /**
  ...
  var IPopupError = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["render", _sfc_render$D]]);
  ...
  function useCombobox(inputRef, options) {
    if (!options) {
      return { dropdownId: "", dropdownIsOpen: (0, import_vue.ref)(false), dropdownOptions: (0, import_vue.ref)([]), activeOptionId: "", activeOption: (0, import_vue.ref)(null), selectedValue: (0, import_vue.ref)(null), toggleDropdown() {
      }, closeDropdown() {
      } };
    }
    ...
    function onInputFocus() {
      var _ref3;
      selectMode.value = (_ref3 = options == null ? void 0 : options.includes(filter2.value)) !== null && _ref3 !== void 0 ? _ref3 : false;
    }
    ...
    return { dropdownId, dropdownIsOpen, dropdownOptions, activeOptionId, activeOption, toggleDropdown, closeDropdown: close, selectedValue };
  }
  function numItems(itemHeight, availableHeight) {
    return Math.min(Math.floor(availableHeight / itemHeight), 6);
  }
  function tryBelow(itemHeight, anchor, viewport) {
    ...
    const fittedHeight = itemHeight * itemsFit;
    return { left: anchor.x, top: anchor.y + anchor.height, width: anchor.width, height: fittedHeight };
  }
  function tryAbove(itemHeight, anchor, viewport) {
    const p1 = viewport.y;
    const p2 = anchor.y;
    ...
    const fittedHeight = itemHeight * itemsFit;
    return { left: anchor.x, top: anchor.y - fittedHeight, width: anchor.width, height: fittedHeight };
  }
  function computeListboxRect(anchor, options, root2 = document.documentElement, { scrollY, scrollX } = window) {
    const { itemHeight } = options;
    const rect = anchor.getBoundingClientRect();
    const anchorRect = { x: Math.floor(rect.x + scrollX), y: Math.floor(rect.top + scrollY), width: Math.floor(rect.width), height: Math.floor(rect.height) };
    const viewportRect = { y: scrollY, height: root2.clientHeight };
    const d = tryBelow(itemHeight, anchorRect, viewportRect);
    if (d) {
      return d;
    }
    const u = tryAbove(itemHeight, anchorRect, viewportRect);
    if (u) {
      return u;
    }
    return void 0;
  }
  var _hoisted_1$B = ["onKeyup"];
  var teleportDisabled = false;
  var _sfc_main$P = /* @__PURE__ */ (0, import_vue.defineComponent)({ __name: "IPopupListbox", props: { isOpen: { type: Boolean }, anchor: {} }, emits: ["close"], setup(__props, { emit: __emit }) {
    const emit = __emit;
    ...
    return (_ctx, _cache) => {
      return _ctx.isOpen ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(import_vue.Teleport, { key: 0, to: "body", disabled: teleportDisabled }, [(0, import_vue.createElementVNode)(
        "div",
        (0, import_vue.mergeProps)({ ref: "popup" }, _ctx.$attrs, { class: popupClasses }),
        [(0, import_vue.createElementVNode)("div", { ref_key: "wrapper", ref: wrapper, role: "presentation", class: "popup__wrapper", onKeyup: (0, import_vue.withKeys)((0, import_vue.withModifiers)(onKeyEsc, ["stop"]), ["esc"]), onClick: _cache[0] || (_cache[0] = (0, import_vue.withModifiers)(() => {
        }, ["stop"])) }, [(0, import_vue.renderSlot)(_ctx.$slots, "default")], 40, _hoisted_1$B)],
        16
        /* FULL_PROPS */
      )])) : (0, import_vue.createCommentVNode)("v-if", true);
    };
  } });
  var _hoisted_1$A = { class: "combobox" };
  var _hoisted_2$s = ["id"];
  var _hoisted_3$n = ["id", "aria-selected", "onClick"];
  var _sfc_main$O = /* @__PURE__ */ (0, import_vue.defineComponent)({ __name: "IOptionsPopup", props: { id: {}, isOpen: { type: Boolean }, options: {}, activeOption: {}, activeOptionId: {}, inputNode: {} }, emits: ["select", "close"], setup(__props, { emit: __emit }) {
    const emit = __emit;
    ...
    (0, import_vue.watchEffect)(async () => {
      ...
      if (__props.activeOption !== null) {
        ...
        if (activeOptionNode) {
          activeOptionNode.scrollIntoView({ behavior: "smooth", block: "nearest" });
        }
      }
    });
    return (_ctx, _cache) => {
      return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_1$A, [(0, import_vue.createVNode)((0, import_vue.unref)(_sfc_main$P), { "is-open": _ctx.isOpen, anchor: _ctx.inputNode, onClose: onListboxClose }, {
        default: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("ul", { id: _ctx.id, ref_key: "listboxNode", ref: listboxNode, role: "listbox", "aria-label": "F\xF6rslag", class: "combobox__listbox" }, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
          import_vue.Fragment,
          null,
          (0, import_vue.renderList)(_ctx.options, (item) => {
            return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", { id: isOptionActive(item) ? _ctx.activeOptionId : void 0, key: item, role: "option", "aria-selected": isOptionActive(item) ? "true" : void 0, class: (0, import_vue.normalizeClass)(["combobox__listbox__option", { "combobox__listbox__option--highlight": isOptionActive(item) }]), onClick: (0, import_vue.withModifiers)(($event) => onOptionClick(item), ["stop", "prevent"]) }, (0, import_vue.toDisplayString)(item), 11, _hoisted_3$n);
          }),
          128
          /* KEYED_FRAGMENT */
        ))], 8, _hoisted_2$s)]),
  ...
  var _sfc_main$N = /* @__PURE__ */ (0, import_vue.defineComponent)({ __name: "IToggleOptionsButton", emits: ["toggle"], setup(__props, { emit: __emit }) {
    const emit = __emit;
    return (_ctx, _cache) => {
      return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("button", { class: "text-field__icon clear-button", type: "button", "aria-label": "\xD6ppna f\xF6rslagen", tabindex: "-1", onClick: _cache[0] || (_cache[0] = (0, import_vue.withModifiers)(($event) => emit("toggle"), ["stop", "prevent"])) }, [(0, import_vue.createVNode)((0, import_vue.unref)(FIcon), { name: "arrow-down" })]);
    };
  } });
  function resolveWidthClass(words, inline) {
    return inline ? void 0 : words.split(" ").map((word) => `i-width-${word}`).join(" ");
  }
  var _sfc_main$M = (0, import_vue.defineComponent)({ name: "FTextField", components: { FLabel, FIcon, IPopupError, IToggleOptionsButton: _sfc_main$N, IOptionsPopup: _sfc_main$O }, inheritAttrs: false, props: {
    /**
    * The id for the input id attribute.
    * The id for the label for attribute.
    * If the prop is not set a random value will be generated.
  ...
  } }, selectedValue: { immediate: false, handler: async function(newValue) {
  ...
  } } }, methods: { onDropdownSelect(value) {
  ...
  var _hoisted_7$b = { key: 3, class: "text-field__append-inner" };
  function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_f_label = (0, import_vue.resolveComponent)("f-label");
    const _component_f_icon = (0, import_vue.resolveComponent)("f-icon");
    const _component_i_popup_error = (0, import_vue.resolveComponent)("i-popup-error");
    const _component_i_toggle_options_button = (0, import_vue.resolveComponent)("i-toggle-options-button");
    const _component_i_options_popup = (0, import_vue.resolveComponent)("i-options-popup");
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      "div",
      ...
      [(0, import_vue.createElementVNode)(
        ...
        [(0, import_vue.renderSlot)(_ctx.$slots, "input-left"), _cache[16] || (_cache[16] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("div", _hoisted_4$i, [(0, import_vue.withDirectives)((0, import_vue.createElementVNode)("input", (0, import_vue.mergeProps)({ id: _ctx.id, ref: "input", "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.viewValue = $event), type: _ctx.type, class: "text-field__input" }, _ctx.$attrs, { onBlur: _cache[1] || (_cache[1] = (...args) => _ctx.onBlur && _ctx.onBlur(...args)), onFocus: _cache[2] || (_cache[2] = (...args) => _ctx.onFocus && _ctx.onFocus(...args)), onChange: _cache[3] || (_cache[3] = (...args) => _ctx.onChange && _ctx.onChange(...args)), onValidity: _cache[4] || (_cache[4] = (...args) => _ctx.onValidity && _ctx.onValidity(...args)), onPendingValidity: _cache[5] || (_cache[5] = (...args) => _ctx.onPendingValidity && _ctx.onPendingValidity(...args)) }), null, 16, _hoisted_5$e), [[import_vue.vModelDynamic, _ctx.viewValue]]), _cache[12] || (_cache[12] = (0, import_vue.createTextVNode)()), _ctx.hasError && _ctx.textFieldTableMode ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(
          _component_f_icon,
          { key: 0, ref: "icon", class: "text-field__icon input-icon text-field__append-inner text-field__error-popup-icon", name: "error" },
          null,
          512
          /* NEED_PATCH */
        )) : (0, import_vue.createCommentVNode)("v-if", true), _cache[13] || (_cache[13] = (0, import_vue.createTextVNode)()), _ctx.textFieldTableMode ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_i_popup_error, { key: 1, anchor: _ctx.getErrorPopupAnchor(), "is-open": _ctx.showPopupError, "error-message": _ctx.validationMessage, onClose: _ctx.closePopupError }, null, 8, ["anchor", "is-open", "error-message", "onClose"])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[14] || (_cache[14] = (0, import_vue.createTextVNode)()), _ctx.$slots["append-inner"] ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_6$b, [(0, import_vue.renderSlot)(_ctx.$slots, "append-inner")])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[15] || (_cache[15] = (0, import_vue.createTextVNode)()), _ctx.options ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_7$b, [(0, import_vue.createVNode)(_component_i_toggle_options_button, { "aria-controls": _ctx.dropdownId, "aria-expanded": _ctx.dropdownIsOpen, onToggle: _ctx.toggleDropdown }, null, 8, ["aria-controls", "aria-expanded", "onToggle"])])) : (0, import_vue.createCommentVNode)("v-if", true)]), _cache[17] || (_cache[17] = (0, import_vue.createTextVNode)()), (0, import_vue.renderSlot)(_ctx.$slots, "input-right")],
        2
        /* CLASS */
      ), _cache[19] || (_cache[19] = (0, import_vue.createTextVNode)()), _ctx.options && _ctx.$refs.input ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(_component_i_options_popup, { key: 0, id: _ctx.dropdownId, "is-open": _ctx.dropdownIsOpen, options: _ctx.dropdownOptions, "active-option": _ctx.activeOption, "active-option-id": _ctx.activeOptionId, "input-node": _ctx.$refs.input, onSelect: _ctx.onDropdownSelect, onClose: _ctx.onDropdownClose }, null, 8, ["id", "is-open", "options", "active-option", "active-option-id", "input-node", "onSelect", "onClose"])) : (0, import_vue.createCommentVNode)("v-if", true)],
      2
      /* CLASS */
    );
  }
  ...
  var _sfc_main$I = (0, import_vue.defineComponent)({ name: "FSearchTextField", components: { FTextField, FIcon }, props: { id: { type: String, required: false, default: () => import_logic.ElementIdService.generateElementId() }, modelValue: { type: String, required: false, default: "" }, clearableScreenReaderText: { type: String, required: false, default: import_logic.TranslationService.provider.translate("fkui.search-text-field.search-screen-reader", "T\xF6m inmatningsf\xE4lt") }, maxLength: { type: Number, default: 80 } }, emits: ["blur", "change", "update", "update:modelValue"], data() {
  ...
  var _sfc_main$G = (0, import_vue.defineComponent)({ name: "FBankgiroTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.parseBankgiro } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$F = (0, import_vue.defineComponent)({ name: "FClearingnumberTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.parseClearingNumber } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$E = (0, import_vue.defineComponent)({ name: "FNumericTextField", extends: FTextField, props: {
    /**
  ...
  var _sfc_main$D = (0, import_vue.defineComponent)({ name: "FPersonnummerTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.formatPersonnummer }, parser: { type: Function, required: false, default: import_logic.parsePersonnummer } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$C = (0, import_vue.defineComponent)({ name: "FPlusgiroTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.parsePlusgiro } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$B = (0, import_vue.defineComponent)({ name: "FPostalCodeTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.formatPostalCode } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$A = (0, import_vue.defineComponent)({ name: "FPercentTextField", extends: FTextField, mixins: [TranslationMixin], props: {
    /**
    * The number of decimals to format number as.
    */
    decimals: { type: Number, required: false, default: void 0 },
  ...
  var _sfc_main$z = (0, import_vue.defineComponent)({ name: "FOrganisationsnummerTextField", extends: FTextField, mixins: [TranslationMixin], props: { formatter: { type: Function, required: false, default: import_logic.parseOrganisationsnummer } }, setup() {
    return { textFieldTableMode: (0, import_vue.inject)("textFieldTableMode", false) };
  }, data() {
  ...
  var _sfc_main$y = (0, import_vue.defineComponent)({ name: "FSortFilterDataset", components: { FSelectField, FTextField, FIcon, IFlex, IFlexItem }, mixins: [TranslationMixin], provide() {
  ...
  function _sfc_render$x(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [(0, import_vue.createElementVNode)("table", (0, import_vue.mergeProps)({ class: ["table", _ctx.tableClasses], tabindex: _ctx.tabindex }, _ctx.$attrs), [_ctx.hasCaption ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("caption", _hoisted_2$p, [(0, import_vue.renderSlot)(_ctx.$slots, "caption")])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[4] || (_cache[4] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("colgroup", null, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        ...
        128
        /* KEYED_FRAGMENT */
      ))])]), _cache[6] || (_cache[6] = (0, import_vue.createTextVNode)()), (0, import_vue.createElementVNode)("tbody", null, [_ctx.isEmpty && _ctx.columns.length === 0 ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("tr", _hoisted_6$9, [(0, import_vue.renderSlot)(_ctx.$slots, "default", (0, import_vue.normalizeProps)((0, import_vue.guardReactiveProps)({ row: {} })))])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[2] || (_cache[2] = (0, import_vue.createTextVNode)()), _ctx.isEmpty ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("tr", _hoisted_7$9, [(0, import_vue.createElementVNode)("td", { class: "table__column table__column--action", colspan: _ctx.columns.length }, [(0, import_vue.renderSlot)(_ctx.$slots, "empty", {}, () => [(0, import_vue.createTextVNode)(
        (0, import_vue.toDisplayString)(_ctx.$t("fkui.data-table.empty", "Tabellen \xE4r tom")),
        1
        /* TEXT */
      )])], 8, _hoisted_8$7)])) : (0, import_vue.createCommentVNode)("v-if", true), _cache[3] || (_cache[3] = (0, import_vue.createTextVNode)()), ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        import_vue.Fragment,
        null,
  ...
  var _sfc_main$w = (0, import_vue.defineComponent)({ name: "FDatepickerField", components: { FCalendar, IPopup, FTextField, FIcon, FCalendarDay }, mixins: [TranslationMixin], inheritAttrs: false, props: {
    /** Selected day.
    * @model
    */
  ...
  function _sfc_render$u(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [((0, import_vue.openBlock)(), (0, import_vue.createBlock)((0, import_vue.resolveDynamicComponent)(_ctx.headerTag), { class: "expandable-panel__heading" }, {
        ...
        default: (0, import_vue.withCtx)(() => [(0, import_vue.withDirectives)((0, import_vue.createElementVNode)("div", { id: _ctx.id, class: "expandable-panel__content" }, [(0, import_vue.createElementVNode)("div", _hoisted_7$8, [(0, import_vue.renderSlot)(_ctx.$slots, "default")]), _cache[5] || (_cache[5] = (0, import_vue.createTextVNode)()), _ctx.hasOutsideSlot ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_8$6, [(0, import_vue.renderSlot)(_ctx.$slots, "outside")])) : (0, import_vue.createCommentVNode)("v-if", true)], 8, _hoisted_6$8), [[import_vue.vShow, _ctx.expanded]])]),
        _: 3
        /* FORWARDED */
      })],
      2
  ...
  function _sfc_render$t(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)(
      ...
      [(0, import_vue.createElementVNode)(
        ...
        default: (0, import_vue.withCtx)(() => [(0, import_vue.withDirectives)((0, import_vue.createElementVNode)("div", { id: _ctx.id, class: "expandable-paragraph__container" }, [(0, import_vue.createElementVNode)("div", _hoisted_6$7, [(0, import_vue.renderSlot)(_ctx.$slots, "default")]), _cache[4] || (_cache[4] = (0, import_vue.createTextVNode)()), !_ctx.list ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", _hoisted_7$7)) : (0, import_vue.createCommentVNode)("v-if", true)], 8, _hoisted_5$a), [[import_vue.vShow, _ctx.expanded]])]),
        _: 3
        /* FORWARDED */
      })],
      2
  ...
  var _sfc_main$p = (0, import_vue.defineComponent)({ name: "FForm", components: { FMessageBox, FErrorList }, provide() {
  ...
  var FLayoutApplicationTemplate = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$l]]);
  ...
  var _sfc_main$k = (0, import_vue.defineComponent)({ name: "FLayoutLeftPanel", components: { FIcon }, props: {
    /**
  ...
  var FLayoutLeftPanel = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$k]]);
  ...
  var _sfc_main$j = (0, import_vue.defineComponent)({ name: "FLayoutRightPanel", components: { FIcon }, props: {
    /**
    * The default width for the panel in pixels
    */
  ...
  var FLayoutRightPanel = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$j]]);
  var _sfc_main$i = (0, import_vue.defineComponent)({ name: "FList", components: { FCheckboxField }, mixins: [TranslationMixin], props: {
    /**
  ...
  var _hoisted_7$5 = { class: "list__item__selectpane__input" };
  var _hoisted_8$5 = ["id"];
  var _hoisted_9$4 = { key: 0, class: "list__item" };
  ...
  function _sfc_render$i(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return !_ctx.selectable ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("ul", _hoisted_1$h, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
      ...
      (0, import_vue.renderList)(_ctx.items, (item, index) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", { id: _ctx.getItemId(item), key: _ctx.itemKey(item), "aria-labelledby": _ctx.getItemId(item), class: (0, import_vue.normalizeClass)([_ctx.itemClasses(item), "list__item"]), tabindex: _ctx.checkbox ? 0 : void 0, onKeydown: (0, import_vue.withModifiers)(($event) => _ctx.onItemKeyDown($event, item), ["self"]), onFocus: _cache[0] || (_cache[0] = (0, import_vue.withModifiers)((...args) => _ctx.onItemFocus && _ctx.onItemFocus(...args), ["self"])), onBlur: _cache[1] || (_cache[1] = (0, import_vue.withModifiers)((...args) => _ctx.onItemBlur && _ctx.onItemBlur(...args), ["self"])) }, [_ctx.checkbox ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", { key: 0, class: "list__item__selectpane", onClick: (0, import_vue.withModifiers)(($event) => _ctx.onSelect(item), ["self"]) }, [(0, import_vue.createElementVNode)("div", _hoisted_7$5, [(0, import_vue.createVNode)(_component_f_checkbox_field, { value: true, "model-value": _ctx.isSelected(item), onClick: (0, import_vue.withModifiers)(($event) => _ctx.onSelect(item), ["self"]) }, {
          default: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("span", { id: _ctx.getAriaLabelledbyId(item), class: "sr-only" }, [(0, import_vue.renderSlot)(_ctx.$slots, "screenreader", (0, import_vue.mergeProps)({ ref_for: true }, { item }))], 8, _hoisted_8$5)]),
          _: 2
          /* DYNAMIC */
        }, 1032, ["model-value", "onClick"])])], 8, _hoisted_6$5)) : (0, import_vue.createCommentVNode)("v-if", true), _cache[3] || (_cache[3] = (0, import_vue.createTextVNode)()), ((0, import_vue.openBlock)(), (0, import_vue.createBlock)((0, import_vue.resolveDynamicComponent)(_ctx.checkbox ? "div" : "a"), { ref_for: true, ref: "listItemPanes", href: !_ctx.checkbox ? "javascript:" : void 0, class: "list__item__itempane", onClick: ($event) => _ctx.onItemClick($event, index, item) }, {
      ...
      128
      /* KEYED_FRAGMENT */
    )), _cache[4] || (_cache[4] = (0, import_vue.createTextVNode)()), _ctx.isEmpty ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", _hoisted_9$4, [(0, import_vue.createElementVNode)("div", _hoisted_10$3, [(0, import_vue.renderSlot)(_ctx.$slots, "empty", {}, () => [(0, import_vue.createElementVNode)(
      "em",
      null,
      (0, import_vue.toDisplayString)(_ctx.$t("fkui.list.empty", "Listan \xE4r tom")),
      1
  ...
  var FList = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$i]]);
  var _sfc_main$h = (0, import_vue.defineComponent)({ name: "FLoader", mixins: [TranslationMixin], inheritAttrs: false, props: {
  ...
  var FLoader = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$h]]);
  ...
  var _sfc_main$g = (0, import_vue.defineComponent)({ name: "IPopupMenu", components: { IPopup }, props: {
    /**
      ...
      default: (0, import_vue.withCtx)(() => [(0, import_vue.createElementVNode)("nav", { class: "ipopupmenu ipopupmenu--vertical", "aria-label": _ctx.ariaLabel }, [(0, import_vue.createElementVNode)("ul", _hoisted_2$b, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        ...
        (0, import_vue.renderList)(_ctx.items, (item, index) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", { ref_for: true, ref: "items", key: item.key, role: "presentation", class: (0, import_vue.normalizeClass)(_ctx.itemClasses(item)), onClick: (event) => _ctx.onClickItem(event, item) }, [(0, import_vue.createElementVNode)("a", { ref_for: true, ref: "anchors", "data-ref-index": index, href: item.href, role: "menuitem", target: item.target, tabindex: "0" }, [_ctx.isSelected(index) ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("span", _hoisted_5$6, [(0, import_vue.createElementVNode)(
            ...
            1
            /* TEXT */
          )], 8, _hoisted_4$7)], 10, _hoisted_3$9);
        }),
        128
        /* KEYED_FRAGMENT */
      ))])], 8, _hoisted_1$f)]),
  ...
  var IPopupMenu = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$g]]);
  ...
  var _sfc_main$f = (0, import_vue.defineComponent)({ name: "FNavigationMenu", components: { FIcon, IPopupMenu }, mixins: [TranslationMixin], props: {
    /**
    * Current route.
    */
  ...
  var _hoisted_3$8 = { class: "imenu__list__anchor-container" };
  var _hoisted_4$6 = ["data-ref-index", "href", "target"];
  var _hoisted_5$5 = { key: 0, class: "sr-only" };
  var _hoisted_6$4 = { key: 0, class: "imenu__popup-item", role: "none" };
  var _hoisted_7$4 = { class: "imenu__list__anchor-container" };
  var _hoisted_8$4 = ["aria-expanded"];
  var _hoisted_9$3 = { class: "sr-only" };
  function _sfc_render$f(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_f_icon = (0, import_vue.resolveComponent)("f-icon");
      ...
      [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(
        ...
        (0, import_vue.renderList)(_ctx.items, (item, index) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", { key: item.key, ref_for: true, ref: "items", "data-ref-index": index, class: (0, import_vue.normalizeClass)(_ctx.itemClasses(item, index)), role: "none", onClick: (event) => _ctx.onClickItem(event, item) }, [(0, import_vue.createElementVNode)("div", _hoisted_3$8, [(0, import_vue.createElementVNode)("a", { ref_for: true, ref: "anchors", "data-ref-index": index, tabindex: "0", href: item.href, target: item.target, class: "imenu__list__anchor", role: "menuitem" }, [_ctx.showItemSrText(index) ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("span", _hoisted_5$5, [(0, import_vue.createElementVNode)(
            ...
            1
            /* TEXT */
          )], 8, _hoisted_4$6)])], 10, _hoisted_2$a);
        }),
        128
        /* KEYED_FRAGMENT */
      )), _cache[6] || (_cache[6] = (0, import_vue.createTextVNode)()), _ctx.hasOverflow ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", _hoisted_6$4, [(0, import_vue.createElementVNode)(
        "div",
        ...
        [(0, import_vue.createElementVNode)("div", _hoisted_7$4, [(0, import_vue.createElementVNode)("a", { ref: "popup-anchor", tabindex: "0", class: "imenu__list__anchor", role: "menuitem", "aria-haspopup": "menu", "aria-expanded": _ctx.popupOpen ? "true" : "false" }, [(0, import_vue.createElementVNode)("span", _hoisted_9$3, [(0, import_vue.createElementVNode)(
          "span",
          null,
