...
const toDisplayString = (val) => {
  return isString$1(val) ? val : val == null ? "" : isArray$7(val) || isObject$8(val) && (val.toString === objectToString$2 || !isFunction$3(val.toString)) ? isRef$1(val) ? toDisplayString(val.value) : JSON.stringify(val, replacer, 2) : String(val);
};
const replacer = (_key, val) => {
  ...
  } else if (isObject$8(val) && !isArray$7(val) && !isPlainObject(val)) {
    return String(val);
  }
  return val;
};
...
const optionValidator = {
  ...
  validation(value, element, config2) {
    ...
    if (!isInvalidOptionConfig(config2)) {
      throw new Error(`Invalid option config for ${element.id}`);
    }
    return config2.options.includes(value);
  }
};
...
const _sfc_main$1e = /* @__PURE__ */ defineComponent({ name: "FIcon", inheritAttrs: false, props: {
  /**
  * Icon name.
  */
...
function _sfc_render$11(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps(_ctx.$attrs, { focusable: "false", class: ["icon", [_ctx.spriteKey, ..._ctx.modifiers]], "aria-hidden": _ctx.ariaHidden }), [renderSlot(_ctx.$slots, "default"), _cache[0] || (_cache[0] = createTextVNode()), createBaseVNode("use", { "xlink:href": _ctx.spriteId }, null, 8, _hoisted_2$G)], 16, _hoisted_1$V);
}
const FIcon = /* @__PURE__ */ _export_sfc$1(_sfc_main$1e, [["render", _sfc_render$11]]);
...
const config = { buttonOrder: FKUIConfigButtonOrder.LEFT_TO_RIGHT, get popupContainer() {
...
const _sfc_main$1d = /* @__PURE__ */ defineComponent({ name: "FModal", components: { FIcon }, mixins: [TranslationMixin], inheritAttrs: true, props: {
  /**
...
const _hoisted_7$f = { key: 0, ref: "modalTitle", class: "modal__title", tabindex: "-1" };
...
const FModal = /* @__PURE__ */ _export_sfc$1(_sfc_main$1d, [["render", _sfc_render$10]]);
...
const _sfc_main$1c = /* @__PURE__ */ defineComponent({ name: "FConfirmModal", components: { FModal }, inheritAttrs: true, props: {
  /**
  * Enable fullscreen mode in mobile.
  */
  fullscreen: { type: Boolean, required: false, default: false },
...
const _hoisted_1$T = { class: "button-group" };
...
function _sfc_render$$(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, { fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, "aria-close-text": _ctx.ariaCloseText, type: "warning", size: _ctx.size, onClose: _ctx.onClose }, {
    ...
    footer: withCtx(() => [createBaseVNode("div", _hoisted_1$T, [(openBlock(true), createElementBlock(
      Fragment,
      null,
...
const FConfirmModal = /* @__PURE__ */ _export_sfc$1(_sfc_main$1c, [["render", _sfc_render$$]]);
const GAP = ["1x", "2x", "3x", "4x", "5x", "6x", "7x", "8x"];
const ALIGNMENT = ["top", "center", "bottom"];
const FLOAT = ["left", "center", "right"];
const _sfc_main$1b = /* @__PURE__ */ defineComponent({ name: "IFlex", inheritAttrs: true, props: {
  /**
...
const IFlex = /* @__PURE__ */ _export_sfc$1(_sfc_main$1b, [["render", _sfc_render$_]]);
const _sfc_main$1a = /* @__PURE__ */ defineComponent({ name: "IFlexItem", inheritAttrs: true, props: {
  /**
...
const IFlexItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$1a, [["render", _sfc_render$Z]]);
...
const _sfc_main$19 = /* @__PURE__ */ defineComponent({ name: "FErrorList", components: { FIcon, IFlex, IFlexItem }, props: {
  /**
...
const _hoisted_1$S = { class: "error-list" };
...
const FErrorList = /* @__PURE__ */ _export_sfc$1(_sfc_main$19, [["render", _sfc_render$Y]]);
...
const _sfc_main$18 = /* @__PURE__ */ defineComponent({ name: "FValidationGroup", props: {
  /**
...
const FValidationGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$18, [["render", _sfc_render$X]]);
...
const _sfc_main$17 = /* @__PURE__ */ defineComponent({ name: "FValidationForm", components: { FValidationGroup, FErrorList }, inheritAttrs: false, props: {
  /**
...
function _sfc_render$W(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_validation_group, { key: _ctx.groupKey, modelValue: _ctx.validity, "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.validity = $event), "stop-propagation": true }, {
    default: withCtx(() => [createBaseVNode("form", mergeProps({ id: _ctx.id }, _ctx.$attrs, { novalidate: "", autocomplete: "off", onSubmit: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.onSubmit && _ctx.onSubmit(...args), ["prevent"])) }), [_ctx.displayErrors ? (openBlock(), createElementBlock(
      ...
      512
      /* NEED_PATCH */
    )) : createCommentVNode("v-if", true), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$R)]),
    _: 3
    /* FORWARDED */
  }, 8, ["modelValue"]);
}
const FValidationForm = /* @__PURE__ */ _export_sfc$1(_sfc_main$17, [["render", _sfc_render$W]]);
const _sfc_main$16 = /* @__PURE__ */ defineComponent({ name: "FFormModal", components: { FModal, FValidationForm }, mixins: [TranslationMixin], inheritAttrs: true, props: {
  /**
  * Enable fullscreen mode in mobile.
  */
...
const _hoisted_1$Q = { class: "button-group" };
...
function _sfc_render$V(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, { "data-test": _ctx.dataTest, fullscreen: _ctx.fullscreen, "is-open": _ctx.isOpen, size: _ctx.size, "aria-close-text": _ctx.ariaCloseText, onClose: _ctx.onClose }, {
    ...
    footer: withCtx(() => [createBaseVNode("div", _hoisted_1$Q, [!_ctx.hasDeprecatedSlots ? (openBlock(true), createElementBlock(
      Fragment,
      { key: 0 },
      renderList(_ctx.preparedButtons, (button) => {
...
const FFormModal = /* @__PURE__ */ _export_sfc$1(_sfc_main$16, [["render", _sfc_render$V]]);
...
const _sfc_main$X = /* @__PURE__ */ defineComponent({ name: "FCheckboxField", inheritAttrs: false, props: {
  /**
...
function _sfc_render$K(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [createBaseVNode("input", mergeProps({ id: _ctx.id }, _ctx.attrs, { ref: "checkboxInput", type: "checkbox", class: "checkbox__input", disabled: _ctx.disabled, onKeydown: _cache[0] || (_cache[0] = withKeys((...args) => _ctx.onKeydown && _ctx.onKeydown(...args), ["space"])), onChange: _cache[1] || (_cache[1] = ($event) => _ctx.updateExpandedFlag()) }), null, 16, _hoisted_1$H), _cache[9] || (_cache[9] = createTextVNode()), createBaseVNode("label", { class: normalizeClass(_ctx.$slots.details ? "checkbox__label checkbox__width" : "checkbox__label"), for: _ctx.id }, [renderSlot(_ctx.$slots, "default"), _cache[8] || (_cache[8] = createTextVNode()), _ctx.$slots.details ? (openBlock(), createElementBlock(
      Fragment,
      { key: 0 },
...
const FCheckboxField = /* @__PURE__ */ _export_sfc$1(_sfc_main$X, [["render", _sfc_render$K]]);
...
const _sfc_main$S = /* @__PURE__ */ defineComponent({ name: "FLabel", components: { FIcon }, props: {
  /**
...
function _sfc_render$E(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(
    ...
    [createBaseVNode(
      ...
      [withDirectives(createBaseVNode("select", mergeProps({ id: _ctx.id, "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.vModel = $event), class: "select-field__select" }, _ctx.attrs), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$D), [[vModelSelect, _ctx.vModel]]), _cache[5] || (_cache[5] = createTextVNode()), _ctx.hasError && _ctx.textFieldTableMode ? (openBlock(), createBlock(
        _component_f_icon,
...
const FSelectField = /* @__PURE__ */ _export_sfc$1(_sfc_main$R, [["render", _sfc_render$E]]);
...
const _sfc_main$Q = /* @__PURE__ */ defineComponent({ name: "IPopupError", components: { FIcon }, inheritAttrs: false, props: {
  /**
...
const IPopupError = /* @__PURE__ */ _export_sfc$1(_sfc_main$Q, [["render", _sfc_render$D]]);
...
function useCombobox(inputRef, options) {
  if (!options) {
    return { dropdownId: "", dropdownIsOpen: ref(false), dropdownOptions: ref([]), activeOptionId: "", activeOption: ref(null), selectedValue: ref(null), toggleDropdown() {
    }, closeDropdown() {
    } };
  }
...
const _sfc_main$P = /* @__PURE__ */ defineComponent({ __name: "IPopupListbox", props: { isOpen: { type: Boolean }, anchor: {} }, emits: ["close"], setup(__props, { emit: __emit }) {
  const emit2 = __emit;
  ...
  return (_ctx, _cache) => {
    return _ctx.isOpen ? (openBlock(), createBlock(Teleport, { key: 0, to: "body", disabled: teleportDisabled }, [createBaseVNode(
      "div",
      mergeProps({ ref: "popup" }, _ctx.$attrs, { class: popupClasses }),
      [createBaseVNode("div", { ref_key: "wrapper", ref: wrapper2, role: "presentation", class: "popup__wrapper", onKeyup: withKeys(withModifiers(onKeyEsc, ["stop"]), ["esc"]), onClick: _cache[0] || (_cache[0] = withModifiers(() => {
      }, ["stop"])) }, [renderSlot(_ctx.$slots, "default")], 40, _hoisted_1$B)],
      16
      /* FULL_PROPS */
    )])) : createCommentVNode("v-if", true);
  };
} });
const _hoisted_1$A = { class: "combobox" };
const _hoisted_2$s = ["id"];
const _hoisted_3$n = ["id", "aria-selected", "onClick"];
const _sfc_main$O = /* @__PURE__ */ defineComponent({ __name: "IOptionsPopup", props: { id: {}, isOpen: { type: Boolean }, options: {}, activeOption: {}, activeOptionId: {}, inputNode: {} }, emits: ["select", "close"], setup(__props, { emit: __emit }) {
  const emit2 = __emit;
  ...
  return (_ctx, _cache) => {
    return openBlock(), createElementBlock("div", _hoisted_1$A, [createVNode(unref(_sfc_main$P), { "is-open": _ctx.isOpen, anchor: _ctx.inputNode, onClose: onListboxClose }, {
      default: withCtx(() => [createBaseVNode("ul", { id: _ctx.id, ref_key: "listboxNode", ref: listboxNode, role: "listbox", "aria-label": "Förslag", class: "combobox__listbox" }, [(openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.options, (item) => {
          return openBlock(), createElementBlock("li", { id: isOptionActive(item) ? _ctx.activeOptionId : void 0, key: item, role: "option", "aria-selected": isOptionActive(item) ? "true" : void 0, class: normalizeClass(["combobox__listbox__option", { "combobox__listbox__option--highlight": isOptionActive(item) }]), onClick: withModifiers(($event) => onOptionClick(item), ["stop", "prevent"]) }, toDisplayString(item), 11, _hoisted_3$n);
        }),
        128
        /* KEYED_FRAGMENT */
      ))], 8, _hoisted_2$s)]),
...
const _sfc_main$N = /* @__PURE__ */ defineComponent({ __name: "IToggleOptionsButton", emits: ["toggle"], setup(__props, { emit: __emit }) {
  const emit2 = __emit;
  return (_ctx, _cache) => {
    return openBlock(), createElementBlock("button", { class: "text-field__icon clear-button", type: "button", "aria-label": "Öppna förslagen", tabindex: "-1", onClick: _cache[0] || (_cache[0] = withModifiers(($event) => emit2("toggle"), ["stop", "prevent"])) }, [createVNode(unref(FIcon), { name: "arrow-down" })]);
  };
} });
function resolveWidthClass(words, inline) {
  return inline ? void 0 : words.split(" ").map((word) => `i-width-${word}`).join(" ");
}
const _sfc_main$M = /* @__PURE__ */ defineComponent({ name: "FTextField", components: { FLabel, FIcon, IPopupError, IToggleOptionsButton: _sfc_main$N, IOptionsPopup: _sfc_main$O }, inheritAttrs: false, props: {
  /**
  * The id for the input id attribute.
  * The id for the label for attribute.
  * If the prop is not set a random value will be generated.
...
const _hoisted_7$b = { key: 3, class: "text-field__append-inner" };
