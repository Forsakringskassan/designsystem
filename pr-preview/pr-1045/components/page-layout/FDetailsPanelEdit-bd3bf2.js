...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-bd3bf2.js
...
exampleComponent.__scopeId = "data-v-bd3bf2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-bd3bf2"
});
export {
  render
};
