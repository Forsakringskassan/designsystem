...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4a6a44.js
...
exampleComponent.__scopeId = "data-v-4a6a44";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4a6a44"
});
export {
  render
};
