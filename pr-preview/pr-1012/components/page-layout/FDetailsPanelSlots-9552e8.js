...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-9552e8.js
...
exampleComponent.__scopeId = "data-v-9552e8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9552e8"
});
export {
  render
};
