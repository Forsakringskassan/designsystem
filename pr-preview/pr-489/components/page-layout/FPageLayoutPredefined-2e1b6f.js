...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-2e1b6f.js
...
exampleComponent.__scopeId = "data-v-2e1b6f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2e1b6f"
});
export {
  render
};
