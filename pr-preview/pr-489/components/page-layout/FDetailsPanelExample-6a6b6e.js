...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-6a6b6e.js
...
exampleComponent.__scopeId = "data-v-6a6b6e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6a6b6e"
});
export {
  render
};
