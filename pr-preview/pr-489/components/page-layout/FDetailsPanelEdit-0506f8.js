...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-0506f8.js
...
exampleComponent.__scopeId = "data-v-0506f8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0506f8"
});
export {
  render
};
