...
// virtual-entry:virtual:packages/vue/src/components/FCrudDataset/examples/FCrudDatasetTableExample.vue:FCrudDatasetTableExample-b68734.js
            ...
            },
            {
              default: _withCtx(() => [
                _createVNode(_component_f_crud_button, {
                  ...
                  default: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(`\xC4ndra  ${row.name}`),
                      1
                      /* TEXT */
                    )
                  ]),
                ...
                _createVNode(_component_f_crud_button, {
                  ...
                  default: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(`Ta bort ${row.name}`),
                      1
                      /* TEXT */
                    )
                  ]),
