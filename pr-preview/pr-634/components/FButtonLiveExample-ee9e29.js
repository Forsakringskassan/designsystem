...
// virtual-entry:virtual:packages/vue/src/components/FButton/examples/FButtonLiveExample.vue:FButtonLiveExample-ee9e29.js
...
var exampleComponent = defineComponent({
  ...
  methods: {
    livemethods() {
      return {
        asyncFunction() {
          return new Promise((resolve) => setTimeout(resolve, 13e4));
        }
      };
    }
  }
