...
// virtual-entry:virtual:packages/vue/src/components/FTooltip/examples/FTooltipHeadingExample.vue:FTooltipHeadingExample-bd23cb.js
...
var exampleComponent = defineComponent({
  ...
  data() {
    return {
      model1: this.expanded,
      model2: this.expanded,
      model3: this.expanded,
      model4: this.expanded,
      model5: this.expanded,
      model6: this.expanded,
      model7: this.expanded
    };
  }
});
  ...
  return _openBlock(), _createElementBlock(
    ...
    [
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model1,
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.model1 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model2,
        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.model2 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model3,
        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.model3 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model4,
        "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.model4 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model5,
        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.model5 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model6,
        "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.model6 = $event),
      ...
      _createVNode(_component_f_tooltip, {
        modelValue: _ctx.model7,
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.model7 = $event),
        "screen-reader-text": "Sk\xE4rml\xE4sartext"
      }, {
