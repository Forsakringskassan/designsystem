...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExample.vue:FTableExample-2602ee.js
  ...
  setup(__props, { expose: __expose }) {
    ...
    const columns = defineTableColumns([
      ...
      },
      {
        ...
        label(row) {
          if (row.aktiv) {
            return `Rad ${row.id} \xE4r klar`;
          } else {
            return `Rad ${row.id} \xE4r inte klar`;
          }
        },
        editable(row) {
          return row.id === "1";
    ...
    const __returned__ = { tableRef, selectFieldOptions, oformateradTextKolumnSynlig, columns, rows, hasKey, sortableAttributes, mySelectedRows, onAddRow, onRemoveRow, onRemoveSelectedRows, get FSortFilterDataset() {
