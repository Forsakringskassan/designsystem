...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-10383b.js
...
var _sfc_main$c = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    function onChange(e) {
      ...
      __props.column.update(__props.row, checked2, !checked2);
    }
    const expose = {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", _hoisted_1$a, [createElementVNode("input", {
        ...
        tabindex: "-1",
        onChange
      }, null, 40, _hoisted_2$7)])) : (openBlock(), createElementBlock("td", _hoisted_3$5, [checked.value ? (openBlock(), createBlock(unref3(FIcon), {
        key: 0,
        "aria-label": ariaLabel.value,
        name: "success"
      }, null, 8, ["aria-label"])) : (openBlock(), createElementBlock("span", _hoisted_4$4, toDisplayString(ariaLabel.value), 1))], 512));
    };
  }
});
var _hoisted_1$9 = {
