...
// virtual-entry:virtual:src/components/XSortFilterDatasetNg/examples/XSortFilterDatasetNgExample.vue:XSortFilterDatasetNgExample-5ac697.js
import { defineComponent as _defineComponent } from "vue";
import { computed, ref, useTemplateRef } from "vue";
import { FCheckboxField, FFieldset, FSelectField, FTextField } from "@fkui/vue";
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const actualElement = computed(() => {
      return searchElement.value?.$el.querySelector("input");
    });
    const flag = ref(true);
    ...
    const __returned__ = { searchElement, actualElement, flag, country, availableCountries, matchCountry, filter, get FCheckboxField() {
