...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableColumnLiveExample.vue:FTableColumnLiveExample-6f2345.js
...
// packages/vue-labs/src/components/FTable/columns/helpers/default-tnum-value.ts
function defaultTnumValue2(type) {
  const tnumTypes = [
    "text:bankAccountNumber",
    "text:bankgiro",
    "text:clearingNumber",
...
// packages/vue-labs/src/components/FTable/is-editable-column.ts
...
// packages/vue-labs/src/components/FTable/is-enable-column.ts
...
// packages/vue-labs/src/components/FTable/examples/stringify-object.ts
...
var exampleComponent = defineComponent3({
  ...
  computed: {
    ...
    defaultTNUM() {
      return defaultTnumValue2(this.textType);
    },
    defaultAlign() {
