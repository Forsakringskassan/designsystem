...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-b28ffa.js
...
var _hoisted_1$e = ["aria-label", "aria-expanded"];
var _hoisted_2$8 = {
  key: 1,
  ref: "expandable",
  tabindex: "-1",
...
var _sfc_main$g = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    function onClick(e) {
      ...
      activateCell(expandableRef.value, {
        focus: true
      });
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])], 8, _hoisted_1$e)])) : (openBlock(), createElementBlock("td", _hoisted_2$8, null, 512));
    };
  }
});
...
var _hoisted_1$b = ["checked", "indeterminate", "aria-label"];
...
var _hoisted_1$a = ["checked", "aria-label"];
var _hoisted_2$7 = {
  key: 1,
  ref: "target",
  tabindex: "-1",
...
var _hoisted_3$4 = ["checked", "aria-label"];
var _sfc_main$c = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    const checked = computed3(() => {
      return Boolean(__props.column.checked(__props.row));
    });
    function onClickInput(e) {
      e.stopPropagation();
      assertRef(targetElement);
      activateCell(targetElement.value, {
        focus: true
      });
      __props.column.update(__props.row, checked.value, !checked.value);
    }
    function onClickTd(e) {
      e.stopPropagation();
      assertRef(targetElement);
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, _hoisted_1$a)])) : (openBlock(), createElementBlock("td", _hoisted_2$7, [createElementVNode("input", {
        checked: Boolean(__props.column.checked(__props.row)),
        type: "checkbox",
        "aria-label": ariaLabel.value
      }, null, 8, _hoisted_3$4)], 512));
    };
  }
});
...
var _sfc_main$b = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    function onClickInput(e) {
      ...
      activateCell(inputElement.value, {
        focus: true
      });
      __props.column.update(__props.row, checked.value, !checked.value);
    }
...
function getRowIndexes(rows2, expandableAttribute) {
  const array = [];
  walk(rows2, expandableAttribute, (row) => {
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return renderAnchor.value ? (openBlock(), createElementBlock("td", {
        ...
        tabindex: "-1"
      }, toDisplayString(__props.column.text(__props.row)), 9, _hoisted_1$7)])) : (openBlock(), createElementBlock("td", _hoisted_2$6, null, 512));
    };
  }
});
var _hoisted_1$6 = {
...
var _sfc_main$8 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    function onClickButton(e) {
      ...
      activateCell(buttonElement.value, {
        focus: true
      });
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["library", "name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_1$6, toDisplayString(__props.column.text(__props.row)), 1)], 512)])) : (openBlock(), createElementBlock("td", _hoisted_2$5, null, 512));
    };
  }
});
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      return renderButton.value ? (openBlock(), createElementBlock("td", {
        ...
        name: "bars"
      }), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_1$5, toDisplayString(__props.column.text(__props.row)), 1)], 512), _cache[1] || (_cache[1] = createTextVNode()), createVNode(unref3(FContextMenu), {
...
function useSelectable(options) {
  ...
  const isIndeterminate = computed3(() => {
    return selectedRows.value.length > 0 && selectedRows.value.length < toValue2(rows2).length;
  });
  ...
  function toggleSelectableHeader() {
    if (isAllRowsSelected.value) {
      ...
      selectedRows.value = [...toValue2(rows2)];
    }
  }
  ...
  let oldKeys = void 0;
  watch3(() => toValue2(rows2), (newValue) => {
...
var exampleComponent = defineComponent3({
    ...
    default: _withCtx(() => [
      _createVNode(_component_f_fieldset, { name: "styling" }, {
        ...
        default: _withCtx(() => [
          ...
          _createVNode(_component_f_checkbox_field, {
            modelValue: _ctx.divided,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.divided = $event),
            value: true
          }, {
      ...
      _createVNode(_component_f_fieldset, { name: "interaktion" }, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_f_select_field, {
            ...
            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.selectable = $event)
          }, {
          ...
          _createVNode(_component_f_checkbox_field, {
            ...
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.isExpandable = $event),
            value: true
          }, {
          ...
          _createVNode(_component_f_checkbox_field, {
            ...
            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => _ctx.isEmpty = $event),
            value: true
          }, {
