...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-95aa0e.js
...
exampleComponent.__scopeId = "data-v-95aa0e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-95aa0e"
});
export {
  render
};
