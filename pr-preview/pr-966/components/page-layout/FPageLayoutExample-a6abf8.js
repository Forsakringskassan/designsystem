...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-a6abf8.js
...
exampleComponent.__scopeId = "data-v-a6abf8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a6abf8"
});
export {
  render
};
