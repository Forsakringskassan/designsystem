...
// virtual-entry:virtual:packages/vue/src/components/FExpandablePanel/examples/FExpandablePanelExample.vue:FExpandablePanelExample-7b93dd.js
import { defineComponent as defineComponent26 } from "vue";
import { FExpandablePanel } from "@fkui/vue";

// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutApplicationTemplate/FLayoutApplicationTemplate.vue?type=script
import { defineComponent } from "vue";
import { isSet } from "@fkui/logic";
var FLayoutApplicationTemplate_default = defineComponent({
...
// sfc-template:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutApplicationTemplate/FLayoutApplicationTemplate.vue?type=template
import { createCommentVNode as _createCommentVNode, renderSlot as _renderSlot, openBlock as _openBlock, createElementBlock as _createElementBlock, createElementVNode as _createElementVNode } from "vue";
var _hoisted_1 = { class: "layout-application-template" };
var _hoisted_2 = {
  key: 0,
  ref: "header",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock("div", _hoisted_1, [
    _ctx.showHeader || _ctx.showTopNavigation ? (_openBlock(), _createElementBlock(
      "header",
      _hoisted_2,
      [
        _createCommentVNode("\n@slot Slot for displaying the header.\n        "),
        _ctx.showHeader ? _renderSlot(_ctx.$slots, "header", { key: 0 }) : _createCommentVNode("v-if", true),
        _ctx.showTopNavigation ? (_openBlock(), _createElementBlock("nav", _hoisted_3, [
          _createCommentVNode("\n@slot Slot for displaying top navigation.\n            "),
          _renderSlot(_ctx.$slots, "top-navigation")
    ...
    _createElementVNode(
      ...
      [
        ...
        _ctx.showFooter ? (_openBlock(), _createElementBlock("footer", _hoisted_5, [
...
// packages/vue/src/components/FLayoutApplicationTemplate/FLayoutApplicationTemplate.vue
FLayoutApplicationTemplate_default.render = render;
FLayoutApplicationTemplate_default.__file = "packages/vue/src/components/FLayoutApplicationTemplate/FLayoutApplicationTemplate.vue";
var FLayoutApplicationTemplate_default2 = FLayoutApplicationTemplate_default;

// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutRightPanel/FLayoutRightPanel.vue?type=script
import { defineComponent as defineComponent14, toRefs as toRefs2 } from "vue";
import { focus as focus7 } from "@fkui/logic";
...
function getSortedHTMLElementsFromVueRef(ref10) {
  const htmlElements = getHTMLElementsFromVueRef(ref10);
...
function getHTMLElementsFromVueRef(ref10) {
  let result = [];
  if (isEmptyArray(ref10)) {
    result = [];
  } else if (refIsVueArray(ref10)) {
    result = ref10.map((vueRef) => vueRef.$el);
  } else if (refIsHTMLElementArray(ref10)) {
    result = [...ref10];
  } else if (isSet3(ref10)) {
    result = [getHTMLElementFromVueRef(ref10)];
  }
  return result;
}
...
function findElementFromVueRef(ref10) {
  if (refIsElement(ref10)) {
    return ref10;
  } else if (refIsVue(ref10)) {
    return ref10.$el;
  }
}
function getElementFromVueRef(ref10) {
  const element = findElementFromVueRef(ref10);
  if (!isSet3(element)) {
    throw new Error(`Unable to find element from ${String(ref10)}.`);
  }
  return element;
}
function getHTMLElementFromVueRef(ref10) {
  const element = findElementFromVueRef(ref10);
  if (!isSet3(element)) {
    throw new Error(`Unable to find element from ${String(ref10)}.`);
  }
  ...
  throw new Error(`Not instance of HTMLELement ${String(ref10)}.`);
}
...
var FIcon_default = defineComponent4({
  name: "FIcon",
  inheritAttrs: false,
  props: {
    /**
...
import { createCommentVNode as _createCommentVNode3, renderSlot as _renderSlot3, createElementVNode as _createElementVNode3, mergeProps as _mergeProps, openBlock as _openBlock4, createElementBlock as _createElementBlock4, Fragment as _Fragment } from "vue";
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock4(), _createElementBlock4(
    ...
    null,
    [
      _createCommentVNode3(" [html-validate-disable-block fkui/prefer-ficon -- this is the FIcon component]"),
      (_openBlock4(), _createElementBlock4("svg", _mergeProps(_ctx.$attrs, {
        focusable: "false",
        class: ["icon", [_ctx.spriteKey, ..._ctx.modifiers]],
        "aria-hidden": _ctx.ariaHidden
      }), [
        _renderSlot3(_ctx.$slots, "default"),
        _createElementVNode3("use", { href: _ctx.spriteId }, null, 8, _hoisted_22)
      ], 16, _hoisted_13))
    ],
    2112
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FModal/FModal.vue?type=script
var FModal_default = defineComponent5({
  name: "FModal",
...
import { createElementVNode as _createElementVNode4, createCommentVNode as _createCommentVNode4, renderSlot as _renderSlot4, openBlock as _openBlock5, createElementBlock as _createElementBlock5, toDisplayString as _toDisplayString, resolveComponent as _resolveComponent, createVNode as _createVNode, normalizeClass as _normalizeClass, withKeys as _withKeys } from "vue";
var _hoisted_14 = ["id"];
...
function render5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.isOpen ? (_openBlock5(), _createElementBlock5("div", {
    key: 0,
    id: _ctx.id,
              ...
              [
                _createElementVNode4("div", _hoisted_42, [
                  _createElementVNode4("div", _hoisted_52, [
                    _createElementVNode4("div", _hoisted_6, [
                      _createElementVNode4(
                        "div",
                        {
                          tabindex: "0",
                      ...
                      _ctx.hasHeaderSlot ? (_openBlock5(), _createElementBlock5(
                        "h1",
                        _hoisted_7,
                        [
                          _createCommentVNode4("@slot Slot for the header. "),
                    ...
                    _createElementVNode4(
                      ...
                      _hoisted_8,
                      [
                        _createCommentVNode4("@slot Slot for the main content, e.g. paragraphs, input fields, etc. "),
                        _renderSlot4(_ctx.$slots, "content")
                      ],
                      512
                      /* NEED_PATCH */
                    ),
                    _createElementVNode4("div", _hoisted_9, [
                      _createCommentVNode4("@slot Slot the footer content, i.e. buttons. "),
  ...
  ], 10, _hoisted_14)) : _createCommentVNode4("v-if", true);
}

// packages/vue/src/components/FModal/FModal.vue
FModal_default.render = render5;
...
var FConfirmModal_default = defineComponent6({
  name: "FConfirmModal",
...
import { createCommentVNode as _createCommentVNode5, renderSlot as _renderSlot5, toDisplayString as _toDisplayString2, createTextVNode as _createTextVNode, renderList as _renderList, Fragment as _Fragment2, openBlock as _openBlock6, createElementBlock as _createElementBlock6, createElementVNode as _createElementVNode5, normalizeClass as _normalizeClass2, resolveComponent as _resolveComponent2, withCtx as _withCtx, createBlock as _createBlock2 } from "vue";
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock6(), _createBlock2(_component_f_modal, {
    ...
    header: _withCtx(() => [
      _createCommentVNode5("@slot Slot for advanced header. "),
      _renderSlot5(_ctx.$slots, "heading", {}, () => [
        _createTextVNode(
    ...
    content: _withCtx(() => [
      _createCommentVNode5("@slot Slot for advanced content. "),
      ...
      _createElementVNode5("div", _hoisted_15, [
        (_openBlock6(true), _createElementBlock6(
          ...
          _renderList(_ctx.preparedButtons, (button) => {
            return _openBlock6(), _createElementBlock6("button", {
              key: button.label,
              type: "button",
              ...
              button.screenreader ? (_openBlock6(), _createElementBlock6(
                "span",
                _hoisted_33,
...
FConfirmModal_default.render = render6;
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/internal-components/IFlex/IFlex.vue?type=script
var IFlex_default = defineComponent7({
  name: "IFlex",
  inheritAttrs: true,
  props: {
    /**
...
var IFlexItem_default = defineComponent8({
  name: "IFlexItem",
  inheritAttrs: true,
  props: {
    /**
...
var FErrorList_default = defineComponent9({
  name: "FErrorList",
...
import { resolveComponent as _resolveComponent3, createVNode as _createVNode2, withCtx as _withCtx2, openBlock as _openBlock9, createBlock as _createBlock3, createCommentVNode as _createCommentVNode8, createTextVNode as _createTextVNode2, renderSlot as _renderSlot8, createElementBlock as _createElementBlock9, renderList as _renderList2, Fragment as _Fragment3, createElementVNode as _createElementVNode6, toDisplayString as _toDisplayString3, withModifiers as _withModifiers } from "vue";
...
var _hoisted_53 = { class: "error-list__link" };
function render9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock9(), _createElementBlock9("div", _hoisted_16, [
    _createVNode2(_component_i_flex, null, {
      default: _withCtx2(() => [
        _ctx.hasTitleSlot ? (_openBlock9(), _createBlock3(_component_i_flex_item, {
          key: 0,
          shrink: ""
        }, {
          default: _withCtx2(() => [
              ...
              (_openBlock9(true), _createElementBlock9(
                ...
                _renderList2(_ctx.items, (item) => {
                  return _openBlock9(), _createElementBlock9("li", {
                    ...
                    ], 8, _hoisted_43)) : (_openBlock9(), _createElementBlock9(
                      _Fragment3,
                      { key: 1 },
                      [
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FValidationGroup/FValidationGroup.vue?type=script
var FValidationGroup_default = defineComponent10({
...
var FValidationForm_default = defineComponent11({
...
function render11(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock11(), _createBlock4(_component_f_validation_group, {
    key: _ctx.groupKey,
    ...
    default: _withCtx3(() => [
      ...
      _createElementVNode7("form", _mergeProps2({ id: _ctx.id }, _ctx.$attrs, {
        novalidate: "",
        autocomplete: "off",
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FModal/FFormModal/FFormModal.vue?type=script
var FFormModal_default = defineComponent12({
  name: "FFormModal",
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock12(), _createBlock5(_component_f_modal, {
...
function renderSlotText(render32, props = {}, options) {
  if (!render32) {
    return void 0;
  }
  const nodes = render32(props);
  if (nodes.length === 0) {
    return void 0;
  }
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutLeftPanel/FLayoutLeftPanel.vue?type=script
import { defineComponent as defineComponent13, toRefs } from "vue";
...
import { openBlock as _openBlock13, createBlock as _createBlock6, createCommentVNode as _createCommentVNode11, Fragment as _Fragment5, createElementBlock as _createElementBlock13, renderSlot as _renderSlot12, createElementVNode as _createElementVNode9, mergeProps as _mergeProps3 } from "vue";
var _hoisted_19 = ["type", "aria-disabled"];
var _hoisted_28 = {
  key: 1,
...
function render13(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock13(), _createElementBlock13("button", _mergeProps3({
    type: $props.type,
    class: $setup.buttonClass,
    "aria-disabled": $setup.disabled
  }, $setup.attrs), [
    $setup.hasIconLeft ? (_openBlock13(), _createElementBlock13(
      _Fragment5,
      { key: 0 },
      [
        $setup.inflight ? (_openBlock13(), _createBlock6($setup["FIcon"], {
          key: 0,
          name: "circle-notch-solid",
          class: "button__icon button__spinner"
        })) : $setup.props.iconLeft ? (_openBlock13(), _createBlock6($setup["FIcon"], {
          key: 1,
          class: "button__icon",
          name: $setup.props.iconLeft,
          library: $setup.props.iconLibrary
        }, null, 8, ["name", "library"])) : _createCommentVNode11("v-if", true)
      ],
      64
      /* STABLE_FRAGMENT */
    )) : _createCommentVNode11("v-if", true),
    !$setup.hasIcon ? (_openBlock13(), _createElementBlock13("span", _hoisted_28, [
      $setup.inflight ? (_openBlock13(), _createBlock6($setup["FIcon"], {
        key: 0,
        name: "circle-notch-solid",
        class: "button__icon button__spinner"
    ...
    _createElementVNode9("span", null, [
      _renderSlot12(_ctx.$slots, "default")
    ]),
    $setup.hasIconRight ? (_openBlock13(), _createElementBlock13(
      _Fragment5,
      { key: 2 },
      [
        $setup.inflight ? (_openBlock13(), _createBlock6($setup["FIcon"], {
          ...
          name: "circle-notch-solid",
          class: "button__icon button__spinner"
        })) : $setup.props.iconRight ? (_openBlock13(), _createBlock6($setup["FIcon"], {
          key: 1,
          class: "button__icon",
    ...
    !$setup.hasIcon ? (_openBlock13(), _createElementBlock13("span", _hoisted_36)) : _createCommentVNode11("v-if", true)
  ], 16, _hoisted_19);
}

// packages/vue/src/components/FButton/FButton.vue
FButton_default.render = render13;
FButton_default.__file = "packages/vue/src/components/FButton/FButton.vue";
var FButton_default2 = FButton_default;

// packages/vue/src/components/FLayoutLeftPanel/f-layout-left-panel-mixin.ts
import {
  onMounted,
  onUnmounted,
  ref as ref3,
...
// packages/vue/src/components/FLayoutLeftPanel/get-grid-classes.ts
...
function useLayoutPanel(options) {
  ...
  let minWidth = 150;
  let maxWidth = 0.5;
  const panelWidth = ref3(0);
  const leftPrimaryClasses = ref3({});
  const rightPrimaryClasses = ref3({});
  ...
  function updatePrimaryGrid() {
    const leftPrimaryElement = document.querySelector(
      "#layout-side-navigation__primary-content"
    );
    const rightPrimaryElement = document.querySelector(
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutLeftPanel/FLayoutLeftPanel.vue?type=script
var FLayoutLeftPanel_default = defineComponent13({
  name: "FLayoutLeftPanel",
  components: {
    FButton: FButton_default2
  },
  props: {
    /**
  ...
  methods: {
    toggleSideNavigation() {
      ...
      window.setTimeout(() => {
        ...
        const ref10 = this.isOpen ? "close-button" : "open-button";
        const element = getElementFromVueRef(this.$refs[ref10]);
        focus6(element);
      }, 0);
    }
  }
...
// sfc-template:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutLeftPanel/FLayoutLeftPanel.vue?type=template
import { createCommentVNode as _createCommentVNode12, renderSlot as _renderSlot13, createElementVNode as _createElementVNode10, resolveComponent as _resolveComponent6, withCtx as _withCtx5, createVNode as _createVNode5, normalizeStyle as _normalizeStyle, normalizeClass as _normalizeClass6, Fragment as _Fragment6, openBlock as _openBlock14, createElementBlock as _createElementBlock14 } from "vue";
var _hoisted_110 = { class: "layout-navigation" };
var _hoisted_29 = ["aria-expanded"];
var _hoisted_37 = { class: "layout-navigation__navigation__inner" };
var _hoisted_44 = {
  key: 1,
  class: "layout-navigation__navigation__inner--minimized"
};
function render14(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_button = _resolveComponent6("f-button");
  return _openBlock14(), _createElementBlock14("div", _hoisted_110, [
    _createCommentVNode12(" [html-validate-disable-next no-inline-style] "),
    _createElementVNode10("nav", {
      id: "layout-navigation__navigation",
      class: "layout-navigation__navigation",
      style: _normalizeStyle(_ctx.navigationStyle),
      "aria-expanded": _ctx.isOpen
    }, [
      _createElementVNode10("div", _hoisted_37, [
        _ctx.isOpen ? (_openBlock14(), _createElementBlock14(
          _Fragment6,
          { key: 0 },
          [
            _createCommentVNode12(" [html-validate-disable-next no-inline-style] "),
            _createElementVNode10(
              ...
              [
                _createCommentVNode12(" @slot Slot for heading "),
                _renderSlot13(_ctx.$slots, "heading"),
                _createVNode5(_component_f_button, {
                  ref: "close-button",
                  "icon-right": "chevrons-left",
                  size: "small",
                  "tertiary-style": "black",
                  variant: "tertiary",
                  onClick: _ctx.toggleSideNavigation
                }, {
                  default: _withCtx5(() => [..._cache[1] || (_cache[1] = [
                    _createElementVNode10(
                      "span",
                      { class: "sr-only" },
            ...
            _cache[2] || (_cache[2] = _createElementVNode10(
              "div",
              null,
              [
                _createElementVNode10("hr")
              ],
              -1
              /* CACHED */
            )),
            ...
            _createElementVNode10(
              "div",
              {
                class: _normalizeClass6(["layout-navigation__navigation__inner__content scroll-target", _ctx.gridClasses]),
                style: _normalizeStyle(_ctx.contentStyle)
              },
              [
                _createCommentVNode12("\n@slot Slot for displaying content in the navigation-panel\n                        "),
                _renderSlot13(_ctx.$slots, "content")
              ],
              6
              /* CLASS, STYLE */
            )
        ...
        !_ctx.isOpen ? (_openBlock14(), _createElementBlock14("div", _hoisted_44, [
          _createVNode5(_component_f_button, {
            ref: "open-button",
            "icon-right": "bars",
            "tertiary-style": "black",
            ...
            default: _withCtx5(() => [..._cache[3] || (_cache[3] = [
              _createElementVNode10(
                "span",
                { class: "sr-only" },
    ...
    _createElementVNode10(
      "div",
      {
        ...
        class: _normalizeClass6(["layout-navigation__primary", _ctx.leftPrimaryClasses]),
        style: _normalizeStyle(_ctx.primaryStyle)
      },
      [
        _createCommentVNode12("\n@slot Slot for displaying the primary content.\n            "),
...
// packages/vue/src/components/FLayoutLeftPanel/FLayoutLeftPanel.vue
FLayoutLeftPanel_default.render = render14;
FLayoutLeftPanel_default.__file = "packages/vue/src/components/FLayoutLeftPanel/FLayoutLeftPanel.vue";

// packages/vue/src/components/FLayoutRightPanel/services/f-layout-right-panel-service.ts
var FRightPanelServiceImpl = class {
  focusedElementBeforeOpenining = null;
  open() {
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutRightPanel/FLayoutRightPanel.vue?type=script
var FLayoutRightPanel_default = defineComponent14({
  ...
  setup(props) {
    const { initialWidth, minWidth, maxWidth } = toRefs2(props);
    return useLayoutPanel({
      initialWidth,
      minWidth,
      maxWidth,
...
// sfc-template:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLayoutRightPanel/FLayoutRightPanel.vue?type=template
import { createCommentVNode as _createCommentVNode13, renderSlot as _renderSlot14, normalizeClass as _normalizeClass7, normalizeStyle as _normalizeStyle2, createElementVNode as _createElementVNode11, resolveComponent as _resolveComponent7, createVNode as _createVNode6, openBlock as _openBlock15, createElementBlock as _createElementBlock15 } from "vue";
var _hoisted_111 = { class: "layout-secondary" };
var _hoisted_210 = { class: "layout-secondary__secondary__inner" };
function render15(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = _resolveComponent7("f-icon");
  return _openBlock15(), _createElementBlock15("div", _hoisted_111, [
    _createCommentVNode13(" [html-validate-disable-next no-inline-style] "),
    _createElementVNode11(
      "div",
      {
        id: "layout-secondary__primary",
        class: _normalizeClass7(["layout-secondary__primary", _ctx.rightPrimaryClasses]),
        style: _normalizeStyle2(_ctx.primaryStyle)
      },
      [
        _createCommentVNode13("\n            @slot Slot for displaying the primary content.\n            "),
    ...
    _createCommentVNode13(" [html-validate-disable-next no-inline-style] "),
    _ctx.isOpen ? (_openBlock15(), _createElementBlock15(
      "aside",
      {
        key: 0,
        style: _normalizeStyle2(_ctx.secondaryStyle),
      ...
      [
        ...
        _createElementVNode11("div", _hoisted_210, [
          _createCommentVNode13(" [html-validate-disable-next no-inline-style] "),
          _createElementVNode11(
            "div",
            {
            ...
            [
              _createCommentVNode13(" @slot Slot for heading "),
              _renderSlot14(_ctx.$slots, "heading")
            ],
            4
            /* STYLE */
          ),
          _cache[4] || (_cache[4] = _createElementVNode11(
            "div",
            null,
            [
              _createElementVNode11("hr", { "aria-hidden": "true" })
            ],
            -1
            /* CACHED */
          )),
          ...
          _createElementVNode11(
            "div",
            {
              class: _normalizeClass7(["layout-secondary__secondary__inner__content scroll-target", _ctx.gridClasses]),
              style: _normalizeStyle2(_ctx.contentStyle)
            },
            [
              _createCommentVNode13("\n                    @slot Slot for displaying content in the secondary-panel\n                    "),
              _renderSlot14(_ctx.$slots, "content"),
              _createElementVNode11("button", {
                ...
                _cache[3] || (_cache[3] = _createElementVNode11(
                  "span",
                  { class: "sr-only" },
...
// packages/vue/src/components/FLayoutRightPanel/FLayoutRightPanel.vue
FLayoutRightPanel_default.render = render15;
FLayoutRightPanel_default.__file = "packages/vue/src/components/FLayoutRightPanel/FLayoutRightPanel.vue";
var FLayoutRightPanel_default2 = FLayoutRightPanel_default;

// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FTextareaField/FTextareaField.vue?type=script
import { defineComponent as defineComponent25 } from "vue";
import { ElementIdService as ElementIdService6, isSet as isSet4 } from "@fkui/logic";

// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLabel/FLabel.vue?type=script
import { defineComponent as defineComponent24, provide, useTemplateRef as useTemplateRef5 } from "vue";
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/internal-components/IPopup/IPopup.vue?type=script
var IPopup_default = defineComponent15({
  name: "IPopup",
  inheritAttrs: false,
  props: {
    /**
...
import { normalizeProps as _normalizeProps, guardReactiveProps as _guardReactiveProps, renderSlot as _renderSlot15, withModifiers as _withModifiers3, withKeys as _withKeys2, createElementVNode as _createElementVNode12, mergeProps as _mergeProps4, Teleport as _Teleport, openBlock as _openBlock16, createBlock as _createBlock7, createCommentVNode as _createCommentVNode14 } from "vue";
function render16(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.isOpen ? (_openBlock16(), _createBlock7(_Teleport, {
    key: 0,
    ...
    _createElementVNode12(
      "div",
      _mergeProps4({ ref: "popup" }, _ctx.$attrs, { class: _ctx.popupClasses }),
      [
        _createElementVNode12(
          "div",
          {
          ...
          [
            _renderSlot15(_ctx.$slots, "default", _normalizeProps(_guardReactiveProps({ toggleIsOpen: _ctx.toggleIsOpen, placement: _ctx.placement })))
          ],
          544
  ...
  ], 8, ["to", "disabled"])) : _createCommentVNode14("v-if", true);
}

// packages/vue/src/internal-components/IPopup/IPopup.vue
IPopup_default.render = render16;
...
import { computed as computed2, nextTick, ref as ref4, useTemplateRef, watch as watch2 } from "vue";
...
var IPopupError_default = /* @__PURE__ */ _defineComponent2({
  __name: "IPopupError",
  props: {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const teleportDisabled2 = ref4(false);
    const placement = ref4("NotCalculated" /* NotCalculated */);
    const arrowPosition = ref4("top");
    const arrowOffset = ref4(24);
...
import { createCommentVNode as _createCommentVNode15, openBlock as _openBlock17, createBlock as _createBlock8, toDisplayString as _toDisplayString5, createElementVNode as _createElementVNode13, createVNode as _createVNode7, createElementBlock as _createElementBlock16, normalizeClass as _normalizeClass8, normalizeStyle as _normalizeStyle3, Teleport as _Teleport2 } from "vue";
var _hoisted_112 = {
  ref: "wrapper",
  class: "popup-error__wrapper"
};
function render17(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.isOpen ? (_openBlock17(), _createBlock8(_Teleport2, {
    key: 0,
        ...
        _createElementVNode13(
          ...
          [
            ...
            _createElementVNode13(
              "div",
              {
                class: _normalizeClass8($setup.arrowClass),
                style: _normalizeStyle3($setup.errorStyle)
              },
              [
                $props.layout === "f-table" ? (_openBlock17(), _createBlock8($setup["FIcon"], {
                  key: 0,
                ...
                _createCommentVNode15(' `tabindex="-1" is set since `IPopupError` has `aria-hidden`, wich cannot be used on focusable elements.\n                        `IPopupError` will be closed on input-field `blur`, so the button is never focusable anyway .\n                    '),
                $props.layout === "f-interactive-table" ? (_openBlock17(), _createElementBlock16("button", {
                  key: 1,
                  tabindex: "-1",
                  type: "button",
  ...
  ], 8, ["to", "disabled"])) : _createCommentVNode15("v-if", true);
}

// packages/vue/src/internal-components/IPopupError/IPopupError.vue
IPopupError_default.render = render17;
...
import { computed as computed3, onUnmounted as onUnmounted3, useTemplateRef as useTemplateRef2, watch as watch3, watchEffect as watchEffect2 } from "vue";
import { debounce as debounce3 } from "@fkui/logic";

// packages/vue/src/composables/use-event-listener.ts
import { onMounted as onMounted2, onUnmounted as onUnmounted2, toValue as toValue2 } from "vue";
function useEventListener(target, event, callback) {
  onMounted2(() => {
    toValue2(target)?.addEventListener(event, callback);
  });
  onUnmounted2(() => {
    toValue2(target)?.removeEventListener(event, callback);
  });
}
...
var IPopupListbox_default = /* @__PURE__ */ _defineComponent3({
...
import { renderSlot as _renderSlot16, createElementVNode as _createElementVNode14, withModifiers as _withModifiers4, withKeys as _withKeys3, mergeProps as _mergeProps5, normalizeClass as _normalizeClass9, Teleport as _Teleport3, openBlock as _openBlock18, createBlock as _createBlock9, createCommentVNode as _createCommentVNode16 } from "vue";
var _hoisted_113 = ["onKeyup"];
var _hoisted_211 = { ref: "content" };
function render18(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.isOpen ? (_openBlock18(), _createBlock9(_Teleport3, {
    key: 0,
    to: $setup.teleportTarget,
    disabled: $setup.teleportDisabled
  }, [
    _createElementVNode14(
      ...
      {
        ref: "popup",
        class: _normalizeClass9($setup.popupClasses)
      },
      [
        _createElementVNode14("div", _mergeProps5({ ref: "wrapper" }, _ctx.$attrs, {
          class: "popup__wrapper",
          tabindex: "0",
  ...
  ], 8, ["to"])) : _createCommentVNode16("v-if", true);
}

// packages/vue/src/internal-components/IPopupListbox/IPopupListbox.vue
IPopupListbox_default.render = render18;
...
import { focus as focus8 } from "@fkui/logic";
...
var IPopupMenu_default = defineComponent16({
  name: "IPopupMenu",
  ...
  methods: {
    ...
    async setFocusOnItem(index) {
      ...
      focus8(itemAnchor, { preventScroll: true });
...
import { renderList as _renderList4, Fragment as _Fragment7, openBlock as _openBlock19, createElementBlock as _createElementBlock17, toDisplayString as _toDisplayString6, createElementVNode as _createElementVNode15, createCommentVNode as _createCommentVNode17, createTextVNode as _createTextVNode3, normalizeClass as _normalizeClass10, resolveComponent as _resolveComponent8, withCtx as _withCtx6, createBlock as _createBlock10 } from "vue";
...
function render19(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_i_popup = _resolveComponent8("i-popup");
  return _openBlock19(), _createBlock10(_component_i_popup, {
    class: "ipopupmenu",
    "is-open": _ctx.isOpen,
    "keyboard-trap": false,
    anchor: _ctx.anchor,
    ...
    default: _withCtx6(() => [
      _createElementVNode15("nav", {
        class: "ipopupmenu ipopupmenu--vertical",
        "aria-label": _ctx.ariaLabel
      }, [
        _createElementVNode15("ul", _hoisted_212, [
          (_openBlock19(true), _createElementBlock17(
            _Fragment7,
            null,
            _renderList4(_ctx.items, (item, index) => {
              return _openBlock19(), _createElementBlock17("li", {
                ref_for: true,
                ref: "items",
                key: item.key,
                role: "presentation",
                class: _normalizeClass10(_ctx.itemClasses(item)),
                onClick: (event) => _ctx.onClickItem(event, item)
              }, [
                _createElementVNode15("a", {
                  ref_for: true,
                  ref: "anchors",
                  ...
                  _ctx.isSelected(index) ? (_openBlock19(), _createElementBlock17("span", _hoisted_54, [
...
IPopupMenu_default.render = render19;
...
var IAnimateExpand_default = defineComponent17({
  name: "IAnimateExpand",
  props: {
    /**
...
import { createCommentVNode as _createCommentVNode18, renderSlot as _renderSlot17, vShow as _vShow, withDirectives as _withDirectives, openBlock as _openBlock20, createElementBlock as _createElementBlock18, normalizeClass as _normalizeClass11, normalizeStyle as _normalizeStyle4, createElementVNode as _createElementVNode16, Fragment as _Fragment8 } from "vue";
var _hoisted_115 = {
  key: 0,
  ref: "content",
...
function render20(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock20(), _createElementBlock18(
    ...
    null,
    [
      _createCommentVNode18(" [html-validate-disable-next no-inline-style] "),
      _createElementVNode16(
        "div",
        {
          class: _normalizeClass11(_ctx.animationClasses),
          style: _normalizeStyle4(_ctx.heightStyle)
        },
        [
          _ctx.shouldVIf ? _withDirectives((_openBlock20(), _createElementBlock18(
            "div",
            _hoisted_115,
            [
              _createCommentVNode18(" @slot Slot used for content shown when component is expanded "),
...
IAnimateExpand_default.render = render20;
...
var ISkipLink_default = defineComponent18({
  name: "ISkipLink",
  mixins: [TranslationMixin],
  props: {
    /**
...
import { createCommentVNode as _createCommentVNode19, renderSlot as _renderSlot18, toDisplayString as _toDisplayString7, createTextVNode as _createTextVNode4, openBlock as _openBlock21, createElementBlock as _createElementBlock19 } from "vue";
var _hoisted_116 = ["href"];
function render21(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock21(), _createElementBlock19("a", {
    class: "iskiplink",
    href: _ctx.href
  }, [
    _createCommentVNode19(" @slot Slot for default skip link text. "),
...
ISkipLink_default.render = render21;
...
import { alertScreenReader, focus as focus9 } from "@fkui/logic";
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/internal-components/calendar/ICalendarMonthGrid.vue?type=script
var ICalendarMonthGrid_default = defineComponent19({
...
import { openBlock as _openBlock22, createElementBlock as _createElementBlock20, createCommentVNode as _createCommentVNode20, createElementVNode as _createElementVNode17, renderList as _renderList5, Fragment as _Fragment9, toDisplayString as _toDisplayString8, renderSlot as _renderSlot19 } from "vue";
...
function render22(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock22(), _createElementBlock20("table", {
    ...
    _createElementVNode17("colgroup", null, [
      !_ctx.internalHideWeekNumbers ? (_openBlock22(), _createElementBlock20("col", _hoisted_213)) : _createCommentVNode20("v-if", true),
      _cache[2] || (_cache[2] = _createElementVNode17(
        "col",
      ...
      _cache[3] || (_cache[3] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
      ...
      _cache[4] || (_cache[4] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
      ...
      _cache[5] || (_cache[5] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
      ...
      _cache[6] || (_cache[6] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
      ...
      _cache[7] || (_cache[7] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
      ...
      _cache[8] || (_cache[8] = _createElementVNode17(
        "col",
        { class: "calendar-month__col--day" },
        null,
        -1
    ...
    _createElementVNode17("thead", null, [
      _createElementVNode17("tr", null, [
        !_ctx.internalHideWeekNumbers ? (_openBlock22(), _createElementBlock20("th", _hoisted_39)) : _createCommentVNode20("v-if", true),
        (_openBlock22(true), _createElementBlock20(
          _Fragment9,
          null,
          _renderList5(_ctx.weekdays, (weekday) => {
            return _openBlock22(), _createElementBlock20("th", {
              key: weekday.name,
              scope: "col",
              "aria-hidden": "true",
              class: "calendar-month__header-cell"
            }, [
              _ctx.showShortWeekdays ? (_openBlock22(), _createElementBlock20("abbr", {
                key: 0,
                title: weekday.name
              }, _toDisplayString8(weekday.shortName), 9, _hoisted_46)) : (_openBlock22(), _createElementBlock20(
                "span",
                _hoisted_55,
    ...
    _createElementVNode17("tbody", null, [
      (_openBlock22(true), _createElementBlock20(
        _Fragment9,
        null,
        _renderList5(_ctx.weeks, (week) => {
          return _openBlock22(), _createElementBlock20("tr", {
            key: week.week
          }, [
            !_ctx.internalHideWeekNumbers ? (_openBlock22(), _createElementBlock20(
              "td",
              _hoisted_62,
            ...
            _ctx.getDayEndOffset(week.days) ? (_openBlock22(), _createElementBlock20("td", {
              key: 2,
              class: "calendar-month__cell",
              colspan: _ctx.getDayEndOffset(week.days),
              "aria-hidden": "true"
            }, null, 8, _hoisted_82)) : _createCommentVNode20("v-if", true)
          ]);
        }),
        128
        /* KEYED_FRAGMENT */
      )),
      _ctx.weeks.length < 5 ? (_openBlock22(), _createElementBlock20("tr", _hoisted_92, [
        _createElementVNode17("td", {
          class: "calendar-month__cell",
          colspan: _ctx.totalCols,
          "aria-hidden": "true"
        }, null, 8, _hoisted_102)
      ])) : _createCommentVNode20("v-if", true),
      _ctx.weeks.length < 6 ? (_openBlock22(), _createElementBlock20("tr", _hoisted_118, [
        _createElementVNode17("td", {
          class: "calendar-month__cell",
          colspan: _ctx.totalCols,
          "aria-hidden": "true"
...
ICalendarMonthGrid_default.render = render22;
...
function getDayTabindex(date, active, entry) {
  const ref10 = active ?? entry;
  if (ref10 && isSameMonth(ref10, date)) {
    return date.equals(ref10) ? 0 : -1;
  } else {
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/internal-components/calendar/ICalendarMonth.vue?type=script
var ICalendarMonth_default = defineComponent20({
  name: "ICalendarMonth",
  components: {
...
import { createCommentVNode as _createCommentVNode21, renderSlot as _renderSlot20, withModifiers as _withModifiers5, createElementVNode as _createElementVNode18, resolveComponent as _resolveComponent9, withCtx as _withCtx7, openBlock as _openBlock23, createBlock as _createBlock11 } from "vue";
var _hoisted_119 = ["data-date", "tabindex", "onClick", "onKeydown"];
function render23(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_i_calendar_month_grid = _resolveComponent9("i-calendar-month-grid");
  return _openBlock23(), _createBlock11(_component_i_calendar_month_grid, { value: _ctx.modelValue }, {
...
ICalendarMonth_default.render = render23;
...
import { capitalize, defineComponent as defineComponent21 } from "vue";
import { ElementIdService as ElementIdService4, alertScreenReader as alertScreenReader2 } from "@fkui/logic";
var ICalendarNavbar_default = defineComponent21({
  ...
  methods: {
    ...
    isFocused(ref10) {
      return document.activeElement === this.$refs[ref10];
    }
  }
});
...
import { toDisplayString as _toDisplayString9, normalizeClass as _normalizeClass12, createElementVNode as _createElementVNode19, createCommentVNode as _createCommentVNode22, resolveComponent as _resolveComponent10, createVNode as _createVNode8, withModifiers as _withModifiers6, openBlock as _openBlock24, createElementBlock as _createElementBlock21 } from "vue";
var _hoisted_120 = { class: "calendar-navbar" };
var _hoisted_214 = { class: "calendar-navbar__month" };
var _hoisted_310 = ["aria-live"];
var _hoisted_47 = ["id", "aria-expanded"];
var _hoisted_56 = {
...
function render24(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock24(), _createElementBlock21("div", _hoisted_120, [
    _createElementVNode19("div", _hoisted_214, [
      _createElementVNode19("span", {
        class: _normalizeClass12([_ctx.monthTitleClass, "calendar-navbar__month--title"]),
        tabindex: "-1",
        "aria-live": _ctx.isFocused("yearSelectorButton") ? "polite" : "off"
      }, _toDisplayString9(_ctx.currentText), 11, _hoisted_310),
      _createCommentVNode22(" Button - Open/close year selector "),
      _ctx.yearSelector ? (_openBlock24(), _createElementBlock21("button", {
        key: 0,
        id: `${_ctx.id}`,
        ...
        _createVNode8(_component_f_icon, {
          class: _normalizeClass12(_ctx.yearSelectorOpen ? "calendar-navbar__arrow--up" : void 0),
          name: "arrow-down"
        }, null, 8, ["class"])
      ], 8, _hoisted_47)) : _createCommentVNode22("v-if", true)
    ]),
    !_ctx.yearSelectorOpen ? (_openBlock24(), _createElementBlock21("button", {
      key: 0,
      ref: "previousButton",
      ...
      _createVNode8(_component_f_icon, {
        class: _normalizeClass12(_ctx.previousIconClasses),
        name: "arrow-right"
      }, null, 8, ["class"])
    ], 8, _hoisted_73)) : _createCommentVNode22("v-if", true),
    !_ctx.yearSelectorOpen ? (_openBlock24(), _createElementBlock21("button", {
      key: 1,
      ref: "nextButton",
      ...
      _createVNode8(_component_f_icon, {
        class: _normalizeClass12(_ctx.nextIconClasses),
        name: "arrow-right"
      }, null, 8, ["class"])
    ], 8, _hoisted_93)) : _createCommentVNode22("v-if", true)
  ]);
}

// packages/vue/src/internal-components/calendar/ICalendarNavbar.vue
ICalendarNavbar_default.render = render24;
...
import { nextTick as nextTick3, ref as ref6, useTemplateRef as useTemplateRef3, watchEffect as watchEffect4 } from "vue";
var IComboboxDropdown_default = /* @__PURE__ */ _defineComponent4({
...
import { createCommentVNode as _createCommentVNode23, renderList as _renderList6, Fragment as _Fragment10, openBlock as _openBlock25, createElementBlock as _createElementBlock22, toDisplayString as _toDisplayString10, withModifiers as _withModifiers7, normalizeClass as _normalizeClass13, createElementVNode as _createElementVNode20, withCtx as _withCtx8, createVNode as _createVNode9 } from "vue";
var _hoisted_121 = { class: "combobox" };
var _hoisted_215 = ["id"];
var _hoisted_311 = ["id", "aria-selected", "onClick"];
function render25(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock25(), _createElementBlock22("div", _hoisted_121, [
    _createVNode9($setup["IPopupListbox"], {
      ...
      default: _withCtx8(() => [
        _createCommentVNode23(" [html-validate-disable-next prefer-native-element] "),
        _createElementVNode20("ul", {
          id: $props.id,
          ref: "listbox",
          role: "listbox",
          ...
          (_openBlock25(true), _createElementBlock22(
            _Fragment10,
            null,
            _renderList6($props.options, (item) => {
              return _openBlock25(), _createElementBlock22("li", {
                id: $setup.isOptionActive(item) ? $props.activeOptionId : void 0,
                key: item,
                role: "option",
                "aria-selected": $setup.isOptionActive(item) ? "true" : void 0,
                class: _normalizeClass13(["combobox__listbox__option", { "combobox__listbox__option--highlight": $setup.isOptionActive(item) }]),
                onClick: _withModifiers7(($event) => $setup.onOptionClick(item), ["stop", "prevent"])
              }, _toDisplayString10(item), 11, _hoisted_311);
            }),
            128
            /* KEYED_FRAGMENT */
          ))
...
IComboboxDropdown_default.render = render25;
...
var IComboboxToggleButton_default = /* @__PURE__ */ _defineComponent5({
...
import { createVNode as _createVNode10, openBlock as _openBlock26, createElementBlock as _createElementBlock23 } from "vue";
var _hoisted_123 = ["aria-label"];
function render26(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock26(), _createElementBlock23("button", {
...
IComboboxToggleButton_default.render = render26;
...
import { defineComponent as defineComponent22 } from "vue";
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FExpand/FExpand.vue?type=script
var FExpand_default = defineComponent22({
  name: "FExpand",
  data() {
    return {
      height: 0
...
import { renderSlot as _renderSlot21, Transition as _Transition, withCtx as _withCtx9, openBlock as _openBlock27, createBlock as _createBlock12 } from "vue";
function render27(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock27(), _createBlock12(_Transition, {
    onEnter: _ctx.enter,
    onAfterEnter: _ctx.afterEnter,
    onLeave: _ctx.leave
  }, {
    default: _withCtx9(() => [
      _renderSlot21(_ctx.$slots, "default", { height: _ctx.height })
    ]),
    _: 3
    /* FORWARDED */
...
FExpand_default.render = render27;
...
import { computed as computed5, onMounted as onMounted4, ref as ref7, watchEffect as watchEffect5 } from "vue";
var initialized = false;
var reducedMotion = ref7(false);
...
import { onMounted as onMounted5, onUnmounted as onUnmounted4, readonly, ref as ref8, watch as watch4 } from "vue";
function useHorizontalOffset(options) {
  const { element: elementRef, parent: parentRef } = options;
  const offset2 = ref8(16);
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FTooltip/FTooltip.vue?type=script
var FTooltip_default = defineComponent23({
  name: "FTooltip",
...
import { createCommentVNode as _createCommentVNode25, resolveComponent as _resolveComponent11, createVNode as _createVNode11, toDisplayString as _toDisplayString11, createElementVNode as _createElementVNode21, Teleport as _Teleport4, openBlock as _openBlock28, createBlock as _createBlock13, renderSlot as _renderSlot22, resolveDynamicComponent as _resolveDynamicComponent2, withCtx as _withCtx10, createElementBlock as _createElementBlock24, mergeProps as _mergeProps6, Fragment as _Fragment11 } from "vue";
var _hoisted_124 = ["aria-expanded"];
var _hoisted_216 = { class: "icon-stack icon-stack--tooltip" };
var _hoisted_312 = { class: "sr-only" };
var _hoisted_48 = {
  key: 0,
  class: "tooltip__bubble",
  tabindex: "-1"
};
var _hoisted_57 = { class: "tooltip__body" };
...
function render28(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock28(), _createElementBlock24(
    _Fragment11,
    null,
    [
      _createCommentVNode25(" [html-validate-disable-next element-case -- false positive, is proper case for Vue] "),
      (_openBlock28(), _createBlock13(_Teleport4, {
        disabled: _ctx.iconTarget === null,
        to: _ctx.iconTarget
      }, [
        _createElementVNode21("button", {
          ref: "button",
          ...
          _createElementVNode21("span", _hoisted_216, [
            _createVNode11(_component_f_icon, { name: "circle" }),
            _createVNode11(_component_f_icon, { name: "i" }),
      ...
      _createElementVNode21(
        ...
        [
          _ctx.ready ? (_openBlock28(), _createElementBlock24("div", _hoisted_48, [
            _ctx.hasHeader ? (_openBlock28(), _createBlock13(_resolveDynamicComponent2(_ctx.headerTag), {
              key: 0,
              class: "tooltip__header"
            }, {
              default: _withCtx10(() => [
                _createCommentVNode25(" @slot Tooltip header content "),
                _renderSlot22(_ctx.$slots, "header")
              ]),
              _: 3
              /* FORWARDED */
            })) : _createCommentVNode25("v-if", true),
            _createElementVNode21("div", _hoisted_57, [
              _createCommentVNode25(" @slot Tooltip body content"),
              _renderSlot22(_ctx.$slots, "body")
            ]),
            _createElementVNode21("div", _hoisted_64, [
              _createElementVNode21("button", {
                class: "close-button",
                type: "button",
                ...
                _createVNode11(_component_f_icon, {
                  class: "button__icon",
                  name: "close"
                })
              ])
...
// sfc-template:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FLabel/FLabel.vue?type=template
import { renderSlot as _renderSlot23, createElementVNode as _createElementVNode22, openBlock as _openBlock29, createElementBlock as _createElementBlock25, createCommentVNode as _createCommentVNode26, resolveComponent as _resolveComponent12, createVNode as _createVNode12 } from "vue";
var _hoisted_125 = { key: 0 };
var _hoisted_217 = {
  key: 0,
  ref: "tooltipAttachTo"
};
var _hoisted_313 = ["for"];
var _hoisted_49 = ["for"];
var _hoisted_58 = {
  key: 0,
...
function render29(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = _resolveComponent12("f-icon");
  return _ctx.$slots.tooltip ? (_openBlock29(), _createElementBlock25("div", _hoisted_125, [
    _ctx.hasDefaultSlot ? (_openBlock29(), _createElementBlock25(
      "div",
      _hoisted_217,
      [
        _createElementVNode22("label", {
          class: "label",
          for: _ctx.forProperty
        }, [
          _renderSlot23(_ctx.$slots, "default")
        ], 8, _hoisted_313)
      ],
      512
      /* NEED_PATCH */
    )) : _createCommentVNode26("v-if", true),
    _createCommentVNode26(" @slot Slot for tooltip. "),
    _renderSlot23(_ctx.$slots, "tooltip"),
    _ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot ? (_openBlock29(), _createElementBlock25("label", {
      key: 1,
      class: "label sr-separator",
      for: _ctx.forProperty
    }, [
      _createCommentVNode26("\n                @slot Optional slot for description.\n                @binding {string[]} description-class CSS classes for primary description content.\n                @binding {string[]} format-description-class CSS classes for format description.\n            "),
      _renderSlot23(_ctx.$slots, "description", {
        descriptionClass: _ctx.descriptionClass,
        formatDescriptionClass: _ctx.formatDescriptionClass
      }),
      _ctx.hasErrorMessageSlot ? (_openBlock29(), _createElementBlock25("span", _hoisted_58, [
        _createVNode12(_component_f_icon, {
          class: "label__icon--left",
          name: "error"
        }),
        _renderSlot23(_ctx.$slots, "error-message")
      ])) : _createCommentVNode26("v-if", true)
    ], 8, _hoisted_49)) : _createCommentVNode26("v-if", true)
  ])) : (_openBlock29(), _createElementBlock25("label", {
    key: 1,
    class: "label",
    for: _ctx.forProperty
  }, [
    _createCommentVNode26(" @slot Slot for label content. "),
    _renderSlot23(_ctx.$slots, "default"),
    _createCommentVNode26("\n            @slot Optional slot for description.\n            @binding {string[]} description-class CSS classes for primary description content.\n            @binding {string[]} format-description-class CSS classes for format description.\n          "),
    _renderSlot23(_ctx.$slots, "description", {
      descriptionClass: _ctx.descriptionClass,
    ...
    _ctx.hasErrorMessageSlot ? (_openBlock29(), _createElementBlock25("span", _hoisted_74, [
      _createVNode12(_component_f_icon, {
        class: "label__icon--left",
        name: "error"
      }),
      _createCommentVNode26(" @slot Slot for displaying single or several error messages. "),
      _renderSlot23(_ctx.$slots, "error-message")
    ])) : _createCommentVNode26("v-if", true)
  ], 8, _hoisted_65));
}

// packages/vue/src/components/FLabel/FLabel.vue
FLabel_default.render = render29;
FLabel_default.__file = "packages/vue/src/components/FLabel/FLabel.vue";
var FLabel_default2 = FLabel_default;

// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FTextareaField/FTextareaField.vue?type=script
var FTextareaField_default = defineComponent25({
  name: "FTextareaField",
  components: {
    FLabel: FLabel_default2
  },
  inheritAttrs: false,
  props: {
    /**
  ...
  computed: {
    ...
    showCharactersLeftWarning() {
      return isSet4(this.softLimit) && isSet4(this.modelValue) && // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- required when `softLimit`
  ...
  mounted() {
    if (isSet4(this.softLimit) && !isSet4(this.maxlength)) {
...
// sfc-template:/home/runner/work/designsystem/designsystem/packages/vue/src/components/FTextareaField/FTextareaField.vue?type=template
import { createCommentVNode as _createCommentVNode27, renderSlot as _renderSlot24, normalizeProps as _normalizeProps2, guardReactiveProps as _guardReactiveProps2, toDisplayString as _toDisplayString12, createTextVNode as _createTextVNode5, Fragment as _Fragment12, openBlock as _openBlock30, createElementBlock as _createElementBlock26, resolveComponent as _resolveComponent13, withCtx as _withCtx11, createSlots as _createSlots, createVNode as _createVNode13, normalizeClass as _normalizeClass14, createBlock as _createBlock14, mergeProps as _mergeProps7, createElementVNode as _createElementVNode23 } from "vue";
var _hoisted_126 = ["id", "disabled"];
function render30(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_label = _resolveComponent13("f-label");
  return _openBlock30(), _createElementBlock26(
    "div",
    {
      class: _normalizeClass14(["textarea-field", _ctx.validityClass])
    },
    [
      _createVNode13(_component_f_label, { for: _ctx.id }, _createSlots({
        default: _withCtx11(() => [
          _createCommentVNode27(" @slot Slot for label content. "),
          _renderSlot24(_ctx.$slots, "default")
        ]),
        description: _withCtx11(({ descriptionClass, formatDescriptionClass }) => [
          _createCommentVNode27("\n                @slot Optional slot for description. See {@link FLabel} for details.\n                @binding {string[]} description-class CSS classes for primary description content.\n                @binding {string[]} format-description-class CSS classes for format description.\n            "),
          _renderSlot24(_ctx.$slots, "description", {
            descriptionClass,
            formatDescriptionClass
          })
        ]),
        "error-message": _withCtx11(() => [
          ...
          _renderSlot24(_ctx.$slots, "error-message", _normalizeProps2(_guardReactiveProps2({ hasError: _ctx.hasError, validationMessage: _ctx.validationMessage })), () => [
            _ctx.hasError ? (_openBlock30(), _createElementBlock26(
              _Fragment12,
              { key: 0 },
              [
                _createTextVNode5(
                  _toDisplayString12(_ctx.validationMessage),
                  1
                  /* TEXT */
                )
              ],
        ...
        _ctx.$slots.tooltip ? {
          name: "tooltip",
          fn: _withCtx11(() => [
            _createCommentVNode27(" @slot Slot for tooltip. "),
            _renderSlot24(_ctx.$slots, "tooltip")
          ]),
          key: "0"
        } : void 0
      ]), 1032, ["for"]),
      _ctx.softLimit ? (_openBlock30(), _createBlock14(_component_f_label, {
        key: 0,
        for: _ctx.id,
        "aria-live": "polite"
      }, {
        description: _withCtx11(({ descriptionClass }) => [
          _ctx.showCharactersLeftWarning ? (_openBlock30(), _createElementBlock26(
            "span",
            {
              key: 0,
              class: _normalizeClass14(descriptionClass)
            },
            _toDisplayString12(_ctx.charactersLeftWarningInterpolated),
            3
            /* TEXT, CLASS */
          )) : _createCommentVNode27("v-if", true)
        ]),
        _: 1
        /* STABLE */
      }, 8, ["for"])) : _createCommentVNode27("v-if", true),
      _createElementVNode23("textarea", _mergeProps7({
        id: _ctx.id,
...
// packages/vue/src/components/FTextareaField/FTextareaField.vue
FTextareaField_default.render = render30;
FTextareaField_default.__file = "packages/vue/src/components/FTextareaField/FTextareaField.vue";
var FTextareaField_default2 = FTextareaField_default;

// virtual-entry:virtual:packages/vue/src/components/FExpandablePanel/examples/FExpandablePanelExample.vue:FExpandablePanelExample-7b93dd.js
import { createTextVNode as _createTextVNode6, createElementVNode as _createElementVNode24, normalizeClass as _normalizeClass15, resolveComponent as _resolveComponent14, withCtx as _withCtx12, createVNode as _createVNode14, openBlock as _openBlock31, createBlock as _createBlock15 } from "vue";
var exampleComponent = defineComponent26({
  name: "FExpandablePanelExample",
  components: { FExpandablePanel, FLayoutApplicationTemplate: FLayoutApplicationTemplate_default2, FLayoutRightPanel: FLayoutRightPanel_default2, FTextareaField: FTextareaField_default2 },
  data() {
    return {
      expanded: false,
      type: Boolean,
...
var _hoisted_127 = { class: "container-fluid" };
function render31(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_textarea_field = _resolveComponent14("f-textarea-field");
  const _component_f_expandable_panel = _resolveComponent14("f-expandable-panel");
  const _component_f_layout_right_panel = _resolveComponent14("f-layout-right-panel");
  const _component_f_layout_application_template = _resolveComponent14("f-layout-application-template");
  return _openBlock31(), _createBlock15(_component_f_layout_application_template, null, {
    default: _withCtx12(() => [
      _createVNode14(_component_f_layout_right_panel, null, {
        default: _withCtx12(() => [
          _createElementVNode24("div", _hoisted_127, [
            _createVNode14(_component_f_expandable_panel, {
              expanded: _ctx.expanded,
              onToggle: _ctx.togglePanelOne
            }, {
              title: _withCtx12(() => [..._cache[1] || (_cache[1] = [
                _createTextVNode6(
              ...
              default: _withCtx12(() => [
                _createVNode14(_component_f_textarea_field, {
                  modelValue: _ctx.about,
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.about = $event),
                  maxlength: 100,
                  "soft-limit": 20
                }, {
                  description: _withCtx12(({ formatDescriptionClass }) => [
                    _cache[2] || (_cache[2] = _createElementVNode24(
                      "label",
                      null,
                      "Test",
                      -1
                    ...
                    _createElementVNode24(
                      "span",
                      {
                        class: _normalizeClass15(formatDescriptionClass)
                      },
                      " (max 100 tecken) ",
                      2
                      /* CLASS */
...
exampleComponent.render = render31;
setup({
  rootComponent: exampleComponent,
  selector: "#example-7b93dd"
});
export {
  render31 as render
};
