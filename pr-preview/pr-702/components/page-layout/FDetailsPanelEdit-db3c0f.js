...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-db3c0f.js
...
exampleComponent.__scopeId = "data-v-db3c0f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db3c0f"
});
export {
  render
};
