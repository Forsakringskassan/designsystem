...
// virtual-entry:virtual:src/components/FTable/examples/FTableColumnLiveExample.vue:FTableColumnLiveExample-7162ef.js
...
function getColumn(options) {
  ...
  if (editable !== void 0 && isTextColumn(column)) {
    column.editable = editable;
  }
  if (enabled !== void 0 && column.type === "button" || column.type === "anchor") {
  ...
  computed: {
    ...
    columns() {
      const column = getColumn({
        ...
        align: this.alignChecked ? this.align : void 0,
  ...
  return _openBlock8(), _createBlock3(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode2(_component_f_fieldset, { name: "rubrik" }, {
        label: _withCtx(() => [..._cache[42] || (_cache[42] = [
          _createTextVNode(
            " Rubriken ",
            -1
            /* CACHED */
