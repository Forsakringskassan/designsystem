...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-be5a0f.js
...
exampleComponent.__scopeId = "data-v-be5a0f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-be5a0f"
});
export {
  render
};
