...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-76f55f.js
...
exampleComponent.__scopeId = "data-v-76f55f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-76f55f"
});
export {
  render
};
