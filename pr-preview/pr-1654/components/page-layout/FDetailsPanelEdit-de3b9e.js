...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-de3b9e.js
...
exampleComponent.__scopeId = "data-v-de3b9e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-de3b9e"
});
export {
  render
};
