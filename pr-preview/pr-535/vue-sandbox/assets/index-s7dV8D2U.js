...
const _sfc_main$1m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const {
      inflight,
      fn: onClick
    } = useInflight(originalAttrs.onClick);
    const attrs = {
      ...originalAttrs,
      onClick
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", mergeProps({
        ...
        class: ["button button--primary", {
          inflight: unref(inflight)
        }],
        disabled: unref(inflight)
      }, attrs), [_cache[0] || (_cache[0] = createBaseVNode("span", {
        class: "loader2"
      }, null, -1)), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$10);
    };
  }
});
...
const _hoisted_4$6 = ["id", "aria-labelledby", "tabindex", "onKeydown"];
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return !__props.selectable ? (openBlock(), createElementBlock("ul", _hoisted_1$f, [(openBlock(true), createElementBlock(Fragment, null, renderList(internalItems.value, (item) => {
      ...
      }), 128)), _cache[0] || (_cache[0] = createTextVNode()), isEmpty2.value ? (openBlock(), createElementBlock("li", _hoisted_2$b, [createBaseVNode("div", _hoisted_3$7, [renderSlot(_ctx.$slots, "empty", {}, () => [createBaseVNode("em", null, toDisplayString(unref($t2)("fkui.list.empty", "Listan är tom")), 1)])])])) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("ul", {
        key: 1,
        ref_key: "ulElement",
        ref: ulElement,
        ...
        }, [createBaseVNode("div", _hoisted_6$4, [createVNode(unref(FCheckboxField), {
          value: true,
      ...
      }), 128)), _cache[2] || (_cache[2] = createTextVNode()), isEmpty2.value ? (openBlock(), createElementBlock("li", _hoisted_8$2, [createBaseVNode("div", _hoisted_9$2, [renderSlot(_ctx.$slots, "empty", {}, () => [createBaseVNode("em", null, toDisplayString(unref($t2)("fkui.list.empty", "Listan är tom")), 1)])])])) : createCommentVNode("", true)], 512));
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function asyncOperation() {
      ...
      const id = counter++;
      items.value.push({ id });
      await new Promise((resolve2) => setTimeout(resolve2, 5e3 + Math.random() * 5e3));
      items.value = items.value.filter((it) => it.id !== id);
      console.log("slow async operation done");
    }
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[3] || (_cache[3] = createBaseVNode("h1", null, "@fkui/vue", -1)),
        createVNode(unref(_sfc_main$1m), { onClick: syncOperation }, {
          default: withCtx(() => _cache[0] || (_cache[0] = [
            createTextVNode("sync button")
          ])),
          _: 1,
          __: [0]
        }),
        createVNode(unref(_sfc_main$1m), { onClick: asyncOperation }, {
          default: withCtx(() => _cache[1] || (_cache[1] = [
            createTextVNode("async button")
          ])),
          _: 1,
          __: [1]
        }),
        ...
        createVNode(unref(_sfc_main$f), { items: items.value }, {
          default: withCtx(({ item }) => [
            createTextVNode(" job #" + toDisplayString(item.id) + " in progress... ", 1)
          ]),
          empty: withCtx(() => _cache[2] || (_cache[2] = [
            createTextVNode("No expensive calls in progress")
          ])),
          _: 1
        }, 8, ["items"])
      ]);
