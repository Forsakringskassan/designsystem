...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-df58b3.js
...
exampleComponent.__scopeId = "data-v-df58b3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-df58b3"
});
export {
  render
};
