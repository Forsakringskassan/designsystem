...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-db4a0c.js
...
exampleComponent.__scopeId = "data-v-db4a0c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db4a0c"
});
export {
  render
};
