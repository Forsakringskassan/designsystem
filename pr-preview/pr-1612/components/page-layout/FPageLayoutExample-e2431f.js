...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-e2431f.js
...
exampleComponent.__scopeId = "data-v-e2431f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-e2431f"
});
export {
  render
};
