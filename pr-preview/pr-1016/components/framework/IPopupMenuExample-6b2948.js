...
// virtual-entry:virtual:packages/vue/src/internal-components/IPopupMenu/examples/IPopupMenuExample.vue:IPopupMenuExample-6b2948.js
...
var IPopup_default = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const teleportDisabled = ref2(false);
    const placement = ref2("NotCalculated" /* NotCalculated */);
    const focus7 = ref2(null);
    ...
    const isInline = computed(() => {
      let inline = teleportDisabled.value || placement.value === "Fallback" /* Fallback */;
    ...
    function applyFocus() {
      ...
      focus7.value = pushFocus2(focusableElement);
    }
...
var IPopupMenu_default = defineComponent12({
  name: "IPopupMenu",
                ...
                _createElementVNode9("a", {
                  ...
                  _ctx.isSelected(index) ? (_openBlock13(), _createElementBlock12("span", _hoisted_53, [
                    _createElementVNode9(
                      "span",
                      null,
                      _toDisplayString5(_ctx.selectedMenuItemScreenReaderText) + "\xA0",
                      1
                      /* TEXT */
                    )
...
// virtual-entry:virtual:packages/vue/src/internal-components/IPopupMenu/examples/IPopupMenuExample.vue:IPopupMenuExample-6b2948.js
import { createElementVNode as _createElementVNode10, resolveComponent as _resolveComponent7, createVNode as _createVNode5, toDisplayString as _toDisplayString6, openBlock as _openBlock14, createElementBlock as _createElementBlock13 } from "vue";
var exampleItems = [
...
var preventKeys2 = /* @__PURE__ */ new Set(["Tab", ...verticalKeys]);
var exampleComponent = defineComponent13({
...
function render14(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_i_popup_menu = _resolveComponent7("i-popup-menu");
  return _openBlock14(), _createElementBlock13("div", null, [
    ...
    _createVNode5(_component_i_popup_menu, {
      id: "popup-menu",
    ...
    _createElementVNode10(
      "pre",
      null,
      "Selected item: " + _toDisplayString6(_ctx.selectedItem),
      1
      /* TEXT */
    )
  ]);
