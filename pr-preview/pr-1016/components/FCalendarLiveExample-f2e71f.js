...
// virtual-entry:virtual:packages/vue/src/components/FCalendar/examples/FCalendarLiveExample.vue:FCalendarLiveExample-f2e71f.js
...
// sfc-script:/home/runner/work/designsystem/designsystem/packages/vue/src/internal-components/IPopup/IPopup.vue?type=script
var IPopup_default = /* @__PURE__ */ _defineComponent({
  ...{
    inheritAttrs: false
  },
  __name: "IPopup",
  props: {
    ...
    inline: { type: String, required: false, default: "auto" },
    container: { type: null, required: false, default: () => void 0 },
    viewport: { type: null, required: false, default: () => document.documentElement },
    keyboardTrap: { type: Boolean, required: false, default: true },
    focusElement: { type: [Function, null], required: false, default: null },
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const isInline = computed(() => {
      let inline = teleportDisabled2.value || placement.value === "Fallback" /* Fallback */;
      if (forceInline.value) {
        inline = true;
      } else if (forceOverlay.value) {
        inline = false;
      } else if (placement.value === "NotCalculated" /* NotCalculated */ && !isMobileSize()) {
        inline = false;
      }
      return inline;
    });
    const forceInline = computed(() => __props.inline === "always");
    const forceOverlay = computed(() => __props.inline === "never");
    ...
    async function toggleIsOpen(isOpenValue) {
      if (!isOpenValue) {
        placement.value = "NotCalculated" /* NotCalculated */;
        if (focus8.value) {
          popFocus2(focus8.value);
          focus8.value = null;
        }
        return;
      }
    ...
    async function calculatePlacement(options) {
      ...
      if (shouldCheckCandidates) {
        const area = getContainer(popupEl, __props.container);
        const result = fitInsideArea({
          area,
          anchor: anchorEl,
          target: wrapperEl,
    ...
    function applyFocus() {
      ...
      const focusableElement = getFocusableElement(wrapper.value, __props.focusElement);
      focus8.value = pushFocus2(focusableElement);
    }
    ...
    function onPopupClickHandler(event) {
      event.stopPropagation();
    }
    function onKeyEsc() {
      emit("close", "escape");
...
var _hoisted_18 = ["onKeyup"];
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.isOpen ? (_openBlock12(), _createBlock6(_Teleport, {
    key: 0,
    ...
    _createElementVNode8(
      "div",
      _mergeProps3({ ref: "popup" }, $setup.attrs, { class: $setup.popupClasses }),
      [
        _createElementVNode8("div", {
          ref: "wrapper",
          role: "presentation",
          class: "popup__wrapper",
          onClick: $setup.onPopupClickHandler,
          onKeyup: _withKeys2(_withModifiers3($setup.onKeyEsc, ["stop"]), ["esc"]),
          onKeydown: _withKeys2($setup.onKeyTab, ["tab"])
        }, [
          _renderSlot11(_ctx.$slots, "default", _normalizeProps(_guardReactiveProps({ toggleIsOpen: $setup.toggleIsOpen, placement: $setup.placement })))
        ], 40, _hoisted_18)
      ],
      16
      /* FULL_PROPS */
    )
  ], 8, ["to", "disabled"])) : _createCommentVNode10("v-if", true);
}
...
var IPopupError_default = defineComponent12({
  name: "IPopupError",
  components: { FIcon: FIcon_default2 },
  inheritAttrs: false,
  props: {
    ...
    _createElementVNode9(
      ...
      [
        _createElementVNode9(
          ...
          _hoisted_19,
          [
            _createCommentVNode11(" [html-validate-disable-next no-inline-style] "),
            _createElementVNode9(
              "div",
              {
...
IPopupError_default.render = render13;
...
var _hoisted_110 = ["onKeyup"];
var _hoisted_27 = { ref: "content" };
function render14(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.isOpen ? (_openBlock14(), _createBlock8(_Teleport3, {
    key: 0,
    to: $setup.teleportTarget,
    disabled: $setup.teleportDisabled
  }, [
  ...
  ], 8, ["to"])) : _createCommentVNode12("v-if", true);
}

// packages/vue/src/internal-components/IPopupListbox/IPopupListbox.vue
IPopupListbox_default.render = render14;
        ...
        _createElementVNode11("ul", _hoisted_28, [
          (_openBlock15(true), _createElementBlock13(
            ...
            _renderList4(_ctx.items, (item, index) => {
              return _openBlock15(), _createElementBlock13("li", {
                ref_for: true,
                ref: "items",
                key: item.key,
                role: "presentation",
                ...
                _createElementVNode11("a", {
                  ...
                  _ctx.isSelected(index) ? (_openBlock15(), _createElementBlock13("span", _hoisted_53, [
...
IPopupMenu_default.render = render15;
...
function render16(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock16(), _createElementBlock14(
    _Fragment6,
    null,
    [
      _createCommentVNode14(" [html-validate-disable-next no-inline-style] "),
      _createElementVNode12(
        ...
        [
          _ctx.shouldVIf ? _withDirectives((_openBlock16(), _createElementBlock14(
            "div",
            _hoisted_112,
            [
              _createCommentVNode14(" @slot Slot used for content shown when component is expanded "),
...
IAnimateExpand_default.render = render16;
...
import { createCommentVNode as _createCommentVNode15, renderSlot as _renderSlot14, toDisplayString as _toDisplayString7, createTextVNode as _createTextVNode4, openBlock as _openBlock17, createElementBlock as _createElementBlock15 } from "vue";
var _hoisted_113 = ["href"];
function render17(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock17(), _createElementBlock15("a", {
    class: "iskiplink",
    href: _ctx.href
  }, [
    _createCommentVNode15(" @slot Slot for default skip link text. "),
...
ISkipLink_default.render = render17;
...
import { openBlock as _openBlock18, createElementBlock as _createElementBlock16, createCommentVNode as _createCommentVNode16, createElementVNode as _createElementVNode13, renderList as _renderList5, Fragment as _Fragment7, toDisplayString as _toDisplayString8, renderSlot as _renderSlot15 } from "vue";
...
function render18(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock18(), _createElementBlock16("table", {
    ...
    _createElementVNode13("colgroup", null, [
      !_ctx.internalHideWeekNumbers ? (_openBlock18(), _createElementBlock16("col", _hoisted_29)) : _createCommentVNode16("v-if", true),
    ...
    _createElementVNode13("thead", null, [
      _createElementVNode13("tr", null, [
        !_ctx.internalHideWeekNumbers ? (_openBlock18(), _createElementBlock16("th", _hoisted_36)) : _createCommentVNode16("v-if", true),
        (_openBlock18(true), _createElementBlock16(
          _Fragment7,
          null,
          _renderList5(_ctx.weekdays, (weekday) => {
            return _openBlock18(), _createElementBlock16("th", {
              key: weekday.name,
              scope: "col",
              "aria-hidden": "true",
              class: "calendar-month__header-cell"
            }, [
              _ctx.showShortWeekdays ? (_openBlock18(), _createElementBlock16("abbr", {
                key: 0,
                title: weekday.name
              }, _toDisplayString8(weekday.shortName), 9, _hoisted_44)) : (_openBlock18(), _createElementBlock16(
                "span",
                _hoisted_54,
    ...
    _createElementVNode13("tbody", null, [
      (_openBlock18(true), _createElementBlock16(
        ...
        _renderList5(_ctx.weeks, (week) => {
          return _openBlock18(), _createElementBlock16("tr", {
            key: week.week
          }, [
            !_ctx.internalHideWeekNumbers ? (_openBlock18(), _createElementBlock16(
              "td",
              _hoisted_62,
            ...
            _ctx.getDayEndOffset(week.days) ? (_openBlock18(), _createElementBlock16("td", {
              key: 2,
              class: "calendar-month__cell",
              colspan: _ctx.getDayEndOffset(week.days),
              "aria-hidden": "true"
            }, null, 8, _hoisted_82)) : _createCommentVNode16("v-if", true)
          ]);
        }),
        128
        /* KEYED_FRAGMENT */
      )),
      _ctx.weeks.length < 5 ? (_openBlock18(), _createElementBlock16("tr", _hoisted_92, [
      ...
      _ctx.weeks.length < 6 ? (_openBlock18(), _createElementBlock16("tr", _hoisted_115, [
        _createElementVNode13("td", {
          class: "calendar-month__cell",
          colspan: _ctx.totalCols,
          "aria-hidden": "true"
...
ICalendarMonthGrid_default.render = render18;
...
var _hoisted_116 = ["data-date", "tabindex", "onClick", "onKeydown"];
...
ICalendarMonth_default.render = render19;
...
var _hoisted_117 = { class: "calendar-navbar" };
...
function render20(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock20(), _createElementBlock17("div", _hoisted_117, [
    _createElementVNode15("div", _hoisted_210, [
      ...
      _createCommentVNode18(" Button - Open/close year selector "),
      _ctx.yearSelector ? (_openBlock20(), _createElementBlock17("button", {
        key: 0,
        id: `${_ctx.id}`,
    ...
    !_ctx.yearSelectorOpen ? (_openBlock20(), _createElementBlock17("button", {
      key: 0,
      ref: "previousButton",
...
function render21(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock21(), _createElementBlock18("div", _hoisted_118, [
    _createVNode7($setup["IPopupListbox"], {
      ...
      default: _withCtx7(() => [
        _createCommentVNode19(" [html-validate-disable-next prefer-native-element] "),
        _createElementVNode16("ul", {
          ...
          (_openBlock21(true), _createElementBlock18(
            _Fragment8,
            null,
            _renderList6($props.options, (item) => {
              return _openBlock21(), _createElementBlock18("li", {
...
IComboboxDropdown_default.render = render21;
...
import { createVNode as _createVNode8, openBlock as _openBlock22, createElementBlock as _createElementBlock19 } from "vue";
var _hoisted_119 = ["aria-label"];
function render22(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock22(), _createElementBlock19("button", {
...
IComboboxToggleButton_default.render = render22;
...
FExpand_default.render = render23;
...
var _hoisted_120 = ["aria-expanded"];
  ...
  return _openBlock24(), _createElementBlock20(
    ...
    [
      ...
      _createElementVNode17(
        ...
        [
          _ctx.ready ? (_openBlock24(), _createElementBlock20("div", _hoisted_46, [
  ...
  return _openBlock25(), _createElementBlock21("fieldset", {
    ...
    (_openBlock25(), _createElementBlock21(
      ...
      [
        ...
        _ctx.hasCheckbox && _ctx.children.length > 1 ? (_openBlock25(), _createElementBlock21("span", _hoisted_213, [
    ...
    _ctx.hasCheckbox ? (_openBlock25(), _createElementBlock21("span", _hoisted_47, [
      _ctx.children.length === 1 ? (_openBlock25(), _createElementBlock21(
        "span",
        _hoisted_57,
    ...
    _ctx.hasTooltipSlot ? (_openBlock25(), _createElementBlock21(
      _Fragment10,
      { key: 1 },
      [
        _createElementVNode18(
        ...
        _ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot || _ctx.hasError ? (_openBlock25(), _createElementBlock21(
          "div",
          {
            key: 0,
  ...
  return _openBlock26(), _createElementBlock22(
    ...
    [
      ...
      _createElementVNode19("label", {
        ...
        _ctx.$slots.details ? (_openBlock26(), _createElementBlock22(
          _Fragment11,
          { key: 0 },
          [
