...
function _sfc_render(_ctx, _cache) {
	...
	return openBlock(), createElementBlock("nav", _hoisted_1$1, [
		...
		createVNode(_component_router_link, { to: "/sort" }, {
			default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode("SortFilter", -1)])]),
			_: 1
		}),
		createVNode(_component_router_link, { to: "/tabstop" }, {
			default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("TabStop", -1)])]),
			_: 1
		}),
		_cache[3] || (_cache[3] = createBaseVNode("span", { class: "test-label" }, " | Endast för testning", -1))
	]);
}
var TopNavigation_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-fd2eaff1"]]);
//#endregion
...
//#endregion
//#region ../../packages/vue/src/components/FTable/examples/FTableTabstopExample.vue?vue&type=script&setup=true&lang.ts
var keyAttribute = "foo";
//#endregion
//#region ../../packages/vue/src/components/FTable/examples/FTableTabstopExample.vue
var FTableTabstopExample_default = /* @__PURE__ */ defineComponent({
	__name: "FTableTabstopExample",
	setup(__props) {
		const tableRef = useTemplateRef("table");
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(FTable_default), {
				ref: "table",
				rows: unref(rows),
...
var router = createRouter({
	...
	routes: [
		...
		},
		{
			path: "/tabstop",
			name: "tabstop",
			component: FTableTabstopExample_default
		}
	]
});
//#endregion
