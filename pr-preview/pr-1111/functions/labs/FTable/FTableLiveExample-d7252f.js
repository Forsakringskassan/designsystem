...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-d7252f.js
...
var nextRadioGroupName = 0;
var radioGroupNameKey = /* @__PURE__ */ Symbol();
function getNextRadioGroupName() {
  return `ftable-radio-${nextRadioGroupName++}`;
}
var _hoisted_1$9 = {
  class: "table-ng__cell table-ng__cell--radio"
};
var _hoisted_2$6 = ["name", "checked", "aria-label"];
var _sfc_main$b = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    const radioGroupPrefix = inject3(radioGroupNameKey, "ftable-radio");
    const ariaLabel = computed3(() => {
      const value = __props.column.label(__props.row);
      return value.length > 0 ? value : void 0;
    });
    const inputName = computed3(() => `${radioGroupPrefix}-${__props.column.name(__props.row)}`);
    function onChange() {
...
var _sfc_main$3 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    const activeRadioByName = /* @__PURE__ */ new Map();
    ...
    provide2(radioGroupNameKey, getNextRadioGroupName());
      ...
      return openBlock(), createElementBlock("table", {
        ...
        return openBlock(), createElementBlock("tr", {
          ...
          return openBlock(), createElementBlock(Fragment2, {
            ...
            onRadioChecked: ($event) => onRadioChecked(column, row)
          }, null, 40, ["row", "column", "active-error-anchor", "onCloseError", "onOnError", "onRadioChecked"])) : "render" in column ? (openBlock(), createBlock(resolveDynamicComponent(column.render(row)), {
            key: 1,
            row
