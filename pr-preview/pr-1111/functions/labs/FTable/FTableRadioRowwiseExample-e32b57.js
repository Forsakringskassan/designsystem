...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableRadioRowwiseExample.vue:FTableRadioRowwiseExample-e32b57.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  __name: "FTableRadioRowwiseExample",
  setup(__props, { expose: __expose }) {
    __expose();
    const rows = [
      { id: 1, name: "Rad 1", optionA: true, optionB: false },
      { id: 2, name: "Rad 2", optionA: false, optionB: true },
      { id: 3, name: "Rad 3", optionA: false, optionB: true }
    ];
    const columns = defineTableColumns([
      ...
      },
      {
        ...
        label: (row) => `V\xE4lj alternativ A f\xF6r ${row.name}`
      },
      {
        type: "radio",
        header: "Alternativ B",
        key: "optionB",
        name: (row) => `rowwise-${row.id}`,
        label: (row) => `V\xE4lj alternativ B f\xF6r ${row.name}`
      }
    ]);
