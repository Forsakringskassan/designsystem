...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableRadioColumnwiseExample.vue:FTableRadioColumnwiseExample-8aecb2.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  __name: "FTableRadioColumnwiseExample",
  setup(__props, { expose: __expose }) {
    __expose();
    const rows = [
      { id: 1, name: "Rad 1", selected: false },
      { id: 2, name: "Rad 2", selected: true },
      { id: 3, name: "Rad 3", selected: false }
    ];
