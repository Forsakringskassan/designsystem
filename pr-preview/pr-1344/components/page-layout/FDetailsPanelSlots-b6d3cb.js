...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-b6d3cb.js
...
exampleComponent.__scopeId = "data-v-b6d3cb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-b6d3cb"
});
export {
  render
};
