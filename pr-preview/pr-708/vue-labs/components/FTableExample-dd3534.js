...
// virtual-entry:virtual:src/components/FTable/examples/FTableExample.vue:FTableExample-dd3534.js
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])], 8, _hoisted_2$6)])) : (openBlock(), createElementBlock("td", _hoisted_3$4, null, 512));
    };
  }
});
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [createElementVNode("table", {
        ...
        onClick,
        onKeydown
      }, [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("thead", null, [createElementVNode("tr", _hoisted_3, [isTreegrid.value ? (openBlock(), createElementBlock("th", _hoisted_4)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), isMultiSelect.value ? (openBlock(), createBlock(_sfc_main$7, {
        key: 1,
        ref: bindSelectableCellApiRef,
        onChange: onSelectAllChange
      })) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), isSingleSelect.value ? (openBlock(), createElementBlock("th", _hoisted_5, toDisplayString(singleSelectColumn.header), 1)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
      ...
      }), 128))])]), _cache[8] || (_cache[8] = createTextVNode()), createElementVNode("tbody", null, [isEmpty2.value ? (openBlock(), createElementBlock("tr", _hoisted_6, [createElementVNode("td", {
      ...
      }), 128))])], 42, _hoisted_1), _cache[9] || (_cache[9] = createTextVNode()), renderSlot(_ctx.$slots, "footer")], 64);
    };
  }
});
...
function render8(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock8(), _createElementBlock8(
    ...
    [
      ...
      _cache[4] || (_cache[4] = _createElementVNode7(
        "button",
        {
          type: "button",
          class: "button button--secondary"
