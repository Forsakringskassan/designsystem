...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-83cd6f.js
...
exampleComponent.__scopeId = "data-v-83cd6f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-83cd6f"
});
export {
  render
};
