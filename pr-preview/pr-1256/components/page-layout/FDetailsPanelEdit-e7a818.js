...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-e7a818.js
...
exampleComponent.__scopeId = "data-v-e7a818";
setup({
  rootComponent: exampleComponent,
  selector: "#example-e7a818"
});
export {
  render
};
