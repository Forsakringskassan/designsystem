...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ccaddb.js
...
exampleComponent.__scopeId = "data-v-ccaddb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ccaddb"
});
export {
  render
};
