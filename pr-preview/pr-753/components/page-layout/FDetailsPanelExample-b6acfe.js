...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-b6acfe.js
...
exampleComponent.__scopeId = "data-v-b6acfe";
setup({
  rootComponent: exampleComponent,
  selector: "#example-b6acfe"
});
export {
  render
};
