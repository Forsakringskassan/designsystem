...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExample.vue:FTableExample-99f56f.js
...
function removeRows(rows, removeRows2, expandableAttribute) {
  for (const it of removeRows2) removeRow(rows, it, expandableAttribute);
}
