...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-fbf0b2.js
...
exampleComponent.__scopeId = "data-v-fbf0b2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fbf0b2"
});
export {
  render
};
