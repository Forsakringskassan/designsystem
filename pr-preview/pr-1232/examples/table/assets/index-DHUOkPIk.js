...
*/
function copyItemIdentifier(from, to) {
	const id = findItemIdentifier(from);
	if (id !== void 0) setItemIdentifier(to, id);
}
...
var ITableExpandButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return __props.isExpandable ? (openBlock(), createElementBlock("td", _hoisted_1$15, [createBaseVNode("button", {
				ref: "expandable",
				tabindex: "-1",
...
var ITableCheckbox_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("td", _hoisted_1$11, [createBaseVNode("input", {
				ref: "target",
...
var ITableButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("td", _hoisted_1$7, [createBaseVNode("button", {
				ref: "button",
				class: "icon-button",
				type: "button",
				tabindex: "-1",
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("td", { class: normalizeClass(["table-ng__cell table-ng__cell--button", { "table-ng__cell--menu-open": isOpen.value }]) }, [
				createBaseVNode("button", {
					...
					_cache[0] || (_cache[0] = createTextVNode()),
					createBaseVNode("span", _hoisted_1$6, toDisplayString(__props.column.text(__props.row)), 1)
				], 512),
				_cache[1] || (_cache[1] = createTextVNode()),
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
				...
				withDirectives(createBaseVNode("div", _hoisted_1$5, [createBaseVNode("span", _hoisted_2$3, toDisplayString(viewValue.value), 1)], 512), [[vShow, !editing.value]]),
				_cache[3] || (_cache[3] = createTextVNode()),
...
function useTabstop(tableRef, metaRows) {
	...
	watch(metaRows, (newRows, oldRows) => {
		...
		if (oldTabstopTr.rowIndex === 1) {
			...
			if (needle !== void 0 && newRows.some(matching(needle))) {
	...
	return rows.map((currentRow) => {
		...
		if (Array.isArray(expandableRows)) {
			...
			if (index !== -1) {
				...
				copyItemIdentifier(currentRow, updatedRow);
				return updatedRow;
			}
		}
		return currentRow;
