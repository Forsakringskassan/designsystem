...
// packages/icon-lib-default/dist/f/spritesheet.json
...
var init_spritesheet = __esm({
  "packages/icon-lib-default/dist/f/spritesheet.json"() {
    spritesheet_default = [
      ...
      {
        key: "f-icon-paper-clip",
        name: "paper-clip",
        prettyName: "Paper clip"
      },
      {
        key: "f-icon-new-window",
        name: "new-window",
        prettyName: "New window"
      },
      {
        key: "f-icon-i",
        name: "i",
      ...
      {
        key: "f-icon-circle-notch-solid",
        name: "circle-notch-solid",
        prettyName: "Circle notch solid"
      },
      {
        key: "f-icon-chevrons-left",
        name: "chevrons-left",
        prettyName: "Chevrons left"
      },
      {
        key: "f-icon-caret-up",
        name: "caret-up",
      ...
      {
        key: "f-icon-caret-down",
        name: "caret-down",
        prettyName: "Caret down"
      },
      {
        key: "f-icon-calendar",
        name: "calendar",
      ...
      {
        key: "f-icon-arrows-rotate",
        name: "arrows-rotate",
        prettyName: "Arrows rotate"
      },
      {
        key: "f-icon-arrow-right",
        name: "arrow-right",
        prettyName: "Arrow right"
      },
      {
        key: "f-icon-arrow-in-circle",
        name: "arrow-in-circle",
        prettyName: "Arrow in circle"
      },
      {
        key: "f-icon-arrow-down",
        name: "arrow-down",
        prettyName: "Arrow down"
      },
      {
        key: "f-icon-alert",
        name: "alert",
...
// packages/icon-lib-default/dist/index.js
var dist_exports = {};
...
var init_dist = __esm({
  "packages/icon-lib-default/dist/index.js"() {
    "use strict";
    init_spritesheet();
    init_injectSpritesheet();
    dist_default = {
      f: { metadata: spritesheet_default, injectSpritesheet }
    };
  }
});
...
// virtual-entry:virtual:packages/vue/src/components/FIcon/examples/FIconAll.vue:FIconAll-7be1c5.js
...
async function importIcons() {
  return importDefault(await Promise.resolve().then(() => (init_dist(), dist_exports)));
}
function decamelize(value) {
  return value.replaceAll(/([A-Z])/g, (_, ch) => `-${ch.toLowerCase()}`);
}
var iconsPromise = importIcons();
