...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup() {
    ...
    function onFocusOut(field, event) {
      ...
      if (!wrapper2.contains(event.relatedTarget) && !field.pressing.value) {
...
const _hoisted_4 = ["onPointerdown", "onPointerup", "onPointercancel"];
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.fields, (field) => {
      return openBlock(), createElementBlock("div", {
        ...
        field.dirty.value && field.focused.value ? (openBlock(), createElementBlock("div", {
          key: 0,
          onPointerdown: ($event) => field.pressing.value = true,
          onPointerup: ($event) => field.pressing.value = false,
          onPointercancel: ($event) => field.pressing.value = false
        }, [
