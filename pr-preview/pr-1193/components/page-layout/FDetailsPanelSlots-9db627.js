...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-9db627.js
...
exampleComponent.__scopeId = "data-v-9db627";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9db627"
});
export {
  render
};
