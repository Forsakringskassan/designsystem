...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExample.vue:FTableExample-fc3fe0.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { tableRef, selectFieldOptions, oformateradTextKolumnSynlig, columns, rows, sortableAttributes, mySelectedRows, onAddRow, onRemoveRow, onRemoveSelectedRows, get FButton() {
      return FButton;
