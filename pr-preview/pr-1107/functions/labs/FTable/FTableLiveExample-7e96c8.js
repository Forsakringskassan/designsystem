...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-7e96c8.js
...
var ITableExpandButton_default = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return __props.isExpandable ? (openBlock(), createElementBlock("td", _hoisted_1$14, [createElementVNode("button", {
        ref: "expandable",
        tabindex: "-1",
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("td", { class: normalizeClass(["table-ng__cell table-ng__cell--button", { "table-ng__cell--menu-open": isOpen.value }]) }, [
        createElementVNode("button", {
          ...
          _cache[0] || (_cache[0] = createTextVNode()),
          createElementVNode("span", _hoisted_1$5, toDisplayString(__props.column.text(__props.row)), 1)
        ], 512),
        _cache[1] || (_cache[1] = createTextVNode()),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
        ...
        withDirectives(createElementVNode("div", _hoisted_1$4, [createElementVNode("span", _hoisted_2$3, toDisplayString(viewValue.value), 1)], 512), [[vShow, !editing.value]]),
...
function useSelectable(options) {
  const { selectable, selectedRows, rows: rows2 } = options;
  ...
  function toggleSelectableHeader() {
    ...
    else selectedRows.value = [...toValue2(rows2)];
  }
...
var exampleComponent = defineComponent3({
  ...
  computed: {
    livedata() {
      let nestedAttribute = void 0;
      if (this.isExpandable) {
        nestedAttribute = this.hasCustomExpandContent ? "expandableContent" : "expandableRows";
      }
      const rows2 = useDatasetRef(this.isEmpty ? [] : this.rows, nestedAttribute).value;
      return {
