...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-06d01f.js
...
exampleComponent.__scopeId = "data-v-06d01f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-06d01f"
});
export {
  render
};
