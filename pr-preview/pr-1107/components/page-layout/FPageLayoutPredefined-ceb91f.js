...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-ceb91f.js
...
exampleComponent.__scopeId = "data-v-ceb91f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ceb91f"
});
export {
  render
};
