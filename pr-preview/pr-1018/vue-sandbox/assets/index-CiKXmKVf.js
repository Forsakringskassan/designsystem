...
function _sfc_render$H(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
      onCancel: _ctx.onCancel
    })), () => [createBaseVNode("div", _hoisted_1$Y, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      return openBlock(), createElementBlock("button", {
        key: button.label,
