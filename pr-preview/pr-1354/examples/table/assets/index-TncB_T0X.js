...
var FButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const disabled = computed(() => {
			return props.disabled || inflight.value || props.isInFlight;
		});
		...
		const buttonClass = computed(() => {
			...
			if (inflight.value || props.isInFlight) classes.push(`button__inflight`);
			return classes;
		});
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("button", mergeProps({
				...
				hasIconLeft.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [unref(inflight) || __props.isInFlight ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
				...
				_cache[0] || (_cache[0] = createTextVNode()),
				!hasIcon.value ? (openBlock(), createElementBlock("span", _hoisted_2$58, [unref(inflight) || __props.isInFlight ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
					name: "circle-notch-solid",
					class: "button__icon button__spinner"
				...
				hasIconRight.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [unref(inflight) || __props.isInFlight ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
					name: "circle-notch-solid",
					class: "button__icon button__spinner"
