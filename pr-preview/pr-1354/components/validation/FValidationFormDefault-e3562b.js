...
// virtual-entry:virtual:packages/vue/src/components/FValidationForm/examples/FValidationFormDefault.vue:FValidationFormDefault-e3562b.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_f_validation_form, { onSubmit: _ctx.onSubmit }, {
    "error-message": _withCtx(() => [..._cache[7] || (_cache[7] = [
      _createTextVNode(
