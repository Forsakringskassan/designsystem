...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableExample.vue:FTableExample-ac9f9a.js
...
function removeRow(rows, row, expandableAttribute) {
  ...
  if (rowIndex !== -1) {
    ...
    removeExpandableRowFromRows(rows, row, expandableAttribute);
  }
}
...
function removeRows(rows, removeRows2, expandableAttribute) {
  for (const it of removeRows2) {
    removeRow(rows, it, expandableAttribute);
  }
}
