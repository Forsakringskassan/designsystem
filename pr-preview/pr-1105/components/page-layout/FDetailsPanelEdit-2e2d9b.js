...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-2e2d9b.js
...
exampleComponent.__scopeId = "data-v-2e2d9b";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2e2d9b"
});
export {
  render
};
