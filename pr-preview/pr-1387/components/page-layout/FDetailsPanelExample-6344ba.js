...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-6344ba.js
...
exampleComponent.__scopeId = "data-v-6344ba";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6344ba"
});
export {
  render
};
