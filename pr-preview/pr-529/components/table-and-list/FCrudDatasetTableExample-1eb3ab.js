...
// virtual-entry:virtual:packages/vue/src/components/FCrudDataset/examples/FCrudDatasetTableExample.vue:FCrudDatasetTableExample-1eb3ab.js
          ...
          _createVNode(
            ...
            },
            {
              default: _withCtx(() => [
                ...
                _createVNode(_component_f_table_button, {
                  icon: "trashcan",
                  onClick: ($event) => deleteItem(row, "variant")
                }, {
                  default: _withCtx(() => [
                    _createTextVNode(
