// node_modules/@forsakringskassan/docs-generator/dist/processors/selectable-version.mjs
...
function clickOutside(dialog, event) {
  if (!dialog) {
    return;
  }
...
function setErrorMessage(element) {
  ...
  p.innerText = "Det gick inte att hitta n\xE5gra tidigare versioner!";
  element.innerHTML = "";
