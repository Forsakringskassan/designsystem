...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-2a93d7.js
...
exampleComponent.__scopeId = "data-v-2a93d7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2a93d7"
});
export {
  render
};
