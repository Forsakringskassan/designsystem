...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-810e9f.js
...
exampleComponent.__scopeId = "data-v-810e9f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-810e9f"
});
export {
  render
};
