...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-a7a77a.js
...
exampleComponent.__scopeId = "data-v-a7a77a";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a7a77a"
});
export {
  render
};
