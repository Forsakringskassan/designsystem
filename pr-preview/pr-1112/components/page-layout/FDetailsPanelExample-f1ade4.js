...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-f1ade4.js
...
exampleComponent.__scopeId = "data-v-f1ade4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f1ade4"
});
export {
  render
};
