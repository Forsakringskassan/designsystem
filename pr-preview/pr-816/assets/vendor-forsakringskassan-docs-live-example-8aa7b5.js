...
function Si(t7, e, r) {
  ...
  if (n === "vue") {
    ...
    let g2, y2 = () => g2 ?? (g2 = Qr(t7, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u })), q2 = (x) => y2().rootNodes.find(({ startSourceSpan: U2 }) => U2 && U2.start.offset === x.startSourceSpan.start.offset) ?? x;
  ...
  let f = (c) => {
    ...
    if (c.type === "element" && (i && (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || fe(c)) && (c.name = A(c.name, (g2) => gi.has(g2))), a)) for (let g2 of c.attrs) g2.namespace || (g2.name = A(g2.name, (y2) => ur.has(c.name) && (ur.get("*").has(y2) || ur.get(c.name).has(y2))));
  }, I2 = (c) => {
    c.sourceSpan && c.endSourceSpan && (c.sourceSpan = new h(c.sourceSpan.start, c.endSourceSpan.end));
  }, F = (c) => {
    if (c.type === "element") {
      let g2 = He(u ? c.name : c.name.toLowerCase());
      !c.namespace || c.namespace === g2.implicitNamespacePrefix || fe(c) ? c.tagDefinition = g2 : c.tagDefinition = He("");
    }
  };
...
var dt = (e, t7) => {
  for (var r in t7) pt2(e, r, { get: t7[r], enumerable: true });
};
var hu = (e, t7, r, n) => {
  if (t7 && typeof t7 == "object" || typeof t7 == "function") for (let u of du(t7)) !Eu.call(e, u) && u !== r && pt2(e, u, { get: () => t7[u], enumerable: !(n = pu(t7, u)) || n.enumerable });
  return e;
};
...
function _u(e) {
  if (typeof e == "string") return W2;
  if (Array.isArray(e)) return Y2;
  if (!e) return;
  let { type: t7 } = e;
  if (Ue2.has(t7)) return t7;
}
var M = _u;
...
function ku(e) {
  if (e.type === B2 && e.break || e.type === g && e.hard || e.type === w2) return true;
}
function Dr2(e) {
...
function ar2(e) {
  for (e = [...e]; e.length >= 2 && y(false, e, -2).type === g && y(false, e, -1).type === w2; ) e.length -= 2;
  if (e.length > 0) {
...
function Ge3(e, t7, r) {
  ...
  let n = e;
  if (t7 > 0) {
    for (let u = 0; u < Math.floor(t7 / r); ++u) n = ie2(n);
...
function Q2(e) {
  ...
  if (Array.isArray(e)) {
    let r = [];
    for (let n of e) if (Array.isArray(n)) r.push(...Q2(n));
    else {
      let u = Q2(n);
      u !== "" && r.push(u);
    }
  ...
  return e.type === _2 ? { ...e, breakContents: Q2(e.breakContents), flatContents: Q2(e.flatContents) } : e.type === B2 ? { ...e, contents: Q2(e.contents), expandedStates: (t7 = e.expandedStates) == null ? void 0 : t7.map(Q2) } : e.type === k2 ? { type: "fill", parts: e.parts.map(Q2) } : e.contents ? { ...e, contents: Q2(e.contents) } : e;
}
function wr2(e) {
  ...
  function n(o, i, s) {
    ...
    if (o.type === g) {
      let D = ((a = s == null ? void 0 : s[i + 1]) == null ? void 0 : a.type) === w2;
    ...
    if (o.type === w2) return ((c = s == null ? void 0 : s[i - 1]) == null ? void 0 : c.type) === g && s[i - 1].hard ? void 0 : "breakParent";
    if (o.type === P2) return "trim";
    if (o.type === N2) return "indent(" + n(o.contents) + ")";
    if (o.type === O2) return o.n === Number.NEGATIVE_INFINITY ? "dedentToRoot(" + n(o.contents) + ")" : o.n < 0 ? "dedent(" + n(o.contents) + ")" : o.n.type === "root" ? "markAsRoot(" + n(o.contents) + ")" : "align(" + JSON.stringify(o.n) + ", " + n(o.contents) + ")";
    if (o.type === _2) return "ifBreak(" + n(o.breakContents) + (o.flatContents ? ", " + n(o.flatContents) : "") + (o.groupId ? (o.flatContents ? "" : ', ""') + `, { groupId: ${u(o.groupId)} }` : "") + ")";
    if (o.type === v2) {
      let D = [];
    ...
    if (o.type === k2) return `fill([${o.parts.map((D) => n(D)).join(", ")}])`;
    if (o.type === L2) return "lineSuffix(" + n(o.contents) + ")";
    if (o.type === I) return "lineSuffixBoundary";
    if (o.type === S2) return `label(${JSON.stringify(o.label)}, ${n(o.contents)})`;
    if (o.type === j2) return "cursor";
...
function wt2(e) {
  ...
  if (t7 > 0 || r > 0) for (e.length = n + 1; r-- > 0; ) e.push(de2);
  return t7;
}
...
`, u) : f;
      ...
      case B2:
        switch (F) {
          ...
          case R2: {
            ...
            if (!f.break && Ke2(d2, i, m, C, r)) i.push(d2);
              ...
              if (f.break) {
                ...
                let x = f.expandedStates[h3], A = { ind: l, mode: H2, doc: x };
                if (Ke2(A, i, m, C, r)) {
                  i.push(A);
                  break;
                }
              }
            } else i.push({ ind: l, mode: R2, doc: f.contents });
            break;
          }
        }
      ...
      case k2: {
        ...
        if (E2 === 0) break;
        let h3 = C[m + 0], x = C[m + 1], A = { ind: l, mode: H2, doc: h3 }, $2 = { ind: l, mode: R2, doc: h3 }, ue = Ke2(A, [], d2, c.length > 0, r, true);
        if (E2 === 1) {
        ...
        Ke2({ ind: l, mode: H2, doc: [h3, x, lu] }, [], d2, c.length > 0, r, true) ? i.push(Ft2, Be2, A) : ue ? i.push(Ft2, lt2, A) : i.push(Ft2, lt2, $2);
        break;
      }
      case _2:
      case v2: {
  ...
  if (p !== -1) {
    ...
    if (l === -1) return { formatted: s.filter((m) => m !== de2).join("") };
...
var bt2 = class {
  ...
  findAncestor(t7) {
    for (let r of fe2(this, Z2, ze2).call(this)) if (t7(r)) return r;
  }
  hasAncestor(t7) {
    for (let r of fe2(this, Z2, ze2).call(this)) if (t7(r)) return true;
    return false;
  }
};
Z2 = /* @__PURE__ */ new WeakSet(), kt2 = function(t7) {
  let { stack: r } = this;
...
function* Lr2(e, t7) {
  ...
  for (let n = 0; n < r.length; n++) {
    let u = r[n];
    for (let o of Ce2(u, t7)) yield o, r.push(o);
  }
}
function Ir2(e, t7) {
...
function Xe2(e, t7) {
  if (Tt2.has(e)) return Tt2.get(e);
  let { printer: { getCommentChildNodes: r, canAttachComment: n, getVisitorKeys: u }, locStart: o, locEnd: i } = t7;
  if (!n) return [];
  let s = ((r == null ? void 0 : r(e, t7)) ?? [...Ce2(e, { getVisitorKeys: J2(u) })]).flatMap((a) => n(a) ? [a] : Xe2(a, t7));
...
function Ur2(e, t7, r, n) {
  ...
  for (; p < l; ) {
    ...
    if (d2 <= i && s <= m) return Ur2(f, t7, r, f);
    if (m <= i) {
      c = f, p = F + 1;
      continue;
    }
...
function Vr(e, t7) {
  let { comments: r } = e;
  if (delete e.comments, !qe2(r) || !t7.printer.canAttachComment) return;
  ...
  for (let [p, l] of D.entries()) {
    ...
    if (u ? A = [l] : (F.enclosingNode = d2, F.precedingNode = f, F.followingNode = m, A = [F, C, E2, h3, x]), Gu(C, E2, D, p)) F.placement = "ownLine", s(...A) || (m ? se2(m, F) : f ? ae2(f, F) : d2 ? ee2(d2, F) : ee2(h3, F));
  ...
  if (jr2(n, t7), !u) for (let p of r) delete p.precedingNode, delete p.enclosingNode, delete p.followingNode;
}
var $r2 = (e) => !/[\S\n\u2028\u2029]/u.test(e);
...
function jr2(e, t7) {
  ...
  for (let [c, { comment: D }] of e.entries()) c < i ? ae2(n, D) : se2(u, D);
...
function Ju(e, t7, r) {
  var c;
  let n = e.node, u = Wr2(e, t7), { printer: o, originalText: i, locStart: s } = t7, a = (c = o.isBlockComment) == null ? void 0 : c.call(o, n);
...
function io2(e, t7) {
  let r = Hr(false, e.plugins).flatMap((u) => u.languages ?? []), n = oo2(r, t7.language) ?? nn(r, t7.physicalFile) ?? nn(r, t7.file) ?? un2(r, t7.physicalFile) ?? un2(r, t7.file) ?? (t7.physicalFile, void 0);
  return n == null ? void 0 : n.parsers[0];
}
var on2 = io2;
var re2 = { key: (e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), value(e) {
  if (e === null || typeof e != "object") return JSON.stringify(e);
  if (Array.isArray(e)) return `[${e.map((r) => re2.value(r)).join(", ")}]`;
...
function vt2(e, t7) {
  ...
  let i, s, a, c, D = 0, p = 0;
  for (; D < n; ) pn2[D] = e.charCodeAt(o + D), Pt2[D] = ++D;
  for (; p < u; ) for (i = t7.charCodeAt(o + p), a = p++, s = p, D = 0; D < n; D++) c = i === pn2[D] ? a : a + 1, a = Pt2[D], s = Pt2[D] = a > s ? c > s ? s + 1 : c : c > a ? a + 1 : c;
  return s;
}
...
function ao2(e, t7) {
  ...
  for (let u of so2) u in t7 && (n[u] = Do(t7[u], r, b2.prototype[u].length));
  return n;
}
var b2 = class {
  static create(t7) {
...
function It2(e) {
  ...
  return co2((t7 || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? { text: t7, list: { title: r.title, values: r.values.map(It2) } } : { text: t7 };
}
function Rt2(e, t7) {
...
function ot2(e, t7) {
  return e === void 0 ? [] : Array.isArray(e) ? e.map((r) => mn2(r, t7)) : [mn2(e, t7)];
}
function jt2(e, t7) {
...
var Dt2 = class {
  ...
  _applyRequiredCheck(t7) {
    for (let r of Object.keys(this._utils.schemas)) if (this._identifyMissing(r, t7) && this._identifyRequired(r)) throw this._invalidHandler(r, Ze2, this._utils);
  }
...
function Fo(e, { isCLI: t7, FlagSchema: r }) {
  ...
  for (let u of e) n.push(po2(u, { isCLI: t7, optionInfos: e, FlagSchema: r })), u.alias && t7 && n.push(tt2.create({ name: u.alias, sourceName: u.name }));
  return n;
}
...
async function Eo(e, t7 = {}) {
  ...
  if (!r.parser) if (r.filepath) {
    if (r.parser = on2(r, { physicalFile: r.filepath }), !r.parser) throw new Le2(`No parser could be inferred for file "${r.filepath}".`);
  } else throw new Le2("No parser and no file path given, couldn't infer a parser.");
  let n = Qe2({ plugins: e.plugins, showDeprecated: true }).options, u = { ...Nn2, ...Object.fromEntries(n.filter((l) => l.default !== void 0).map((l) => [l.name, l.default])) }, o = $t2(r.plugins, r.parser), i = await Wt2(o, r.parser);
...
async function Bo(e, t7, r, n) {
  let u = await ne2({ ...r, ...t7, parentParser: r.parser, originalText: e, cursorOffset: void 0, rangeStart: void 0, rangeEnd: void 0 }, { passThrough: true }), { ast: o } = await De2(e, u), i = await n(o, u);
  return $e(i);
}
function _o(e, t7) {
...
async function Ye2(e, t7) {
  ...
  let r = /* @__PURE__ */ new Map(), n = new Or2(e), u = Kr2(t7), o = /* @__PURE__ */ new Map();
  await Ln2(n, s, t7, Ye2, o);
  let i = await Rn2(n, t7, s, void 0, o);
  if (Gr2(t7), t7.cursorOffset >= 0) {
    if (t7.nodeAfterCursor && !t7.nodeBeforeCursor) return [X2, i];
    if (t7.nodeBeforeCursor && !t7.nodeAfterCursor) return [i, X2];
  }
  return i;
  function s(c, D) {
...
function xo(e, t7) {
  ...
  for (let F of Lr2(e, { getVisitorKeys: o, filter: i })) a.push(F), s = F;
  if (Ir2(s, { getVisitorKeys: o })) return { cursorNode: s };
...
function wo(e, t7) {
  ...
  if (!r) return e;
  let u = J2(n), o = r.ignoredProperties ?? /* @__PURE__ */ new Set();
  return i(e);
  function i(s, a) {
...
function To(e, t7, { locStart: r, locEnd: n }) {
  ...
  let i = r(e.node);
  for (let a of Un2(t7.parentNodes)) if (r(a) >= i) o = a;
  else break;
  let s = n(t7.node);
...
async function Hn2(e, t7, r = 0) {
  ...
  if (r > 0) {
    ...
    i.cursorNodeStart !== void 0 && (i.cursorNodeStart -= i.formatted.indexOf(a), i.cursorNodeStart < 0 && (i.cursorNodeStart = 0, i.cursorNodeText = i.cursorNodeText.trimStart()), i.cursorNodeStart + i.cursorNodeText.length > a.length && (i.cursorNodeText = i.cursorNodeText.trimEnd())), i.formatted = a + xe2(t7.endOfLine);
  }
...
async function Jt(e, t7) {
  ...
  if (u.rangeStart >= u.rangeEnd && n !== "" || u.requirePragma && !await Kn2(n, u) || u.checkIgnorePragma && await vo(n, u)) return { formatted: e, cursorOffset: t7.cursorOffset, comments: [] };
  let o;
...
function Vo2(e, t7) {
  let r = null, n = t7;
  for (; n !== r; ) r = n, n = T2(e, n), n = ye(e, n), n = Ae2(e, n), n = U(e, n);
  return n;
}
var je2 = Vo2;
function $o2(e, t7) {
  let r = null, n = t7;
  for (; n !== r; ) r = n, n = He2(e, n), n = ye(e, n), n = T2(e, n);
