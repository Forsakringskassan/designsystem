...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ff6a40.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { name, panel, ExamplePanel, rows, openPanel, get FButton() {
      return FButton;
      ...
      default: _withCtx((layoutScope) => [
        ...
        _createElementVNode("div", {
          ...
          _createVNode($setup["FInteractiveTable"], {
            ...
            caption: _withCtx(() => [..._cache[7] || (_cache[7] = [
              _createTextVNode(
                "Tabell",
                -1
                /* CACHED */
...
exampleComponent.__scopeId = "data-v-ff6a40";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ff6a40"
});
export {
  render
};
