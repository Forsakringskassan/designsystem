...
import { defineComponent, computed, createElementBlock, openBlock, normalizeClass, renderSlot, mergeProps, createTextVNode, createElementVNode, ref, useAttrs, unref, createCommentVNode, Fragment, createBlock, createApp, resolveComponent, withKeys, createVNode, toDisplayString, withCtx, renderList, withModifiers, isVNode, Comment, getCurrentInstance, resolveDynamicComponent, capitalize, onMounted, toValue, onUnmounted, useSlots, normalizeProps, guardReactiveProps, Transition, Teleport, normalizeStyle, useTemplateRef, watchEffect, watch, nextTick, withDirectives, vShow, readonly, inject, toRef, provide, createSlots, vModelSelect, vModelDynamic, toHandlers, shallowRef, getCurrentScope, onScopeDispose, hasInjectionContext, defineCustomElement, effectScope, onUpdated, toRefs } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", mergeProps({
        ...
        class: "button__icon",
        name: props.iconLeft
      }, null, 8, ["name"])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), !hasIcon.value ? (openBlock(), createElementBlock(Fragment, {
        key: 1
      }, [unref(inflight) ? (openBlock(), createBlock(unref(FIcon), {
        key: 0,
        name: "circle-notch-solid",
        class: "button__icon button__inflight"
      })) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), renderSlot(_ctx.$slots, "default"), _cache[2] || (_cache[2] = createTextVNode()), hasIconRight.value ? (openBlock(), createElementBlock(Fragment, {
        key: 2
      }, [unref(inflight) ? (openBlock(), createBlock(unref(FIcon), {
        key: 0,
        name: "circle-notch-solid",
      ...
      }, null, 8, ["name"])) : createCommentVNode("", true)], 64)) : createCommentVNode("", true)], 16, _hoisted_1$$);
    };
  }
});
