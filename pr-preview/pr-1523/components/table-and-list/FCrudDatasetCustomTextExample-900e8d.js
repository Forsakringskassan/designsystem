...
// virtual-entry:virtual:packages/vue/src/components/FCrudDataset/examples/FCrudDatasetCustomTextExample.vue:FCrudDatasetCustomTextExample-900e8d.js
  ...
  methods: {
    ...
    getMaxId() {
      return this.fruits.reduce((max, item) => {
        return Math.max(max, Math.trunc(Number(item.id)));
      }, 0);
    },
    saveModel(row) {
