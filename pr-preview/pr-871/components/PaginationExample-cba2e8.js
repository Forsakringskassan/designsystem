...
// virtual-entry:virtual:packages/vue/src/design-component-tests/Pagination/examples/PaginationExample.vue:PaginationExample-cba2e8.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    paginator() {
      return (
        /* HTML */
        `<f-paginator navigator-label="Navigate between persons" />`
      );
    },
