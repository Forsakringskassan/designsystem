...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-38b2d8.js
...
exampleComponent.__scopeId = "data-v-38b2d8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-38b2d8"
});
export {
  render
};
