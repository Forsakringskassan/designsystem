...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-11f26f.js
...
exampleComponent.__scopeId = "data-v-11f26f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-11f26f"
});
export {
  render
};
