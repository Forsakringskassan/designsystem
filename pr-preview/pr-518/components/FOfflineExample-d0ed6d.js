...
// virtual-entry:virtual:packages/vue/src/components/FOffline/examples/FOfflineExample.vue:FOfflineExample-d0ed6d.js
...
// packages/vue/src/plugins/focus/FocusPlugin.ts
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.isOpen ? (_openBlock6(), _createElementBlock6("div", {
    key: 0,
    id: _ctx.id,
                ...
                _createElementVNode3("div", _hoisted_4, [
                  _createElementVNode3("div", _hoisted_5, [
                    _createElementVNode3("div", _hoisted_6, [
                      ...
                      _ctx.hasHeaderSlot ? (_openBlock6(), _createElementBlock6(
                        "h1",
                        _hoisted_7,
                        [
                          _createCommentVNode5("@slot Slot for the header. "),
                    ...
                    _createElementVNode3(
                      ...
                      _hoisted_8,
                      [
                        _createCommentVNode5("@slot Slot for the main content, e.g. paragraphs, input fields, etc. "),
                    ...
                    _createElementVNode3("div", _hoisted_9, [
                      _createCommentVNode5("@slot Slot the footer content, i.e. buttons. "),
  ...
  ], 10, _hoisted_13)) : _createCommentVNode5("v-if", true);
}

// packages/vue/src/components/FModal/FModal.vue
FModal_default.render = render6;
...
var FConfirmModal_default = defineComponent7({
  name: "FConfirmModal",
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock7(), _createBlock2(_component_f_modal, {
    ...
    header: _withCtx(() => [
      _createCommentVNode6("@slot Slot for advanced header. "),
      _renderSlot6(_ctx.$slots, "heading", {}, () => [
        _createTextVNode(
    ...
    content: _withCtx(() => [
      _createCommentVNode6("@slot Slot for advanced content. "),
      _renderSlot6(_ctx.$slots, "content", {}, () => [
        _createTextVNode(
      ...
      _createElementVNode4("div", _hoisted_14, [
        (_openBlock7(true), _createElementBlock7(
          ...
          _renderList(_ctx.preparedButtons, (button) => {
            return _openBlock7(), _createElementBlock7("button", {
              key: button.label,
              type: "button",
              class: _normalizeClass4([button.classlist, "button-group__item"]),
...
FConfirmModal_default.render = render7;
...
var FOffline_default = defineComponent12({
  ...
  components: {
    ...
    IFlex: IFlex_default2,
    IFlexItem: IFlexItem_default2
  },
  data() {
    return {
...
function render12(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_i_flex = _resolveComponent6("i-flex");
  return _openBlock12(), _createElementBlock12("div", {
    ref: "offline",
...
// virtual-entry:virtual:packages/vue/src/components/FOffline/examples/FOfflineExample.vue:FOfflineExample-d0ed6d.js
import { toDisplayString as _toDisplayString5, createTextVNode as _createTextVNode4, resolveComponent as _resolveComponent7, withCtx as _withCtx6, createVNode as _createVNode6, createElementVNode as _createElementVNode9, resolveDirective as _resolveDirective, openBlock as _openBlock13, createElementBlock as _createElementBlock13, withDirectives as _withDirectives2 } from "vue";
...
function render13(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_offline = _resolveComponent7("f-offline");
  const _directive_test = _resolveDirective("test");
  return _withDirectives2((_openBlock13(), _createElementBlock13("div", null, [
    _createVNode6(_component_f_offline, null, {
      default: _withCtx6(() => [
        _createTextVNode4(
          _toDisplayString5(_ctx.offlineMessage),
          1
          /* TEXT */
        )
      ]),
