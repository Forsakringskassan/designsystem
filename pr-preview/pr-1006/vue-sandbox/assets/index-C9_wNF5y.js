...
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock(Fragment, null, [
    _cache[0] || (_cache[0] = createBaseVNode("h1", null, "Rubriknivå 1 (h1)", -1)),
    _cache[1] || (_cache[1] = createTextVNode(" Text under rubrik ", -1)),
    _cache[2] || (_cache[2] = createBaseVNode("h2", null, "Rubriknivå 2 (h2)", -1)),
    _cache[3] || (_cache[3] = createTextVNode(" Text under rubrik ", -1)),
    _cache[4] || (_cache[4] = createBaseVNode("h3", null, "Rubriknivå 3 (h3)", -1)),
    _cache[5] || (_cache[5] = createTextVNode(" Text under rubrik ", -1)),
    _cache[6] || (_cache[6] = createBaseVNode("h4", null, "Rubriknivå 4 (h4)", -1)),
    _cache[7] || (_cache[7] = createTextVNode(" Text under rubrik ", -1)),
    _cache[8] || (_cache[8] = createBaseVNode("h5", null, "Rubriknivå 5 (h5)", -1)),
    _cache[9] || (_cache[9] = createTextVNode(" Text under rubrik ", -1)),
    _cache[10] || (_cache[10] = createBaseVNode("h6", null, "Rubriknivå 6 (h6)", -1)),
    _cache[11] || (_cache[11] = createTextVNode(" Text under rubrik ", -1))
  ], 64);
}
