...
(() => {
  ...
  function getHTMLElementFromVueRef(ref) {
    ...
    if (!(0, import_logic2.isSet)(element)) {
  ...
  var config = {
    ...
    set production(value) {
      production = value;
      import_logic3.configLogic.production = value;
    },
    get production() {
      return production;
    }
  ...
  var SPACING = 10;
  var exampleComponent = (0, import_vue28.defineComponent)({
  ...
  function render12(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue29.openBlock)(), (0, import_vue29.createElementBlock)("div", _hoisted_18, [
      ...
      (0, import_vue29.withDirectives)((0, import_vue29.createElementVNode)(
        ...
        [import_vue29.vModelSelect, _ctx.constraint]
      ]),
      _cache[5] || (_cache[5] = (0, import_vue29.createElementVNode)(
        "p",
        null,
        [
          (0, import_vue29.createTextVNode)("Dra "),
          (0, import_vue29.createElementVNode)("i", null, "ankaret"),
          (0, import_vue29.createTextVNode)(" med hj\xE4lp av musen.")
        ],
        -1
        /* HOISTED */
      )),
