...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
      ...
      }, _ctx.$attrs), [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2$e, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[16] || (_cache[16] = createTextVNode()), createBaseVNode("colgroup", null, [unref(isExpandableTable) ? (openBlock(), createElementBlock("col", _hoisted_3$9)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("col", _hoisted_4$8)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
        return openBlock(), createElementBlock("col", {
          key: column.id,
          class: normalizeClass(column.size)
        }, null, 2);
        ...
        return openBlock(), createElementBlock(Fragment, {
        ...
        }, null, 8, ["rotate"])])) : createCommentVNode("", true)])) : createCommentVNode("", true), _cache[7] || (_cache[7] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("td", _hoisted_15, [createBaseVNode("div", _hoisted_16, [__props.selectable === "single" ? (openBlock(), createBlock(unref(FRadioField), {
          key: 0,
          name: rowKey(row),
          value: true,
          ...
          default: withCtx(() => [hasCheckboxDescription.value ? (openBlock(), createElementBlock("span", _hoisted_18, [renderSlot(_ctx.$slots, "checkbox-description", mergeProps({
            ref_for: true
          }, {
            row
          }))])) : createCommentVNode("", true)]),
          ...
          return openBlock(), createElementBlock("tr", {
            ...
            class: "table__column--placeholder"
          }, null, -1)), _cache[10] || (_cache[10] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("td", _hoisted_19)) : createCommentVNode("", true), _cache[11] || (_cache[11] = createTextVNode()), !unref(hasExpandableSlot) ? renderSlot(_ctx.$slots, "default", mergeProps({
            key: 1,
            ref_for: true
          }, {
            row: expandableRow
      ...
      }), 128)), _cache[14] || (_cache[14] = createTextVNode()), isEmpty2.value && columns.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_21, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
      })))])) : createCommentVNode("", true), _cache[15] || (_cache[15] = createTextVNode()), isEmpty2.value ? (openBlock(), createElementBlock("tr", _hoisted_22, [createBaseVNode("td", {
        class: "table__column table__column--action",
        colspan: nbOfColumns.value
      }, [renderSlot(_ctx.$slots, "empty", {}, () => [createTextVNode(toDisplayString(
        /** Text som visas som standardinnehåll i slotten `empty` (när tabellen är tom). */
        unref($t2)("fkui.interactive-table.empty", "Tabellen är tom")
      ), 1)])], 8, _hoisted_23), _cache[13] || (_cache[13] = createTextVNode()), renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
