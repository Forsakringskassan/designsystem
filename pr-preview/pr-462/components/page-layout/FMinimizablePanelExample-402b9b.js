...
// virtual-entry:virtual:packages/vue/src/components/FMinimizablePanel/examples/FMinimizablePanelExample.vue:FMinimizablePanelExample-402b9b.js
          ...
          _createVNode($setup["FMinimizablePanel"], null, {
            default: _withCtx(({ isOpen, header, footer, content }) => [
              isOpen ? (_openBlock(), _createElementBlock(
                ...
                { key: 0 },
                [
                  _createElementVNode("h1", { slot: header }, "Rubrik", 8, _hoisted_1),
                  _createElementVNode("p", { slot: content }, "Inneh\xE5ll", 8, _hoisted_2),
                  _createElementVNode("div", { slot: footer }, "Fot", 8, _hoisted_3)
                ],
                64
                /* STABLE_FRAGMENT */
