...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-7932f5.js
...
exampleComponent.__scopeId = "data-v-7932f5";
setup({
  rootComponent: exampleComponent,
  selector: "#example-7932f5"
});
export {
  render
};
