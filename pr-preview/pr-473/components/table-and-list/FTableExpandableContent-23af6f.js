...
// virtual-entry:virtual:packages/vue/src/components/FInteractiveTable/draft/FTableExpandableContent.vue:FTableExpandableContent-23af6f.js
...
var exampleComponent = {
  __name: "FTableExpandableContent",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock($setup["FInteractiveTable"], {
    ...
    caption: _withCtx(() => _cache[0] || (_cache[0] = [
      _createTextVNode(" Expanderbara rader med inneh\xE5ll ")
    ])),
