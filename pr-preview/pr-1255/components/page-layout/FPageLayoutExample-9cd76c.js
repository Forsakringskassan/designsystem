...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-9cd76c.js
...
exampleComponent.__scopeId = "data-v-9cd76c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9cd76c"
});
export {
  render
};
