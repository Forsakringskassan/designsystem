...
function isColumnTypeText(column) {
  const type = column.type;
  ...
  setup(__props, {
    ...
    function fromColumnValue() {
      ...
      if (validity.value.isValid) {
        ...
        if (isColumnTypeText(__props.column)) {
          var _props$column$format2;
          const value = __props.column.value(__props.row);
          return (_props$column$format2 = __props.column.formatter(value)) !== null && _props$column$format2 !== void 0 ? _props$column$format2 : value;
        }
      }
      return `${__props.column.value(__props.row)}`;
    }
