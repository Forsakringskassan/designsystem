...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-daf6a5.js
...
exampleComponent.__scopeId = "data-v-daf6a5";
setup({
  rootComponent: exampleComponent,
  selector: "#example-daf6a5"
});
export {
  render
};
