...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-9d4e15.js
...
exampleComponent.__scopeId = "data-v-9d4e15";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9d4e15"
});
export {
  render
};
