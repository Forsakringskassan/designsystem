...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4950a8.js
...
exampleComponent.__scopeId = "data-v-4950a8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4950a8"
});
export {
  render
};
