...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-f2b00f.js
...
exampleComponent.__scopeId = "data-v-f2b00f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-f2b00f"
});
export {
  render
};
