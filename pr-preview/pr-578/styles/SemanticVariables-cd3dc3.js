...
// virtual-entry:virtual:docs/styles/examples/SemanticVariables.vue:SemanticVariables-cd3dc3.js
...
exampleComponent.__scopeId = "data-v-cd3dc3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-cd3dc3"
});
export {
  render
};
