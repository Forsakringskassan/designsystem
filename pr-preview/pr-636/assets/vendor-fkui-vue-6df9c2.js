...
import { defineComponent, computed, createElementBlock, openBlock, normalizeClass, renderSlot, mergeProps, createTextVNode, createElementVNode, createBlock, createCommentVNode, unref, createApp, resolveComponent, withKeys, createVNode, toDisplayString, withCtx, Fragment, renderList, withModifiers, isVNode, Comment, getCurrentInstance, resolveDynamicComponent, capitalize, watch, getCurrentScope, onScopeDispose, onMounted, nextTick, hasInjectionContext, inject, toValue, shallowRef, watchEffect, ref, useTemplateRef, onUnmounted, useSlots, normalizeProps, guardReactiveProps, Transition, Teleport, normalizeStyle, withDirectives, vShow, readonly, toRef, provide, createSlots, vModelSelect, vModelDynamic, toHandlers, defineCustomElement, effectScope, onUpdated, toRefs } from "vue";
...
function formatDateRange(el, range2) {
  var _parseDate4, _parseDate5;
  el.classList.add("formatter--date-range");
  el.textContent = "";
  if (!isDateRange(range2)) {
    return;
  }
  const fromDate = range2.from instanceof FDate ? range2.from : FDate.fromIso((_parseDate4 = parseDate(range2.from)) !== null && _parseDate4 !== void 0 ? _parseDate4 : "");
  const toDate = range2.to instanceof FDate ? range2.to : FDate.fromIso((_parseDate5 = parseDate(range2.to)) !== null && _parseDate5 !== void 0 ? _parseDate5 : "");
...
var _hoisted_3$w = ["aria-live"];
var _hoisted_4$r = ["id", "aria-expanded"];
var _hoisted_5$m = {
...
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, toDisplayString(_ctx.currentText), 11, _hoisted_3$w), _cache[5] || (_cache[5] = createTextVNode()), _ctx.yearSelector ? (openBlock(), createElementBlock("button", {
    key: 0,
    id: `${_ctx.id}`,
  ...
  }, [createElementVNode("span", _hoisted_5$m, toDisplayString(_ctx.currentText), 1), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_6$g, toDisplayString(_ctx.yearSelectorOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1), _cache[4] || (_cache[4] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.yearSelectorOpen ? "calendar-navbar__arrow--up" : void 0),
    name: "arrow-down"
  }, null, 8, ["class"])], 8, _hoisted_4$r)) : createCommentVNode("", true)]), _cache[8] || (_cache[8] = createTextVNode()), !_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
    key: 0,
    ref: "previousButton",
...
function onKeyDown(event, options) {
  ...
  switch (event.key) {
    case "ArrowUp":
      event.preventDefault();
      activeYear.value = activeYear.value.equals(firstYear) ? lastYear : activeYear.value.previous();
      focus2(activeYear.value);
      break;
    case "ArrowDown":
      event.preventDefault();
      activeYear.value = activeYear.value.equals(lastYear) ? firstYear : activeYear.value.next();
      focus2(activeYear.value);
      break;
    case "Enter":
    case " ":
...
function useYearSelector(options) {
  ...
  const selectableYears = computed(() => Array.from(range(minYear.value, maxYear.value)));
  watchEffect(async () => {
  ...
  useEventListener$1(yearSelector, "keydown", (event) => {
    if (!yearSelectorOpen.value) {
      return;
    }
    onKeyDown(event, {
  ...
  function focusOnYear(year) {
    ...
    const yearElements = getHTMLElementsFromVueRef(options.yearElements.value);
  ...
  function onClickSelectYear(year) {
    activeYear.value = year;
    selectYear(year);
    closeYearSelector();
  }
  function selectYear(year) {
    const offset2 = year.value - currentYear.value.value;
    const updatedDate = modelValue.value.addYears(offset2);
    options.onChangeDate(clamp$1(updatedDate, minDate.value, maxDate.value));
  }
...
function useCalendarHeight(options) {
  const {
    src,
    dst,
    property
...
var _sfc_main$17 = defineComponent({
  ...
  setup(props, context) {
    ...
    const calendar = computed(() => {
      var _findHTMLElementFromV;
      return (_findHTMLElementFromV = findHTMLElementFromVueRef(calendarRef.value)) !== null && _findHTMLElementFromV !== void 0 ? _findHTMLElementFromV : null;
    });
    const yearSelector = computed(() => {
      var _findHTMLElementFromV2;
      return (_findHTMLElementFromV2 = findHTMLElementFromVueRef(yearSelectorRef.value)) !== null && _findHTMLElementFromV2 !== void 0 ? _findHTMLElementFromV2 : null;
    });
    const calendarNavbar = computed(() => {
      var _findHTMLElementFromV3;
      return (_findHTMLElementFromV3 = findHTMLElementFromVueRef(calendarNavbarRef.value)) !== null && _findHTMLElementFromV3 !== void 0 ? _findHTMLElementFromV3 : null;
    });
    const {
      yearSelectorOpen,
      activeYear,
    ...
    watch(() => props.minDate, (value) => minDate.value = value);
    watch(() => props.maxDate, (value) => maxDate.value = value);
    return {
      yearSelectorOpen,
      activeYear,
      selectableYears,
  ...
  computed: {
    yearNounText() {
      return this.$t("fkui.calendar.year-noun", "\xC5rtal");
    }
  },
  methods: {
    getSelectableYearId(year) {
...
var _hoisted_3$u = ["aria-activedescendant", "aria-label"];
var _hoisted_4$p = ["id", "tabindex", "aria-selected", "onClick"];
function _sfc_render$C(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$R, [createVNode(_component_i_calendar_navbar, {
    id: _ctx.id,
    ref: "calendarNavbar",
    "year-selector-open": _ctx.yearSelectorOpen,
    "onUpdate:yearSelectorOpen": _cache[0] || (_cache[0] = ($event) => _ctx.yearSelectorOpen = $event),
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
    "max-date": _ctx.maxDate,
    "year-selector": _ctx.yearSelector,
    "onUpdate:modelValue": _ctx.onChangeDate
  }, null, 8, ["id", "year-selector-open", "model-value", "min-date", "max-date", "year-selector", "onUpdate:modelValue"]), _cache[1] || (_cache[1] = createTextVNode()), _ctx.yearSelectorOpen ? (openBlock(), createElementBlock("div", _hoisted_2$D, [createElementVNode("ul", {
    role: "listbox",
    class: "calendar__year-selector__listbox",
    "aria-activedescendant": _ctx.getSelectableYearId(_ctx.activeYear),
    "aria-label": _ctx.yearNounText
  }, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.selectableYears, (year) => {
    return openBlock(), createElementBlock("li", {
      id: _ctx.getSelectableYearId(year),
      ref_for: true,
      ref: "yearElements",
      key: year.value,
      role: "option",
      tabindex: _ctx.activeYear.equals(year) ? 0 : -1,
      "aria-selected": _ctx.activeYear.equals(year) ? "true" : void 0,
      class: normalizeClass(["calendar__year-selector__year", {
        "calendar__year-selector__year--highlight": _ctx.activeYear.equals(year)
      }]),
      onClick: withModifiers(($event) => _ctx.onClickSelectYear(year), ["stop", "prevent"])
    }, toDisplayString(year), 11, _hoisted_4$p);
  }), 128))], 8, _hoisted_3$u)], 512)) : (openBlock(), createBlock(_component_i_calendar_month, {
    key: 1,
    ref: "calendar",
    "model-value": _ctx.modelValue,
    "min-date": _ctx.minDate,
...
var _sfc_main$15 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const hasBadgeSlot = computed(() => hasSlot2("badge"));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        onValidity
      }, [hasBadgeSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$B, [renderSlot(_ctx.$slots, "badge")])) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), hasHeaderSlot.value ? (openBlock(), createElementBlock("div", _hoisted_3$t, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({
        headingSlotClass: "card__header-label"
      })))])) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({
        ...
        _: 1
      })) : createCommentVNode("", true)]), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("div", _hoisted_4$o, [renderSlot(_ctx.$slots, "default")]), _cache[4] || (_cache[4] = createTextVNode()), hasFooterSlot.value ? (openBlock(), createElementBlock("div", _hoisted_5$k, [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
        hasError: hasError.value,
        validationMessage: validationMessage.value
...
var _sfc_main$x = defineComponent({
  ...
  methods: {
    ...
    onOpenPopup() {
      ...
      const popup = getHTMLElementFromVueRef(this.$refs.popup);
      const navMonth = popup.querySelector(".calendar-navbar__month--title");
      if (navMonth) {
        navMonth.focus({
          preventScroll: true
        });
...
function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$u, [createElementVNode("div", {
    ...
    default: withCtx(() => [createElementVNode("div", {
      ...
      _: 1
    }, 8, ["modelValue", "tab-date", "min-date", "max-date", "year-selector", "onClick", "onKeyup"]), _cache[12] || (_cache[12] = createTextVNode()), createElementVNode("div", _hoisted_4$e, [createElementVNode("button", {
...
function useKeyboardHandler(options) {
  ...
  useEventListener$1(separator, "keydown", (event) => {
    if (!attachment.value) {
      return;
    }
...
function usePointerHandler(options) {
  ...
  useEventListener$1(separator, "pointerdown", (event) => {
    const {
      isPrimary,
      button,
      target,
