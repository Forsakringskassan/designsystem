...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-a33b3e.js
...
exampleComponent.__scopeId = "data-v-a33b3e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a33b3e"
});
export {
  render
};
