...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-be27f1.js
...
exampleComponent.__scopeId = "data-v-be27f1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-be27f1"
});
export {
  render
};
