...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-27405f.js
...
exampleComponent.__scopeId = "data-v-27405f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-27405f"
});
export {
  render
};
