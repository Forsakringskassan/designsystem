...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ce7b5e.js
...
exampleComponent.__scopeId = "data-v-ce7b5e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ce7b5e"
});
export {
  render
};
