...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-ece0e1.js
...
exampleComponent.__scopeId = "data-v-ece0e1";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ece0e1"
});
export {
  render
};
