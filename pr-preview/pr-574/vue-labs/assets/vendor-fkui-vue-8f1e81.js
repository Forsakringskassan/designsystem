...
function _sfc_render$Q(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", mergeProps(_ctx.$attrs, {
    ...
    href: _ctx.spriteId
  }, null, 8, _hoisted_2$L)], 16, _hoisted_1$11);
}
var FIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1n, [["render", _sfc_render$Q]]);
var _hoisted_1$10 = ["type"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        class: "button__icon",
        name: props.iconLeft
      }, null, 8, ["name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), renderSlot(_ctx.$slots, "default"), _cache[1] || (_cache[1] = createTextVNode()), props.iconRight ? (openBlock(), createBlock(unref(FIcon), {
        key: 1,
        class: "button__icon",
        name: props.iconRight
      }, null, 8, ["name"])) : createCommentVNode("", true)], 10, _hoisted_1$10);
    };
  }
});
...
function _sfc_render$O(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$_, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createElementVNode("span", null, toDisplayString(button.label), 1), _cache[0] || (_cache[0] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$y, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$J);
    }), 128))])]),
    _: 3,
    __: [1, 2]
...
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$Z, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
      ...
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$I, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createElementVNode("ul", _hoisted_3$x, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
...
function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$X, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createElementVNode("span", null, toDisplayString(button.label), 1), _cache[2] || (_cache[2] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$w, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$G);
    }), 128))])]),
    _: 3,
    __: [3, 4]
...
function _sfc_render$u(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, {
    ...
    name: "i"
  }), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_3$q, toDisplayString(_ctx.screenReaderText), 1)])], 8, _hoisted_1$I)], 8, ["disabled", "to"])), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("div", mergeProps({
    ref: "wrapper",
    class: "tooltip"
...
function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$v, [createElementVNode("div", {
    ...
    "input-right": withCtx(() => [createElementVNode("button", {
      ...
      name: "calendar"
    }), _cache[6] || (_cache[6] = createTextVNode()), createElementVNode("span", _hoisted_3$i, toDisplayString(_ctx.calendarButtonText), 1)], 8, _hoisted_2$p)]),
...
var _hoisted_1$u = {
  class: "definition-list__term"
};
var _hoisted_2$o = {
  class: "definition-list__description"
};
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("dl", {
        class: normalizeClass(["definition-list", __props.justified ? "definition-list--justified" : ""])
      }, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.definitions, (definition) => {
        return openBlock(), createElementBlock(Fragment, {
          key: definition.term
        }, [createElementVNode("dt", _hoisted_1$u, toDisplayString(definition.term), 1), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("dd", _hoisted_2$o, toDisplayString(definition.description), 1)], 64);
      }), 128))], 2);
    };
  }
});
...
export {
  ...
  FDatepickerField,
  _sfc_main$x as FDefinitionList,
