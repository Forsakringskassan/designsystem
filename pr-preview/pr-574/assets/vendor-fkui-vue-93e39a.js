    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$u, [__props.gridded ? (openBlock(), createElementBlock("dl", _hoisted_2$o, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.definitions, (definition) => {
        return openBlock(), createElementBlock(Fragment, {
          key: definition.term
        }, [createElementVNode("dt", null, toDisplayString(definition.term), 1), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("dd", null, toDisplayString(definition.definition), 1)], 64);
      }), 128))])) : (openBlock(true), createElementBlock(Fragment, {
        key: 1
      }, renderList(__props.definitions, (definition) => {
        return openBlock(), createElementBlock("div", {
          key: definition.term
        }, toDisplayString(definition.term) + ": " + toDisplayString(definition.definition), 1);
      }), 128))]);
    };
  }
});
