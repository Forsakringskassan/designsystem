...
var _sfc_main$x = /* @__PURE__ */ defineComponent({
  ...
  props: {
    /**
     * The definitions to be displayed in the menu.
     */
    definitions: {
      type: Array,
      required: true
    ...
    /**
     * Show the definition list in a aligned layout.
     */
    aligned: {
      type: Boolean,
      required: false,
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$u, [__props.aligned ? (openBlock(), createElementBlock("dl", _hoisted_2$o, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.definitions, (definition) => {
        return openBlock(), createElementBlock(Fragment, {
          key: definition.term
        }, [createElementVNode("dt", null, toDisplayString(definition.term) + ":", 1), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("dd", null, toDisplayString(definition.description), 1)], 64);
      }), 128))])) : (openBlock(true), createElementBlock(Fragment, {
        key: 1
      }, renderList(__props.definitions, (definition) => {
        return openBlock(), createElementBlock("div", {
          key: definition.term
        }, toDisplayString(definition.term) + ": " + toDisplayString(definition.description), 1);
      }), 128))]);
    };
  }
});
