...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-db9d13.js
...
exampleComponent.__scopeId = "data-v-db9d13";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db9d13"
});
export {
  render
};
