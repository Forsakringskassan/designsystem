...
// virtual-entry:virtual:packages/vue/src/components/FTable/docs/FTableColumnLiveExample.vue:FTableColumnLiveExample-acbf59.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    normalizedKey() {
      return this.columnType.includes("text") ? this.textType : this.columnType;
    },
    columns() {
