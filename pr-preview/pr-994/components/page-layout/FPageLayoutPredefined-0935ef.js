...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-0935ef.js
...
exampleComponent.__scopeId = "data-v-0935ef";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0935ef"
});
export {
  render
};
