...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-8783b4.js
...
exampleComponent.__scopeId = "data-v-8783b4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8783b4"
});
export {
  render
};
