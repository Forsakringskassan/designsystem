...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-0935bf.js
...
exampleComponent.__scopeId = "data-v-0935bf";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0935bf"
});
export {
  render
};
