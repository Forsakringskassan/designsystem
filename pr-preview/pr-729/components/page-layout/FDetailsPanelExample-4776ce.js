...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4776ce.js
...
exampleComponent.__scopeId = "data-v-4776ce";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4776ce"
});
export {
  render
};
