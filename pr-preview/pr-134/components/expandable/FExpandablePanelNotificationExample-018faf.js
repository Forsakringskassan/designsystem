...
(() => {
  ...
  // virtual-entry:./packages/vue/src/components/FExpandablePanel/examples/FExpandablePanelNotificationExample.vue
  ...
  setup({
    ...
    selector: "#FExpandablePanelNotificationExample"
  });
})();
