...
let FDate$1 = class FDate {
  ...
  get monthName() {
    if (this.isValid()) {
      return this.value.locale(getLocale$1()).format("MMMM");
    } else {
      return "";
    }
  }
  ...
  get monthNameShort() {
    if (this.isValid()) {
      return this.value.locale(getLocale$1()).format("MMM");
    } else {
      return "";
    }
  }
  ...
  get dayName() {
    if (this.isValid()) {
      return this.value.locale(getLocale$1()).format("dddd");
    } else {
      return "";
    }
  }
  ...
  get dayNameShort() {
    if (this.isValid()) {
      return this.value.locale(getLocale$1()).format("ddd");
    } else {
      return "";
    }
  }
...
function parsePersonnummer(value, now = FDate$1.now()) {
  ...
  const date = FDate$1.fromYearMonthDay(century + year, month, dayWithoutSamordning);
...
function scrollTo(element, arg = 0) {
  if (typeof arg === "number") {
    ...
    const scroll = elemRect.top - bodyRect.top - offset2;
...
function scrollToSlow(element, duration, offset2 = 0) {
  const steps = duration / 1e3 * FRAMERATE;
  const interval = duration / steps;
  const target = elementTop(element) - offset2;
...
class FDate2 {
  ...
  static fromIso(value) {
    const match = value.match(/^(?<year>\d{4})-(?<month>\d{2})-(?<day>\d{2})$/);
    if (match && match.groups) {
      const date = new FDate2(value);
      const { month } = match.groups;
      if (date.isValid() && date.month === parseInt(month, 10)) {
        return date;
      }
    }
    return FDate2.invalid();
  }
  /**
   * Create {@link FDate} from `Date`.
   *
   ...
   */
  startOfMonth() {
    return new FDate2(this.value.startOf("month"));
  }
  /**
   * Returns a cloned {@link FDate} object and set it to the end of month.
   *
   ...
   */
  endOfMonth() {
    return new FDate2(this.value.endOf("month"));
  }
  /**
   * Returns a new {@link FDate} object with a specified amount of days added.
   * Specify a negative amount in order to subtract days.
   ...
   */
  addDays(value) {
    return new FDate2(this.value.add(value, "day"));
  }
  /**
   * Returns a cloned {@link FDate} object with a specified amount of months added.
   * Specify a negative amount in order to subtract months.
   ...
   */
  addMonths(value) {
    return new FDate2(this.value.add(value, "month"));
  }
  /**
   * Returns a new {@link FDate} object with a specified amount of years added.
   * Specify a negative amount in order to subtract years.
   ...
   */
  addYears(value) {
    return new FDate2(this.value.add(value, "year"));
  }
  /**
   * Returns a new {@link FDate} object with the date before This one.
   *
...
function mountComponent(callingInstance, Component, options = {}) {
  ...
  const app2 = createApp(Component, data);
  const fkuiContext = getRunningContext(callingInstance);
  if (fkuiContext) {
    Object.assign(app2._context, fkuiContext.appContext);
  }
  app2.mount(el);
  const unmount = app2.unmount;
  app2.unmount = () => {
    unmount.call(app2);
    if (el.parentNode) {
...
function openModal(callingInstance, Component, options) {
  ...
  return new Promise((resolve2, reject) => {
    ...
    const app2 = mountComponent(callingInstance, Component, {
      attachTo,
      isOpen: true,
      onClose(data) {
...
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$Y, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
      ...
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$H, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createBaseVNode("ul", _hoisted_3$x, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
...
const _hoisted_2$F = ["type", "form", "onClick"];
const _hoisted_3$w = {
  key: 0,
  class: "sr-only"
};
...
const _hoisted_3$v = ["aria-disabled", "aria-live"];
const _hoisted_4$q = {
  class: "sr-only"
};
const _hoisted_5$l = ["aria-disabled", "aria-live"];
const _hoisted_6$g = {
  class: "sr-only"
};
function _sfc_render$F(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return openBlock(), createElementBlock("div", _hoisted_1$U, [createBaseVNode("div", _hoisted_2$E, toDisplayString(_ctx.currentText), 1), _cache[4] || (_cache[4] = createTextVNode()), createBaseVNode("button", {
    ref: "previousButton",
  ...
  }, [createBaseVNode("span", _hoisted_4$q, toDisplayString(_ctx.previousSrText), 1), _cache[2] || (_cache[2] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.previousIconClasses),
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_3$v), _cache[5] || (_cache[5] = createTextVNode()), createBaseVNode("button", {
    ref: "nextButton",
  ...
  }, [createBaseVNode("span", _hoisted_6$g, toDisplayString(_ctx.nextSrText), 1), _cache[3] || (_cache[3] = createTextVNode()), createVNode(_component_f_icon, {
    class: normalizeClass(_ctx.nextIconClasses),
    name: "arrow-right"
  }, null, 8, ["class"])], 8, _hoisted_5$l)]);
}
const ICalendarNavbar = /* @__PURE__ */ _export_sfc$1(_sfc_main$1a, [["render", _sfc_render$F]]);
...
function _sfc_render$E(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createBaseVNode("colgroup", null, [!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("col", _hoisted_2$D)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), _cache[3] || (_cache[3] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[4] || (_cache[4] = createTextVNode()), _cache[5] || (_cache[5] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[6] || (_cache[6] = createTextVNode()), _cache[7] || (_cache[7] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[8] || (_cache[8] = createTextVNode()), _cache[9] || (_cache[9] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[10] || (_cache[10] = createTextVNode()), _cache[11] || (_cache[11] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[12] || (_cache[12] = createTextVNode()), _cache[13] || (_cache[13] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1)), _cache[14] || (_cache[14] = createTextVNode()), _cache[15] || (_cache[15] = createBaseVNode("col", {
    class: "calendar-month__col--day"
  }, null, -1))]), _cache[22] || (_cache[22] = createTextVNode()), createBaseVNode("thead", null, [createBaseVNode("tr", null, [!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("th", _hoisted_3$u)) : createCommentVNode("", true), _cache[16] || (_cache[16] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.weekdays, (weekday) => {
  ...
  }), 128))])]), _cache[23] || (_cache[23] = createTextVNode()), createBaseVNode("tbody", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.weeks, (week) => {
  ...
  }), 128)), _cache[20] || (_cache[20] = createTextVNode()), _ctx.weeks.length < 5 ? (openBlock(), createElementBlock("tr", _hoisted_9$5, [createBaseVNode("td", {
    class: "calendar-month__cell",
    colspan: _ctx.totalCols,
    "aria-hidden": "true"
  }, null, 8, _hoisted_10$2)])) : createCommentVNode("", true), _cache[21] || (_cache[21] = createTextVNode()), _ctx.weeks.length < 6 ? (openBlock(), createElementBlock("tr", _hoisted_11$2, [createBaseVNode("td", {
    class: "calendar-month__cell",
    colspan: _ctx.totalCols,
    "aria-hidden": "true"
  }, null, 8, _hoisted_12$2)])) : createCommentVNode("", true)])], 40, _hoisted_1$T);
}
const ICalendarMonthGrid = /* @__PURE__ */ _export_sfc$1(_sfc_main$19, [["render", _sfc_render$E]]);
const DayStep = {
  ArrowRight: 1,
  ArrowLeft: -1,
  ArrowUp: -7,
  ...
  methods: {
    ...
    getTabindex(date) {
      ...
      if (document.activeElement instanceof HTMLElement) {
        ...
        activeDate = activeString ? FDate2.fromIso(activeString) : void 0;
      }
      return getDayTabindex(date, activeDate, this.tabDate);
    }
  }
});
const _hoisted_1$S = ["data-date", "tabindex", "onClick", "onKeydown"];
...
const ICalendarMonth = /* @__PURE__ */ _export_sfc$1(_sfc_main$18, [["render", _sfc_render$D]]);
...
const FCalendar = /* @__PURE__ */ _export_sfc$1(_sfc_main$17, [["render", _sfc_render$C]]);
...
function _sfc_render$B(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createBaseVNode("span", _hoisted_1$Q, toDisplayString(_ctx.day.day), 1), _cache[0] || (_cache[0] = createTextVNode()), createBaseVNode("span", _hoisted_2$C, toDisplayString(_ctx.srText), 1)], 2);
}
const FCalendarDay = /* @__PURE__ */ _export_sfc$1(_sfc_main$16, [["render", _sfc_render$B]]);
...
function fitInsideArea(options) {
  ...
  const index2 = candidates.findIndex((it) => isInside(clippedArea, it, spacing));
  if (index2 >= 0) {
    const match = candidates[index2];
    return {
      x: match.x,
      y: match.y,
...
const _sfc_main$13 = /* @__PURE__ */ defineComponent({
  ...
  methods: {
    ...
    async calculatePlacement() {
      ...
      const wrapper2 = getHTMLElementFromVueRef(this.$refs.wrapper);
    ...
    applyFocus() {
      ...
      const focusableElement = getFocusableElement(wrapper2, this.focusElement);
...
const IPopup = /* @__PURE__ */ _export_sfc$1(_sfc_main$13, [["render", _sfc_render$z]]);
...
function _sfc_render$y(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _ctx.isOpen ? (openBlock(), createBlock(Teleport, {
    ...
    "aria-hidden": "true"
  }, [createBaseVNode("div", _hoisted_1$O, [createBaseVNode("div", {
...
const _sfc_main$11 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }), [createBaseVNode("div", _hoisted_2$A, [renderSlot(_ctx.$slots, "default")], 512)], 16, _hoisted_1$N)], 512)], 8, ["to"])) : createCommentVNode("", true);
    };
  }
});
...
const IAnimateExpand = /* @__PURE__ */ _export_sfc$1(_sfc_main$$, [["render", _sfc_render$w]]);
...
function useCombobox(inputRef, options, onOptionSelected) {
  ...
  function setNextOption() {
    if (activeOption.value && hasMultipleOptions.value) {
      const index2 = dropdownOptions.value.indexOf(activeOption.value);
      if (index2 === dropdownOptions.value.length - 1) {
        activeOption.value = dropdownOptions.value[0];
      } else {
        activeOption.value = dropdownOptions.value[index2 + 1];
      }
    } else {
      activeOption.value = dropdownOptions.value[0];
    }
...
function _sfc_render$s(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
  ...
  }), null, 16, _hoisted_1$F), _cache[9] || (_cache[9] = createTextVNode()), createBaseVNode("label", {
    ...
    key: 0
  }, [_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$o, [_cache[3] || (_cache[3] = createBaseVNode("br", null, null, -1)), _cache[4] || (_cache[4] = createTextVNode()), renderSlot(_ctx.$slots, "details")])) : createCommentVNode("", true), _cache[7] || (_cache[7] = createTextVNode()), _ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, {
    key: 1,
    onEnter: _ctx.enter,
    onAfterEnter: _ctx.afterEnter,
    onLeave: _ctx.leave
  }, {
    default: withCtx(() => [_ctx.expanded ? (openBlock(), createElementBlock("span", _hoisted_4$k, [_cache[5] || (_cache[5] = createBaseVNode("br", null, null, -1)), _cache[6] || (_cache[6] = createTextVNode()), renderSlot(_ctx.$slots, "details", {
      height: _ctx.height
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$D, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        updateItem,
        deleteItem
      }))), _cache[6] || (_cache[6] = createTextVNode()), hasAddSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$t, [createBaseVNode("button", {
...
function setInternalKeys(items, key, nestedKey, seenValues = /* @__PURE__ */ new Set()) {
  ...
  return items.map((item, index2) => {
    ...
    if (invalidValue) {
      throw new Error(`Key [${keyString}] is missing or has invalid value in item index ${index2}`);
    }
    if (seenValues.has(value)) {
      throw new Error(`Expected each item to have key [${keyString}] with unique value but encountered duplicate of "${value}" in item index ${index2}.`);
    }
...
function _sfc_render$o(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [renderSlot(_ctx.$slots, "input-left"), _cache[17] || (_cache[17] = createTextVNode()), createBaseVNode("div", _hoisted_4$h, [withDirectives(createBaseVNode("input", mergeProps({
    id: _ctx.id,
    ref: "input",
        ...
        default: withCtx(() => [createVNode(unref(IFlexItem), {
          ...
          default: withCtx(() => [createVNode(unref(IFlex), {
            ...
            default: withCtx(() => [__props.showFilter ? (openBlock(), createBlock(unref(IFlexItem), {
              ...
              default: withCtx(() => [createBaseVNode("div", _hoisted_2$q, [createVNode(unref(FIcon), {
                name: "search",
                ...
                default: withCtx(() => [createBaseVNode("span", _hoisted_3$k, toDisplayString(__props.placeholderFilter), 1)]),
                _: 1
                ...
                name: "close"
              }), _cache[2] || (_cache[2] = createTextVNode()), createBaseVNode("span", _hoisted_5$d, toDisplayString(unref($t2)("fkui.sort-filter-dataset.clear.filter", "Rensa sökfält")), 1)], 8, _hoisted_4$g)) : createCommentVNode("", true)])]),
              _: 1
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, _ctx.$attrs), [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2$p, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createBaseVNode("colgroup", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
        return openBlock(), createElementBlock("col", {
          key: column.id,
          class: normalizeClass(column.size)
        }, null, 2);
      }), 128))]), _cache[6] || (_cache[6] = createTextVNode()), createBaseVNode("thead", null, [createBaseVNode("tr", _hoisted_3$j, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
...
function updateCalendarValue(datepicker, newValue) {
  ...
  const newCalendarValue = FDate2.fromIso(newValue);
...
function getDisplayMonth(minDate, maxDate, selectedDate, initialMonth) {
  ...
  return month || FDate2.now().startOfMonth();
}
const _sfc_main$x = /* @__PURE__ */ defineComponent({
  ...
  emits: ["change", "update:modelValue"],
  setup() {
    const defaultMinDate = FDate2.now().addYears(-10);
    const defaultMaxDate = FDate2.now().addYears(10);
    return {
      textFieldValue: ref(""),
  ...
  methods: {
    ...
    async onValidationConfigUpdate(event) {
      ...
      if (this.validationConfig.minDate) {
        ...
        this.minDate = FDate2.fromIso(minDateConfig.limit.toString());
      }
      if (this.validationConfig.maxDate) {
        ...
        this.maxDate = FDate2.fromIso(maxDateConfig.limit.toString());
      }
    },
    isDateEnabled(day) {
    ...
    highlightDay(date) {
      return this.highlightToday && date.equals(FDate2.now());
    },
...
const _hoisted_2$o = ["disabled", "aria-expanded"];
const _hoisted_3$i = {
  class: "sr-only"
};
const _hoisted_4$e = {
...
function _sfc_render$k(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$u, [createBaseVNode("div", {
    ref: "calendarInputs",
    ...
    "input-right": withCtx(() => [createBaseVNode("button", {
      ref: "calendarButton",
      disabled: _ctx.disabled,
      ...
      name: "calendar"
    }), _cache[6] || (_cache[6] = createTextVNode()), createBaseVNode("span", _hoisted_3$i, toDisplayString(_ctx.calendarButtonText), 1)], 8, _hoisted_2$o)]),
    ...
    default: withCtx(() => [createBaseVNode("div", {
      ...
      _: 1
    }, 8, ["modelValue", "tab-date", "min-date", "max-date", "onClick", "onKeyup"]), _cache[12] || (_cache[12] = createTextVNode()), createBaseVNode("div", _hoisted_4$e, [createBaseVNode("button", {
    ...
    }, [createBaseVNode("span", null, toDisplayString(_ctx.$t("fkui.datepicker-field.close", "Stäng")), 1), _cache[11] || (_cache[11] = createTextVNode()), createVNode(_component_f_icon, {
      "aria-hidden": "true",
      class: "button__icon",
      name: "close"
    })], 32)])], 2)]),
...
const FDatepickerField = /* @__PURE__ */ _export_sfc$1(_sfc_main$x, [["render", _sfc_render$k]]);
...
function useExpandableTable(expandableAttribute, keyAttribute, describedby, emit2, slots) {
  ...
  function expandableRowClasses(row, index2) {
    const rows = expandableRows(row);
    if (!rows) {
      return [];
    }
    const border = index2 < rows.length - 1 ? ["table__row--expanded-border"] : [];
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    function onKeydown$1(event, index2) {
      onKeydown({
    ...
    function rowClasses(row, index2) {
      ...
      const striped = props.striped && index2 % 2 !== 0 ? ["table__row--striped"] : [];
    ...
    function callbackBeforeItemDelete(item) {
      ...
      const index2 = internalRows.value.indexOf(item);
      const target = (_getPreviousFocus = getPreviousFocus(index2)) !== null && _getPreviousFocus !== void 0 ? _getPreviousFocus : getNextFocus(index2);
      if (target) {
        target.focus();
      }
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
      ...
      }, _ctx.$attrs), [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2$f, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[16] || (_cache[16] = createTextVNode()), createBaseVNode("colgroup", null, [unref(isExpandableTable) ? (openBlock(), createElementBlock("col", _hoisted_3$a)) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("col", _hoisted_4$9)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
        return openBlock(), createElementBlock("col", {
          key: column.id,
          class: normalizeClass(column.size)
        }, null, 2);
      }), 128))]), _cache[17] || (_cache[17] = createTextVNode()), createBaseVNode("thead", null, [createBaseVNode("tr", _hoisted_5$7, [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
        row: {}
      }))), _cache[4] || (_cache[4] = createTextVNode()), unref(isExpandableTable) ? (openBlock(), createElementBlock("th", _hoisted_6$5, [createBaseVNode("span", _hoisted_7$3, toDisplayString(
        ...
        ref: "tbodyElement",
        key: tbodyKey.value
      }, [(openBlock(true), createElementBlock(Fragment, null, renderList(internalRows.value, (row, index2) => {
        return openBlock(), createElementBlock(Fragment, {
          ...
          tabindex: "0",
          onKeydown: withModifiers(($event) => onKeydown$1($event, index2), ["self"]),
...
function addStep(dst, key, element) {
  const index2 = dst.findIndex((it) => it.key === key);
  if (index2 >= 0) {
...
const FWizard = /* @__PURE__ */ _export_sfc$1(_sfc_main$1$1, [["render", _sfc_render$1$1]]);
const SCROLL_DURATION = 500;
let ongoingScrollPromise = void 0;
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  methods: {
    ...
    async afterAnimation(open) {
      ...
      await this.$nextTick();
      if (!index.isVisibleInViewport(headerElement)) {
        await index.scrollTo(headerElement, {
          duration: SCROLL_DURATION,
          offset: 10
        });
      }
...
const _hoisted_1$2 = ["aria-current"];
const _hoisted_2$1 = {
  "aria-hidden": "true",
...
const _hoisted_12 = ["data-disabled"];
const _hoisted_13 = {
  class: "sr-only"
};
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
  ...
  })), () => [createBaseVNode("span", _hoisted_2$1, toDisplayString(_ctx.defaultCurrentStepInformation), 1)]) : createCommentVNode("", true), _cache[11] || (_cache[11] = createTextVNode()), createBaseVNode("div", _hoisted_3$1, [createBaseVNode("div", _hoisted_4, [createVNode(_component_f_icon, {
    name: "success"
  }), _cache[3] || (_cache[3] = createTextVNode()), createBaseVNode("div", _hoisted_5, toDisplayString(_ctx.stepNumber), 1)]), _cache[4] || (_cache[4] = createTextVNode()), _cache[5] || (_cache[5] = createBaseVNode("div", {
    class: "wizard-step__icon-container__line-down"
  }, null, -1))]), _cache[12] || (_cache[12] = createTextVNode()), createBaseVNode("div", _hoisted_6, [(openBlock(), createBlock(resolveDynamicComponent(_ctx.inheritedProps.headerTag), {
    ...
    }, [createBaseVNode("span", _hoisted_7, toDisplayString(_ctx.defaultCurrentStepInformation) + " ", 1), createTextVNode(" " + toDisplayString(_ctx.title) + " ", 1), createBaseVNode("span", _hoisted_8, "  " + toDisplayString(_ctx.$t("fkui.wizard-step.finished-step", "Avklarat steg")), 1)], 32)) : (openBlock(), createElementBlock(Fragment, {
      key: 1
    }, [createBaseVNode("span", _hoisted_9, toDisplayString(_ctx.defaultCurrentStepInformation) + " ", 1), createTextVNode(" " + toDisplayString(_ctx.title) + " ", 1), _ctx.isPending ? (openBlock(), createElementBlock("span", _hoisted_10, "\n                         " + toDisplayString(_ctx.$t("fkui.wizard-step.pending", "Inaktivt")), 1)) : createCommentVNode("", true)], 64))]),
    _: 1
  }))], 512), _cache[13] || (_cache[13] = createTextVNode()), _cache[14] || (_cache[14] = createBaseVNode("div", {
    ...
    default: withCtx(() => [createVNode(_component_f_validation_form, {
      ...
      default: withCtx(() => [renderSlot(_ctx.$slots, "default"), _cache[7] || (_cache[7] = createTextVNode()), createBaseVNode("div", _hoisted_11, [createBaseVNode("button", {
        ...
        key: 1
      }, [createTextVNode(toDisplayString(_ctx.$t("fkui.wizard-step.button.next.text", "Fortsätt")) + " ", 1), createBaseVNode("span", _hoisted_13, "\n                                         " + toDisplayString(_ctx.$t("fkui.wizard-step.button.next.sr-text", "till nästa steg")), 1)], 64))])], 8, _hoisted_12), _cache[6] || (_cache[6] = createTextVNode()), createBaseVNode("button", {
...
const FWizardStep = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["render", _sfc_render$3]]);
/*!
  * vue-router v4.5.1
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_form_modal, {
    ...
    header: withCtx(() => _cache[2] || (_cache[2] = [
      createTextVNode(" Fruktsallad ")
    ])),
    "error-message": withCtx(() => _cache[3] || (_cache[3] = [
      createTextVNode(" Oj, du har glömt fylla i något. Gå till: ")
    ])),
    "input-text-fields": withCtx(() => [
...
const ExampleModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
...
const _hoisted_2 = { id: "api-result" };
const _hoisted_3 = { key: 0 };
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_text_field = resolveComponent("f-text-field");
  const _component_f_wizard_step = resolveComponent("f-wizard-step");
  const _component_f_datepicker_field = resolveComponent("f-datepicker-field");
  ...
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_f_wizard, {
      modelValue: _ctx.current,
      "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.current = $event),
      "header-tag": "h2",
      ...
      default: withCtx(() => [
        createVNode(_component_f_wizard_step, {
          ...
          default: withCtx(() => [
            ...
            _ctx.result ? (openBlock(), createElementBlock("div", _hoisted_1, [
              _cache[6] || (_cache[6] = createBaseVNode("pre", null, "Modalen stängdes med resultatet:", -1)),
        ...
        createVNode(_component_f_wizard_step, {
          ...
          default: withCtx(() => [
            withDirectives((openBlock(), createBlock(_component_f_datepicker_field, {
    ...
    _ctx.done ? (openBlock(), createElementBlock("p", _hoisted_3, "Allt är ifyllt")) : createCommentVNode("", true)
  ]);
}
