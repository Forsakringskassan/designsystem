    ...
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
      ...
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$K, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createBaseVNode("ul", _hoisted_3$A, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
        return openBlock(), createElementBlock("li", {
          ...
          "aria-hidden": "true"
        }, null, -1)), _cache[2] || (_cache[2] = createTextVNode()), createBaseVNode("span", _hoisted_5$m, toDisplayString(item.title), 1)], 8, _hoisted_4$t)) : (openBlock(), createElementBlock(Fragment, {
          key: 1
        }, [_cache[3] || (_cache[3] = createBaseVNode("span", {
          class: "error-list__bullet",
          "aria-hidden": "true"
        }, null, -1)), _cache[4] || (_cache[4] = createTextVNode()), createBaseVNode("span", null, toDisplayString(item.title), 1)], 64))]);
      }), 128))])]),
      _: 3
    })]),
    _: 3
...
function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_validation_group, {
    ...
    default: withCtx(() => [createBaseVNode("form", mergeProps({
      ...
      _: 3
    }, 8, ["items", "before-navigate"])], 512)) : createCommentVNode("", true), _cache[2] || (_cache[2] = createTextVNode()), renderSlot(_ctx.$slots, "default")], 16, _hoisted_1$_)]),
    _: 3
  }, 8, ["modelValue"]);
}
