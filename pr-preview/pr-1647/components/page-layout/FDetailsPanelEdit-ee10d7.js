...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-ee10d7.js
...
exampleComponent.__scopeId = "data-v-ee10d7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ee10d7"
});
export {
  render
};
