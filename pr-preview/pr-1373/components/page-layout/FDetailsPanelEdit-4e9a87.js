...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-4e9a87.js
...
exampleComponent.__scopeId = "data-v-4e9a87";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4e9a87"
});
export {
  render
};
