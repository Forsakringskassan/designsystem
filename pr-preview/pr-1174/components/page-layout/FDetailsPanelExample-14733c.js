...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-14733c.js
import { defineComponent as _defineComponent } from "vue";
import { FButton, FDetailsPanel, FPageLayout, FResizePane, useDetailsPanel } from "@fkui/vue";
import { createElementVNode as _createElementVNode, toDisplayString as _toDisplayString, withCtx as _withCtx, createVNode as _createVNode, createTextVNode as _createTextVNode, openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue";
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { name, panel, ExamplePanel, openPanel, get FButton() {
      return FButton;
    }, get FPageLayout() {
      return FPageLayout;
    }, get FResizePane() {
...
exampleComponent.__scopeId = "data-v-14733c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-14733c"
});
export {
  render
};
