...
function getWeekdayNamings(locale) {
	return namings[locale ?? getLocale()];
}
...
var FDate = class FDate {
	...
	*/
	get weekDay() {
		if (!this.isValid()) return 0;
		const result = Number.parseInt(this.value.format("d"), 10);
		if (!result) return Weekday.SUNDAY;
		return result;
	}
	/**
	* This returns a `boolean` indicating whether the FDate object contains a valid date or not.
...
* @since v6.12.0
*/
var FYear = class FYear {
	_value;
	constructor(value) {
		if (Math.round(value) === value) this._value = value;
		else this._value = NaN;
	}
	/**
	...
	*/
	static now() {
		return new FYear((/* @__PURE__ */ new Date()).getFullYear());
	}
	/**
	...
	*/
	static fromYear(value) {
		return new FYear(typeof value === "string" ? Number.parseInt(value, 10) : value);
	}
	/**
	...
	*/
	static fromDate(value) {
		if (value instanceof Date) return new FYear(value.getFullYear());
		else return new FYear(value.year);
	}
	/**
	...
	*/
	toString() {
		if (this.isValid()) return this._value.toString();
		else return "";
	}
	/**
	...
	*/
	toJSON() {
		if (this.isValid()) return this._value;
		else return null;
	}
	/**
	* @internal
	*/
	static toFYear(value) {
		if (value instanceof FYear) return value;
		else return FYear.fromYear(value);
	}
	/**
	* @internal
	*/
...
var FBadge_default = /* @__PURE__ */ defineComponent({
	__name: "FBadge",
	props: {
		status: {
			type: String,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(["badge", badgeClass.value]) }, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
...
function itemEquals(item1, item2, compareAttribute) {
	if (!isSet(item1) || !isSet(item2)) return false;
...
function includeItem(item, itemList, compareAttribute) {
	if (!isSet(item) || !isSet(itemList)) return false;
...
function handleKeyboardFocusNavigation(key, focusedElement, focusableElements) {
	...
	if (keyDown.includes(key)) {
		tabPosition++;
		if (tabPosition === focusableElements.length) tabPosition = 0;
	}
	if (keyUp.includes(key)) {
		tabPosition--;
		if (tabPosition === -1) tabPosition = focusableElements.length - 1;
	}
	if (focusableElements[tabPosition]) focusableElements[tabPosition].focus();
}
/**
* @public
*/
...
function getHTMLElementsFromVueRef(ref) {
	let result = [];
	if (isEmptyArray(ref)) result = [];
	else if (refIsVueArray(ref)) result = ref.map((vueRef) => vueRef.$el);
	else if (refIsHTMLElementArray(ref)) result = [...ref];
	else if (isSet(ref)) result = [getHTMLElementFromVueRef(ref)];
	return result;
}
...
var _hoisted_1$65 = ["id"];
var _hoisted_2$48 = { class: "modal__backdrop" };
var _hoisted_3$38 = { class: "modal__inner-container" };
var _hoisted_4$30 = { class: "modal__dialog" };
var _hoisted_5$23 = { class: "modal__dialog-inner" };
var _hoisted_6$17 = { class: "modal__header" };
var _hoisted_7$13 = {
	key: 0,
	ref: "modalTitle",
	class: "modal__title",
...
var _hoisted_10$4 = { class: "modal__shelf" };
...
function _sfc_render$50(_ctx, _cache, $props, $setup, $data, $options) {
	...
	}, [createBaseVNode("div", _hoisted_2$48, [createBaseVNode("div", {
		class: "modal__outer-container scroll-target",
		tabindex: "-1",
		role: "dialog",
		"aria-modal": "true",
		onKeyup: _cache[3] || (_cache[3] = withKeys((...args) => _ctx.onClose && _ctx.onClose(...args), ["esc"]))
	}, [createBaseVNode("div", _hoisted_3$38, [createBaseVNode("div", {
		ref: "modalDialogContainer",
		class: normalizeClass(["modal__dialog-container", _ctx.containerClasses])
	}, [createBaseVNode("div", _hoisted_4$30, [
		createBaseVNode("div", _hoisted_5$23, [
			createBaseVNode("div", _hoisted_6$17, [
				createBaseVNode("div", {
					tabindex: "0",
					onFocus: _cache[0] || (_cache[0] = (...args) => _ctx.onFocusFirst && _ctx.onFocusFirst(...args))
				}, null, 32),
				_cache[4] || (_cache[4] = createTextVNode()),
				_ctx.hasHeaderSlot ? (openBlock(), createElementBlock("h1", _hoisted_7$13, [renderSlot(_ctx.$slots, "header")], 512)) : createCommentVNode("", true)
			]),
			_cache[5] || (_cache[5] = createTextVNode()),
			createBaseVNode("div", _hoisted_8$9, [renderSlot(_ctx.$slots, "content")], 512),
			_cache[6] || (_cache[6] = createTextVNode()),
			createBaseVNode("div", _hoisted_9$7, [renderSlot(_ctx.$slots, "footer")])
		]),
	...
	])], 2)])], 32)])], 10, _hoisted_1$65)) : createCommentVNode("", true);
}
...
var _hoisted_1$64 = { class: "button-group" };
var _hoisted_2$47 = ["onClick"];
var _hoisted_3$37 = {
	key: 0,
	class: "sr-only"
};
function _sfc_render$49(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_modal, {
		...
		footer: withCtx(() => [createBaseVNode("div", _hoisted_1$64, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
			return openBlock(), createElementBlock("button", {
				...
				_cache[0] || (_cache[0] = createTextVNode()),
				button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$37, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)
			], 10, _hoisted_2$47);
		}), 128))])]),
		_: 3
	}, 8, [
...
var FErrorList_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		liClasses(errorItem) {
			const classes = [];
			if (!this.bullets && errorItem.id) classes.push("error-list__link");
			return classes;
		},
...
var _hoisted_1$63 = { class: "error-list" };
var _hoisted_2$46 = { key: 0 };
var _hoisted_3$36 = { class: "error-list__list error-list--list-style-none" };
var _hoisted_4$29 = ["onClick"];
var _hoisted_5$22 = { class: "error-list__link" };
function _sfc_render$46(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$63, [createVNode(_component_i_flex, null, {
		default: withCtx(() => [
			...
			createVNode(_component_i_flex_item, { grow: "" }, {
				default: withCtx(() => [
					_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$46, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true),
					_cache[5] || (_cache[5] = createTextVNode()),
					createBaseVNode("ul", _hoisted_3$36, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
						...
						}, [_ctx.bullets ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
							_cache[1] || (_cache[1] = createBaseVNode("span", {
								class: "error-list__bullet",
								"aria-hidden": "true"
							}, null, -1)),
							_cache[2] || (_cache[2] = createTextVNode()),
							createBaseVNode("span", _hoisted_5$22, toDisplayString(item.title), 1)
						], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(item.title), 1)], 64))], 8, _hoisted_4$29)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [_ctx.bullets ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						...
						], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(item.title), 1)], 64))], 64))], 2);
					}), 128))])
				]),
				_: 3
			})
...
function _sfc_render$44(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_validation_group, {
		...
		default: withCtx(() => [createBaseVNode("form", mergeProps({ id: _ctx.id }, _ctx.$attrs, {
			...
			_ctx.displayErrors ? (openBlock(), createElementBlock("nav", _hoisted_2$45, [createVNode(_component_f_error_list, {
				items: _ctx.errors,
...
var _hoisted_1$61 = { class: "button-group" };
var _hoisted_2$44 = [
	"type",
	"form",
	"onClick"
...
function _sfc_render$43(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_modal, {
		...
		footer: withCtx(() => [createBaseVNode("div", _hoisted_1$61, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
			return openBlock(), createElementBlock("button", {
				key: button.label,
				...
				createBaseVNode("span", null, toDisplayString(button.label), 1),
				_cache[2] || (_cache[2] = createTextVNode()),
				button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$35, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)
			], 10, _hoisted_2$44);
		}), 128))])]),
		_: 3
	}, 8, [
...
function isNumberFormat(value) {
	...
	if (typeof maybeNumberformat.decimals !== "number") return false;
	return ["number", "string"].includes(typeof maybeNumberformat.number);
}
/**
* @internal
*/
function formatNumber$1(el, number) {
	el.classList.add("formatter--number");
	el.textContent = "";
	if (typeof number === "string" || typeof number === "number") {
		var _numberFormater;
		el.textContent = (_numberFormater = formatNumber(number)) !== null && _numberFormater !== void 0 ? _numberFormater : "";
	} else if (isNumberFormat(number)) {
		var _numberFormater2;
		el.textContent = (_numberFormater2 = formatNumber(number.number, number.decimals)) !== null && _numberFormater2 !== void 0 ? _numberFormater2 : "";
	}
}
/**
* @internal
...
function formatDate(el, date) {
	...
	} else if (date instanceof FDate) el.textContent = date.toString();
}
/**
* @internal
*/
function formatDateFull(el, date) {
	...
	} else if (date instanceof FDate) el.textContent = date.toString(DateFormat.FULL);
}
/**
* @internal
*/
function formatDateLong(el, date) {
	...
	} else if (date instanceof FDate) el.textContent = date.toString(DateFormat.LONG);
}
/**
* @internal
*/
function formatDateRange(el, range) {
	...
	if (fromDate.isValid() && toDate.isValid()) el.textContent = `${fromDate.toString()} – ${toDate.toString()}`;
}
/**
* @internal
*/
...
* @internal
*/
function formatPersonnummer$1(el, pnr) {
...
function removeObsoleteClasses(el) {
	el.classList.forEach((it) => {
		if (it.startsWith("formatter--")) el.classList.remove(it);
	});
}
/**
...
* @public
*/
var FormatPlugin = { install(app) {
	app.directive("format", (el, { value, arg }) => {
...
var ICalendarMonthGrid_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		...
		onFocusout(e) {
			...
			if (!component.contains(relatedTarget)) this.focused = false;
		},
...
var _hoisted_4$28 = ["title"];
var _hoisted_5$21 = { key: 1 };
var _hoisted_6$16 = {
	key: 0,
	class: "calendar-month__cell calendar-month__cell--week-number",
	"aria-hidden": "true"
};
var _hoisted_7$12 = ["colspan"];
...
function _sfc_render$40(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("table", {
		...
		createBaseVNode("colgroup", null, [
			!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("col", _hoisted_2$43)) : createCommentVNode("", true),
			_cache[2] || (_cache[2] = createTextVNode()),
			_cache[3] || (_cache[3] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[4] || (_cache[4] = createTextVNode()),
			_cache[5] || (_cache[5] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[6] || (_cache[6] = createTextVNode()),
			_cache[7] || (_cache[7] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[8] || (_cache[8] = createTextVNode()),
			_cache[9] || (_cache[9] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[10] || (_cache[10] = createTextVNode()),
			_cache[11] || (_cache[11] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[12] || (_cache[12] = createTextVNode()),
			_cache[13] || (_cache[13] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1)),
			_cache[14] || (_cache[14] = createTextVNode()),
			_cache[15] || (_cache[15] = createBaseVNode("col", { class: "calendar-month__col--day" }, null, -1))
		]),
		_cache[22] || (_cache[22] = createTextVNode()),
		createBaseVNode("thead", null, [createBaseVNode("tr", null, [
			!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("th", _hoisted_3$34)) : createCommentVNode("", true),
			_cache[16] || (_cache[16] = createTextVNode()),
			(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.weekdays, (weekday) => {
				return openBlock(), createElementBlock("th", {
					...
					key: 0,
					title: weekday.name
				}, toDisplayString(weekday.shortName), 9, _hoisted_4$28)) : (openBlock(), createElementBlock("span", _hoisted_5$21, toDisplayString(weekday.name), 1))]);
			}), 128))
		])]),
		_cache[23] || (_cache[23] = createTextVNode()),
		createBaseVNode("tbody", null, [
			(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.weeks, (week) => {
				return openBlock(), createElementBlock("tr", { key: week.week }, [
					!_ctx.internalHideWeekNumbers ? (openBlock(), createElementBlock("td", _hoisted_6$16, toDisplayString(week.week), 1)) : createCommentVNode("", true),
					_cache[17] || (_cache[17] = createTextVNode()),
					_ctx.getDayStartOffset(week.days) ? (openBlock(), createElementBlock("td", {
						key: 1,
					...
					_ctx.getDayEndOffset(week.days) ? (openBlock(), createElementBlock("td", {
						key: 2,
						class: "calendar-month__cell",
			...
			_ctx.weeks.length < 5 ? (openBlock(), createElementBlock("tr", _hoisted_9$6, [createBaseVNode("td", {
				class: "calendar-month__cell",
				colspan: _ctx.totalCols,
				"aria-hidden": "true"
			}, null, 8, _hoisted_10$3)])) : createCommentVNode("", true),
			_cache[21] || (_cache[21] = createTextVNode()),
			_ctx.weeks.length < 6 ? (openBlock(), createElementBlock("tr", _hoisted_11$2, [createBaseVNode("td", {
				class: "calendar-month__cell",
				colspan: _ctx.totalCols,
				"aria-hidden": "true"
...
var ICalendarMonthGrid_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(ICalendarMonthGrid_vue_vue_type_script_lang_default, [["render", _sfc_render$40]]);
var DayStep = {
	ArrowRight: 1,
	ArrowLeft: -1,
	ArrowUp: -7,
...
function getDayTabindex(date, active, entry) {
	const ref = active !== null && active !== void 0 ? active : entry;
	if (ref && isSameMonth(ref, date)) return date.equals(ref) ? 0 : -1;
	else return date.day === 1 ? 0 : -1;
}
...
function getMessage($t, date, minDate, maxDate) {
	if (!isInvalidMonth(date, minDate, maxDate)) return;
...
var ICalendarMonth_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "ICalendarMonth",
	components: { ICalendarMonthGrid: ICalendarMonthGrid_default },
	mixins: [TranslationMixin],
	props: {
		modelValue: {
			type: Object,
...
function _sfc_render$39(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_i_calendar_month_grid, { value: _ctx.modelValue }, {
		default: withCtx(({ date }) => [createBaseVNode("div", {
			ref: date.toString(),
			role: "gridcell",
...
var ICalendarMonth_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(ICalendarMonth_vue_vue_type_script_lang_default, [["render", _sfc_render$39]]);
var ICalendarNavbar_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		...
		onClickPreviousButton() {
			...
			if (message) alertScreenReader(message, { assertive: true });
		},
		onClickNextButton() {
...
var _hoisted_1$57 = { class: "calendar-navbar" };
var _hoisted_2$42 = { class: "calendar-navbar__month" };
var _hoisted_3$33 = ["aria-live"];
var _hoisted_4$27 = ["id", "aria-expanded"];
var _hoisted_5$20 = {
	class: "calendar-navbar__year-selector-button--title",
	"aria-hidden": "true"
};
var _hoisted_6$15 = { class: "sr-only" };
var _hoisted_7$11 = ["aria-disabled", "aria-live"];
var _hoisted_8$7 = { class: "sr-only" };
var _hoisted_9$5 = ["aria-disabled", "aria-live"];
var _hoisted_10$2 = { class: "sr-only" };
function _sfc_render$38(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$57, [
		createBaseVNode("div", _hoisted_2$42, [
			...
			}, toDisplayString(_ctx.currentText), 11, _hoisted_3$33),
			_cache[5] || (_cache[5] = createTextVNode()),
			_ctx.yearSelector ? (openBlock(), createElementBlock("button", {
				key: 0,
				id: `${_ctx.id}`,
				...
				createBaseVNode("span", _hoisted_5$20, toDisplayString(_ctx.currentText), 1),
				_cache[3] || (_cache[3] = createTextVNode()),
				createBaseVNode("span", _hoisted_6$15, toDisplayString(_ctx.yearSelectorOpen ? _ctx.closeYearSelectorText : _ctx.openYearSelectorText), 1),
				_cache[4] || (_cache[4] = createTextVNode()),
				createVNode(_component_f_icon, {
					class: normalizeClass(_ctx.yearSelectorOpen ? "calendar-navbar__arrow--up" : void 0),
					name: "arrow-down"
				}, null, 8, ["class"])
			], 8, _hoisted_4$27)) : createCommentVNode("", true)
		]),
		_cache[8] || (_cache[8] = createTextVNode()),
		!_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
			key: 0,
			ref: "previousButton",
			...
			createBaseVNode("span", _hoisted_8$7, toDisplayString(_ctx.previousSrText), 1),
			_cache[6] || (_cache[6] = createTextVNode()),
			createVNode(_component_f_icon, {
				class: normalizeClass(_ctx.previousIconClasses),
				name: "arrow-right"
			}, null, 8, ["class"])
		], 8, _hoisted_7$11)) : createCommentVNode("", true),
		_cache[9] || (_cache[9] = createTextVNode()),
		!_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("button", {
			key: 1,
			ref: "nextButton",
			...
			createBaseVNode("span", _hoisted_10$2, toDisplayString(_ctx.nextSrText), 1),
			_cache[7] || (_cache[7] = createTextVNode()),
			createVNode(_component_f_icon, {
...
var ICalendarNavbar_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(ICalendarNavbar_vue_vue_type_script_lang_default, [["render", _sfc_render$38]]);
...
function useCalendarHeight(options) {
	...
	const cachedHeight = /* @__PURE__ */ ref(NaN);
	watchEffect(() => {
		if (height.value > 0) cachedHeight.value = height.value;
	});
	watchEffect(() => {
		if (cachedHeight.value) dst.value?.style.setProperty(property, `${String(cachedHeight.value)}px`);
	});
}
/**
* @internal
...
function useYearSelector(options) {
	const yearSelectorOpen = /* @__PURE__ */ ref(false);
	const activeYear = /* @__PURE__ */ shallowRef(FYear.fromYear("invalid"));
	...
	watchEffect(async () => {
		if (!yearSelectorOpen.value) return;
		await nextTick();
...
var FCalendar_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FCalendar",
	components: {
		ICalendarNavbar: ICalendarNavbar_default,
		ICalendarMonth: ICalendarMonth_default
	},
	props: {
		modelValue: {
			type: Object,
	...
	setup(props, context) {
		const modelValue = /* @__PURE__ */ shallowRef(props.modelValue);
		const minDate = /* @__PURE__ */ shallowRef(props.minDate);
		const maxDate = /* @__PURE__ */ shallowRef(props.maxDate);
	...
	computed: { yearNounText() {
		return this.$t("fkui.calendar.year-noun", "Årtal");
	} },
	methods: {
...
var _hoisted_1$56 = { class: "calendar__wrapper" };
var _hoisted_2$41 = {
	key: 0,
	ref: "yearSelector",
	class: "calendar__year-selector"
};
var _hoisted_3$32 = ["aria-activedescendant", "aria-label"];
var _hoisted_4$26 = [
	"id",
	"tabindex",
	"aria-selected",
...
function _sfc_render$37(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$56, [
		createVNode(_component_i_calendar_navbar, {
			id: _ctx.id,
			ref: "calendarNavbar",
		...
		_cache[1] || (_cache[1] = createTextVNode()),
		_ctx.yearSelectorOpen ? (openBlock(), createElementBlock("div", _hoisted_2$41, [createBaseVNode("ul", {
			role: "listbox",
			...
			return openBlock(), createElementBlock("li", {
				...
				class: normalizeClass(["calendar__year-selector__year", { "calendar__year-selector__year--highlight": _ctx.activeYear.equals(year) }]),
				onClick: withModifiers(($event) => _ctx.onClickSelectYear(year), ["stop", "prevent"])
			}, toDisplayString(year), 11, _hoisted_4$26);
		}), 128))], 8, _hoisted_3$32)], 512)) : (openBlock(), createBlock(_component_i_calendar_month, {
			key: 1,
			ref: "calendar",
			"model-value": _ctx.modelValue,
			"min-date": _ctx.minDate,
			...
			default: withCtx(({ date, focused }) => [renderSlot(_ctx.$slots, "default", {
				date,
				isFocused: focused
			})]),
			_: 3
...
var FCalendar_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FCalendar_vue_vue_type_script_lang_default, [["render", _sfc_render$37]]);
/**
* @public
*
...
function getCalendarDaySrText(day, enabled, selected, t) {
	const parts = [];
	if (!enabled) parts.push(t("fkui.calendar.day.unselectable", "inte valbar"));
	else if (selected) parts.push(t("fkui.calendar.day.selected", "vald dag"));
	const today = FDate.now();
	if (day.equals(today)) parts.push(t("fkui.calendar.day.today", "idag"));
	else if (day.equals(today.addDays(-1))) parts.push(t("fkui.calendar.day.yesterday", "igår"));
	else if (day.equals(today.addDays(1))) parts.push(t("fkui.calendar.day.tomorrow", "imorgon"));
	parts.push(day.toString(DateFormat.FULL));
	return parts.join(" ");
}
var FCalendarDay_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FCalendarDay",
	mixins: [TranslationMixin],
	props: {
		day: {
	...
	computed: {
		...
		dayClasses() {
			...
			if (this.highlight) classes.push(`${component}--highlight`);
			if (this.enabled) {
				if (this.selected) classes.push(`${component}--selected`);
			} else classes.push(`${component}--disabled`);
			return classes;
		}
	}
});
var _hoisted_1$55 = { "aria-hidden": "true" };
var _hoisted_2$40 = { class: "sr-only" };
function _sfc_render$36(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("span", { class: normalizeClass(_ctx.dayClasses) }, [
		createBaseVNode("span", _hoisted_1$55, toDisplayString(_ctx.day.day), 1),
		_cache[0] || (_cache[0] = createTextVNode()),
		createBaseVNode("span", _hoisted_2$40, toDisplayString(_ctx.srText), 1)
	], 2);
}
var FCalendarDay_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FCalendarDay_vue_vue_type_script_lang_default, [["render", _sfc_render$36]]);
/**
...
var _hoisted_3$31 = { class: "card__content" };
var _hoisted_4$25 = {
	key: 1,
	class: "card__footer"
};
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				hasHeaderSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$39, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ headingSlotClass: "card__header-label" })))])) : createCommentVNode("", true),
				_cache[1] || (_cache[1] = createTextVNode()),
				...
				_cache[2] || (_cache[2] = createTextVNode()),
				createBaseVNode("div", _hoisted_3$31, [renderSlot(_ctx.$slots, "default")]),
				_cache[3] || (_cache[3] = createTextVNode()),
				hasFooterSlot.value ? (openBlock(), createElementBlock("div", _hoisted_4$25, [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
					hasError: hasError.value,
					validationMessage: validationMessage.value
				})))])) : createCommentVNode("", true)
			], 42, _hoisted_1$54);
...
var IPopupMenu_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	watch: {
		...
		modelValue: { async handler(newVal) {
			...
			if (index >= 0) await this.activateItem(index);
			else this.setFocusedItemIndex(0);
		} },
		focusedItem: { async handler(newVal) {
			if (newVal.length === 0) return;
			const index = this.indexOfItemByKey(newVal);
			if (index >= 0) await this.setFocusOnItem(index);
			else this.setFocusedItemIndex(0);
		} }
	},
	methods: {
		...
		onClickItem(event, item) {
			...
			if (!(target instanceof HTMLElement && target.tagName === "A")) this.clickItemAnchor(item);
		},
		clickItemAnchor(item) {
			if (!item.href) return;
			const index = this.items.indexOf(item);
			getSortedHTMLElementsFromVueRef(this.$refs.anchors)[index].click();
		},
		selectItem(key) {
		...
		itemClasses(item) {
			return ["ipopupmenu__list__item", ...item.key === this.modelValue ? ["ipopupmenu__list__item--highlight"] : []];
		},
		async setFocusOnItem(index) {
			...
			focus$1(itemAnchor, { preventScroll: true });
			const key = this.items[index].key;
			this.$emit("update:focusedItem", key);
		},
		async activateItem(index) {
			if (index !== this.currentFocusedItemIndex) await this.setFocusOnItem(index);
		...
		onKeyUp(event) {
			if (!this.enableKeyboardNavigation) return;
			if (preventKeys$1.has(event.key)) event.preventDefault();
		},
		async onKeyDown(event) {
			if (!this.enableKeyboardNavigation) return;
			if (!preventKeys$1.has(event.key)) return;
			...
			if (tabOutPrev || tabOutNext) {
				if (tabOutPrev) event.preventDefault();
				this.$emit("close");
				return;
			}
...
function _sfc_render$33(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_i_popup, {
		...
		default: withCtx(() => [createBaseVNode("nav", {
			...
			"aria-label": _ctx.ariaLabel
		}, [createBaseVNode("ul", _hoisted_2$37, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item, index) => {
			return openBlock(), createElementBlock("li", {
				ref_for: true,
				ref: "items",
				key: item.key,
				...
				target: item.target,
				tabindex: "0"
			}, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$19, [createBaseVNode("span", null, toDisplayString(_ctx.selectedMenuItemScreenReaderText) + "\xA0", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$24)], 10, _hoisted_3$30);
		}), 128))])], 8, _hoisted_1$51)]),
		_: 1
	}, 8, [
		"is-open",
...
var IAnimateExpand_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		...
		async openAnimation() {
			...
			this.timerList = [setTimeout(async () => {
				this.timerList = [];
				this.cssClasses = NO_CSS_CLASSES;
				this.height = "";
				await this.afterAnimation(true);
...
function _sfc_render$32(_ctx, _cache, $props, $setup, $data, $options) {
	...
	}, [_ctx.shouldVIf ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$50, [renderSlot(_ctx.$slots, "default")], 512)), [[vShow, _ctx.shouldVShow]]) : createCommentVNode("", true)], 6);
}
...
var reducedMotion = /* @__PURE__ */ ref(false);
/**
* @internal
*/
function useAnimation(options) {
	...
	onMounted(() => {
		...
		} else reducedMotion.value = true;
		initialized = true;
	});
	watchEffect(() => {
		if (elementRef.value) elementRef.value.classList.toggle("expanded", current === "expand");
	});
	return {
		...
		animate(state) {
			...
			if (state === "expand") animation = element.animate([{ height: 0 }, { height: `${String(h)}px` }], {
				duration,
				easing
			});
			else animation = element.animate([{ height: `${String(h)}px` }, { height: 0 }], {
				duration,
				easing
			});
...
function useHorizontalOffset(options) {
	...
	return /* @__PURE__ */ readonly(offset);
	function updateOffset() {
		...
		setTimeout(() => {
			...
			offset.value = element.offsetLeft - parent.offsetLeft - borderWidth + center;
		}, 0);
	}
}
var FTooltip_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FTooltip",
	components: {
	...
	setup(props) {
		...
		const iconTarget = computed(() => {
			...
			if (attachTo.value) return attachTo.value;
			return null;
		});
	...
	created() {
		if (useSlots().header && !this.headerTag) throw new Error("Tooltip with header must define headerTag");
	},
	methods: { onClickToggle() {
		this.isOpen = !this.isOpen;
		const value = this.isOpen;
		const event = { isOpen: this.isOpen };
		this.$emit("update:modelValue", value);
		this.$emit("toggle", event);
		if (!this.isOpen) focus(this.$refs.button);
		this.animate(value ? "expand" : "collapse");
	} }
});
var _hoisted_1$46 = ["aria-expanded"];
var _hoisted_2$35 = { class: "icon-stack icon-stack--tooltip" };
var _hoisted_3$28 = { class: "sr-only" };
var _hoisted_4$23 = {
	key: 0,
	class: "tooltip__bubble",
	tabindex: "-1"
};
var _hoisted_5$18 = { class: "tooltip__body" };
var _hoisted_6$14 = { class: "tooltip__footer" };
function _sfc_render$29(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock(Fragment, null, [
		...
		}, [createBaseVNode("span", _hoisted_2$35, [
			createVNode(_component_f_icon, { name: "circle" }),
			_cache[2] || (_cache[2] = createTextVNode()),
			createVNode(_component_f_icon, { name: "i" }),
			_cache[3] || (_cache[3] = createTextVNode()),
			createBaseVNode("span", _hoisted_3$28, toDisplayString(_ctx.screenReaderText), 1)
		])], 8, _hoisted_1$46)], 8, ["disabled", "to"])),
		_cache[7] || (_cache[7] = createTextVNode()),
		createBaseVNode("div", mergeProps({
			ref: "wrapper",
			class: "tooltip"
		}, _ctx.$attrs), [_ctx.ready ? (openBlock(), createElementBlock("div", _hoisted_4$23, [
			_ctx.hasHeader ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), {
				key: 0,
			...
			_cache[5] || (_cache[5] = createTextVNode()),
			createBaseVNode("div", _hoisted_5$18, [renderSlot(_ctx.$slots, "body")]),
			_cache[6] || (_cache[6] = createTextVNode()),
			createBaseVNode("div", _hoisted_6$14, [createBaseVNode("button", {
				class: "close-button",
				type: "button",
				onClick: _cache[1] || (_cache[1] = (...args) => _ctx.onClickToggle && _ctx.onClickToggle(...args))
			}, [
				createBaseVNode("span", null, toDisplayString(_ctx.closeButtonText), 1),
				_cache[4] || (_cache[4] = createTextVNode()),
				createVNode(_component_f_icon, {
					class: "button__icon",
					name: "close"
...
var FTooltip_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FTooltip_vue_vue_type_script_lang_default, [["render", _sfc_render$29]]);
/**
* @internal
*/
...
var _hoisted_6$13 = { key: 1 };
var _hoisted_7$10 = { "aria-hidden": "true" };
var _hoisted_8$6 = {
	key: 0,
	class: "label__message label__message--error"
};
function _sfc_render$28(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("fieldset", {
		...
		(openBlock(), createElementBlock("legend", {
			...
			_cache[1] || (_cache[1] = createTextVNode()),
			_ctx.hasCheckbox && _ctx.children.length > 1 ? (openBlock(), createElementBlock("span", _hoisted_2$34, [createBaseVNode("span", null, toDisplayString(_ctx.numberOfCheckboxesScreenReaderText), 1)])) : createCommentVNode("", true),
			_cache[2] || (_cache[2] = createTextVNode()),
			...
			})), () => [_ctx.hasError ? (openBlock(), createElementBlock("span", _hoisted_3$27, [createVNode(_component_f_icon, {
				class: "label__icon--left",
				name: "error"
			}), createTextVNode(" " + toDisplayString(_ctx.validity.validationMessage), 1)])) : createCommentVNode("", true)])
		], 2)),
		_cache[7] || (_cache[7] = createTextVNode()),
		_ctx.hasCheckbox ? (openBlock(), createElementBlock("span", _hoisted_4$22, [_ctx.children.length === 1 ? (openBlock(), createElementBlock("span", _hoisted_5$17, toDisplayString(_ctx.checkboxCheckedScreenReaderText), 1)) : (openBlock(), createElementBlock("span", _hoisted_6$13, toDisplayString(_ctx.numberOfCheckedCheckboxesScreenText), 1))])) : createCommentVNode("", true),
		_cache[8] || (_cache[8] = createTextVNode()),
		_ctx.hasTooltipSlot ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
			createBaseVNode("div", {
				ref: "tooltipAttachTo",
				class: normalizeClass(["label", _ctx.groupLabelClassTooltip])
			}, [createBaseVNode("span", _hoisted_7$10, [renderSlot(_ctx.$slots, "label")])], 2),
			_cache[5] || (_cache[5] = createTextVNode()),
...
var FCheckboxField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		updateExpandedFlag() {
			this.expanded = getHTMLElementFromVueRef(this.$refs.checkboxInput).checked;
		},
...
var _hoisted_1$44 = ["id", "disabled"];
var _hoisted_2$33 = ["for"];
var _hoisted_3$26 = {
	key: 0,
	...
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("label", {
			...
			_ctx.$slots.details ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
				_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$26, [renderSlot(_ctx.$slots, "details")])) : createCommentVNode("", true),
				_cache[3] || (_cache[3] = createTextVNode()),
				_ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, {
					...
					default: withCtx(() => [_ctx.expanded ? (openBlock(), createElementBlock("span", _hoisted_4$21, [renderSlot(_ctx.$slots, "details", { height: _ctx.height })])) : createCommentVNode("", true)]),
					_: 3
				}, 8, [
					"onEnter",
					"onAfterEnter",
...
var FOrganisationsnummerTextField_default = /* @__PURE__ */ defineComponent({
...
function getDisplayMonth(minDate, maxDate, selectedDate, initialMonth) {
	let effectiveDate;
	if (selectedDate?.isValid()) effectiveDate = selectedDate;
	else if (initialMonth?.isValid()) effectiveDate = initialMonth;
	else effectiveDate = FDate.now();
	let month;
	if (!isInvalidMonth(effectiveDate, minDate, maxDate)) month = effectiveDate.startOfMonth();
	else if (isMonthBefore(effectiveDate, minDate)) month = minDate?.startOfMonth();
	else if (isMonthAfter(effectiveDate, maxDate)) month = maxDate?.startOfMonth();
	return month !== null && month !== void 0 ? month : FDate.now().startOfMonth();
}
function isDayEnabled(day, config) {
	return passesMinDate(day, config.minDate) && passesMaxDate(day, config.maxDate) && passesInvalidDates(day, config.invalidDates) && passesInvalidWeekdays(day, config.invalidWeekdays);
}
function passesMinDate(day, config) {
	if (!config) throw new Error("MinDate validator must be set");
	if (!config.limit) throw new Error("Invalid minDate config");
	return config.limit <= day.toString();
}
function passesMaxDate(day, config) {
	if (!config) throw new Error("MaxDate validator must be set");
	if (!config.limit) throw new Error("Invalid maxDate config");
	return day.toString() <= config.limit;
}
function passesInvalidDates(day, config) {
	if (!config) return true;
	if (!isInvalidDatesConfig(config)) throw new Error("Invalid invalidDates config");
	return !config.dates.includes(day.toString());
}
function passesInvalidWeekdays(day, config) {
	if (!config) return true;
	if (!isInvalidWeekdaysConfig(config)) throw new Error("Invalid invalidWeekdays config");
...
function updateCalendarValue(datepicker, newValue) {
	...
	if (!newCalendarValue.isValid()) datepicker.calendarValue = void 0;
	else if (isInvalidMonth(newCalendarValue, minDate, maxDate)) datepicker.calendarValue = void 0;
	else if (!isDateEnabled(newCalendarValue)) datepicker.calendarValue = void 0;
	else if (!datepicker.calendarValue?.equals(newCalendarValue)) datepicker.calendarValue = newCalendarValue;
}
var FDatepickerField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FDatepickerField",
	components: {
		FCalendar: FCalendar_default,
		IPopup: IPopup_default,
		FTextField: FTextField_default,
		FIcon: FIcon_default,
		FCalendarDay: FCalendarDay_default
	},
	mixins: [TranslationMixin],
	inheritAttrs: false,
	props: {
	...
	setup() {
		...
		return {
			textFieldValue: /* @__PURE__ */ ref(""),
			textFieldTouched: /* @__PURE__ */ ref(false),
			textFieldValidityRevealed: /* @__PURE__ */ ref(false),
			textFieldTableMode: inject("textFieldTableMode", false),
			componentTouched: /* @__PURE__ */ ref(false),
			calendarMonth: /* @__PURE__ */ shallowRef(getDisplayMonth(defaultMinDate, defaultMaxDate)),
			calendarValue: /* @__PURE__ */ shallowRef(void 0),
			isCalendarOpen: /* @__PURE__ */ ref(false),
			validationConfig: /* @__PURE__ */ ref({}),
			minDate: /* @__PURE__ */ shallowRef(defaultMinDate),
			maxDate: /* @__PURE__ */ shallowRef(defaultMaxDate),
			calendarInputs: /* @__PURE__ */ ref(null)
		};
	},
	computed: {
		calendarButtonText() {
			...
			if (calendarValue?.isValid()) {
				...
				return `${this.$t("fkui.datepicker-field.change", "Ändra datum")} ${prettyDate}`;
			} else return this.$t("fkui.datepicker-field.choose", "Välj datum");
		},
		popupClass() {
	...
	methods: {
		...
		onValidityTextField({ detail }) {
			if (this.textFieldValidityRevealed && detail.validityMode === "INITIAL") {
				this.textFieldTouched = false;
				this.componentTouched = false;
			}
			if (!this.textFieldTouched && ["blur", "change"].includes(detail.nativeEvent)) this.textFieldTouched = true;
			if (this.isCalendarOpen) alertScreenReader(detail.validationMessage, { assertive: true });
			this.textFieldValidityRevealed = detail.validityMode !== "INITIAL";
			if (detail.validityMode === "INITIAL" || !this.textFieldTouched || this.componentTouched) return;
			const inputElement = getInputElement(this);
		...
		onClickCalendarButton() {
			if (!this.isCalendarOpen) this.calendarMonth = getDisplayMonth(this.minDate, this.maxDate, this.calendarValue, this.initialMonth);
			this.isCalendarOpen = !this.isCalendarOpen;
		},
		onFocusoutTextFieldButton(e) {
			if (this.componentTouched || this.$refs.component === null) return;
		...
		async onSelectCalendarDay(date) {
			...
			if (!this.isCalendarOpen) getHTMLElementFromVueRef(this.$refs.calendarButton).focus();
		...
		onOpenPopup() {
			...
			const navMonth = getHTMLElementFromVueRef(this.$refs.popup).querySelector(".calendar-navbar__month--title");
			if (navMonth) navMonth.focus({ preventScroll: true });
		},
		onClosePopup() {
			this.isCalendarOpen = false;
		},
		onValidationConfigUpdate(event) {
			...
			if (this.validationConfig.minDate) {
				...
				if (!minDateConfig.limit) throw new Error("MinDate validator must be set");
			...
			if (this.validationConfig.maxDate) {
				...
				if (!maxDateConfig.limit) throw new Error("MaxDate validator must be set");
...
var _hoisted_2$26 = ["disabled", "aria-expanded"];
var _hoisted_3$20 = { class: "sr-only" };
var _hoisted_4$15 = { class: "datepicker-field__close" };
	...
	return openBlock(), createElementBlock("div", _hoisted_1$32, [
		createBaseVNode("div", {
			...
			"input-right": withCtx(() => [createBaseVNode("button", {
				...
				createVNode(_component_f_icon, { name: "calendar" }),
				_cache[6] || (_cache[6] = createTextVNode()),
				createBaseVNode("span", _hoisted_3$20, toDisplayString(_ctx.calendarButtonText), 1)
			], 8, _hoisted_2$26)]),
			default: withCtx(() => [
				renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(_ctx.$t("fkui.datepicker-field.label", "Datum")), 1)]),
				_cache[7] || (_cache[7] = createTextVNode()),
				_cache[8] || (_cache[8] = createTextVNode()),
				_cache[9] || (_cache[9] = createTextVNode()),
				_cache[10] || (_cache[10] = createTextVNode())
		...
		_cache[13] || (_cache[13] = createTextVNode()),
		createVNode(_component_i_popup, {
			...
			default: withCtx(() => [createBaseVNode("div", {
				...
				createVNode(_component_f_calendar, {
					...
					default: withCtx(({ date, isFocused }) => [createVNode(_component_f_calendar_day, {
						day: date,
				...
				_cache[12] || (_cache[12] = createTextVNode()),
				createBaseVNode("div", _hoisted_4$15, [createBaseVNode("button", {
					...
					createBaseVNode("span", null, toDisplayString(_ctx.$t("fkui.datepicker-field.close", "Stäng")), 1),
...
var FDatepickerField_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FDatepickerField_vue_vue_type_script_lang_default, [["render", _sfc_render$20]]);
var layoutRegister = {};
/**
* @internal
*/
...
var FDialogueTree_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FDialogueTree",
	components: { FIcon: FIcon_default },
	props: {
		modelValue: {
	...
	computed: {
		userData() {
			if (isDialogueTreeEndQuestion(this.currentStep)) return this.currentStep.userData;
		},
		options() {
			if (!isDialogueTreeEndQuestion(this.currentStep)) return this.currentStep.options;
			return [];
		}
	},
	created() {
		this.currentStep = this.dialogueTree;
		if (isDialogueTreeEndQuestion(this.currentStep)) this.emitChange(true);
	...
	methods: {
		async onClickedOption(option, index) {
			...
			if (isDialogueTreeEndQuestion(option.question)) {
				...
				if (firstElement) focus$1(firstElement);
			}
		},
		emitChange(lastStep) {
			const emit = {
...
var _hoisted_1$25 = { class: "dialogue-tree" };
var _hoisted_2$21 = ["aria-label"];
var _hoisted_3$16 = ["onClick"];
function _sfc_render$19(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_icon = resolveComponent("f-icon");
	return openBlock(), createElementBlock("div", _hoisted_1$25, [_ctx.options.length > 0 ? (openBlock(), createElementBlock("ul", {
		...
		return openBlock(), createElementBlock("li", {
			...
			_cache[0] || (_cache[0] = createTextVNode()),
			createVNode(_component_f_icon, { name: "arrow-right" })
		], 8, _hoisted_3$16)]);
	}), 128))], 8, _hoisted_2$21)) : renderSlot(_ctx.$slots, "default", normalizeProps(mergeProps({ key: 1 }, { userData: _ctx.userData })))]);
}
var FDialogueTree_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FDialogueTree_vue_vue_type_script_lang_default, [["render", _sfc_render$19]]);
...
function _sfc_render$18(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", { class: normalizeClass(["expandable-panel", _ctx.expandedClass]) }, [
		...
		_cache[5] || (_cache[5] = createTextVNode()),
		createVNode(_component_f_expand, null, {
...
var FExpandableParagraph_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
...
var _hoisted_1$23 = ["aria-expanded", "aria-controls"];
var _hoisted_2$19 = { class: "expandable-paragraph__icon" };
var _hoisted_3$14 = { class: "icon-stack" };
var _hoisted_4$12 = {
	key: 0,
	class: "expandable-paragraph__related-information"
};
var _hoisted_5$10 = ["id"];
var _hoisted_6$8 = { class: "expandable-paragraph__content" };
var _hoisted_7$5 = {
	key: 0,
...
function _sfc_render$17(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_icon = resolveComponent("f-icon");
	const _component_f_expand = resolveComponent("f-expand");
	return openBlock(), createElementBlock("div", { class: normalizeClass(["expandable-paragraph", [_ctx.expandedClass, _ctx.listClass]]) }, [
		createBaseVNode("div", { class: normalizeClass(_ctx.relatedClass) }, [
			(openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { class: normalizeClass(["expandable-paragraph__heading", _ctx.headerVisualClass]) }, {
				default: withCtx(() => [createBaseVNode("button", mergeProps({
					type: "button",
					class: "expandable-paragraph__button",
					"aria-expanded": _ctx.expanded ? "true" : "false",
					"aria-controls": _ctx.id
				}, _ctx.$attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickMinimize && _ctx.onClickMinimize(...args)) }), [
					createBaseVNode("span", _hoisted_2$19, [createBaseVNode("span", _hoisted_3$14, [
						createVNode(_component_f_icon, { name: "dash" }),
						_cache[1] || (_cache[1] = createTextVNode()),
						createVNode(_component_f_icon, { name: "dash" })
					])]),
					_cache[2] || (_cache[2] = createTextVNode()),
			...
			_cache[3] || (_cache[3] = createTextVNode()),
			_ctx.hasRelatedSlot ? (openBlock(), createElementBlock("div", _hoisted_4$12, [renderSlot(_ctx.$slots, "related")])) : createCommentVNode("", true)
		], 2),
		_cache[5] || (_cache[5] = createTextVNode()),
		createVNode(_component_f_expand, null, {
			default: withCtx(() => [withDirectives(createBaseVNode("div", {
				...
				createBaseVNode("div", _hoisted_6$8, [renderSlot(_ctx.$slots, "default")]),
				_cache[4] || (_cache[4] = createTextVNode()),
				!_ctx.list ? (openBlock(), createElementBlock("div", _hoisted_7$5)) : createCommentVNode("", true)
			], 8, _hoisted_5$10), [[vShow, _ctx.expanded]])]),
			_: 3
		})
	], 2);
}
var FExpandableParagraph_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FExpandableParagraph_vue_vue_type_script_lang_default, [["render", _sfc_render$17]]);
...
var FFileItem_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FFileItem",
	components: { FIcon: FIcon_default },
	inheritAttrs: false,
	props: {
	...
	computed: {
		...
		mimeTypeChangedText() {
			var _split$pop, _this$originalMimeTyp, _split$pop2, _this$mimeType, _this$changedMimeType;
			const originalMimeType = (_split$pop = ((_this$originalMimeTyp = this.originalMimeType) !== null && _this$originalMimeTyp !== void 0 ? _this$originalMimeTyp : "").split("/").pop()) !== null && _split$pop !== void 0 ? _split$pop : "";
			const currentMimeType = (_split$pop2 = ((_this$mimeType = this.mimeType) !== null && _this$mimeType !== void 0 ? _this$mimeType : "").split("/").pop()) !== null && _split$pop2 !== void 0 ? _split$pop2 : "";
			return ((_this$changedMimeType = this.changedMimeTypeText) !== null && _this$changedMimeType !== void 0 ? _this$changedMimeType : this.$t("fkui.file-item.changed-mime-type.text", "(%before% ändrad till %after%)")).replace("%before%", originalMimeType).replace("%after%", currentMimeType);
		},
		iconName() {
			const { mimeType } = this;
			if (!mimeType) return DEFAULT_ICON;
			if (iconMap[mimeType]) return iconMap[mimeType];
			const wildcard = [mimeType.split("/", 1)[0], "*"].join("/");
			if (iconMap[wildcard]) return iconMap[wildcard];
			return DEFAULT_ICON;
		}
	}
});
var _hoisted_1$22 = { class: "file-item" };
var _hoisted_2$18 = { class: "file-item__row" };
var _hoisted_3$13 = ["id"];
var _hoisted_4$11 = { class: "file-item__file-name" };
	...
	return openBlock(), createElementBlock("div", _hoisted_1$22, [
		createBaseVNode("div", _hoisted_2$18, [
			createBaseVNode("a", mergeProps({
				...
				createVNode(_component_f_icon, { name: _ctx.iconName }, null, 8, ["name"]),
				_cache[0] || (_cache[0] = createTextVNode()),
				createBaseVNode("span", _hoisted_4$11, toDisplayString(_ctx.fileName), 1),
				_cache[1] || (_cache[1] = createTextVNode()),
				createBaseVNode("span", _hoisted_5$9, "\xA0" + toDisplayString(_ctx.$t("fkui.file-item.file-open", "öppnas i nytt fönster")), 1)
			], 16, _hoisted_3$13),
			_cache[2] || (_cache[2] = createTextVNode()),
		...
		renderSlot(_ctx.$slots, "default"),
		_cache[4] || (_cache[4] = createTextVNode()),
		_ctx.isMimeTypeChanged ? (openBlock(), createElementBlock("div", _hoisted_6$7, toDisplayString(_ctx.mimeTypeChangedText), 1)) : createCommentVNode("", true),
		_cache[5] || (_cache[5] = createTextVNode()),
		_cache[6] || (_cache[6] = createBaseVNode("hr", { class: "file-item__separator" }, null, -1))
	]);
}
var FFileItem_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FFileItem_vue_vue_type_script_lang_default, [["render", _sfc_render$16]]);
var FFileSelector_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FFileSelector",
	components: { FIcon: FIcon_default },
	inheritAttrs: false,
	props: {
	...
	computed: {
		attrs() {
			return {
				...
				id: this.id,
				onChange: (event) => {
					if (event.target instanceof HTMLInputElement) this.$emit("change", event.target.files);
				}
			};
		},
		labelClass() {
...
var _hoisted_1$21 = { class: "file-selector" };
var _hoisted_2$17 = [
	"id",
	"aria-labelledby",
	"aria-disabled"
];
var _hoisted_3$12 = ["id", "for"];
function _sfc_render$15(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$21, [
		...
		}, _ctx.attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClick && _ctx.onClick(...args)) }), null, 16, _hoisted_2$17),
		_cache[2] || (_cache[2] = createTextVNode()),
		createBaseVNode("label", {
			id: _ctx.labelId,
			role: "button",
...
var FFileSelector_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FFileSelector_vue_vue_type_script_lang_default, [["render", _sfc_render$15]]);
var anyType = [
	String,
	Object,
	Array,
...
var _hoisted_2$11 = {
	key: 0,
	class: "list__item list__item--empty"
};
...
var _hoisted_6$5 = { class: "list__item__selectpane__input" };
var _hoisted_7$3 = ["id"];
var _hoisted_8$2 = {
	key: 0,
	class: "list__item list__item--empty"
};
var _hoisted_9$2 = { class: "list__item__itempane" };
var FList_default = /* @__PURE__ */ defineComponent({
	__name: "FList",
	props: {
		items: {
			type: Array,
	...
	setup(__props, { emit: __emit }) {
		...
		const activeItem = /* @__PURE__ */ ref(void 0);
		...
		onMounted(() => {
			if (props.selectable && props.checkbox) {
				if (!slots.screenreader) throw new Error("Slot \"screenreader\" is required when having \"selectable\" & \"checkbox\" option.");
		...
		function updateVModelWithSelectedItems() {
			if (props.modelValue) emit("update:modelValue", selectedItems.value);
		}
		function updateSelectedItemsFromVModel() {
			if (Array.isArray(props.modelValue)) selectedItems.value = props.modelValue.filter((item) => {
				return includeItem(item, internalItems.value, internalKey);
			});
			else selectedItems.value = [];
		}
		function updateActiveItemFromVModel() {
			if (props.active === void 0) activeItem.value = void 0;
			else if (!itemEquals(props.active, activeItem.value, internalKey)) activeItem.value = props.active;
		}
		function dispatchPaginateDatasetEvent(type) {
			assertRef(ulElement);
			const event = new CustomEvent(`paginateDataset:${type}`, { bubbles: true });
		...
		function onItemFocus(event) {
			if (event?.target) event.target.style.position = "relative";
		}
		function onItemBlur(event) {
			if (event?.target) event.target.style.position = "static";
		}
		...
		function callbackBeforeItemDelete(item) {
			...
			if (targetIndex < 0 && internalItems.value.length > 1) targetIndex = 1;
		...
		return (_ctx, _cache) => {
			return !__props.selectable ? (openBlock(), createElementBlock("ul", _hoisted_1$15, [
				(openBlock(true), createElementBlock(Fragment, null, renderList(internalItems.value, (item) => {
					return openBlock(), createElementBlock("li", {
						key: itemKey(item),
						class: "list__item"
					}, [createBaseVNode("div", {
					...
					}, [renderSlot(_ctx.$slots, "default", mergeProps({ ref_for: true }, { item }))], 512)]);
				}), 128)),
				_cache[0] || (_cache[0] = createTextVNode()),
				isEmpty.value ? (openBlock(), createElementBlock("li", _hoisted_2$11, [createBaseVNode("div", _hoisted_3$7, [renderSlot(_ctx.$slots, "empty", {}, () => [createBaseVNode("em", null, toDisplayString(unref($t)("fkui.list.empty", "Listan är tom")), 1)])])])) : createCommentVNode("", true)
				...
				(openBlock(true), createElementBlock(Fragment, null, renderList(internalItems.value, (item, index) => {
					return openBlock(), createElementBlock("li", {
						...
						__props.checkbox ? (openBlock(), createElementBlock("div", {
						...
						}, [createBaseVNode("div", _hoisted_6$5, [createVNode(unref(FCheckboxField_default), {
							value: true,
							...
							default: withCtx(() => [createBaseVNode("span", {
								...
								class: "sr-only"
							}, [renderSlot(_ctx.$slots, "screenreader", mergeProps({ ref_for: true }, { item }))], 8, _hoisted_7$3)]),
							_: 2
						}, 1032, ["model-value", "onClick"])])], 8, _hoisted_5$6)) : createCommentVNode("", true),
						_cache[1] || (_cache[1] = createTextVNode()),
						(openBlock(), createBlock(resolveDynamicComponent(__props.checkbox ? "div" : "a"), {
							ref_for: true,
							ref: "listItemPanes",
							...
							default: withCtx(() => [renderSlot(_ctx.$slots, "default", mergeProps({ ref_for: true }, { item }))]),
							_: 2
						}, 1032, ["href", "onClick"]))
					], 42, _hoisted_4$6);
				}), 128)),
				_cache[2] || (_cache[2] = createTextVNode()),
				isEmpty.value ? (openBlock(), createElementBlock("li", _hoisted_8$2, [createBaseVNode("div", _hoisted_9$2, [renderSlot(_ctx.$slots, "empty", {}, () => [createBaseVNode("em", null, toDisplayString(unref($t)("fkui.list.empty", "Listan är tom")), 1)])])])) : createCommentVNode("", true)
			], 512));
		};
	}
});
...
var FMessageBox_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FMessageBox_vue_vue_type_script_lang_default, [["render", _sfc_render$8]]);
/**
...
var FNavigationMenu_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["selectedRoute", "update:route"],
	setup() {
		return { isMounted: /* @__PURE__ */ ref(false) };
	},
	data() {
		return {
			selectedItem: "",
	...
	computed: {
		items() {
			if (!this.routes || !Array.isArray(this.routes)) return [];
		...
		menuClasses() {
			return ["imenu", ...this.vertical ? ["imenu--vertical"] : ["imenu--horizontal"]];
		},
		popupItemClasses() {
			return [
				"imenu__popup-item__wrapper",
				"imenu__list__item",
				...this.overflowItemSelected ? ["imenu__list__item--highlight"] : []
			];
		},
		selectedItemSrText() {
			if (this.selectedMenuItemScreenReaderText === "") return this.$t("fkui.navigation-menu.current-page", "Aktuell sida");
			else return this.selectedMenuItemScreenReaderText;
		},
		popupLabel() {
		...
		popupMenuSelectedSrText() {
			if (this.menuMoreWithSelectedItemsScreenReaderText === "") return this.$t("fkui.navigation-menu.more-selection", "underliggande vald nu");
			else return this.menuMoreWithSelectedItemsScreenReaderText;
		}
	},
	watch: {
		route: {
	...
	methods: {
		itemClasses(item, index) {
			...
			return [
				"imenu__list__item",
				...item.key === this.selectedItem ? ["imenu__list__item--highlight"] : [],
				...hidden
			];
		},
		...
		getAnchor(index) {
			return this.getVisibleAnchors()[index];
		},
		findItemByKey(key) {
			return this.items.find((it) => it.key === key);
		},
		...
		selectItem(key) {
			if (key !== this.selectedItem) this.selectedItem = key;
			if (key !== this.route) {
		...
		async activateItem(index) {
			if (this.hasOverflow && index === this.overflowIndex) {
		...
		onPopupMenuItemSelected(key) {
			this.selectItem(key);
			if (key !== this.selectedItem) this.togglePopup(false);
		},
		togglePopup(open) {
			if (open) this.popupAnchor = getHTMLElementFromVueRef(this.$refs["popup-item"]);
			this.popupOpen = open;
		},
		async setFocusOnItem(index) {
			if (this.popupOpen) {
			...
			focus(this.getAnchor(index), { preventScroll: true });
		},
		async onResize() {
			if (!this.isMounted || this.vertical) return;
			...
			if (this.overflowIndex === foundOverflowIndex) return;
			...
			const offset = getAbsolutePosition(wrapper).x - firstHiddenItemRect.x;
		...
		async onKeyDown(event) {
			...
			const focusedIndex = anchors.indexOf(event.target);
			...
			if (tabPrev && firstItemFocused || tabNext && lastItemFocused) return;
			const action = actionFromKeyboardEvent(event);
			if (action === null) return;
			event.preventDefault();
...
var _hoisted_3$5 = { class: "imenu__list__anchor-container" };
var _hoisted_4$4 = [
	"data-ref-index",
	"href",
	"target"
...
var _hoisted_7$2 = { class: "imenu__list__anchor-container" };
		...
		createBaseVNode("ul", {
			...
			(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item, index) => {
				return openBlock(), createElementBlock("li", {
					...
					role: "menuitem"
				}, [_ctx.showItemSrText(index) ? (openBlock(), createElementBlock("span", _hoisted_5$4, [createBaseVNode("span", null, toDisplayString(_ctx.selectedItemSrText) + "\xA0", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$4)])], 10, _hoisted_2$7);
			}), 128)),
			_cache[6] || (_cache[6] = createTextVNode()),
			_ctx.hasOverflow ? (openBlock(), createElementBlock("li", _hoisted_6$3, [createBaseVNode("div", {
				ref: "popup-item",
				...
				createBaseVNode("span", _hoisted_9$1, [createBaseVNode("span", null, toDisplayString(_ctx.popupMenuSrText) + "\xA0", 1)]),
				createTextVNode(" " + toDisplayString(_ctx.popupLabel) + " ", 1),
				createVNode(_component_f_icon, {
					name: "arrow-down",
					class: "imenu__list__anchor-icon-right"
				})
			], 8, _hoisted_8$1)])], 2)])) : createCommentVNode("", true)
		], 32),
		_cache[7] || (_cache[7] = createTextVNode()),
		createVNode(_component_i_popup_menu, {
			ref: "popup-menu",
			...
			"is-open",
			"anchor",
			"selected-menu-item-screen-reader-text",
			"aria-label",
			"onSelect"
		])
	], 10, _hoisted_1$9);
...
var FPaginateDataset_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const dataFetchingInProgress = /* @__PURE__ */ ref(false);
		...
		const currentPageItems = computed(() => {
			if (fetchedData.value) return fetchedData.value;
			return toDataset(__props.items.slice(firstItemIndex.value, lastItemIndex.value), __props.items);
		});
		const currentPageItemLength = computed(() => currentPageItems.value.length);
		const numberOfPages = computed(() => Math.max(1, Math.ceil(numberOfItems.value / __props.itemsPerPage)));
		const numberOfItems = computed(() => __props.itemsLength > 0 ? __props.itemsLength : __props.items.length);
		onMounted(() => {
			refetchData();
		});
		...
		watch(numberOfPages, (newNumberOfPages) => {
			if (currentPage.value > newNumberOfPages) currentPage.value = newNumberOfPages;
		});
		async function refetchData() {
			try {
				dataFetchingInProgress.value = true;
				fetchedData.value = await __props.fetchData(firstItemIndex.value, lastItemIndex.value);
			} finally {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				"on:paginateDataset:previous": goToPreviousPage,
				"on:paginateDataset:next": goToNextPage,
...
function pageClasses(page, currentPage) {
	...
	if (page === currentPage) classes.push(`${rootClass}--active`);
	return classes;
}
function showPageNumberAsGap(options) {
	...
	*/
	const showGapToLastPage = pages.indexOf(page) === pages.length - 2 && page !== numberOfPages - 1;
...
var _hoisted_4$1 = { class: "paginator__page-counter" };
var _hoisted_5$1 = { class: "sr-only" };
var _hoisted_6$1 = { "aria-hidden": "" };
var _hoisted_7$1 = ["aria-label"];
var FPaginator_default = /* @__PURE__ */ defineComponent({
	__name: "FPaginator",
	props: {
		numberOfPages: { default: () => void 0 },
		currentPage: { default: () => void 0 },
		numberOfPagesToShow: { default: 9 },
		navigatorLabel: { default: () => void 0 }
	},
	setup(__props) {
		const resolvedNavigatorLabel = computed(() => {
			var _props$navigatorLabe;
			return (_props$navigatorLabe = __props.navigatorLabel) !== null && _props$navigatorLabe !== void 0 ? _props$navigatorLabe : $t("fkui.paginator.defaultNavigatorLabel", "Navigera mellan sidor");
		});
		const $t = useTranslate();
		const paginateDataset = inject(paginateDatasetKey, {
			currentPage: /* @__PURE__ */ ref(1),
			numberOfPages: /* @__PURE__ */ ref(1)
		});
		...
		const pages = computed(() => computePages({
			currentPage: currentPage.value,
			numberOfPages: numberOfPages.value,
			maxPagesShown: maxPagesShown$1.value
		}));
		...
		const pageCounterAriaLabel = computed(() => $t("fkui.paginator.page-counter-aria", "Sida {{ currentPage }} av {{ numberOfPages }}", {
			currentPage: currentPage.value,
			numberOfPages: numberOfPages.value
		}));
		const pageCounterLabel = computed(() => $t("fkui.paginator.page-counter", "{{ currentPage }} av {{ numberOfPages }}", {
			currentPage: currentPage.value,
			numberOfPages: numberOfPages.value
		}));
		function pageLabel(page) {
			...
			*/
			return $t("fkui.paginator.page-label", "Sida {{ page }}", { page });
		}
		function onClickPreviousButton() {
			assertRef(paginatorRef);
			paginatorRef.value.dispatchEvent(new CustomEvent(`paginateDataset:previous`, { bubbles: true }));
		}
		function onClickNextButton() {
			assertRef(paginatorRef);
			paginatorRef.value.dispatchEvent(new CustomEvent(`paginateDataset:next`, { bubbles: true }));
		}
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("nav", {
				...
				createBaseVNode("button", {
					...
					createVNode(unref(FIcon_default), { name: "chevrons-left" }),
					_cache[0] || (_cache[0] = createTextVNode()),
					createBaseVNode("span", null, toDisplayString(previousButtonLabel.value), 1)
				], 8, _hoisted_2$3),
				_cache[3] || (_cache[3] = createTextVNode()),
				(openBlock(true), createElementBlock(Fragment, null, renderList(pages.value, (page, index) => {
					return openBlock(), createElementBlock("button", {
						...
						"data-page": [
							page,
							page === 1 ? "first" : void 0,
							page === numberOfPages.value ? "last" : void 0
						].filter(Boolean).join(" "),
						type: "button",
				...
				createBaseVNode("div", _hoisted_4$1, [
					createBaseVNode("span", _hoisted_5$1, toDisplayString(pageCounterAriaLabel.value), 1),
					_cache[1] || (_cache[1] = createTextVNode()),
					createBaseVNode("span", _hoisted_6$1, toDisplayString(pageCounterLabel.value), 1)
				]),
				_cache[5] || (_cache[5] = createTextVNode()),
				createBaseVNode("button", {
					type: "button",
					...
					createBaseVNode("span", null, toDisplayString(nextButtonLabel.value), 1),
					_cache[2] || (_cache[2] = createTextVNode()),
					createVNode(unref(FIcon_default), { name: "arrow-right" })
				], 8, _hoisted_7$1)
			], 8, _hoisted_1$5);
		};
	}
});
var _hoisted_1$4 = { class: "progress" };
var _hoisted_2$2 = [
	"aria-label",
	"aria-valuenow",
	"aria-valuetext"
];
var _hoisted_3$1 = { class: "sr-only" };
var MIN_VALUE = 0;
var MAX_VALUE = 100;
var FProgressbar_default = /* @__PURE__ */ defineComponent({
	__name: "FProgressbar",
	props: {
		value: {
			type: Number,
	...
	setup(__props) {
		...
		const progressBarClass = computed(() => {
			if (progressValueNow.value === MIN_VALUE) return "progress__meter--pending";
			else if (progressValueNow.value === MAX_VALUE) return "progress__meter--finished";
			else return "progress__meter--inprogress";
		});
		const progressText = computed(() => {
			return props.valueText.replace("%VALUE%", progressValueNow.value.toString());
		});
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$4, [createBaseVNode("span", {
			...
			}, [createBaseVNode("span", _hoisted_3$1, toDisplayString(progressText.value), 1)], 14, _hoisted_2$2)]);
		};
	}
});
...
var FWizardStep_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		...
		async afterAnimation(open) {
			...
			const headerElement = getHTMLElementFromVueRef(this.$refs.header);
			await this.$nextTick();
			if (!index.isVisibleInViewport(headerElement)) await index.scrollTo(headerElement, {
				duration: SCROLL_DURATION,
				offset: 10
			});
...
var _hoisted_3$3 = { class: "wizard-step__icon-container" };
var _hoisted_4$2 = { class: "wizard-step__icon-container__circle" };
var _hoisted_5$2 = {
...
var _hoisted_8$3 = { class: "sr-only" };
	...
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("div", _hoisted_3$3, [
			createBaseVNode("div", _hoisted_4$2, [
				...
				_cache[3] || (_cache[3] = createTextVNode()),
				createBaseVNode("div", _hoisted_5$2, toDisplayString(_ctx.stepNumber), 1)
			]),
			_cache[4] || (_cache[4] = createTextVNode()),
			_cache[5] || (_cache[5] = createBaseVNode("div", { class: "wizard-step__icon-container__line-down" }, null, -1))
		]),
		_cache[12] || (_cache[12] = createTextVNode()),
		createBaseVNode("div", _hoisted_6$2, [(openBlock(), createBlock(resolveDynamicComponent(_ctx.inheritedProps.headerTag), { class: "wizard-step__header__title" }, {
			default: withCtx(() => [_ctx.showLink ? (openBlock(), createElementBlock("a", {
				...
				createBaseVNode("span", _hoisted_8$3, " \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.finished-step", "Avklarat steg")), 1)
			], 32)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
				createBaseVNode("span", _hoisted_9$3, toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0", 1),
				createTextVNode(" " + toDisplayString(_ctx.title) + " ", 1),
...
var App_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render$2]]);
//#endregion
...
//#endregion
//#region src/views/ComponentTestsModal.vue
var ComponentTestsModal_default = /* @__PURE__ */ defineComponent({
	__name: "ComponentTestsModal",
	props: { isOpen: { type: Boolean } },
	emits: [
		"cancel",
		"close",
	...
	setup(__props, { emit: __emit }) {
				...
				question: {
					...
					options: [{
						...
						question: {
							...
							userData: { label: "formA" }
						}
					}, {
						label: "Nej",
						question: {
							label: "Om din anställning",
							userData: { label: "formB" }
						}
					}]
				}
			};
		...
		const treeData = /* @__PURE__ */ ref(buildDialogTree());
		const value = /* @__PURE__ */ reactive({ organisationNumber: "" });
		const current = /* @__PURE__ */ ref({
			label: "",
			lastStep: true,
			steps: []
		});
		...
		const buttons = /* @__PURE__ */ ref(createInitialButtons());
		function onCancel() {
			emit("cancel");
		}
		...
		function onChange(event) {
			if (event.lastStep) {
				if (!buttons.value.some((b) => b.submitButton)) buttons.value.unshift({
					label: "Lägg till",
					type: "primary",
			...
			} else buttons.value = buttons.value.filter((b) => !b.submitButton);
		}
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createBlock(unref(FFormModal_default), {
				"is-open": __props.isOpen,
				value,
				...
				header: withCtx(() => [createTextVNode(toDisplayString(current.value.label), 1)]),
				"error-message": withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("Oj, du har glömt fylla i något. Gå till:", -1)])]),
				"input-text-fields": withCtx(() => [createVNode(unref(FDialogueTree_default), {
					modelValue: current.value,
					"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => current.value = $event),
					"dialogue-tree": treeData.value
				}, {
					default: withCtx(({ userData }) => [userData.label ? withDirectives((openBlock(), createBlock(unref(FOrganisationsnummerTextField_default), {
						key: 0,
						modelValue: value.organisationNumber,
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => value.organisationNumber = $event)
					}, null, 8, ["modelValue"])), [[
...
//#endregion
//#region src/views/SandboxFormModal.vue?vue&type=script&lang.ts
var SandboxFormModal_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
...
//#endregion
//#region src/views/SandboxFormModal.vue
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_form_modal, {
		...
		header: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode("Formulärsmodal", -1)])]),
		"error-message": withCtx(() => [..._cache[3] || (_cache[3] = [createTextVNode("Oj, du har glömt fylla i något. Gå till:", -1)])]),
		"input-text-fields": withCtx(() => [withDirectives((openBlock(), createBlock(_component_f_text_field, {
			modelValue: _ctx.value.field1,
			"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.value.field1 = $event)
		}, {
			default: withCtx(() => [..._cache[4] || (_cache[4] = [createTextVNode(" Fält 1 ", -1)])]),
			_: 1
		}, 8, ["modelValue"])), [[
			_directive_validation,
			{ maxLength: { length: 32 } },
			...
			default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode(" Fält 2 ", -1)])]),
			_: 1
		}, 8, ["modelValue"])), [[
			_directive_validation,
			{ maxLength: { length: 32 } },
...
var SandboxFormModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SandboxFormModal_vue_vue_type_script_lang_default, [["render", _sfc_render$1]]);
//#endregion
//#region src/views/ComponentTestsView.vue?vue&type=script&lang.ts
var ComponentTestsView_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FBadge: FBadge_default,
		FButton: FButton_default,
		FCalendar: FCalendar_default,
		FCalendarDay: FCalendarDay_default,
		FCard: FCard_default,
		FCheckboxField: FCheckboxField_default,
		FDatepickerField: FDatepickerField_default,
		FExpandablePanel: FExpandablePanel_default,
		FExpandableParagraph: FExpandableParagraph_default,
		FFieldset: FFieldset_default,
		FFileItem: FFileItem_default,
		FFileSelector: FFileSelector_default,
		FIcon: FIcon_default,
		FList: FList_default,
		FMessageBox: FMessageBox_default,
		FModal: FModal_default,
		FNavigationMenu: FNavigationMenu_default,
		FPaginateDataset: FPaginateDataset_default,
		FPaginator: FPaginator_default,
		FProgressbar: FProgressbar_default,
		FRadioField: FRadioField_default,
		FSelectField: FSelectField_default,
		FTextareaField: FTextareaField_default,
		FTextField: FTextField_default,
		FTooltip: FTooltip_default,
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default
	},
	setup() {
		const current = /* @__PURE__ */ ref("step7");
		const chips = /* @__PURE__ */ ref([]);
		const labelField = /* @__PURE__ */ ref("");
		const done = /* @__PURE__ */ ref(false);
		const calendarMonth = /* @__PURE__ */ shallowRef(FDate.fromIso("2026-03-01"));
		const calendarMin = /* @__PURE__ */ shallowRef(FDate.fromIso("2020-01-01"));
		const calendarMax = /* @__PURE__ */ shallowRef(FDate.fromIso("2030-12-31"));
	...
	data() {
		return {
			...
			inmatningCombobox: "",
			inmatningCheckboxes: [],
			inmatningCheckboxesBordered: [],
			inmatningRadio: void 0,
			inmatningRadioBordered: void 0,
			comboboxOptions: [
				"Albanien",
				"Belgien",
				"Danmark",
	...
	computed: {
		modalTypeLabel() {
			return {
				...
				form: "Formulärsmodal"
			}[this.modalSelectedType] ?? "Standard";
		},
		modalType() {
			return [
				"",
				...
				"warning",
				"error"
			].includes(this.modalSelectedType) ? this.modalSelectedType : "";
		}
	},
	methods: {
		onToggle() {
		...
		openModal() {
			this.modalResult = "";
			formModal(this, ComponentTestsModal_default).then((result) => {
				this.modalResult = result;
			}).catch(() => {});
		},
		async openSelectedModal() {
			if (this.modalSelectedType === "confirm") await confirmModal(this, {
				...
				this.modalResult = "";
				try {
					this.modalResult = await formModal(this, SandboxFormModal_default);
				} catch {}
...
//#endregion
//#region src/views/ComponentTestsView.vue
var _hoisted_1 = { class: "sandbox-root container" };
var _hoisted_2 = { class: "row" };
var _hoisted_3 = { class: "col col--md-9" };
var _hoisted_4 = { class: "badge-list" };
var _hoisted_5 = { class: "badge-list" };
var _hoisted_6 = { key: 0 };
var _hoisted_7 = { class: "section-spacing-bottom" };
var _hoisted_8 = { class: "section-spacing-bottom" };
var _hoisted_9 = { class: "section-spacing-bottom" };
var _hoisted_10 = { class: "row" };
var _hoisted_11 = { class: "col col--md-6" };
var _hoisted_12 = { class: "row" };
var _hoisted_13 = { class: "col col--md-6 section-spacing-bottom" };
var _hoisted_14 = { class: "section-spacing-bottom" };
var _hoisted_15 = { class: "row" };
var _hoisted_16 = { class: "col col--md-9" };
var _hoisted_17 = { class: "row" };
var _hoisted_18 = { class: "col col--md-9" };
var _hoisted_19 = { class: "row" };
var _hoisted_20 = { class: "col col--md-9 section-spacing-top" };
var _hoisted_21 = { class: "row" };
var _hoisted_22 = { class: "col col--md-9" };
var _hoisted_23 = { class: "button-row-list" };
var _hoisted_24 = { class: "button-row" };
var _hoisted_25 = { class: "button-row" };
var _hoisted_26 = { class: "button-row" };
var _hoisted_27 = { class: "button-row button-row--inverted" };
var _hoisted_28 = { class: "row" };
var _hoisted_29 = { class: "col col--md-9" };
var _hoisted_30 = { class: "button-group" };
var _hoisted_31 = { class: "section-spacing-top" };
...
var _hoisted_36 = { class: "col col--md-9" };
var _hoisted_37 = { class: "row section-spacing-top" };
var _hoisted_38 = { class: "col col--md-6" };
var _hoisted_39 = { class: "row" };
var _hoisted_40 = { class: "col col--md-6" };
var _hoisted_41 = { class: "section-spacing" };
var _hoisted_42 = {
	key: 0,
	class: "result-spacing"
};
var _hoisted_43 = { key: 0 };
var _hoisted_44 = { class: "button-group" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_badge = resolveComponent("f-badge");
	...
	const _component_f_expandable_paragraph = resolveComponent("f-expandable-paragraph");
	const _component_f_file_selector = resolveComponent("f-file-selector");
	const _component_f_progressbar = resolveComponent("f-progressbar");
	const _component_f_file_item = resolveComponent("f-file-item");
	...
	const _component_f_paginator = resolveComponent("f-paginator");
	const _component_f_paginate_dataset = resolveComponent("f-paginate-dataset");
	const _component_f_navigation_menu = resolveComponent("f-navigation-menu");
	const _component_f_wizard = resolveComponent("f-wizard");
	const _component_f_modal = resolveComponent("f-modal");
	const _directive_validation = resolveDirective("validation");
	return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", null, [_cache[126] || (_cache[126] = createBaseVNode("header", { class: "fk-header" }, [createBaseVNode("div", { class: "fk-header__inner" }, [createBaseVNode("a", {
		...
		default: withCtx(() => [
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_4, [
					createVNode(_component_f_badge, null, {
						default: withCtx(() => [..._cache[28] || (_cache[28] = [createTextVNode("Standard", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, { status: "info" }, {
						default: withCtx(() => [..._cache[29] || (_cache[29] = [createTextVNode("Info", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, { status: "success" }, {
						default: withCtx(() => [..._cache[30] || (_cache[30] = [createTextVNode("Success", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, { status: "warning" }, {
						default: withCtx(() => [..._cache[31] || (_cache[31] = [createTextVNode("Varning", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, { status: "error" }, {
						default: withCtx(() => [..._cache[32] || (_cache[32] = [createTextVNode("Fel", -1)])]),
						_: 1
					})
				]), createBaseVNode("div", _hoisted_5, [
					createVNode(_component_f_badge, { inverted: "" }, {
						default: withCtx(() => [..._cache[33] || (_cache[33] = [createTextVNode("Standard", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, {
						status: "info",
						inverted: ""
					}, {
						default: withCtx(() => [..._cache[34] || (_cache[34] = [createTextVNode("Info", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, {
						status: "success",
						...
						default: withCtx(() => [..._cache[35] || (_cache[35] = [createTextVNode("Success", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, {
						status: "warning",
						...
						default: withCtx(() => [..._cache[36] || (_cache[36] = [createTextVNode("Varning", -1)])]),
						_: 1
					}),
					createVNode(_component_f_badge, {
						status: "error",
						...
						default: withCtx(() => [..._cache[37] || (_cache[37] = [createTextVNode("Fel", -1)])]),
						_: 1
					})
				])]),
				_: 1
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createVNode(_component_f_fieldset, {
					name: "chips",
					chip: "",
					horizontal: ""
				}, {
					label: withCtx(() => [..._cache[38] || (_cache[38] = [createTextVNode("Välj alternativ", -1)])]),
					default: withCtx(() => [
						createVNode(_component_f_checkbox_field, {
							modelValue: _ctx.chips,
							"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.chips = $event),
							value: "chip1"
						}, {
							default: withCtx(() => [..._cache[39] || (_cache[39] = [createTextVNode("Chip 1", -1)])]),
							_: 1
						}, 8, ["modelValue"]),
						createVNode(_component_f_checkbox_field, {
							modelValue: _ctx.chips,
							"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.chips = $event),
							value: "chip2"
						}, {
							default: withCtx(() => [..._cache[40] || (_cache[40] = [createTextVNode("Chip 2", -1)])]),
							_: 1
						}, 8, ["modelValue"]),
						createVNode(_component_f_checkbox_field, {
							modelValue: _ctx.chips,
							"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.chips = $event),
							value: "chip3"
						}, {
							default: withCtx(() => [..._cache[41] || (_cache[41] = [createTextVNode("Chip 3", -1)])]),
							_: 1
						}, 8, ["modelValue"]),
						createVNode(_component_f_checkbox_field, {
							modelValue: _ctx.chips,
							"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.chips = $event),
							value: "chip4",
							disabled: ""
						}, {
							default: withCtx(() => [..._cache[42] || (_cache[42] = [createTextVNode("Chip 4", -1)])]),
							_: 1
						}, 8, ["modelValue"])
					]),
					_: 1
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createVNode(_component_f_button, {
					variant: "secondary",
					"icon-left": "plus",
					onClick: _ctx.openModal
				}, {
					default: withCtx(() => [..._cache[43] || (_cache[43] = [createTextVNode(" Öppna modal ", -1)])]),
					_: 1
				}, 8, ["onClick"]), _ctx.modalResult ? (openBlock(), createElementBlock("pre", _hoisted_6, "Resultat: " + toDisplayString(_ctx.modalResult), 1)) : createCommentVNode("", true)]),
				_: 1
			}),
			createVNode(_component_f_wizard_step, {
				key: "step4",
				...
				default: withCtx(() => [withDirectives((openBlock(), createBlock(_component_f_text_field, {
					modelValue: _ctx.labelField,
					"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.labelField = $event),
					"input-width": "md-6"
				}, {
					default: withCtx(() => [..._cache[44] || (_cache[44] = [createTextVNode("Etikett", -1)])]),
					tooltip: withCtx(() => [createVNode(_component_f_tooltip, {
						"screen-reader-text": "Läs mer om fältet",
						"header-tag": "h2"
					}, {
						header: withCtx(() => [..._cache[45] || (_cache[45] = [createTextVNode("Rubrik", -1)])]),
						body: withCtx(() => [..._cache[46] || (_cache[46] = [createTextVNode("Här kan du läsa mer om vad fältet är till för.", -1)])]),
						_: 1
					})]),
					description: withCtx(({ descriptionClass, formatDescriptionClass }) => [createBaseVNode("span", { class: normalizeClass(descriptionClass) }, "Hjälptext", 2), createBaseVNode("span", { class: normalizeClass(formatDescriptionClass) }, "Formatbeskrivning", 2)]),
					_: 1
				}, 8, ["modelValue"])), [[
					_directive_validation,
					void 0,
			...
			createVNode(_component_f_wizard_step, {
				key: "step5",
				"use-error-list": false,
				title: "Expanderbara ytor"
			}, {
				default: withCtx(() => [createVNode(_component_f_expandable_panel, {
					expanded: _ctx.expanded,
					onToggle: _ctx.onToggle
				}, {
					title: withCtx(() => [..._cache[47] || (_cache[47] = [createTextVNode("Titel", -1)])]),
					default: withCtx(() => [..._cache[48] || (_cache[48] = [createBaseVNode("p", null, "Innehåll i den expanderbara panelen.", -1)])]),
					_: 1
				}, 8, ["expanded", "onToggle"]), createVNode(_component_f_expandable_paragraph, {
					expanded: _ctx.expandedParagraph,
					"header-tag": "span",
					onToggle: _ctx.onToggleParagraph
				}, {
					title: withCtx(() => [..._cache[49] || (_cache[49] = [createTextVNode("Titel", -1)])]),
					default: withCtx(() => [..._cache[50] || (_cache[50] = [createBaseVNode("span", null, "Innehåll i det expanderbara stycket.", -1)])]),
					_: 1
				}, 8, ["expanded", "onToggle"])]),
				_: 1
			}),
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createVNode(_component_f_file_selector, { accept: "application/pdf, image/jpeg, image/png" }, {
					default: withCtx(() => [..._cache[51] || (_cache[51] = [createTextVNode(" Lägg till fil ", -1)])]),
					_: 1
				}), createVNode(_component_f_file_item, {
					"file-name": "exempel.pdf",
					"mime-type": "application/pdf"
				}, {
					default: withCtx(() => [createVNode(_component_f_progressbar, {
			...
			createVNode(_component_f_wizard_step, {
				key: "step8",
				"use-error-list": false,
				title: "Inmatningskomponenter"
			}, {
				default: withCtx(() => [
					withDirectives((openBlock(), createBlock(_component_f_text_field, { "input-width": "md-6" }, {
						default: withCtx(() => [..._cache[52] || (_cache[52] = [createTextVNode("Inmatningsfält", -1)])]),
						_: 1
					})), [[
						_directive_validation,
						void 0,
					...
					createBaseVNode("div", _hoisted_7, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						"input-width": "md-6",
						disabled: ""
					}, {
						default: withCtx(() => [..._cache[53] || (_cache[53] = [createTextVNode("Inmatningsfält - inaktiverat", -1)])]),
						_: 1
					})), [[
						_directive_validation,
						void 0,
					...
					withDirectives((openBlock(), createBlock(_component_f_datepicker_field, {
						modelValue: _ctx.inmatningDate,
						"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.inmatningDate = $event),
						"input-width": "md-6",
						"year-selector": ""
					}, {
						default: withCtx(() => [..._cache[54] || (_cache[54] = [createTextVNode("Datum", -1)])]),
						_: 1
					}, 8, ["modelValue"])), [[
						_directive_validation,
						{
					...
					createBaseVNode("div", _hoisted_8, [createVNode(_component_f_datepicker_field, {
						modelValue: _ctx.inmatningDateDisabled,
						"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.inmatningDateDisabled = $event),
						"input-width": "md-6",
						disabled: ""
					}, {
						default: withCtx(() => [..._cache[55] || (_cache[55] = [createTextVNode("Datum - inaktiverat", -1)])]),
						_: 1
					}, 8, ["modelValue"])]),
					createVNode(_component_f_select_field, {
						modelValue: _ctx.inmatningSelect,
						"onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => _ctx.inmatningSelect = $event),
						"select-width": "md-6"
					}, {
						label: withCtx(() => [..._cache[56] || (_cache[56] = [createTextVNode("Dropplista", -1)])]),
						default: withCtx(() => [
							_cache[57] || (_cache[57] = createBaseVNode("option", { value: "" }, "Välj", -1)),
							_cache[58] || (_cache[58] = createBaseVNode("option", { value: "1" }, "Alternativ 1", -1)),
							_cache[59] || (_cache[59] = createBaseVNode("option", { value: "2" }, "Alternativ 2", -1)),
							_cache[60] || (_cache[60] = createBaseVNode("option", { value: "3" }, "Alternativ 3", -1))
						]),
						_: 1
					}, 8, ["modelValue"]),
					createBaseVNode("div", _hoisted_9, [createVNode(_component_f_select_field, {
						"select-width": "md-6",
						disabled: ""
					}, {
						label: withCtx(() => [..._cache[61] || (_cache[61] = [createTextVNode("Dropplista - inaktiverad", -1)])]),
						default: withCtx(() => [
							_cache[62] || (_cache[62] = createBaseVNode("option", { value: "" }, "Välj", -1)),
							_cache[63] || (_cache[63] = createBaseVNode("option", { value: "1" }, "Alternativ 1", -1)),
							_cache[64] || (_cache[64] = createBaseVNode("option", { value: "2" }, "Alternativ 2", -1)),
							_cache[65] || (_cache[65] = createBaseVNode("option", { value: "3" }, "Alternativ 3", -1))
						]),
						_: 1
					})]),
					createBaseVNode("div", _hoisted_10, [createBaseVNode("div", _hoisted_11, [createVNode(_component_f_textarea_field, {
						modelValue: _ctx.about,
						"onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => _ctx.about = $event),
						maxlength: 100,
						"soft-limit": 20,
						resizable: ""
					}, {
						default: withCtx(() => [..._cache[66] || (_cache[66] = [createTextVNode("Flerradigt inmatningsfält", -1)])]),
						description: withCtx(({ formatDescriptionClass }) => [createBaseVNode("span", { class: normalizeClass(formatDescriptionClass) }, "(max 100 tecken)", 2)]),
						_: 1
					}, 8, ["modelValue"])])]),
					createBaseVNode("div", _hoisted_12, [createBaseVNode("div", _hoisted_13, [createVNode(_component_f_textarea_field, { disabled: "" }, {
						default: withCtx(() => [..._cache[67] || (_cache[67] = [createTextVNode("Flerradigt inmatningsfält - inaktiverat", -1)])]),
						_: 1
					})])]),
					withDirectives((openBlock(), createBlock(_component_f_text_field, {
						modelValue: _ctx.inmatningCombobox,
						"onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => _ctx.inmatningCombobox = $event),
						options: _ctx.comboboxOptions,
						"input-width": "md-6"
					}, {
						default: withCtx(() => [..._cache[68] || (_cache[68] = [createTextVNode("Kombobox", -1)])]),
						_: 1
					...
					createBaseVNode("div", _hoisted_14, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						options: _ctx.comboboxOptions,
						"input-width": "md-6",
						disabled: ""
					}, {
						default: withCtx(() => [..._cache[69] || (_cache[69] = [createTextVNode("Kombobox - inaktiverad", -1)])]),
						_: 1
					}, 8, ["options"])), [[
						_directive_validation,
						void 0,
					...
					createBaseVNode("div", _hoisted_15, [createBaseVNode("div", _hoisted_16, [createVNode(_component_f_fieldset, { name: "inmatning-checkboxes" }, {
						label: withCtx(() => [..._cache[70] || (_cache[70] = [createTextVNode("Kryssrutor", -1)])]),
						default: withCtx(() => [
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxes,
								"onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => _ctx.inmatningCheckboxes = $event),
								value: "1"
							}, {
								default: withCtx(() => [..._cache[71] || (_cache[71] = [createTextVNode("Alternativ 1", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxes,
								"onUpdate:modelValue": _cache[11] || (_cache[11] = ($event) => _ctx.inmatningCheckboxes = $event),
								value: "2"
							}, {
								default: withCtx(() => [..._cache[72] || (_cache[72] = [createTextVNode("Alternativ 2", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxes,
								"onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => _ctx.inmatningCheckboxes = $event),
								value: "3",
								disabled: ""
							}, {
								default: withCtx(() => [..._cache[73] || (_cache[73] = [createTextVNode("Alternativ 3", -1)])]),
								_: 1
							}, 8, ["modelValue"])
						]),
						_: 1
					})])]),
					createBaseVNode("div", _hoisted_17, [createBaseVNode("div", _hoisted_18, [createVNode(_component_f_fieldset, {
						name: "inmatning-checkboxes-bordered",
						border: "",
						"show-details": "always"
					}, {
						label: withCtx(() => [..._cache[74] || (_cache[74] = [createTextVNode("Kryssrutor med ram och utökad label", -1)])]),
						default: withCtx(() => [
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxesBordered,
								"onUpdate:modelValue": _cache[13] || (_cache[13] = ($event) => _ctx.inmatningCheckboxesBordered = $event),
								value: "1"
							}, {
								default: withCtx(() => [..._cache[75] || (_cache[75] = [createTextVNode("Alternativ 1", -1)])]),
								details: withCtx(() => [..._cache[76] || (_cache[76] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxesBordered,
								"onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => _ctx.inmatningCheckboxesBordered = $event),
								value: "2"
							}, {
								default: withCtx(() => [..._cache[77] || (_cache[77] = [createTextVNode("Alternativ 2", -1)])]),
								details: withCtx(() => [..._cache[78] || (_cache[78] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_checkbox_field, {
								modelValue: _ctx.inmatningCheckboxesBordered,
								"onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => _ctx.inmatningCheckboxesBordered = $event),
								value: "3"
							}, {
								default: withCtx(() => [..._cache[79] || (_cache[79] = [createTextVNode("Alternativ 3", -1)])]),
								details: withCtx(() => [..._cache[80] || (_cache[80] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"])
						]),
						_: 1
					})])]),
					createBaseVNode("div", _hoisted_19, [createBaseVNode("div", _hoisted_20, [createVNode(_component_f_fieldset, { name: "inmatning-radio" }, {
						label: withCtx(() => [..._cache[81] || (_cache[81] = [createTextVNode("Radioknappar", -1)])]),
						default: withCtx(() => [
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadio,
								"onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => _ctx.inmatningRadio = $event),
								value: "1"
							}, {
								default: withCtx(() => [..._cache[82] || (_cache[82] = [createTextVNode("Alternativ 1", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadio,
								"onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => _ctx.inmatningRadio = $event),
								value: "2"
							}, {
								default: withCtx(() => [..._cache[83] || (_cache[83] = [createTextVNode("Alternativ 2", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadio,
								"onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => _ctx.inmatningRadio = $event),
								value: "3",
								disabled: ""
							}, {
								default: withCtx(() => [..._cache[84] || (_cache[84] = [createTextVNode("Alternativ 3", -1)])]),
								_: 1
							}, 8, ["modelValue"])
						]),
						_: 1
					})])]),
					createBaseVNode("div", _hoisted_21, [createBaseVNode("div", _hoisted_22, [createVNode(_component_f_fieldset, {
						name: "inmatning-radio-bordered",
						border: "",
						"show-details": "always"
					}, {
						label: withCtx(() => [..._cache[85] || (_cache[85] = [createTextVNode("Radioknappar med ram och utökad label", -1)])]),
						default: withCtx(() => [
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadioBordered,
								"onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => _ctx.inmatningRadioBordered = $event),
								value: "1"
							}, {
								default: withCtx(() => [..._cache[86] || (_cache[86] = [createTextVNode("Alternativ 1", -1)])]),
								details: withCtx(() => [..._cache[87] || (_cache[87] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadioBordered,
								"onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => _ctx.inmatningRadioBordered = $event),
								value: "2"
							}, {
								default: withCtx(() => [..._cache[88] || (_cache[88] = [createTextVNode("Alternativ 2", -1)])]),
								details: withCtx(() => [..._cache[89] || (_cache[89] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"]),
							createVNode(_component_f_radio_field, {
								modelValue: _ctx.inmatningRadioBordered,
								"onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => _ctx.inmatningRadioBordered = $event),
								value: "3"
							}, {
								default: withCtx(() => [..._cache[90] || (_cache[90] = [createTextVNode("Alternativ 3", -1)])]),
								details: withCtx(() => [..._cache[91] || (_cache[91] = [createTextVNode("Hjälptext", -1)])]),
								_: 1
							}, 8, ["modelValue"])
						]),
						_: 1
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createVNode(_component_f_calendar, {
					modelValue: _ctx.calendarMonth,
					"onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => _ctx.calendarMonth = $event),
					"min-date": _ctx.calendarMin,
					"max-date": _ctx.calendarMax,
					"year-selector": ""
				}, {
					default: withCtx(({ date, isFocused }) => [createVNode(_component_f_calendar_day, {
						day: date,
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_23, [
					createBaseVNode("div", _hoisted_24, [
						createVNode(_component_f_button, {
							...
							default: withCtx(() => [..._cache[92] || (_cache[92] = [createTextVNode("Primär", -1)])]),
							_: 1
						}),
						createVNode(_component_f_button, {
							size: "medium",
							...
							default: withCtx(() => [..._cache[93] || (_cache[93] = [createTextVNode("Sekundär", -1)])]),
							_: 1
						}),
						createVNode(_component_f_button, {
							size: "medium",
							...
							default: withCtx(() => [..._cache[94] || (_cache[94] = [createTextVNode("Disabled", -1)])]),
							_: 1
						})
					]),
					createBaseVNode("div", _hoisted_25, [createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						"icon-left": "plus",
						"align-text": ""
					}, {
						default: withCtx(() => [..._cache[95] || (_cache[95] = [createTextVNode("Tertiär", -1)])]),
						_: 1
					}), createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						...
						default: withCtx(() => [..._cache[96] || (_cache[96] = [createTextVNode("Tertiär understruken", -1)])]),
						_: 1
					})]),
					createBaseVNode("div", _hoisted_26, [createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						...
						default: withCtx(() => [..._cache[97] || (_cache[97] = [createTextVNode("Tertiär svart", -1)])]),
						_: 1
					}), createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						...
						default: withCtx(() => [..._cache[98] || (_cache[98] = [createTextVNode("Tertiär understruken svart", -1)])]),
						_: 1
					})]),
					createBaseVNode("div", _hoisted_27, [createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						...
						default: withCtx(() => [..._cache[99] || (_cache[99] = [createTextVNode("Tertiär inverterad", -1)])]),
						_: 1
					}), createVNode(_component_f_button, {
						size: "medium",
						variant: "tertiary",
						...
						default: withCtx(() => [..._cache[100] || (_cache[100] = [createTextVNode("Tertiär understruken inverterad", -1)])]),
						_: 1
					})])
				])]),
				_: 1
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_28, [createBaseVNode("div", _hoisted_29, [createVNode(_component_f_card, null, {
					header: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, "Arbete", 2)]),
					default: withCtx(() => [..._cache[101] || (_cache[101] = [
						createBaseVNode("p", null, "Arbetsgivare", -1),
						createBaseVNode("p", null, [
							createTextVNode(" Gatan 1 "),
							createBaseVNode("br"),
							createTextVNode(" 123 45 Staden "),
							createBaseVNode("br"),
							createTextVNode(" Sverige ")
						], -1),
						createBaseVNode("p", null, [createBaseVNode("label", { class: "label" }, " Telefonnummer "), createBaseVNode("span", null, " 0109999999 ")], -1)
					])]),
					footer: withCtx(() => [createBaseVNode("div", _hoisted_30, [createVNode(_component_f_button, {
						variant: "tertiary",
						"align-text": "",
						class: "button-group__item",
						"icon-left": "trashcan"
					}, {
						default: withCtx(() => [..._cache[102] || (_cache[102] = [createTextVNode(" Ta bort ", -1)])]),
						_: 1
					}), createVNode(_component_f_button, {
						variant: "tertiary",
						"align-text": "",
						...
						default: withCtx(() => [..._cache[103] || (_cache[103] = [createTextVNode(" Ändra ", -1)])]),
						_: 1
					})])]),
					_: 1
				})])])]),
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [_cache[106] || (_cache[106] = createBaseVNode("div", { class: "link-row" }, [createBaseVNode("a", {
					class: "anchor",
					href: "#"
				}, "En länk"), createBaseVNode("a", {
					class: "anchor anchor--discrete",
					href: "#"
				}, "En diskret länk")], -1)), createBaseVNode("div", _hoisted_31, [createBaseVNode("div", _hoisted_32, [createBaseVNode("div", _hoisted_33, [createBaseVNode("a", _hoisted_34, [
					_cache[104] || (_cache[104] = createTextVNode(" Ansök om hundbidrag ", -1)),
					_cache[105] || (_cache[105] = createBaseVNode("span", { class: "sr-only" }, " Till tjänsten ansök om hundbidrag ", -1)),
					createVNode(_component_f_icon, {
						name: "arrow-right",
			...
			createVNode(_component_f_wizard_step, {
				key: "step13",
				"use-error-list": false,
				title: "Meddelanderutor"
			}, {
				default: withCtx(() => [createBaseVNode("div", _hoisted_35, [createBaseVNode("div", _hoisted_36, [
					createVNode(_component_f_message_box, { type: "info" }, {
						default: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, "Information", 2), _cache[107] || (_cache[107] = createBaseVNode("p", null, "Det här är ett informationsmeddelande med lite mer text.", -1))]),
						_: 1
					}),
					createVNode(_component_f_message_box, { type: "warning" }, {
						default: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, "Varning", 2), _cache[108] || (_cache[108] = createBaseVNode("p", null, "Det här är ett varningsmeddelande med lite mer text.", -1))]),
						_: 1
					}),
					createVNode(_component_f_message_box, { type: "error" }, {
						default: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, "Fel", 2), _cache[109] || (_cache[109] = createBaseVNode("p", null, "Det här är ett felmeddelande med lite mer text.", -1))]),
						_: 1
					}),
					createVNode(_component_f_message_box, { type: "success" }, {
						default: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, "Klart", 2), _cache[110] || (_cache[110] = createBaseVNode("p", null, "Det här är ett bekräftelsemeddelande med lite mer text.", -1))]),
						_: 1
					})
				])]), createBaseVNode("div", _hoisted_37, [createBaseVNode("div", _hoisted_38, [
					createVNode(_component_f_message_box, {
						type: "info",
						layout: "short"
					}, {
						default: withCtx(() => [..._cache[111] || (_cache[111] = [createTextVNode("Kort informationsmeddelande.", -1)])]),
						_: 1
					}),
					createVNode(_component_f_message_box, {
						type: "warning",
						...
						default: withCtx(() => [..._cache[112] || (_cache[112] = [createTextVNode("Kort varningsmeddelande.", -1)])]),
						_: 1
					}),
					createVNode(_component_f_message_box, {
						type: "error",
						...
						default: withCtx(() => [..._cache[113] || (_cache[113] = [createTextVNode("Kort felmeddelande.", -1)])]),
						_: 1
					}),
					createVNode(_component_f_message_box, {
						type: "success",
						...
						default: withCtx(() => [..._cache[114] || (_cache[114] = [createTextVNode("Kort bekräftelsemeddelande.", -1)])]),
						_: 1
					})
				])])]),
				_: 1
			...
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createBaseVNode("div", _hoisted_39, [createBaseVNode("div", _hoisted_40, [createVNode(_component_f_select_field, {
					id: "modal-type-select",
					modelValue: _ctx.modalSelectedType,
					"onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => _ctx.modalSelectedType = $event)
				}, {
					label: withCtx(() => [..._cache[115] || (_cache[115] = [createTextVNode("Välj variant", -1)])]),
					default: withCtx(() => [
						_cache[116] || (_cache[116] = createBaseVNode("option", { value: "" }, "Standard", -1)),
						_cache[117] || (_cache[117] = createBaseVNode("option", { value: "information" }, "Info", -1)),
						_cache[118] || (_cache[118] = createBaseVNode("option", { value: "warning" }, "Varning", -1)),
						_cache[119] || (_cache[119] = createBaseVNode("option", { value: "error" }, "Fel", -1)),
						_cache[120] || (_cache[120] = createBaseVNode("option", { value: "confirm" }, "Bekräftelsemodal", -1)),
						_cache[121] || (_cache[121] = createBaseVNode("option", { value: "form" }, "Formulärsmodal", -1))
					]),
					_: 1
				}, 8, ["modelValue"])])]), createBaseVNode("div", _hoisted_41, [createVNode(_component_f_button, {
					size: "medium",
					variant: "secondary",
					onClick: _cache[24] || (_cache[24] = () => {
						_ctx.openSelectedModal();
					})
				}, {
					default: withCtx(() => [..._cache[122] || (_cache[122] = [createTextVNode("Öppna modal", -1)])]),
					_: 1
				}), _ctx.modalResult && _ctx.modalSelectedType === "form" ? (openBlock(), createElementBlock("div", _hoisted_42, [_cache[123] || (_cache[123] = createBaseVNode("pre", null, "Modalen stängdes med resultatet:", -1)), createBaseVNode("pre", null, toDisplayString(_ctx.modalResult), 1)])) : createCommentVNode("", true)])]),
				_: 1
			}),
			createVNode(_component_f_wizard_step, {
				key: "step15",
				...
				default: withCtx(() => [createVNode(_component_f_paginate_dataset, {
					items: _ctx.rows,
					"items-per-page": 4
				}, {
					default: withCtx(({ items: currentPageItems }) => [createVNode(_component_f_list, {
						items: currentPageItems,
						"key-attribute": "id"
					}, {
						default: withCtx(({ item }) => [createBaseVNode("h6", null, toDisplayString(item.name) + " (" + toDisplayString(item.id) + ")", 1)]),
						_: 1
					}, 8, ["items"]), createVNode(_component_f_paginator, { "navigator-label": "Navigera mellan personer" })]),
					_: 1
				}, 8, ["items"])]),
				_: 1
			}),
			createVNode(_component_f_wizard_step, {
				...
				default: withCtx(() => [createVNode(_component_f_navigation_menu, {
			...
			createVNode(_component_f_wizard_step, {
				...
				"next-button-text": withCtx(() => [..._cache[124] || (_cache[124] = [createTextVNode("Klar", -1)])]),
				_: 1
			})
		]),
		_: 1
	}, 8, ["modelValue", "onCompleted"]), _ctx.done ? (openBlock(), createElementBlock("p", _hoisted_43, "Wizarden är klar!")) : createCommentVNode("", true)])])])]), !["confirm", "form"].includes(_ctx.modalSelectedType) ? (openBlock(), createBlock(_component_f_modal, {
		key: 0,
		"is-open": _ctx.modalIsOpen,
		type: _ctx.modalType,
		onClose: _cache[27] || (_cache[27] = ($event) => _ctx.modalIsOpen = false)
	}, {
		header: withCtx(() => [createTextVNode(toDisplayString(_ctx.modalTypeLabel), 1)]),
		content: withCtx(() => [createBaseVNode("p", null, "Det här är innehållet i en modal av typen " + toDisplayString(_ctx.modalTypeLabel.toLowerCase()) + ".", 1)]),
		footer: withCtx(() => [createBaseVNode("div", _hoisted_44, [createBaseVNode("button", {
			type: "button",
			class: "button button--primary button-group__item button--large",
			onClick: _cache[26] || (_cache[26] = ($event) => _ctx.modalIsOpen = false)
		}, " Stäng ")])]),
		_: 1
	}, 8, ["is-open", "type"])) : createCommentVNode("", true)], 64);
}
var ComponentTestsView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ComponentTestsView_vue_vue_type_script_lang_default, [["render", _sfc_render], ["__scopeId", "data-v-ab814acf"]]);
//#endregion
...
var router = createRouter({
	...
	routes: [{
		path: "/",
		component: ComponentTestsView_default
	}]
});
//#endregion
//#region src/main.ts
