...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-56d1de.js
...
function useSelectable(options) {
  ...
  function toggleSelectableHeader() {
    if (toValue2(rows2).length === 0) {
      headerState.value = headerState.value !== true;
      return;
    }
    if (headerState.value !== true) selectedRows.value = [...toValue2(rows2)];
