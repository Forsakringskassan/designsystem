...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-840e4e.js
...
exampleComponent.__scopeId = "data-v-840e4e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-840e4e"
});
export {
  render
};
