...
// virtual-entry:virtual:src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-9de85c.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    columnsTemplate() {
      return `:columns="${this.hasRowHeader ? "columnsWithHeader" : "columnsDefault"}"`;
    },
    stripedTemplate() {
      ...
      return (
        ...
        `
                <f-table
                    ...
                    key-attribute="id"
                    ${this.stripedTemplate}
                    ${this.selectableTemplate}
      ...
      _createVNode(_component_f_fieldset, { name: "interaktion" }, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_f_select_field, {
            ...
            onChange: _cache[4] || (_cache[4] = ($event) => _ctx.selectedRows = [])
          }, {
