...
var Mo = class ss {
  ...
  _consumeCdata(t) {
    ...
    this._addToParent(new Bi(n, new h(t.sourceSpan.start, (i || r).sourceSpan.end), [r]));
  }
  _consumeComment(t) {
...
`) {
  ...
  _consumeElementStartTag(t) {
    ...
    let c = this._peek.sourceSpan.fullStart, u = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), p = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart), d = new h(t.sourceSpan.start.moveBy(1), t.sourceSpan.end), S2 = new re(s, n, i, [], o, u, p, void 0, d, a?.isVoid ?? false), m = this._getContainer(), g = m !== null && !!(!((r = this._getTagDefinition(m)) === null || r === void 0) && r.isClosedByChild(S2.name));
  ...
  _consumeComponentStartTag(t) {
    ...
    this._advance();
    let p = this._peek.sourceSpan.fullStart, d = new h(t.sourceSpan.start, p, t.sourceSpan.fullStart), S2 = new h(t.sourceSpan.start, p, t.sourceSpan.fullStart), m = new Q(n, o, c, i, s, [], u, d, S2, void 0), g = this._getContainer(), E = g !== null && m.tagName !== null && !!(!((r = this._getTagDefinition(g)) === null || r === void 0) && r.isClosedByChild(m.tagName));
...
function ol(e) {
  if (e.kind === "block") {
    ...
    e.parameters = { kind: "angularControlFlowBlockParameters", children: e.parameters, sourceSpan: new h(e.parameters[0].sourceSpan.start, B(0, e.parameters, -1).sourceSpan.end) };
  }
}
function ll(e) {
...
function Xr(e, t, r, n = {}) {
  let { frontMatter: i, content: s } = r.shouldParseFrontMatter ? cr(e) : { content: e }, a = new pt(e, n.filepath), o = new Fe(a, 0, 0, 0), c = o.moveBy(e.length), { parseOptions: u, rootNodes: p } = t(s, r), d = { kind: "root", sourceSpan: new h(o, c), children: p }, S2;
  if (i) {
  ...
  diffWithOptionsObj(t, u, r, o) {
    ...
    let F2 = -1 / 0, C2 = 1 / 0, y2 = () => {
      for (let m = Math.max(F2, -D2); m <= Math.min(C2, D2); m += 2) {
        ...
        if (!z2 || A2 && E.oldPos < g.oldPos ? h3 = this.addToPath(g, true, false, 0, r) : h3 = this.addToPath(E, false, true, 1, r), p = this.extractCommon(h3, u, t, m, r), h3.oldPos + 1 >= i && p + 1 >= s) return a(this.buildValues(h3.lastComponent, u, t)) || true;
...
`, o) : E;
      ...
      case U2:
        ...
        break;
      case I:
        a.push({ indent: ir2(m, t), mode: h3, doc: E.contents });
        break;
      case k2:
        a.push({ indent: ar2(m, E.n, t), mode: h3, doc: E.contents });
        break;
      case v2:
        y2();
        break;
      ...
      case w2: {
        ...
        let $n2 = z2[A2 + 2], Vn2 = { indent: m, mode: h3, doc: { ...E, [Ht2]: A2 + 2 } }, Kn2 = tt2({ indent: m, mode: q2, doc: [re2, Be2, $n2] }, [], g, D2.length > 0, u, true);
      ...
      case L2:
        ...
        break;
      case M:
        D2.length > 0 && a.push({ indent: m, mode: h3, doc: Ie2 });
        break;
      case _2:
        switch (h3) {
          case q2:
...
function Cr2(e, t) {
  ...
  for (let [l2, d] of f2.entries()) {
    ...
    if (o ? g = [d] : (c.enclosingNode = F2, c.precedingNode = p, c.followingNode = C2, g = [c, y2, m, h3, E]), To2(y2, m, f2, l2)) c.placement = "ownLine", s(...g) || (C2 ? fe2(C2, c) : p ? le2(p, c) : F2 ? ue2(F2, c) : ue2(h3, c));
    else if (No2(y2, m, f2, l2)) c.placement = "endOfLine", i(...g) || (p ? le2(p, c) : C2 ? fe2(C2, c) : F2 ? ue2(F2, c) : ue2(h3, c));
