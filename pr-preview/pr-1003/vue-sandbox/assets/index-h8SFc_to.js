...
const _hoisted_1 = { class: "text-box" };
const _hoisted_2 = { class: "container" };
const _hoisted_3 = { class: "overflowing-container" };
const _hoisted_4 = { class: "text-box" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "DefaultView",
  setup(__props) {
    const valtLand = /* @__PURE__ */ ref("");
    const land = /* @__PURE__ */ ref([
      "Abchazien",
      "Afghanistan",
      "Albanien",
      "Algeriet",
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        _cache[6] || (_cache[6] = createBaseVNode("div", { class: "space-box" }, null, -1)),
        withDirectives((openBlock(), createBlock(unref(FTextField), {
          modelValue: valtLand.value,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => valtLand.value = $event),
          maxlength: "100",
          options: land.value
        }, {
          default: withCtx(() => [..._cache[3] || (_cache[3] = [
            createTextVNode(" Välj land ", -1)
          ])]),
          _: 1
        }, 8, ["modelValue", "options"])), [
          [
            _directive_validation,
            { allowList: { list: land.value } },
            void 0,
            { allowList: true }
          ]
        ]),
        createBaseVNode("div", _hoisted_1, [
          withDirectives((openBlock(), createBlock(unref(FTextField), {
            modelValue: valtLand.value,
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => valtLand.value = $event),
            maxlength: "100",
            options: land.value
          }, {
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              withDirectives((openBlock(), createBlock(unref(FTextField), {
                modelValue: valtLand.value,
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => valtLand.value = $event),
                maxlength: "100",
                options: land.value
              }, {
