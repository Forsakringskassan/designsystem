...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-feab0e.js
...
exampleComponent.__scopeId = "data-v-feab0e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-feab0e"
});
export {
  render
};
