...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-a8cd8c.js
...
exampleComponent.__scopeId = "data-v-a8cd8c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a8cd8c"
});
export {
  render
};
