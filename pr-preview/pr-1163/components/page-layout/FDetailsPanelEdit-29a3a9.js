...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-29a3a9.js
...
exampleComponent.__scopeId = "data-v-29a3a9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-29a3a9"
});
export {
  render
};
