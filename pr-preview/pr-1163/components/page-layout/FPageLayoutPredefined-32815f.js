...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-32815f.js
...
exampleComponent.__scopeId = "data-v-32815f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-32815f"
});
export {
  render
};
