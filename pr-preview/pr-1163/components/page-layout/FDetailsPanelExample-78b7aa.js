...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-78b7aa.js
...
exampleComponent.__scopeId = "data-v-78b7aa";
setup({
  rootComponent: exampleComponent,
  selector: "#example-78b7aa"
});
export {
  render
};
