...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-51f6e6.js
...
exampleComponent.__scopeId = "data-v-51f6e6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-51f6e6"
});
export {
  render
};
