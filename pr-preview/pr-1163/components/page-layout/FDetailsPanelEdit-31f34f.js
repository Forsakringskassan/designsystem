...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-31f34f.js
...
exampleComponent.__scopeId = "data-v-31f34f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-31f34f"
});
export {
  render
};
