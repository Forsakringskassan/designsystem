...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-3fc8bd.js
...
exampleComponent.__scopeId = "data-v-3fc8bd";
setup({
  rootComponent: exampleComponent,
  selector: "#example-3fc8bd"
});
export {
  render
};
