...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-3db889.js
...
exampleComponent.__scopeId = "data-v-3db889";
setup({
  rootComponent: exampleComponent,
  selector: "#example-3db889"
});
export {
  render
};
