...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d8e8da.js
...
exampleComponent.__scopeId = "data-v-d8e8da";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d8e8da"
});
export {
  render
};
