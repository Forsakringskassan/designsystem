...
function _sfc_render$O(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createBaseVNode("div", _hoisted_1$X, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createBaseVNode("span", null, toDisplayString(button.label), 1), _cache[0] || (_cache[0] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$x, " " + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$F);
    }), 128))])]),
    _: 3
...
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$W, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
      ...
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$E, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createBaseVNode("ul", _hoisted_3$w, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
...
function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createBaseVNode("div", _hoisted_1$U, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createBaseVNode("span", null, toDisplayString(button.label), 1), _cache[2] || (_cache[2] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$v, " " + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$C);
    }), 128))])]),
    _: 3
...
const _sfc_main$X = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }), [createBaseVNode("div", _hoisted_2$x, [renderSlot(_ctx.$slots, "default")], 512)], 16, _hoisted_1$L)], 512)], 8, ["to"])) : createCommentVNode("", true);
    };
  }
});
...
function _sfc_render$x(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    }, [createBaseVNode("ul", _hoisted_2$w, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item, index) => {
      return openBlock(), createElementBlock("li", {
        ref_for: true,
        ref: "items",
        key: item.key,
        ...
        target: item.target,
        tabindex: "0"
      }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$h, [createBaseVNode("span", null, toDisplayString(_ctx.selectedMenuItemScreenReaderText) + " ", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$m)], 10, _hoisted_3$r);
    }), 128))])], 8, _hoisted_1$K)]),
    _: 1
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$B, [renderSlot(_ctx.$slots, "default"), _cache[6] || (_cache[6] = createTextVNode()), hasAddSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$q, [createBaseVNode("button", {
...
function _sfc_render$p(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_f_icon = resolveComponent("f-icon");
  return _ctx.$slots.tooltip ? (openBlock(), createElementBlock("div", _hoisted_1$z, [_ctx.hasDefaultSlot ? (openBlock(), createElementBlock("div", _hoisted_2$p, [createBaseVNode("label", {
    class: "label",
        ...
        default: withCtx(() => [createVNode(unref(IFlexItem), {
          ...
          default: withCtx(() => [createVNode(unref(IFlex), {
            ...
            default: withCtx(() => [__props.showFilter ? (openBlock(), createBlock(unref(IFlexItem), {
              ...
              default: withCtx(() => [createBaseVNode("div", _hoisted_2$n, [createVNode(unref(FIcon), {
                name: "search",
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, _ctx.$attrs), [hasCaption.value ? (openBlock(), createElementBlock("caption", _hoisted_2$m, [renderSlot(_ctx.$slots, "caption")])) : createCommentVNode("", true), _cache[4] || (_cache[4] = createTextVNode()), createBaseVNode("colgroup", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column) => {
...
const _hoisted_2$k = ["aria-orientation"];
const _hoisted_3$g = ["aria-orientation"];
const STEP_SIZE = 10;
...
const FResizePane = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["styles", [_style_0$1]]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(tagName$1), mergeProps({
        ...
        default: withCtx(() => [createBaseVNode("div", _hoisted_1$p, [renderSlot(_ctx.$slots, "default")])]),
        _: 3
...
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, [createBaseVNode("div", _hoisted_1$o, [createBaseVNode("div", _hoisted_2$j, [renderSlot(_ctx.$slots, "header")]), _cache[1] || (_cache[1] = createTextVNode()), createBaseVNode("button", {
        class: "panel__close-button",
        type: "button",
        onClick: _cache[0] || (_cache[0] = ($event) => emit2("closed"))
      }, [renderSlot(_ctx.$slots, "icon")])]), _cache[2] || (_cache[2] = createTextVNode()), createBaseVNode("div", _hoisted_3$f, [renderSlot(_ctx.$slots, "content")]), _cache[3] || (_cache[3] = createTextVNode()), createBaseVNode("div", _hoisted_4$c, [renderSlot(_ctx.$slots, "footer")])], 2)], 512);
    };
  }
});
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const closeText = (
      ...
      $t2("fkui.details-panel.close", "Stäng")
    );
    useResize({
      visible,
      overlay
    ...
    return (_ctx, _cache) => {
      return visible.value ? (openBlock(), createBlock(resolveDynamicComponent(tagName), {
        ...
        default: withCtx(() => [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
          ...
          footer,
          content
        }))), _cache[1] || (_cache[1] = createTextVNode()), createBaseVNode("div", _hoisted_1$n, [createVNode(unref(FIcon), {
          name: "close"
        }, {
          default: withCtx(() => [createBaseVNode("title", null, toDisplayString(unref(closeText)), 1)]),
          _: 1
        })])]),
        _: 3
            ...
            default: withCtx(() => [
              createVNode(unref(XPersonPanel), {
                ...
                default: withCtx(({ item, header: header2, content: content2 }) => [
                  createBaseVNode("h2", { slot: header2 }, "Detaljer om person", 8, _hoisted_1),
              ...
              createVNode(unref(XExpensePanel), {
                ...
                default: withCtx(({ item, content: content2 }) => [
                  createBaseVNode("div", { slot: content2 }, [
                    createBaseVNode("dl", null, [
                      _cache[8] || (_cache[8] = createBaseVNode("dt", null, "ID", -1)),
                      createBaseVNode("dd", null, toDisplayString(item.id), 1),
                      _cache[9] || (_cache[9] = createBaseVNode("dt", null, "Beskrivning", -1)),
                      createBaseVNode("dd", null, toDisplayString(item.description), 1),
                      _cache[10] || (_cache[10] = createBaseVNode("dt", null, "Belopp", -1)),
...
const App = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-4f935d69"]]);
