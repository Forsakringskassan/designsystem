...
function _sfc_render$E(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("table", {
    ...
    return openBlock(), createElementBlock("th", {
      ...
      key: 0,
      title: weekday.name
    }, toDisplayString(weekday.shortName), 9, _hoisted_4$o)) : (openBlock(), createElementBlock("span", _hoisted_5$i, toDisplayString(weekday.name), 1))]);
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    default: withCtx(() => [createElementVNode("nav", {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        target: item.target,
        tabindex: "0"
      }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$h, [createElementVNode("span", null, toDisplayString(_ctx.selectedMenuItemScreenReaderText) + "\xA0", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$m)], 10, _hoisted_3$r);
    }), 128))])], 8, _hoisted_1$K)]),
    _: 1
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    default: withCtx(() => [createElementVNode("nav", {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        ref_for: true,
        ref: "anchors"
      }, toDisplayString(item.label), 513)], 8, _hoisted_4$i), _cache[4] || (_cache[4] = createTextVNode()), _ctx.hasSeparatorAfterItemAt(index) ? (openBlock(), createElementBlock("hr", _hoisted_5$e)) : createCommentVNode("", true)], 8, _hoisted_3$m);
          ...
          default: withCtx(() => [createVNode(unref(IFlex), {
            ...
            default: withCtx(() => [__props.showFilter ? (openBlock(), createBlock(unref(IFlexItem), {
              ...
              default: withCtx(() => [createElementVNode("div", _hoisted_2$n, [createVNode(unref(FIcon), {
                ...
                name: "close"
              }), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("span", _hoisted_5$b, toDisplayString(unref($t2)("fkui.sort-filter-dataset.clear.filter", "Rensa s\xF6kf\xE4lt")), 1)], 8, _hoisted_4$f)) : createCommentVNode("", true)])]),
              _: 1
...
var _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, [createElementVNode("div", _hoisted_1$o, [createElementVNode("div", _hoisted_2$j, [renderSlot(_ctx.$slots, "header")]), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("button", {
        class: "panel__close-button",
        type: "button",
        onClick: _cache[0] || (_cache[0] = ($event) => emit("closed"))
      }, [renderSlot(_ctx.$slots, "icon")])]), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("div", _hoisted_3$f, [renderSlot(_ctx.$slots, "content")]), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("div", _hoisted_4$c, [renderSlot(_ctx.$slots, "footer")])], 2)], 512);
    };
  }
});
