...
var FResizePane$1 = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["styles", [_style_0$1]]]);
...
var _sfc_main$p = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    if (!customElements.get(tagName$1)) {
      customElements.define(tagName$1, defineCustomElement(FResizePane$1));
    }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(tagName$1), mergeProps({
        ...
        default: withCtx(() => [createElementVNode("div", _hoisted_1$p, [renderSlot(_ctx.$slots, "default", {}, void 0, true)])]),
        _: 3
      }, 16, ["disabled", "hidden", "overlay", "offset"]);
    };
  }
});
var FResizePane = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-49784a2f"]]);
var panels = [];
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        class: normalizeClass(["panel", [attachClass.value]])
...
var _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(panel).item.value ? (openBlock(), createBlock(resolveDynamicComponent(tagName), {
        key: 0,
