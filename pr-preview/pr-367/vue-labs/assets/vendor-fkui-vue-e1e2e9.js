...
function _sfc_render$O(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$X, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createElementVNode("span", null, toDisplayString(button.label), 1), _cache[0] || (_cache[0] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$y, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$G);
    }), 128))])]),
    _: 3
...
function _sfc_render$L(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$W, [createVNode(_component_i_flex, null, {
    default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
      ...
      default: withCtx(() => [_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$F, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), createElementVNode("ul", _hoisted_3$x, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
...
function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_f_modal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1$U, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
      ...
      }, [createElementVNode("span", null, toDisplayString(button.label), 1), _cache[2] || (_cache[2] = createTextVNode()), button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$w, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)], 10, _hoisted_2$D);
    }), 128))])]),
    _: 3
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _: 1
      })) : createCommentVNode("", true)]), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("div", _hoisted_3$t, [renderSlot(_ctx.$slots, "default")]), _cache[3] || (_cache[3] = createTextVNode()), hasFooterSlot.value ? (openBlock(), createElementBlock("div", _hoisted_4$n, [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
        hasError: hasError.value,
        validationMessage: validationMessage.value
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    default: withCtx(() => [createElementVNode("nav", {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        target: item.target,
        tabindex: "0"
      }, [_ctx.isSelected(index) ? (openBlock(), createElementBlock("span", _hoisted_5$h, [createElementVNode("span", null, toDisplayString(_ctx.selectedMenuItemScreenReaderText) + "\xA0", 1)])) : createCommentVNode("", true), createTextVNode(" " + toDisplayString(item.label), 1)], 8, _hoisted_4$m)], 10, _hoisted_3$s);
    }), 128))])], 8, _hoisted_1$K)]),
    _: 1
...
function _sfc_render$u(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [(openBlock(), createBlock(Teleport, {
    ...
    name: "i"
  }), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("span", _hoisted_3$q, toDisplayString(_ctx.screenReaderText), 1)])], 8, _hoisted_1$F)], 8, ["disabled", "to"])), _cache[7] || (_cache[7] = createTextVNode()), createElementVNode("div", mergeProps({
    ref: "wrapper",
    class: "tooltip"
  ...
  return openBlock(), createBlock(_component_i_popup, {
    ...
    default: withCtx(() => [createElementVNode("nav", {
      ...
      return openBlock(), createElementBlock("li", {
        ...
        ref_for: true,
        ref: "anchors"
      }, toDisplayString(item.label), 513)], 8, _hoisted_4$i), _cache[4] || (_cache[4] = createTextVNode()), _ctx.hasSeparatorAfterItemAt(index) ? (openBlock(), createElementBlock("hr", _hoisted_5$e)) : createCommentVNode("", true)], 8, _hoisted_3$n);
...
function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$s, [createElementVNode("div", {
    ...
    "input-right": withCtx(() => [createElementVNode("button", {
      ...
      name: "calendar"
    }), _cache[6] || (_cache[6] = createTextVNode()), createElementVNode("span", _hoisted_3$i, toDisplayString(_ctx.calendarButtonText), 1)], 8, _hoisted_2$m)]),
...
var _sfc_main$o = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, [createElementVNode("div", _hoisted_1$o, [(openBlock(), createBlock(resolveDynamicComponent(_ctx.headingTag), {
        class: "panel__title"
      }, {
        default: withCtx(() => [renderSlot(_ctx.$slots, "header")]),
        _: 3
      })), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("button", {
        class: "panel__close-button",
        type: "button",
        onClick: _cache[0] || (_cache[0] = ($event) => emit("closed"))
      }, [renderSlot(_ctx.$slots, "icon")])]), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("div", _hoisted_2$k, [renderSlot(_ctx.$slots, "content")]), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("div", _hoisted_3$g, [renderSlot(_ctx.$slots, "footer")])], 2)], 512);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(panel).item.value ? (openBlock(), createBlock(resolveDynamicComponent(tagName), {
        ...
        default: withCtx(() => [createElementVNode("div", _hoisted_1$n, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({
          item: unref(panel).item.value,
          close: onClose
        })))]), _cache[1] || (_cache[1] = createTextVNode()), createElementVNode("div", _hoisted_2$j, [renderSlot(_ctx.$slots, "content", normalizeProps(guardReactiveProps({
          item: unref(panel).item.value,
          close: onClose
        })))]), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("div", _hoisted_3$f, [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
          item: unref(panel).item.value,
          close: onClose
        })))]), _cache[3] || (_cache[3] = createTextVNode()), createElementVNode("div", _hoisted_4$c, [createVNode(unref(FIcon), {
          name: "close"
        }, {
          default: withCtx(() => [createElementVNode("title", null, toDisplayString(unref($t2)("fkui.details-panel.close", "St\xE4ng")), 1)]),
          _: 1
        })])]),
        _: 3
