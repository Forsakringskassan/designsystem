...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-5e8c49.js
  ...
  return _openBlock(), _createBlock($setup["FPageLayout"], { layout: "three-column" }, {
    right: _withCtx(() => [
      _createVNode($setup["RowPanel"], {
        ...
        default: _withCtx(({ item, close, header, content, footer }) => [
          ...
          _createElementVNode("div", { slot: footer }, "[footer]", 8, _hoisted_6)
        ]),
        _: 1
        /* STABLE */
      })
