...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d0fbb2.js
...
exampleComponent.__scopeId = "data-v-d0fbb2";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d0fbb2"
});
export {
  render
};
