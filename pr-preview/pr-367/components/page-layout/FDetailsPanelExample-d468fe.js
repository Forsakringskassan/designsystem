...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d468fe.js
        ...
        default: _withCtx(() => [
          _createVNode($setup["RowPanel"], { name: $setup.name }, {
            default: _withCtx(({ item, close, header, content }) => [
              _createElementVNode("h2", { slot: header }, "Detaljpanel", 8, _hoisted_1),
