...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-16163f.js
        ...
        _createVNode($setup["FResizePane"], {
          ...
          default: _withCtx(() => [
            _createVNode($setup["ExamplePanel"], { name: $setup.name }, {
              default: _withCtx(({ header, content }) => [
                _createElementVNode("h2", { slot: header }, "Detaljpanel", 8, _hoisted_2),
                _createElementVNode("div", { slot: content }, "Inneh\xE5ll", 8, _hoisted_3)
              ]),
              _: 1
              /* STABLE */
            })
...
exampleComponent.__scopeId = "data-v-16163f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-16163f"
});
export {
  render
};
