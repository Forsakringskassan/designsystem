...
// virtual-entry:virtual:src/components/FPagination/examples/FPaginationExample.vue:FPaginationExample-e2509e.js
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, toDisplayString(unref($t)("fkui.table.paginator.previous", "F\xF6reg\xE5ende")), 9, _hoisted_2), _cache[2] || (_cache[2] = createTextVNode()), (openBlock(true), createElementBlock(Fragment, null, renderList(pages.value, (page) => {
      ...
      }, toDisplayString(unref($t)("fkui.table.paginator.next", "N\xE4sta")), 9, _hoisted_4)], 512)) : createCommentVNode("", true);
    };
  }
});
