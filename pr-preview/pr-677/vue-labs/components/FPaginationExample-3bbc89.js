...
// virtual-entry:virtual:src/components/FPagination/examples/FPaginationExample.vue:FPaginationExample-3bbc89.js
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const maxNumberOfPagesToShow = computed(() => Math.min(__props.numberOfPagesToShow, 9));
    const pages = computed(() => {
      let startPage = Math.max(__props.currentPage - Math.floor(maxNumberOfPagesToShow.value / 2), 1);
      let endPage = startPage + maxNumberOfPagesToShow.value - 1;
      if (endPage > __props.numberOfPages) {
        endPage = __props.numberOfPages;
        startPage = Math.max(endPage - maxNumberOfPagesToShow.value + 1, 1);
      }
      const pages2 = [];
    ...
    return (_ctx, _cache) => {
      return showPaginator.value ? (openBlock(), createElementBlock("nav", _hoisted_1, [createElementVNode("button", {
        ...
        return openBlock(), createElementBlock("button", {
          ...
          type: "button",
          size: "small",
          disabled: page === __props.currentPage,
          class: normalizeClass(pageClasses(page)),
          "aria-current": page === __props.currentPage,
