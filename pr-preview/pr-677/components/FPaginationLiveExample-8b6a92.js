...
// virtual-entry:virtual:packages/vue/src/components/FPagination/examples/FPaginationLiveExample.vue:FPaginationLiveExample-8b6a92.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    paginator() {
      return (
        /* HTML */
        this.showPaginator ? `<f-paginator :number-of-pages :current-page />` : ``
      );
    },
    template() {
      return (
  ...
  watch: {
    itemsPerPage(newValue) {
      this.numberOfItemsPerPage = Math.max(1, Math.min(newValue, 100));
    }
  }
});
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      _createVNode(_component_f_fieldset, { name: "component" }, {
        ...
        default: _withCtx(() => [
          ...
          _createVNode(_component_f_radio_field, {
            ...
            default: _withCtx(() => [..._cache[7] || (_cache[7] = [
              _createTextVNode(
                " Interaktiv tabell (st\xF6der paginering med ",
                -1
                /* CACHED */
              ),
              _createElementVNode(
      ...
      _createVNode(_component_f_fieldset, { name: "alternatives" }, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_f_checkbox_field, {
            ...
            default: _withCtx(() => [..._cache[10] || (_cache[10] = [
              _createTextVNode(
                " H\xE4mta data dymaniskt (med f\xF6rdr\xF6jning) ",
                -1
                /* CACHED */
              )
            ])]),
          ...
          _createVNode(_component_f_checkbox_field, {
            modelValue: _ctx.showPaginator,
            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.showPaginator = $event),
            value: true
          }, {
