...
// virtual-entry:virtual:packages/vue/src/design-component-tests/Pagination/examples/PaginationExample.vue:PaginationExample-68cdb6.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    selectable() {
      return (
        /* HTML */
        this.showInteractiveListWithCheckboxes ? `v-model="selectedRows" selectable` : ``
      );
    },
    template() {
      return (
        ...
        `
                <f-paginate-dataset ${this.items} ${this.itemsPerPage}>
                    <template #default="{ items: currentPageItems }">
                        ...
                        <f-list :items="currentPageItems" key-attribute="id" ${this.selectable}>
