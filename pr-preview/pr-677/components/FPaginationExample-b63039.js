...
// virtual-entry:virtual:packages/vue/src/components/FPagination/examples/FPaginationExample.vue:FPaginationExample-b63039.js
import { defineComponent as _defineComponent } from "vue";
import { ref } from "vue";
import { FDataTable, FInteractiveTable, FPagination, FTableColumn, FPaginator } from "@fkui/vue";
...
// virtual-entry:virtual:packages/vue/src/components/FPagination/examples/FPaginationExample.vue:FPaginationExample-b63039.js
import { createTextVNode as _createTextVNode, toDisplayString as _toDisplayString, withCtx as _withCtx, createVNode as _createVNode, Fragment as _Fragment, openBlock as _openBlock, createElementBlock as _createElementBlock } from "vue";
var exampleComponent = /* @__PURE__ */ _defineComponent({
  __name: "FPaginationExample",
  setup(__props, { expose: __expose }) {
    __expose();
    const rows = ref(persons);
    async function fetchData(first, last) {
      await new Promise((resolve) => setTimeout(resolve, 500));
      return rows.value.slice(first, last);
    }
    const __returned__ = { rows, fetchData, get FDataTable() {
      return FDataTable;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return _openBlock(), _createElementBlock(
    ...
    null,
    [
      _createVNode($setup["FPagination"], { items: $setup.rows }, {
        default: _withCtx(({ items: currentPageItems, currentPage, numberOfPages }) => [
          _createVNode($setup["FDataTable"], { rows: currentPageItems }, {
            ...
            default: _withCtx(({ row }) => [
              ...
              _createVNode(
                ...
                },
                {
                  default: _withCtx(() => [
                    _createTextVNode(
                      _toDisplayString(row.firstName),
                      1
                      /* TEXT */
                    )
                  ]),
      ...
      _createVNode($setup["FPagination"], {
        "items-length": $setup.rows.length,
        "fetch-data": $setup.fetchData,
        "items-per-page": 7
      }, {
        default: _withCtx(({ items: currentPageItems, currentPage, numberOfPages }) => [
