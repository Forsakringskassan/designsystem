...
// virtual-entry:virtual:packages/vue/src/design-component-tests/Pagination/examples/PaginationExample.vue:PaginationExample-30f5b8.js
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_fieldset, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_f_checkbox_field, {
            ...
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.fetchDataDynamically = $event),
            value: true
          }, {
          ...
          _createVNode(_component_f_checkbox_field, {
            ...
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.showPaginatorInHeader = $event),
            value: true
          }, {
          ...
          _createVNode(_component_f_checkbox_field, {
            ...
            "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.showPaginatorInFooter = $event),
            value: true
          }, {
      ...
      _createVNode(_component_f_select_field, {
        ...
        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.numberOfPagesToShowAtMost = $event)
      }, {
