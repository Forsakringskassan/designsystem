...
// virtual-entry:virtual:packages/vue/src/components/FPagination/examples/FPaginationLiveExample.vue:FPaginationLiveExample-e7ac6d.js
  ...
  computed: {
    ...
    template() {
      return (
        /* HTML */
        `
                <f-pagination :items="rows" ${this.itemsPerPage}>
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_fieldset, { name: "checkbox" }, {
        label: _withCtx(() => [..._cache[8] || (_cache[8] = [
          _createTextVNode(
            "Dynamisk h\xE4mtning av data",
            -1
            /* CACHED */
          )
        ])]),
