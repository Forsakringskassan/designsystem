...
// virtual-entry:virtual:packages/vue/src/components/FPagination/examples/FPaginationLiveExample.vue:FPaginationLiveExample-929a78.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    ...
    paginator() {
      return (
        /* HTML */
        `<f-paginator ${this.numberOfPagesToShow} />`
      );
    },
    template() {
      return (
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _createVNode(_component_f_fieldset, {
        ...
        default: _withCtx(() => [
          _createVNode(_component_f_checkbox_field, {
            ...
            details: _withCtx(() => [..._cache[13] || (_cache[13] = [
              _createTextVNode(
      ...
      _createVNode(_component_f_select_field, {
        ...
        "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.numberOfPagesToShowAtMost = $event)
      }, {
