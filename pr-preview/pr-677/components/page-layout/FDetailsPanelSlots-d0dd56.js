...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-d0dd56.js
...
exampleComponent.__scopeId = "data-v-d0dd56";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d0dd56"
});
export {
  render
};
