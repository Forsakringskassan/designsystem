...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-9425f4.js
...
exampleComponent.__scopeId = "data-v-9425f4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9425f4"
});
export {
  render
};
