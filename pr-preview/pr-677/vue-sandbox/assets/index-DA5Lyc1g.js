...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      ), 1)])) : createCommentVNode("", true), _cache[5] || (_cache[5] = createTextVNode()), __props.selectable ? (openBlock(), createElementBlock("th", _hoisted_8$4, [createBaseVNode("span", _hoisted_9$3, toDisplayString(
