...
// virtual-entry:virtual:packages/vue-labs/src/components/FTable/examples/FTableLiveExample.vue:FTableLiveExample-0d08a1.js
...
var exampleComponent = defineComponent3({
  ...
  computed: {
    livedata() {
      ...
      const rows2 = useDatasetRef(this.isEmpty ? [] : [...this.rows], nestedAttribute);
      return {
