...
// virtual-entry:virtual:packages/vue/src/components/FPageLayout/examples/FPageLayoutExample.vue:FPageLayoutExample-9019a7.js
...
exampleComponent.__scopeId = "data-v-9019a7";
setup({
  rootComponent: exampleComponent,
  selector: "#example-9019a7"
});
export {
  render
};
