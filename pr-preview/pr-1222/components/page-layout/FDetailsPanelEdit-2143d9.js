...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-2143d9.js
...
exampleComponent.__scopeId = "data-v-2143d9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2143d9"
});
export {
  render
};
