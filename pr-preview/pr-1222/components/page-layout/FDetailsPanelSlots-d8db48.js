...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-d8db48.js
...
exampleComponent.__scopeId = "data-v-d8db48";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d8db48"
});
export {
  render
};
