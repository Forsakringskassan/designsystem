...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d10a5f.js
...
exampleComponent.__scopeId = "data-v-d10a5f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d10a5f"
});
export {
  render
};
