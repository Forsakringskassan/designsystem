...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-0e16ed.js
...
exampleComponent.__scopeId = "data-v-0e16ed";
setup({
  rootComponent: exampleComponent,
  selector: "#example-0e16ed"
});
export {
  render
};
