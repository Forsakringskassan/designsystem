...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-6179de.js
...
exampleComponent.__scopeId = "data-v-6179de";
setup({
  rootComponent: exampleComponent,
  selector: "#example-6179de"
});
export {
  render
};
