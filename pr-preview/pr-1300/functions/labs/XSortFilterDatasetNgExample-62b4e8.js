...
// virtual-entry:virtual:packages/vue-labs/src/components/XSortFilterDatasetNg/examples/XSortFilterDatasetNgExample.vue:XSortFilterDatasetNgExample-62b4e8.js
...
// packages/vue-labs/src/components/XSortFilterDatasetNg/examples/fruit-data.ts
var fruits = [
  {
    id: "1",
    name: "\xC4pple",
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const flag = ref2(true);
    const country = ref2(null);
    ...
    const __returned__ = { searchRef, actualElement, flag, country, availableCountries, matchCountry, filter, get FCheckboxField() {
      ...
      return XSortFilterDatasetNg_default;
    }, get fruits() {
      return fruits;
    } };
