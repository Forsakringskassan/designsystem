...
var capitalize$6 = cacheStringFunction((str) => {
	return str.charAt(0).toUpperCase() + str.slice(1);
});
var toHandlerKey = cacheStringFunction((str) => {
	return str ? `on${capitalize$6(str)}` : ``;
});
...
function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
	...
	if (instance) {
		...
		if (type === COMPONENTS) {
			...
			if (selfName && (selfName === name || selfName === camelize(name) || selfName === capitalize$6(camelize(name)))) return Component;
		}
...
function resolve(registry, name) {
	return registry && (registry[name] || registry[camelize(name)] || registry[capitalize$6(camelize(name))]);
}
...
function addFocusListener(elements, listener) {
	for (const element of elements) element.addEventListener("focus", listener);
}
/**
...
function documentOrderComparator(a, b) {
	...
	return (a.compareDocumentPosition(b) & BITMASK) - 1;
}
/**
...
function saveFocus(document) {
	if (document.activeElement instanceof HTMLElement) pushFocus();
}
/**
...
function forcePopFocus() {
	if (_focusElementStack.length === 0) throw new Error("Can not call pop on an empty focus stack");
	focus$1(_focusElementStack.pop()?.element);
}
/**
...
function removeFocusListener(elements, listener) {
	for (const element of elements) element.removeEventListener("focus", listener);
}
...
var require_global_this$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_fails$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_descriptors$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = !require_fails$1()(function() {
		return Object.defineProperty({}, 1, { get: function() {
			return 7;
		} })[1] !== 7;
	});
}));
var require_function_bind_native$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = !require_fails$1()(function() {
		var test = function() {}.bind();
		return typeof test != "function" || test.hasOwnProperty("prototype");
	});
}));
var require_function_call$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var NATIVE_BIND = require_function_bind_native$1();
	var call = Function.prototype.call;
	module.exports = NATIVE_BIND ? call.bind(call) : function() {
		return call.apply(call, arguments);
	};
}));
var require_object_property_is_enumerable$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
...
var require_create_property_descriptor$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_function_uncurry_this$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var NATIVE_BIND = require_function_bind_native$1();
...
var require_classof_raw$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
...
var require_indexed_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var fails = require_fails$1();
	var classof = require_classof_raw$1();
	var $Object = Object;
...
var require_is_null_or_undefined$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = function(it) {
		return it === null || it === void 0;
	};
}));
var require_require_object_coercible$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isNullOrUndefined = require_is_null_or_undefined$1();
...
var require_to_indexed_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var IndexedObject = require_indexed_object$1();
	var requireObjectCoercible = require_require_object_coercible$1();
	module.exports = function(it) {
		return IndexedObject(requireObjectCoercible(it));
	};
}));
var require_is_callable$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_is_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isCallable = require_is_callable$1();
	module.exports = function(it) {
		return typeof it == "object" ? it !== null : isCallable(it);
	};
}));
var require_get_built_in$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var isCallable = require_is_callable$1();
...
var require_object_is_prototype_of$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_function_uncurry_this$1()({}.isPrototypeOf);
}));
var require_environment_user_agent$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var navigator = require_global_this$1().navigator;
	var userAgent = navigator && navigator.userAgent;
	module.exports = userAgent ? String(userAgent) : "";
}));
var require_environment_v8_version$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var userAgent = require_environment_user_agent$1();
...
var require_symbol_constructor_detection$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var V8_VERSION = require_environment_v8_version$1();
	var fails = require_fails$1();
	var $String = require_global_this$1().String;
	module.exports = !!Object.getOwnPropertySymbols && !fails(function() {
		var symbol = Symbol("symbol detection");
		return !$String(symbol) || !(Object(symbol) instanceof Symbol) || !Symbol.sham && V8_VERSION && V8_VERSION < 41;
	});
}));
var require_use_symbol_as_uid$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_symbol_constructor_detection$1() && !Symbol.sham && typeof Symbol.iterator == "symbol";
}));
var require_is_symbol$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getBuiltIn = require_get_built_in$1();
	var isCallable = require_is_callable$1();
	var isPrototypeOf = require_object_is_prototype_of$1();
	var USE_SYMBOL_AS_UID = require_use_symbol_as_uid$1();
	var $Object = Object;
...
var require_try_to_string$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var $String = String;
...
var require_a_callable$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isCallable = require_is_callable$1();
	var tryToString = require_try_to_string$1();
	var $TypeError = TypeError;
	module.exports = function(argument) {
...
var require_get_method$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aCallable = require_a_callable$1();
	var isNullOrUndefined = require_is_null_or_undefined$1();
...
var require_ordinary_to_primitive$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
	var isCallable = require_is_callable$1();
	var isObject = require_is_object$1();
	var $TypeError = TypeError;
...
var require_is_pure$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = false;
}));
var require_define_global_property$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
...
var require_shared_store$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var IS_PURE = require_is_pure$1();
	var globalThis = require_global_this$1();
	var defineGlobalProperty = require_define_global_property$1();
...
var require_shared$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var store = require_shared_store$1();
	module.exports = function(key, value) {
		return store[key] || (store[key] = value || {});
	};
}));
var require_to_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var requireObjectCoercible = require_require_object_coercible$1();
	var $Object = Object;
	module.exports = function(argument) {
...
var require_has_own_property$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var toObject = require_to_object$1();
	var hasOwnProperty = uncurryThis({}.hasOwnProperty);
	module.exports = Object.hasOwn || function hasOwn(it, key) {
		return hasOwnProperty(toObject(it), key);
	};
}));
var require_uid$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var id = 0;
...
var require_well_known_symbol$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var shared = require_shared$1();
	var hasOwn = require_has_own_property$1();
	var uid = require_uid$1();
	var NATIVE_SYMBOL = require_symbol_constructor_detection$1();
	var USE_SYMBOL_AS_UID = require_use_symbol_as_uid$1();
...
var require_to_primitive$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
	var isObject = require_is_object$1();
	var isSymbol = require_is_symbol$1();
	var getMethod = require_get_method$1();
	var ordinaryToPrimitive = require_ordinary_to_primitive$1();
	var wellKnownSymbol = require_well_known_symbol$1();
	var $TypeError = TypeError;
...
var require_to_property_key$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toPrimitive = require_to_primitive$1();
	var isSymbol = require_is_symbol$1();
	module.exports = function(argument) {
...
var require_document_create_element$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var isObject = require_is_object$1();
...
var require_ie8_dom_define$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
	var fails = require_fails$1();
	var createElement = require_document_create_element$1();
...
var require_object_get_own_property_descriptor$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
	var DESCRIPTORS = require_descriptors$1();
	var call = require_function_call$1();
	var propertyIsEnumerableModule = require_object_property_is_enumerable$1();
	var createPropertyDescriptor = require_create_property_descriptor$1();
	var toIndexedObject = require_to_indexed_object$1();
	var toPropertyKey = require_to_property_key$1();
	var hasOwn = require_has_own_property$1();
	var IE8_DOM_DEFINE = require_ie8_dom_define$1();
	var $getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
...
var require_v8_prototype_define_bug$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
	var fails = require_fails$1();
	module.exports = DESCRIPTORS && fails(function() {
...
var require_an_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isObject = require_is_object$1();
	var $String = String;
	var $TypeError = TypeError;
	module.exports = function(argument) {
...
var require_object_define_property$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
	var DESCRIPTORS = require_descriptors$1();
	var IE8_DOM_DEFINE = require_ie8_dom_define$1();
	var V8_PROTOTYPE_DEFINE_BUG = require_v8_prototype_define_bug$1();
	var anObject = require_an_object$1();
	var toPropertyKey = require_to_property_key$1();
	var $TypeError = TypeError;
	var $defineProperty = Object.defineProperty;
	var $getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
...
var require_create_non_enumerable_property$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
	var definePropertyModule = require_object_define_property$1();
	var createPropertyDescriptor = require_create_property_descriptor$1();
...
var require_function_name$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
	var hasOwn = require_has_own_property$1();
	var FunctionPrototype = Function.prototype;
...
var require_inspect_source$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var isCallable = require_is_callable$1();
	var store = require_shared_store$1();
...
var require_weak_map_basic_detection$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var isCallable = require_is_callable$1();
	var WeakMap = globalThis.WeakMap;
	module.exports = isCallable(WeakMap) && /native code/.test(String(WeakMap));
}));
var require_shared_key$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var shared = require_shared$1();
	var uid = require_uid$1();
...
var require_hidden_keys$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = {};
}));
var require_internal_state$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var NATIVE_WEAK_MAP = require_weak_map_basic_detection$1();
	var globalThis = require_global_this$1();
	var isObject = require_is_object$1();
	var createNonEnumerableProperty = require_create_non_enumerable_property$1();
	var hasOwn = require_has_own_property$1();
	var shared = require_shared_store$1();
	var sharedKey = require_shared_key$1();
	var hiddenKeys = require_hidden_keys$1();
...
var require_make_built_in$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var fails = require_fails$1();
	var isCallable = require_is_callable$1();
	var hasOwn = require_has_own_property$1();
	var DESCRIPTORS = require_descriptors$1();
	var CONFIGURABLE_FUNCTION_NAME = require_function_name$1().CONFIGURABLE;
	var inspectSource = require_inspect_source$1();
	var InternalStateModule = require_internal_state$1();
...
var require_define_built_in$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isCallable = require_is_callable$1();
	var definePropertyModule = require_object_define_property$1();
	var makeBuiltIn = require_make_built_in$1();
	var defineGlobalProperty = require_define_global_property$1();
...
var require_math_trunc$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var ceil = Math.ceil;
...
var require_to_integer_or_infinity$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var trunc = require_math_trunc$1();
	module.exports = function(argument) {
		var number = +argument;
		return number !== number || number === 0 ? 0 : trunc(number);
	};
}));
var require_to_absolute_index$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toIntegerOrInfinity = require_to_integer_or_infinity$1();
	var max = Math.max;
	var min = Math.min;
...
var require_to_length$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toIntegerOrInfinity = require_to_integer_or_infinity$1();
	var min = Math.min;
	module.exports = function(argument) {
...
var require_length_of_array_like$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toLength = require_to_length$1();
	module.exports = function(obj) {
		return toLength(obj.length);
	};
}));
var require_array_includes$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toIndexedObject = require_to_indexed_object$1();
	var toAbsoluteIndex = require_to_absolute_index$1();
	var lengthOfArrayLike = require_length_of_array_like$1();
...
var require_object_keys_internal$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var hasOwn = require_has_own_property$1();
	var toIndexedObject = require_to_indexed_object$1();
	var indexOf = require_array_includes$1().indexOf;
	var hiddenKeys = require_hidden_keys$1();
...
var require_enum_bug_keys$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = [
		"constructor",
		"hasOwnProperty",
		"isPrototypeOf",
...
var require_object_get_own_property_names$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
	var internalObjectKeys = require_object_keys_internal$1();
	var hiddenKeys = require_enum_bug_keys$1().concat("length", "prototype");
	exports.f = Object.getOwnPropertyNames || function getOwnPropertyNames(O) {
		return internalObjectKeys(O, hiddenKeys);
	};
}));
var require_object_get_own_property_symbols$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
	exports.f = Object.getOwnPropertySymbols;
}));
var require_own_keys$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getBuiltIn = require_get_built_in$1();
	var uncurryThis = require_function_uncurry_this$1();
	var getOwnPropertyNamesModule = require_object_get_own_property_names$1();
	var getOwnPropertySymbolsModule = require_object_get_own_property_symbols$1();
	var anObject = require_an_object$1();
...
var require_copy_constructor_properties$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var hasOwn = require_has_own_property$1();
	var ownKeys = require_own_keys$1();
	var getOwnPropertyDescriptorModule = require_object_get_own_property_descriptor$1();
	var definePropertyModule = require_object_define_property$1();
...
var require_is_forced$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var fails = require_fails$1();
	var isCallable = require_is_callable$1();
...
var require_export$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var getOwnPropertyDescriptor = require_object_get_own_property_descriptor$1().f;
	var createNonEnumerableProperty = require_create_non_enumerable_property$1();
	var defineBuiltIn = require_define_built_in$1();
	var defineGlobalProperty = require_define_global_property$1();
	var copyConstructorProperties = require_copy_constructor_properties$1();
	var isForced = require_is_forced$1();
...
var require_object_keys$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var internalObjectKeys = require_object_keys_internal$1();
	var enumBugKeys = require_enum_bug_keys$1();
	module.exports = Object.keys || function keys(O) {
		return internalObjectKeys(O, enumBugKeys);
	};
}));
var require_object_define_properties$1 = /* @__PURE__ */ __commonJSMin$1(((exports) => {
	var DESCRIPTORS = require_descriptors$1();
	var V8_PROTOTYPE_DEFINE_BUG = require_v8_prototype_define_bug$1();
	var definePropertyModule = require_object_define_property$1();
	var anObject = require_an_object$1();
	var toIndexedObject = require_to_indexed_object$1();
	var objectKeys = require_object_keys$1();
...
var require_html$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_get_built_in$1()("document", "documentElement");
}));
var require_object_create$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var anObject = require_an_object$1();
	var definePropertiesModule = require_object_define_properties$1();
	var enumBugKeys = require_enum_bug_keys$1();
	var hiddenKeys = require_hidden_keys$1();
	var html = require_html$1();
...
var require_add_to_unscopables$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var wellKnownSymbol = require_well_known_symbol$1();
	var create = require_object_create$1();
	var defineProperty = require_object_define_property$1().f;
...
(/* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var $includes = require_array_includes$1().includes;
	var fails = require_fails$1();
	var addToUnscopables = require_add_to_unscopables$1();
...
var require_is_array = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var classof = require_classof_raw$1();
	module.exports = Array.isArray || function isArray(argument) {
		return classof(argument) === "Array";
	};
}));
var require_array_set_length = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
...
var require_does_not_exceed_safe_integer = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var $TypeError = TypeError;
	var MAX_SAFE_INTEGER = 9007199254740991;
	module.exports = function(it) {
...
var require_es_array_push = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var toObject = require_to_object$1();
	var lengthOfArrayLike = require_length_of_array_like$1();
	var setArrayLength = require_array_set_length();
	var doesNotExceedSafeInteger = require_does_not_exceed_safe_integer();
	var INCORRECT_TO_LENGTH = require_fails$1()(function() {
...
var require_set_helpers$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
...
var require_a_set$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var has = require_set_helpers$1().has;
	module.exports = function(it) {
		has(it);
		return it;
	};
}));
var require_iterate_simple$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
...
var require_set_iterate$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var iterateSimple = require_iterate_simple$1();
	var SetHelpers = require_set_helpers$1();
...
var require_set_clone$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var SetHelpers = require_set_helpers$1();
	var iterate = require_set_iterate$1();
	var Set = SetHelpers.Set;
...
var require_function_uncurry_this_accessor$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var aCallable = require_a_callable$1();
...
var require_set_size$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_function_uncurry_this_accessor$1()(require_set_helpers$1().proto, "size", "get") || function(set) {
		return set.size;
	};
}));
var require_get_iterator_direct$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = function(obj) {
		return {
			iterator: obj,
			next: obj.next,
...
var require_get_set_record$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aCallable = require_a_callable$1();
	var anObject = require_an_object$1();
	var call = require_function_call$1();
	var toIntegerOrInfinity = require_to_integer_or_infinity$1();
	var getIteratorDirect = require_get_iterator_direct$1();
...
var require_set_difference$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var SetHelpers = require_set_helpers$1();
	var clone = require_set_clone$1();
	var size = require_set_size$1();
	var getSetRecord = require_get_set_record$1();
	var iterateSet = require_set_iterate$1();
	var iterateSimple = require_iterate_simple$1();
...
var require_set_method_accept_set_like$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getBuiltIn = require_get_built_in$1();
...
var require_es_set_difference_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var difference = require_set_difference$1();
	var fails = require_fails$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("difference", function(result) {
...
var require_set_intersection$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var SetHelpers = require_set_helpers$1();
	var size = require_set_size$1();
	var getSetRecord = require_get_set_record$1();
...
var require_es_set_intersection_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var fails = require_fails$1();
	var intersection = require_set_intersection$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("intersection", function(result) {
...
var require_iterator_close$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
	var anObject = require_an_object$1();
	var getMethod = require_get_method$1();
...
var require_set_is_disjoint_from$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var has = require_set_helpers$1().has;
	var size = require_set_size$1();
	var getSetRecord = require_get_set_record$1();
	var iterateSet = require_set_iterate$1();
	var iterateSimple = require_iterate_simple$1();
	var iteratorClose = require_iterator_close$1();
...
var require_es_set_is_disjoint_from_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var isDisjointFrom = require_set_is_disjoint_from$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("isDisjointFrom", function(result) {
			return !result;
		})
	}, { isDisjointFrom });
}));
var require_set_is_subset_of$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var size = require_set_size$1();
	var iterate = require_set_iterate$1();
	var getSetRecord = require_get_set_record$1();
...
var require_es_set_is_subset_of_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var isSubsetOf = require_set_is_subset_of$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("isSubsetOf", function(result) {
			return result;
		})
	}, { isSubsetOf });
}));
var require_set_is_superset_of$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var has = require_set_helpers$1().has;
	var size = require_set_size$1();
	var getSetRecord = require_get_set_record$1();
...
var require_es_set_is_superset_of_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var isSupersetOf = require_set_is_superset_of$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("isSupersetOf", function(result) {
			return !result;
		})
	}, { isSupersetOf });
}));
var require_set_symmetric_difference$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var SetHelpers = require_set_helpers$1();
	var clone = require_set_clone$1();
	var getSetRecord = require_get_set_record$1();
...
var require_set_method_get_keys_before_cloning_detection$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_es_set_symmetric_difference_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var symmetricDifference = require_set_symmetric_difference$1();
	var setMethodGetKeysBeforeCloning = require_set_method_get_keys_before_cloning_detection$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("symmetricDifference") || !setMethodGetKeysBeforeCloning("symmetricDifference")
	}, { symmetricDifference });
}));
var require_set_union$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var aSet = require_a_set$1();
	var add = require_set_helpers$1().add;
	var clone = require_set_clone$1();
	var getSetRecord = require_get_set_record$1();
	var iterateSimple = require_iterate_simple$1();
...
var require_es_set_union_v2$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var union = require_set_union$1();
	var setMethodGetKeysBeforeCloning = require_set_method_get_keys_before_cloning_detection$1();
	$({
		target: "Set",
		proto: true,
		real: true,
		forced: !require_set_method_accept_set_like$1()("union") || !setMethodGetKeysBeforeCloning("union")
	}, { union });
}));
require_es_array_push();
require_es_set_difference_v2$1();
require_es_set_intersection_v2$1();
require_es_set_is_disjoint_from_v2$1();
require_es_set_is_subset_of_v2$1();
require_es_set_is_superset_of_v2$1();
require_es_set_symmetric_difference_v2$1();
require_es_set_union_v2$1();
...
var _hoisted_1$80 = ["aria-hidden"];
var _hoisted_2$59 = ["href"];
...
var require__listCacheClear = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Removes all key-value entries from the list cache.
	*
	* @private
...
var require__assocIndexOf = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var eq = require_eq();
	/**
	* Gets the index at which the `key` is found in `array` of key-value pairs.
	*
...
var require__listCacheDelete = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__listCacheGet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var assocIndexOf = require__assocIndexOf();
	/**
	* Gets the list cache value for `key`.
	*
...
var require__listCacheHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var assocIndexOf = require__assocIndexOf();
	/**
	* Checks if a list cache value for `key` exists.
	*
...
var require__listCacheSet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
	var assocIndexOf = require__assocIndexOf();
	/**
	* Sets the list cache `key` to `value`.
...
var require__ListCache = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__stackClear = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__stackDelete = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Removes `key` and its value from the stack.
	*
	* @private
...
var require__stackGet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Gets the stack value for `key`.
	*
	* @private
...
var require__stackHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Checks if a stack value for `key` exists.
	*
	* @private
...
var require__freeGlobal = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = typeof global == "object" && global && global.Object === Object && global;
}));
var require__root = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var freeGlobal = require__freeGlobal();
	/** Detect free variable `self`. */
	var freeSelf = typeof self == "object" && self && self.Object === Object && self;
	module.exports = freeGlobal || freeSelf || Function("return this")();
}));
var require__Symbol = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__root().Symbol;
}));
var require__getRawTag = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__objectToString = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Used to resolve the
	* [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
	* of values.
...
var require__baseGetTag = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_isObject = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Checks if `value` is the
	* [language type](http://www.ecma-international.org/ecma-262/7.0/#sec-ecmascript-language-types)
	* of `Object`. (e.g. arrays, functions, objects, regexes, `new Number(0)`, and `new String('')`)
...
var require_isFunction = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__coreJsData = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__root()["__core-js_shared__"];
}));
var require__isMasked = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__toSource = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/** Used to resolve the decompiled source of functions. */
...
var require__baseIsNative = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__getValue = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Gets the value at `key` of `object`.
	*
	* @private
...
var require__getNative = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__Map = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(require__root(), "Map");
}));
var require__nativeCreate = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(Object, "create");
}));
var require__hashClear = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__hashDelete = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Removes `key` and its value from the hash.
	*
	* @private
...
var require__hashGet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var nativeCreate = require__nativeCreate();
	/** Used to stand-in for `undefined` hash values. */
	var HASH_UNDEFINED = "__lodash_hash_undefined__";
	/** Used to check objects for own properties. */
...
var require__hashHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var nativeCreate = require__nativeCreate();
	/** Used to check objects for own properties. */
	var hasOwnProperty = Object.prototype.hasOwnProperty;
	/**
...
var require__hashSet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var nativeCreate = require__nativeCreate();
	/** Used to stand-in for `undefined` hash values. */
	var HASH_UNDEFINED = "__lodash_hash_undefined__";
	/**
...
var require__Hash = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__mapCacheClear = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_an_instance$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isPrototypeOf = require_object_is_prototype_of$1();
	var $TypeError = TypeError;
...
var require_correct_prototype_getter$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = !require_fails$1()(function() {
		function F() {}
...
var require_object_get_prototype_of$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var hasOwn = require_has_own_property$1();
	var isCallable = require_is_callable$1();
	var toObject = require_to_object$1();
	var sharedKey = require_shared_key$1();
	var CORRECT_PROTOTYPE_GETTER = require_correct_prototype_getter$1();
	var IE_PROTO = sharedKey("IE_PROTO");
	var $Object = Object;
...
var require_define_built_in_accessor$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var makeBuiltIn = require_make_built_in$1();
	var defineProperty = require_object_define_property$1();
...
var require_create_property$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var DESCRIPTORS = require_descriptors$1();
	var definePropertyModule = require_object_define_property$1();
	var createPropertyDescriptor = require_create_property_descriptor$1();
...
var require_iterators_core$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var fails = require_fails$1();
	var isCallable = require_is_callable$1();
	var isObject = require_is_object$1();
	var create = require_object_create$1();
	var getPrototypeOf = require_object_get_prototype_of$1();
	var defineBuiltIn = require_define_built_in$1();
	var wellKnownSymbol = require_well_known_symbol$1();
	var IS_PURE = require_is_pure$1();
...
var require_es_iterator_constructor$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var globalThis = require_global_this$1();
	var anInstance = require_an_instance$1();
	var anObject = require_an_object$1();
	var isCallable = require_is_callable$1();
	var getPrototypeOf = require_object_get_prototype_of$1();
	var defineBuiltInAccessor = require_define_built_in_accessor$1();
	var createProperty = require_create_property$1();
	var fails = require_fails$1();
	var hasOwn = require_has_own_property$1();
	var wellKnownSymbol = require_well_known_symbol$1();
	var IteratorPrototype = require_iterators_core$1().IteratorPrototype;
	var DESCRIPTORS = require_descriptors$1();
	var IS_PURE = require_is_pure$1();
...
var require_define_built_ins$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var defineBuiltIn = require_define_built_in$1();
...
var require_create_iter_result_object$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_iterator_close_all$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var iteratorClose = require_iterator_close$1();
...
var require_iterator_create_proxy$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
	var create = require_object_create$1();
	var createNonEnumerableProperty = require_create_non_enumerable_property$1();
	var defineBuiltIns = require_define_built_ins$1();
	var wellKnownSymbol = require_well_known_symbol$1();
	var InternalStateModule = require_internal_state$1();
	var getMethod = require_get_method$1();
	var IteratorPrototype = require_iterators_core$1().IteratorPrototype;
	var createIterResultObject = require_create_iter_result_object$1();
	var iteratorClose = require_iterator_close$1();
	var iteratorCloseAll = require_iterator_close_all$1();
	var TO_STRING_TAG = wellKnownSymbol("toStringTag");
...
var require_call_with_safe_iteration_closing$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var anObject = require_an_object$1();
	var iteratorClose = require_iterator_close$1();
...
var require_iterator_helper_throws_on_invalid_iterator$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_iterator_helper_without_closing_on_early_error$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
...
var require_es_iterator_map$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var call = require_function_call$1();
	var aCallable = require_a_callable$1();
	var anObject = require_an_object$1();
	var getIteratorDirect = require_get_iterator_direct$1();
	var createIteratorProxy = require_iterator_create_proxy$1();
	var callWithSafeIterationClosing = require_call_with_safe_iteration_closing$1();
	var iteratorClose = require_iterator_close$1();
	var iteratorHelperThrowsOnInvalidIterator = require_iterator_helper_throws_on_invalid_iterator$1();
	var iteratorHelperWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1();
	var IS_PURE = require_is_pure$1();
...
var require__isKeyable = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Checks if `value` is suitable for use as unique object key.
	*
	* @private
...
var require__getMapData = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_iterator_constructor$1();
	require_es_iterator_map$1();
...
var require__mapCacheDelete = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__mapCacheGet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getMapData = require__getMapData();
	/**
	* Gets the map value for `key`.
	*
...
var require__mapCacheHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getMapData = require__getMapData();
	/**
	* Checks if a map value for `key` exists.
	*
...
var require__mapCacheSet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var getMapData = require__getMapData();
	/**
	* Sets the map `key` to `value`.
	*
...
var require__MapCache = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__stackSet = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
...
var require__Stack = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__setCacheAdd = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/** Used to stand-in for `undefined` hash values. */
	var HASH_UNDEFINED = "__lodash_hash_undefined__";
	/**
...
var require__setCacheHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
...
var require__SetCache = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
...
var require__arraySome = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
...
var require__cacheHas = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
...
var require__equalArrays = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
...
var require__Uint8Array = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__root().Uint8Array;
}));
var require_function_uncurry_this_clause$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var classofRaw = require_classof_raw$1();
	var uncurryThis = require_function_uncurry_this$1();
	module.exports = function(fn) {
		if (classofRaw(fn) === "Function") return uncurryThis(fn);
	};
}));
var require_function_bind_context$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this_clause$1();
	var aCallable = require_a_callable$1();
	var NATIVE_BIND = require_function_bind_native$1();
...
var require_iterators$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = {};
}));
var require_is_array_iterator_method$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var wellKnownSymbol = require_well_known_symbol$1();
	var Iterators = require_iterators$1();
	var ITERATOR = wellKnownSymbol("iterator");
	var ArrayPrototype = Array.prototype;
	module.exports = function(it) {
...
var require_to_string_tag_support$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var TO_STRING_TAG = require_well_known_symbol$1()("toStringTag");
	var test = {};
	test[TO_STRING_TAG] = "z";
	module.exports = String(test) === "[object z]";
}));
var require_classof$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var TO_STRING_TAG_SUPPORT = require_to_string_tag_support$1();
	var isCallable = require_is_callable$1();
	var classofRaw = require_classof_raw$1();
	var TO_STRING_TAG = require_well_known_symbol$1()("toStringTag");
	var $Object = Object;
...
var require_get_iterator_method$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var classof = require_classof$1();
	var getMethod = require_get_method$1();
	var isNullOrUndefined = require_is_null_or_undefined$1();
	var Iterators = require_iterators$1();
	var ITERATOR = require_well_known_symbol$1()("iterator");
	module.exports = function(it) {
		if (!isNullOrUndefined(it)) return getMethod(it, ITERATOR) || getMethod(it, "@@iterator") || Iterators[classof(it)];
	};
}));
var require_get_iterator$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var call = require_function_call$1();
	var aCallable = require_a_callable$1();
	var anObject = require_an_object$1();
	var tryToString = require_try_to_string$1();
	var getIteratorMethod = require_get_iterator_method$1();
	var $TypeError = TypeError;
...
var require_iterate$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var bind = require_function_bind_context$1();
	var call = require_function_call$1();
	var anObject = require_an_object$1();
	var tryToString = require_try_to_string$1();
	var isArrayIteratorMethod = require_is_array_iterator_method$1();
	var lengthOfArrayLike = require_length_of_array_like$1();
	var isPrototypeOf = require_object_is_prototype_of$1();
	var getIterator = require_get_iterator$1();
	var getIteratorMethod = require_get_iterator_method$1();
	var iteratorClose = require_iterator_close$1();
	var $TypeError = TypeError;
...
var require_es_iterator_for_each$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var call = require_function_call$1();
	var iterate = require_iterate$1();
	var aCallable = require_a_callable$1();
	var anObject = require_an_object$1();
	var getIteratorDirect = require_get_iterator_direct$1();
	var iteratorClose = require_iterator_close$1();
	var forEachWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1()("forEach", TypeError);
	$({
		target: "Iterator",
		proto: true,
		real: true,
...
var require__mapToArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_iterator_constructor$1();
	require_es_iterator_for_each$1();
	/**
	* Converts `map` to its key-value pairs.
	*
	* @private
...
var require__setToArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_iterator_constructor$1();
	require_es_iterator_for_each$1();
	/**
	* Converts `set` to an array of its values.
...
var require__equalByTag = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__arrayPush = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Appends the elements of `values` to `array`.
	*
	* @private
...
var require_isArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Array.isArray;
}));
var require__baseGetAllKeys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__arrayFilter = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
...
var require_stubArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* This method returns a new empty array.
	*
	* @static
...
var require__getSymbols = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__baseTimes = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* The base implementation of `_.times` without support for iteratee shorthands
	* or max array length checks.
	*
...
var require_isObjectLike = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Checks if `value` is object-like. A value is object-like if it's not `null`
	* and has a `typeof` result of "object".
	*
...
var require__baseIsArguments = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_isArguments = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_stubFalse = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* This method returns `false`.
	*
	* @static
...
var require_isBuffer = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__isIndex = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/** Used as references for various `Number` constants. */
	var MAX_SAFE_INTEGER = 9007199254740991;
	/** Used to detect unsigned integer values. */
	var reIsUint = /^(?:0|[1-9]\d*)$/;
...
var require_isLength = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/** Used as references for various `Number` constants. */
	var MAX_SAFE_INTEGER = 9007199254740991;
	/**
	* Checks if `value` is a valid array-like length.
...
var require__baseIsTypedArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__baseUnary = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
...
var require__nodeUtil = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var freeGlobal = require__freeGlobal();
	/** Detect free variable `exports`. */
	var freeExports = typeof exports == "object" && exports && !exports.nodeType && exports;
	/** Detect free variable `module`. */
...
var require_isTypedArray = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__arrayLikeKeys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
...
var require__isPrototype = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/** Used for built-in method references. */
	var objectProto = Object.prototype;
	/**
	* Checks if `value` is likely a prototype object.
...
var require__overArg = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	/**
	* Creates a unary function that invokes `func` with its argument transformed.
	*
	* @private
...
var require__nativeKeys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__overArg()(Object.keys, Object);
}));
var require__baseKeys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_push();
...
var require_isArrayLike = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_keys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__getAllKeys = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__equalObjects = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_array_buffer_basic_detection$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = typeof ArrayBuffer != "undefined" && typeof DataView != "undefined";
}));
var require_array_buffer_byte_length$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var uncurryThisAccessor = require_function_uncurry_this_accessor$1();
	var classof = require_classof_raw$1();
...
var require_array_buffer_is_detached$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var NATIVE_ARRAY_BUFFER = require_array_buffer_basic_detection$1();
	var arrayBufferByteLength = require_array_buffer_byte_length$1();
...
var require_es_array_buffer_detached$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var DESCRIPTORS = require_descriptors$1();
	var defineBuiltInAccessor = require_define_built_in_accessor$1();
	var isDetached = require_array_buffer_is_detached$1();
...
var require_to_index$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var toIntegerOrInfinity = require_to_integer_or_infinity$1();
	var toLength = require_to_length$1();
	var $RangeError = RangeError;
	module.exports = function(it) {
...
var require_array_buffer_not_detached$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isDetached = require_array_buffer_is_detached$1();
	var $TypeError = TypeError;
	module.exports = function(it) {
...
var require_environment$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var userAgent = require_environment_user_agent$1();
	var classof = require_classof_raw$1();
...
var require_environment_is_node$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_environment$1() === "NODE";
}));
var require_get_built_in_node_module$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var IS_NODE = require_environment_is_node$1();
	module.exports = function(name) {
		if (IS_NODE) {
			try {
...
var require_structured_clone_proper_transfer$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var fails = require_fails$1();
	var V8 = require_environment_v8_version$1();
	var ENVIRONMENT = require_environment$1();
...
var require_detach_transferable$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var getBuiltInNodeModule = require_get_built_in_node_module$1();
	var PROPER_STRUCTURED_CLONE_TRANSFER = require_structured_clone_proper_transfer$1();
	var structuredClone = globalThis.structuredClone;
	var $ArrayBuffer = globalThis.ArrayBuffer;
...
var require_array_buffer_transfer$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
	var uncurryThis = require_function_uncurry_this$1();
	var uncurryThisAccessor = require_function_uncurry_this_accessor$1();
	var toIndex = require_to_index$1();
	var notDetached = require_array_buffer_not_detached$1();
	var arrayBufferByteLength = require_array_buffer_byte_length$1();
	var detachTransferable = require_detach_transferable$1();
	var PROPER_STRUCTURED_CLONE_TRANSFER = require_structured_clone_proper_transfer$1();
	var structuredClone = globalThis.structuredClone;
	var ArrayBuffer = globalThis.ArrayBuffer;
	var DataView = globalThis.DataView;
...
var require_es_array_buffer_transfer$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var $transfer = require_array_buffer_transfer$1();
	if ($transfer) $({
		target: "ArrayBuffer",
		proto: true
...
var require_es_array_buffer_transfer_to_fixed_length$1 = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var $transfer = require_array_buffer_transfer$1();
	if ($transfer) $({
		target: "ArrayBuffer",
...
var require__DataView = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(require__root(), "DataView");
}));
var require__Promise = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(require__root(), "Promise");
}));
var require__Set = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(require__root(), "Set");
}));
var require__WeakMap = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require__getNative()(require__root(), "WeakMap");
}));
var require__getTag = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	require_es_array_buffer_detached$1();
	require_es_array_buffer_transfer$1();
	require_es_array_buffer_transfer_to_fixed_length$1();
...
var require__baseIsEqualDeep = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require__baseIsEqual = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_isEqual = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_es_iterator_find = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var call = require_function_call$1();
	var iterate = require_iterate$1();
	var aCallable = require_a_callable$1();
	...
	var getIteratorDirect = require_get_iterator_direct$1();
	var iteratorClose = require_iterator_close$1();
	var findWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1()("find", TypeError);
	$({
		target: "Iterator",
		proto: true,
		real: true,
...
*/
function findHTMLElementFromVueRef(ref) {
...
var require_map_helpers = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
...
var require_es_map_get_or_insert = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
...
var require_es_map_get_or_insert_computed = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var aCallable = require_a_callable$1();
	var MapHelpers = require_map_helpers();
	var IS_PURE = require_is_pure$1();
...
function getRunningContext(callingInstance) {
	if (!callingInstance.$fkui) throw new Error("Application running context is unset. Call `setRunningContext(app)` after `app = createApp(..)`.");
...
function getTargetElement(target) {
	...
	if (!element) throw new Error(`mountComponent(..) requires a target element (selector "${target}" returned no element)`);
	return element;
}
function createContainer(options) {
	...
	const element = document.createElement("div");
	if (attachFirst) parent.insertBefore(element, parent.firstChild);
...
function mountComponent(callingInstance, Component, options = {}) {
	if (!Component) throw new Error("mountComponent(..) called without a component");
	...
	if (fkuiContext) Object.assign(app._context, fkuiContext.appContext);
	app.mount(el);
...
function unpackPayload(event, src) {
	const { reason = event, data: rawData } = src !== null && src !== void 0 ? src : {};
	return {
		reason,
		data: rawData
	};
...
function openModal(callingInstance, Component, options) {
	if (typeof options === "string") return openModal(callingInstance, Component, { props: { content: options } });
...
async function formModal(callingInstance, Component, options) {
	...
	if (result.reason === "submit") return result.data;
	else throw "cancel";
}
/** @internal */
function focusElement(element, container) {
	if (elementIsRadioButton(element)) focusRadioButtonGroup(element, container);
	else focus$1(element);
}
/** @internal */
function focusRadioButtonGroup(element, container) {
	...
	if (checkedRadioButton) focus$1(checkedRadioButton);
	else focus$1(element);
}
/** @internal */
...
function sizeClass(size) {
	if (!size) return [];
	else if (size === "fullscreen") return [`modal__dialog-container--fullwidth`];
	else return [`modal__dialog-container--${size}`];
}
/**
* Level: Ready
*/
var FModal_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	computed: {
		...
		containerClasses() {
			...
			if (this.fullscreen) return [...size, "modal__dialog-container--fullscreen"];
			else return size;
		},
		hasHeaderSlot() {
	...
	methods: {
		...
		openModal() {
			...
			} else if (this.focus === "open") focus$1(focusElement);
		},
		/**
		...
		*/
		...
		onFocusFirst() {
			focusElement(findTabbableElements(this.$refs.modalDialogContainer).at(-2), this.$el);
		},
		onFocusLast() {
			const firstTabbableElement = findTabbableElements(this.$refs.modalDialogContainer)[1];
			focusElement(firstTabbableElement, this.$el);
		}
	}
});
var _hoisted_1$78 = ["id"];
var _hoisted_2$57 = { class: "modal__backdrop" };
var _hoisted_3$42 = { class: "modal__inner-container" };
var _hoisted_4$33 = { class: "modal__dialog" };
var _hoisted_5$25 = { class: "modal__dialog-inner" };
var _hoisted_6$18 = { class: "modal__header" };
var _hoisted_7$14 = {
	key: 0,
	ref: "modalTitle",
	class: "modal__title",
...
var _hoisted_9$8 = { class: "modal__footer" };
var _hoisted_10$5 = { class: "modal__shelf" };
...
function _sfc_render$49(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return _ctx.isOpen ? (openBlock(), createElementBlock("div", {
	...
	}, [createBaseVNode("div", _hoisted_2$57, [createBaseVNode("div", {
		class: "modal__outer-container scroll-target",
		tabindex: "-1",
		role: "dialog",
		"aria-modal": "true",
		onKeyup: _cache[3] || (_cache[3] = withKeys((...args) => _ctx.onClose && _ctx.onClose(...args), ["esc"]))
	}, [createBaseVNode("div", _hoisted_3$42, [createBaseVNode("div", {
		ref: "modalDialogContainer",
		class: normalizeClass(["modal__dialog-container", _ctx.containerClasses])
	}, [createBaseVNode("div", _hoisted_4$33, [
		createBaseVNode("div", _hoisted_5$25, [
			createBaseVNode("div", _hoisted_6$18, [
				createBaseVNode("div", {
					tabindex: "0",
					onFocus: _cache[0] || (_cache[0] = (...args) => _ctx.onFocusFirst && _ctx.onFocusFirst(...args))
				}, null, 32),
				_cache[4] || (_cache[4] = createTextVNode()),
				_ctx.hasHeaderSlot ? (openBlock(), createElementBlock("h1", _hoisted_7$14, [renderSlot(_ctx.$slots, "header")], 512)) : createCommentVNode("", true)
			]),
			_cache[5] || (_cache[5] = createTextVNode()),
			createBaseVNode("div", _hoisted_8$10, [renderSlot(_ctx.$slots, "content")], 512),
			_cache[6] || (_cache[6] = createTextVNode()),
			createBaseVNode("div", _hoisted_9$8, [renderSlot(_ctx.$slots, "footer")])
		]),
		...
		createBaseVNode("div", _hoisted_10$5, [
			createBaseVNode("button", {
				...
				createBaseVNode("span", null, toDisplayString(_ctx.$t("fkui.modal.close", "Stäng")), 1),
				_cache[7] || (_cache[7] = createTextVNode()),
				createVNode(_component_f_icon, { name: "close" })
			], 8, _hoisted_11$4),
...
var FConfirmModal_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	computed: { preparedButtons() {
		...
		return config.buttonOrder === FKUIConfigButtonOrder.RIGHT_TO_LEFT ? preparedButtonList.toReversed() : preparedButtonList;
	} },
	methods: {
		onClose() {
...
var _hoisted_1$77 = { class: "button-group" };
var _hoisted_2$56 = ["onClick"];
var _hoisted_3$41 = {
	key: 0,
	class: "sr-only"
};
function _sfc_render$48(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_modal, {
		...
		footer: withCtx(() => [createBaseVNode("div", _hoisted_1$77, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
			return openBlock(), createElementBlock("button", {
				...
				createBaseVNode("span", null, toDisplayString(button.label), 1),
				_cache[0] || (_cache[0] = createTextVNode()),
				button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$41, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)
			], 10, _hoisted_2$56);
		}), 128))])]),
		_: 3
	}, 8, [
...
function focusError(item) {
	...
	const focusElement = document.querySelector(`#${String(item.focusElementId)}`);
	scrollTo(element, window.innerHeight * .25);
...
var FErrorList_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: { async onClickItem(item) {
		await this.beforeNavigate(item);
		focusError(item);
	} }
});
var _hoisted_1$76 = { class: "error-list" };
var _hoisted_2$55 = { key: 0 };
var _hoisted_3$40 = { class: "error-list__list error-list--list-style-none" };
var _hoisted_4$32 = ["onClick"];
var _hoisted_5$24 = { class: "error-list__link" };
function _sfc_render$45(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$76, [createVNode(_component_i_flex, null, {
		default: withCtx(() => [
			_ctx.hasTitleSlot ? (openBlock(), createBlock(_component_i_flex_item, {
				key: 0,
				shrink: ""
			}, {
			...
			_cache[7] || (_cache[7] = createTextVNode()),
			createVNode(_component_i_flex_item, { grow: "" }, {
				default: withCtx(() => [
					_ctx.hasTitleSlot ? (openBlock(), createElementBlock("div", _hoisted_2$55, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true),
					_cache[5] || (_cache[5] = createTextVNode()),
					createBaseVNode("ul", _hoisted_3$40, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item) => {
						return openBlock(), createElementBlock("li", { key: item.id }, [item.id ? (openBlock(), createElementBlock("a", {
							key: 0,
							href: "javascript:",
							...
							_cache[2] || (_cache[2] = createTextVNode()),
							createBaseVNode("span", _hoisted_5$24, toDisplayString(item.title), 1)
						], 8, _hoisted_4$32)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
var require_es_iterator_every = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var call = require_function_call$1();
	var iterate = require_iterate$1();
	var aCallable = require_a_callable$1();
	...
	var getIteratorDirect = require_get_iterator_direct$1();
	var iteratorClose = require_iterator_close$1();
	var everyWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1()("every", TypeError);
	$({
		target: "Iterator",
		proto: true,
		real: true,
...
var require_es_iterator_filter = /* @__PURE__ */ __commonJSMin$1((() => {
	var $ = require_export$1();
	var call = require_function_call$1();
	var aCallable = require_a_callable$1();
	var anObject = require_an_object$1();
...
function cleanUpElements(vm) {
	return new Promise((resolve) => {
		...
		*/
		window.setTimeout(() => {
			for (const id of Object.keys(vm.components)) if (!vm.$el.querySelector(`#${id}`)) delete vm.components[id];
			resolve();
		}, 0);
	});
}
...
* @public
*/
var FValidationFormAction = /* @__PURE__ */ function(FValidationFormAction) {
	FValidationFormAction[FValidationFormAction["CONTINUE"] = 0] = "CONTINUE";
	FValidationFormAction[FValidationFormAction["CANCEL"] = 1] = "CANCEL";
...
var FValidationForm_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		async hasFormErrors() {
			...
			if (this.validity.isValid) return false;
...
function _sfc_render$43(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_validation_group, {
		...
		default: withCtx(() => [createBaseVNode("form", mergeProps({ id: _ctx.id }, _ctx.$attrs, {
			novalidate: "",
			autocomplete: "off",
			onSubmit: _cache[0] || (_cache[0] = withModifiers((...args) => _ctx.onSubmit && _ctx.onSubmit(...args), ["prevent"]))
		}), [
			_ctx.displayErrors ? (openBlock(), createElementBlock("nav", _hoisted_2$54, [createVNode(_component_f_error_list, {
				items: _ctx.errors,
				"before-navigate": _ctx.errorListBeforeNavigate
			}, {
				title: withCtx(() => [renderSlot(_ctx.$slots, "error-message")]),
				_: 3
			}, 8, ["items", "before-navigate"])], 512)) : createCommentVNode("", true),
			_cache[2] || (_cache[2] = createTextVNode()),
			renderSlot(_ctx.$slots, "default")
		], 16, _hoisted_1$75)]),
		_: 3
...
var FValidationForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FValidationForm_vue_vue_type_script_lang_default, [["render", _sfc_render$43]]);
var FFormModal_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FFormModal",
	components: {
		FModal: FModal_default,
		FValidationForm: FValidationForm_default
	},
	mixins: [TranslationMixin],
	inheritAttrs: true,
	props: {
...
var _hoisted_1$74 = { class: "button-group" };
var _hoisted_2$53 = [
	"type",
	"form",
	"onClick"
...
function _sfc_render$42(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createBlock(_component_f_modal, {
		...
		content: withCtx(() => [
			...
			_cache[1] || (_cache[1] = createTextVNode()),
			createVNode(_component_f_validation_form, {
				id: _ctx.formId,
		...
		footer: withCtx(() => [createBaseVNode("div", _hoisted_1$74, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.preparedButtons, (button) => {
			return openBlock(), createElementBlock("button", {
				key: button.label,
				...
				createBaseVNode("span", null, toDisplayString(button.label), 1),
				_cache[2] || (_cache[2] = createTextVNode()),
				button.screenreader ? (openBlock(), createElementBlock("span", _hoisted_3$39, "\xA0" + toDisplayString(button.screenreader), 1)) : createCommentVNode("", true)
			], 10, _hoisted_2$53);
		}), 128))])]),
		_: 3
	}, 8, [
...
async function confirmModal(callingInstance, texts) {
	...
	const { reason } = await openModal(callingInstance, FConfirmModal_default, { props: {
...
var require_function_apply$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var NATIVE_BIND = require_function_bind_native$1();
	var FunctionPrototype = Function.prototype;
...
(/* @__PURE__ */ __commonJSMin$1((() => {
	...
	var iteratorClose = require_iterator_close$1();
	var iteratorHelperWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1();
	var apply = require_function_apply$1();
	var fails = require_fails$1();
	var $TypeError = TypeError;
...
var _hoisted_1$67 = ["id"];
var _hoisted_2$48 = {
	key: 0,
	class: "card__header"
};
var _hoisted_3$35 = { class: "card__content" };
var _hoisted_4$28 = {
	key: 1,
	class: "card__footer"
};
var FCard_default = /* @__PURE__ */ defineComponent({
	__name: "FCard",
	props: {
		/**
	...
	setup(__props) {
		...
		const validationMessage = /* @__PURE__ */ ref("");
		const hasError = /* @__PURE__ */ ref(false);
		...
		function onValidity({ detail }) {
			if (!isMounted.value) return;
			if (detail.elementId !== props.id) return;
			if (!props.focusRef) throw new Error("Element to focus on when card is invalid (`focusRef`) is required when using card validation.");
			...
			if (!focusElementId) throw new Error("An id must be set on the card's focus element.");
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				hasHeaderSlot.value ? (openBlock(), createElementBlock("div", _hoisted_2$48, [renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ headingSlotClass: "card__header-label" })))])) : createCommentVNode("", true),
				_cache[1] || (_cache[1] = createTextVNode()),
				renderSlot(_ctx.$slots, "error-message", normalizeProps(guardReactiveProps({
					hasError: hasError.value,
					validationMessage: validationMessage.value
				})), () => [hasError.value ? (openBlock(), createBlock(unref(IFlex_default), {
					key: 0,
					gap: "1x",
					...
					default: withCtx(() => [
						createVNode(unref(IFlexItem_default), {
							...
							default: withCtx(() => [createVNode(unref(FIcon_default), { name: "error" })]),
							_: 1
						}),
						_cache[0] || (_cache[0] = createTextVNode()),
				...
				_cache[2] || (_cache[2] = createTextVNode()),
				createBaseVNode("div", _hoisted_3$35, [renderSlot(_ctx.$slots, "default")]),
				_cache[3] || (_cache[3] = createTextVNode()),
				hasFooterSlot.value ? (openBlock(), createElementBlock("div", _hoisted_4$28, [renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps({
					hasError: hasError.value,
					validationMessage: validationMessage.value
				})))])) : createCommentVNode("", true)
			], 42, _hoisted_1$67);
...
(/* @__PURE__ */ __commonJSMin$1((() => {
	...
	var getIteratorDirect = require_get_iterator_direct$1();
	var iteratorClose = require_iterator_close$1();
	var someWithoutClosingOnEarlyError = require_iterator_helper_without_closing_on_early_error$1()("some", TypeError);
	$({
		target: "Iterator",
		proto: true,
		real: true,
...
function getCandidates(anchor, target, clippedArea, spacing, candidateOrder) {
	...
	if (candidateOrder === "IPopupError") return [
		b,
		a,
		d,
		c,
...
function isInside(outer, inner, spacing) {
	const xSpacing = inner.direction === 0 || inner.direction === 2 ? spacing : 0;
	const ySpacing = inner.direction === 1 || inner.direction === 2 ? spacing : 0;
...
var IPopupError_default = /* @__PURE__ */ defineComponent({
	__name: "IPopupError",
	props: {
		isOpen: { type: Boolean },
		errorMessage: { default: "Error" },
		anchor: { default: () => void 0 },
		arrowAnchor: { default: () => void 0 },
		layout: {}
	},
	emits: ["close"],
	setup(__props, { emit: __emit }) {
		...
		const teleportDisabled = /* @__PURE__ */ ref(false);
		const placement = /* @__PURE__ */ ref(Placement.NotCalculated);
		const arrowPosition = /* @__PURE__ */ ref("top");
		const arrowOffset = /* @__PURE__ */ ref(24);
		const popupClasses = computed(() => {
			return ["popup-error", ...teleportDisabled.value || placement.value === Placement.Fallback ? ["popup-error--inline"] : ["popup-error--overlay"]];
		});
		...
		function setArrowOffset() {
			var _props$arrowAnchor;
			const targetArrowAnchor = (_props$arrowAnchor = __props.arrowAnchor) !== null && _props$arrowAnchor !== void 0 ? _props$arrowAnchor : __props.anchor?.nextElementSibling;
			if (!targetArrowAnchor || !wrapperRef.value) return;
		...
		async function toggleIsOpen(isOpen) {
			...
			if (!__props.anchor) throw new Error("No anchor element found");
		...
		function onResize() {
			toggleIsOpen(__props.isOpen);
		}
		function onScroll(event) {
			if (event.target instanceof HTMLElement && Boolean(event.target.closest(".popup-error"))) return;
			toggleIsOpen(__props.isOpen);
		}
		const debouncedOnResize = debounce(onResize, 100);
		const debouncedOnScroll = debounce(onScroll, 100);
		watch(() => __props.anchor, (anchorElement, _, onCleanup) => {
		...
		return (_ctx, _cache) => {
			return __props.isOpen ? (openBlock(), createBlock(Teleport, {
				...
				class: normalizeClass(popupClasses.value),
				"aria-hidden": "true"
			}, [createBaseVNode("div", _hoisted_1$66, [createBaseVNode("div", {
				class: normalizeClass(arrowClass.value),
				style: normalizeStyle(errorStyle.value)
			}, [
				__props.layout === "f-table" ? (openBlock(), createBlock(unref(FIcon_default), {
					key: 0,
				...
				_cache[1] || (_cache[1] = createTextVNode()),
				__props.layout === "f-interactive-table" ? (openBlock(), createElementBlock("button", {
					key: 1,
					tabindex: "-1",
					type: "button",
...
var _hoisted_1$65 = ["onKeyup"];
var _hoisted_2$47 = { ref: "content" };
...
var IPopupListbox_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}), [createBaseVNode("div", _hoisted_2$47, [renderSlot(_ctx.$slots, "default")], 512)], 16, _hoisted_1$65)], 512)], 8, ["to"])) : createCommentVNode("", true);
		};
	}
});
...
function noop$3() {}
var IAnimateExpand_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "IAnimateExpand",
	props: {
		/**
	...
	computed: {
		...
		shouldVIf() {
			if (this.useVShow) return true;
			else return this.internalExpanded;
		},
		shouldVShow() {
			if (this.useVShow) return this.internalExpanded;
			else return true;
		}
	},
	watch: { expanded: {
		immediate: false,
		handler() {
			if (this.expanded && this.animate) this.openAnimation();
			else if (this.expanded) this.openNoAnimation();
			else if (this.animate) this.closeAnimation();
			else this.closeNoAnimation();
		}
	} },
	beforeMount() {
		if (this.expanded) this.height = "";
		else if (this.animate) this.cssClasses = this.opacity ? CLOSED_CSS_CLASS_OPACITY : CLOSED_CSS_CLASS;
	},
	methods: {
		getContentHeight() {
		...
		async openAnimation() {
			...
			this.height = this.getContentHeight();
			for (const timer of this.timerList) clearTimeout(timer);
...
function _sfc_render$32(_ctx, _cache, $props, $setup, $data, $options) {
	...
	}, [_ctx.shouldVIf ? withDirectives((openBlock(), createElementBlock("div", _hoisted_1$63, [renderSlot(_ctx.$slots, "default")], 512)), [[vShow, _ctx.shouldVShow]]) : createCommentVNode("", true)], 6);
}
var IAnimateExpand_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(IAnimateExpand_vue_vue_type_script_lang_default, [["render", _sfc_render$32]]);
...
var _hoisted_1$61 = { class: "combobox" };
var _hoisted_2$45 = ["id"];
var _hoisted_3$33 = [
	"id",
	"aria-selected",
	"onClick"
...
var IComboboxDropdown_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$61, [createVNode(unref(IPopupListbox_default), {
				...
				default: withCtx(() => [createBaseVNode("ul", {
					...
					}, toDisplayString(item), 11, _hoisted_3$33);
				}), 128))], 8, _hoisted_2$45)]),
				_: 1
			}, 8, [
				"is-open",
...
var IComboboxToggleButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, ["rotate"])], 8, _hoisted_1$60);
		};
	}
});
var openedStyle = { height: "auto" };
var initialStyle = {
	overflow: "hidden",
...
var FExpand_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FExpand",
	data() {
		return { height: 0 };
	},
...
var FExpand_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FExpand_vue_vue_type_script_lang_default, [["render", _sfc_render$30]]);
/**
* @internal
*/
...
function* contentClasses(options) {
	...
	if (hasRadiobutton) yield "radio-button-group__content";
	if (hasCheckbox) yield "checkbox-group__content";
	yield contentClass;
}
/**
* @internal
...
var FFieldset_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	computed: {
		...
		groupLabelClassTooltip() {
			if (this.hasDescriptionSlot || this.hasErrorMessageSlot || this.hasError) return [];
			else return this.groupLabelClass;
		},
		groupContentClass() {
	...
	async mounted() {
		await this.$nextTick();
		const types = new Set(Array.from(this.$el.querySelectorAll(`input[type="checkbox"], input[type="radio"]`), (it) => it.getAttribute("type")));
		this.hasCheckbox = types.has("checkbox");
		this.hasRadiobutton = types.has("radio");
		if (this.hasCheckbox) this.updateCheckboxChildren();
	},
	updated() {
		if (this.hasCheckbox) this.debouncedUpdateChildren();
	},
	methods: {
		async onValidity({ detail }) {
			...
			if (this.validityElement) dispatchComponentValidityEvent(this.validityElement, this.dispatchObject);
		...
		*/
		...
		async updateCheckboxChildren() {
			...
			if (!isEqual$1(this.children, checkboxes)) this.children = checkboxes;
		}
	}
});
...
var _hoisted_5$19 = { key: 0 };
var _hoisted_6$14 = { key: 1 };
var _hoisted_7$11 = { "aria-hidden": "true" };
var _hoisted_8$7 = {
	key: 0,
	class: "label__message label__message--error"
};
function _sfc_render$28(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("fieldset", {
		...
		(openBlock(), createElementBlock("legend", {
			...
			_cache[1] || (_cache[1] = createTextVNode()),
			_ctx.hasCheckbox && _ctx.children.length > 1 ? (openBlock(), createElementBlock("span", _hoisted_2$43, [createBaseVNode("span", null, toDisplayString(_ctx.numberOfCheckboxesScreenReaderText), 1)])) : createCommentVNode("", true),
			_cache[2] || (_cache[2] = createTextVNode()),
			...
			})), () => [_ctx.hasError ? (openBlock(), createElementBlock("span", _hoisted_3$31, [createVNode(_component_f_icon, {
				class: "label__icon--left",
				name: "error"
			}), createTextVNode(" " + toDisplayString(_ctx.validity.validationMessage), 1)])) : createCommentVNode("", true)])
		], 2)),
		_cache[7] || (_cache[7] = createTextVNode()),
		_ctx.hasCheckbox ? (openBlock(), createElementBlock("span", _hoisted_4$25, [_ctx.children.length === 1 ? (openBlock(), createElementBlock("span", _hoisted_5$19, toDisplayString(_ctx.checkboxCheckedScreenReaderText), 1)) : (openBlock(), createElementBlock("span", _hoisted_6$14, toDisplayString(_ctx.numberOfCheckedCheckboxesScreenText), 1))])) : createCommentVNode("", true),
		_cache[8] || (_cache[8] = createTextVNode()),
		_ctx.hasTooltipSlot ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
			createBaseVNode("div", {
				ref: "tooltipAttachTo",
				class: normalizeClass(["label", _ctx.groupLabelClassTooltip])
			}, [createBaseVNode("span", _hoisted_7$11, [renderSlot(_ctx.$slots, "label")])], 2),
			_cache[5] || (_cache[5] = createTextVNode()),
			renderSlot(_ctx.$slots, "tooltip"),
			_cache[6] || (_cache[6] = createTextVNode()),
			_ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot || _ctx.hasError ? (openBlock(), createElementBlock("div", {
				key: 0,
...
var _hoisted_3$28 = ["for"];
var _hoisted_4$22 = ["for"];
var _hoisted_5$17 = {
	key: 0,
	class: "label__message label__message--error"
};
...
function _sfc_render$26(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_icon = resolveComponent("f-icon");
	return _ctx.$slots.tooltip ? (openBlock(), createElementBlock("div", _hoisted_1$53, [
		_ctx.hasDefaultSlot ? (openBlock(), createElementBlock("div", _hoisted_2$39, [createBaseVNode("label", {
			class: "label",
			for: _ctx.forProperty
		}, [renderSlot(_ctx.$slots, "default")], 8, _hoisted_3$28)], 512)) : createCommentVNode("", true),
		_cache[2] || (_cache[2] = createTextVNode()),
		renderSlot(_ctx.$slots, "tooltip"),
		_cache[3] || (_cache[3] = createTextVNode()),
		_ctx.hasDescriptionSlot || _ctx.hasErrorMessageSlot ? (openBlock(), createElementBlock("label", {
			...
			_cache[1] || (_cache[1] = createTextVNode()),
			_ctx.hasErrorMessageSlot ? (openBlock(), createElementBlock("span", _hoisted_5$17, [
		...
		_cache[6] || (_cache[6] = createTextVNode()),
		_ctx.hasErrorMessageSlot ? (openBlock(), createElementBlock("span", _hoisted_7$10, [
			createVNode(_component_f_icon, {
				class: "label__icon--left",
				name: "error"
			}),
...
var FNumericTextField_default = /* @__PURE__ */ defineComponent({
	name: "FNumericTextField",
	extends: FTextField_default,
	props: {
		/**
	...
	mounted() {
		...
		ValidationService.addValidatorsToElement(inputElement, { number: {} }, true);
		ValidationService.validateElement(inputElement);
	}
});
var require_array_from_constructor_and_list$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var lengthOfArrayLike = require_length_of_array_like$1();
...
var require_get_built_in_prototype_method = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var globalThis = require_global_this$1();
...
(/* @__PURE__ */ __commonJSMin$1((() => {
	...
	var aCallable = require_a_callable$1();
	var toIndexedObject = require_to_indexed_object$1();
	var arrayFromConstructorAndList = require_array_from_constructor_and_list$1();
...
var require_to_string$1 = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var classof = require_classof$1();
	var $String = String;
	module.exports = function(argument) {
...
var require_parse_json_string = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var uncurryThis = require_function_uncurry_this$1();
	var hasOwn = require_has_own_property$1();
...
(/* @__PURE__ */ __commonJSMin$1((() => {
	...
	var isArray = require_is_array();
	var hasOwn = require_has_own_property$1();
	var toString = require_to_string$1();
	var lengthOfArrayLike = require_length_of_array_like$1();
	var createProperty = require_create_property$1();
	var fails = require_fails$1();
...
var require_is_raw_json = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	var isObject = require_is_object$1();
	var getInternalState = require_internal_state$1().get;
...
var require_array_slice = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = require_function_uncurry_this$1()([].slice);
}));
var require_native_raw_json = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = !require_fails$1()(function() {
		var unsafeInt = "9007199254740993";
...
var FExpandablePanel_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FExpandablePanel",
	components: {
		FIcon: FIcon_default,
		FExpand: FExpand_default
	},
	mixins: [TranslationMixin],
	inheritAttrs: false,
	props: {
...
var _hoisted_1$24 = ["aria-expanded", "aria-controls"];
var _hoisted_2$20 = { class: "expandable-panel__title" };
var _hoisted_3$15 = { class: "expandable-panel__title__text" };
var _hoisted_4$13 = ["title"];
var _hoisted_5$11 = { class: "sr-only" };
var _hoisted_6$9 = { class: "expandable-panel__icon" };
var _hoisted_7$6 = ["id"];
var _hoisted_8$4 = { class: "expandable-panel__body" };
var _hoisted_9$4 = {
	key: 0,
...
function _sfc_render$18(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", { class: normalizeClass(["expandable-panel", _ctx.expandedClass]) }, [
		(openBlock(), createBlock(resolveDynamicComponent(_ctx.headerTag), { class: "expandable-panel__heading" }, {
			default: withCtx(() => [createBaseVNode("button", mergeProps({
				type: "button",
				"aria-expanded": _ctx.expanded ? "true" : "false",
				"aria-controls": _ctx.id
			}, _ctx.$attrs, { onClick: _cache[0] || (_cache[0] = (...args) => _ctx.onClickHeadingButton && _ctx.onClickHeadingButton(...args)) }), [
				createBaseVNode("span", _hoisted_2$20, [
					createBaseVNode("span", _hoisted_3$15, [renderSlot(_ctx.$slots, "title")]),
					_cache[2] || (_cache[2] = createTextVNode()),
					_ctx.haveNotifications ? (openBlock(), createElementBlock("span", {
						key: 0,
						class: "expandable-panel__notification",
						title: _ctx.notificationTitle
					}, [
						createBaseVNode("span", _hoisted_5$11, toDisplayString(_ctx.screenReaderNotificationText), 1),
						_cache[1] || (_cache[1] = createTextVNode()),
						createVNode(_component_f_icon, { name: "bell" })
					], 8, _hoisted_4$13)) : createCommentVNode("", true)
				]),
				_cache[3] || (_cache[3] = createTextVNode()),
				createBaseVNode("span", _hoisted_6$9, [createVNode(_component_f_icon, { name: "arrow-down" })])
			], 16, _hoisted_1$24)]),
			_: 3
		})),
		_cache[5] || (_cache[5] = createTextVNode()),
		createVNode(_component_f_expand, {
			ref: "fexpand",
			height: _ctx.height
		}, {
			default: withCtx(() => [withDirectives(createBaseVNode("div", {
				...
				createBaseVNode("div", _hoisted_8$4, [renderSlot(_ctx.$slots, "default")]),
				_cache[4] || (_cache[4] = createTextVNode()),
				_ctx.hasOutsideSlot ? (openBlock(), createElementBlock("div", _hoisted_9$4, [renderSlot(_ctx.$slots, "outside")])) : createCommentVNode("", true)
			], 8, _hoisted_7$6), [[vShow, _ctx.expanded]])]),
			_: 3
		}, 8, ["height"])
	], 2);
}
var FExpandablePanel_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FExpandablePanel_vue_vue_type_script_lang_default, [["render", _sfc_render$18]]);
var anyType = [
	String,
	Object,
	Array,
...
var FRadioField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	...
	methods: {
		async onValidity({ detail }) {
			if (detail.target !== this.$el.querySelector("input")) return;
			await this.$nextTick();
			let errorMessage = "";
			if (hasSlot(this, "default")) {
				...
				if (labelText) errorMessage = `${labelText} ${slotText}`;
				else errorMessage = slotText;
			}
			const element = this.$el.querySelector(`#${detail.elementId}`);
			if (element) dispatchComponentValidityEvent(element, {
				...detail,
...
function _sfc_render$13$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("input", mergeProps({
			...
			disabled: _ctx.disabled
		}, _ctx.attrs), null, 16, _hoisted_1$20),
		_cache[3] || (_cache[3] = createTextVNode()),
		createBaseVNode("label", {
			...
			renderSlot(_ctx.$slots, "default"),
			_cache[2] || (_cache[2] = createTextVNode()),
			_ctx.$slots.details ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
				_ctx.showDetails === "always" ? (openBlock(), createElementBlock("span", _hoisted_3$11, [renderSlot(_ctx.$slots, "details")])) : createCommentVNode("", true),
				_cache[1] || (_cache[1] = createTextVNode()),
				_ctx.showDetails === "when-selected" ? (openBlock(), createBlock(Transition, {
					key: 1,
					onEnter: _ctx.enter,
					onAfterEnter: _ctx.afterEnter,
					onLeave: _ctx.leave
				}, {
					default: withCtx(() => [_ctx.value === _ctx.modelValue ? (openBlock(), createElementBlock("span", _hoisted_4$10, [renderSlot(_ctx.$slots, "details", { height: _ctx.height })])) : createCommentVNode("", true)]),
					_: 3
				}, 8, [
					"onEnter",
					"onAfterEnter",
...
var FRadioField_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FRadioField_vue_vue_type_script_lang_default, [["render", _sfc_render$13$1]]);
...
var FMessageBox_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FMessageBox",
	components: {
		FIcon: FIcon_default,
		IFlex: IFlex_default,
	...
	computed: {
		messageBoxType() {
			if (this.layout === "short") return `message-box--${this.type}-short`;
			else return `message-box--${this.type}`;
		},
		bannerType() {
...
function _sfc_render$8$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	const _component_i_flex_item = resolveComponent("i-flex-item");
	const _component_i_flex = resolveComponent("i-flex");
	return openBlock(), createElementBlock("div", { class: normalizeClass(["message-box", [_ctx.messageBoxType, _ctx.bannerType]]) }, [
		_ctx.provideScreenReaderContext ? (openBlock(), createElementBlock("span", _hoisted_1$12, toDisplayString(_ctx.screenReaderContext()), 1)) : createCommentVNode("", true),
		_cache[2] || (_cache[2] = createTextVNode()),
		createVNode(_component_i_flex, { gap: "2x" }, {
			default: withCtx(() => [
				_ctx.layout === "short" ? (openBlock(), createBlock(_component_i_flex_item, {
					key: 0,
					class: "message-box__icon",
					shrink: "",
					align: "center"
				}, {
					default: withCtx(() => [createBaseVNode("span", { class: normalizeClass(["icon-stack", _ctx.stackTypeClass]) }, [
						createVNode(_component_f_icon, {
				...
				_cache[1] || (_cache[1] = createTextVNode()),
				createVNode(_component_i_flex_item, {
					class: "message-box__content",
					grow: "",
					align: "center"
				}, {
					default: withCtx(() => [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(_ctx.layout === "short" ? {} : { headingSlotClass: _ctx.headingClass })))]),
					_: 3
				})
			]),
			_: 3
...
var FMessageBox_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FMessageBox_vue_vue_type_script_lang_default, [["render", _sfc_render$8$1]]);
...
var FTextareaField_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FTextareaField",
	components: { FLabel: FLabel_default },
	inheritAttrs: false,
	props: {
		/**
		* The id for the input id attribute.
	...
	computed: {
		...
		charactersLeft() {
			if (this.modelValue) return this.maxlength - this.modelValue.length;
			else return this.maxlength;
		},
		showCharactersLeftWarning() {
			return isSet(this.softLimit) && isSet(this.modelValue) && this.modelValue.length >= this.maxlength - this.softLimit;
		},
		...
		textareaClass() {
			...
			if (this.resizable) classes.push("textarea-field__resize--vertical");
			else classes.push("textarea-field__resize--none");
			return classes;
		}
	},
	mounted() {
		if (isSet(this.softLimit) && !isSet(this.maxlength)) throw new Error("You must pass a maxlength");
	},
	methods: {
		onInput(event) {
...
var _hoisted_1$2$1 = ["id", "disabled"];
function _sfc_render$2$1(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_label = resolveComponent("f-label");
	return openBlock(), createElementBlock("div", { class: normalizeClass(["textarea-field", _ctx.validityClass]) }, [
		createVNode(_component_f_label, { for: _ctx.id }, createSlots({
		...
		_cache[6] || (_cache[6] = createTextVNode()),
		_ctx.softLimit ? (openBlock(), createBlock(_component_f_label, {
			key: 0,
			for: _ctx.id,
			"aria-live": "polite"
		}, {
			description: withCtx(({ descriptionClass }) => [_ctx.showCharactersLeftWarning ? (openBlock(), createElementBlock("span", {
				key: 0,
				class: normalizeClass(descriptionClass)
...
var FTextareaField_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FTextareaField_vue_vue_type_script_lang_default, [["render", _sfc_render$2$1]]);
...
function reindex(dst) {
	...
	for (const [i, element] of dst.entries()) element.stepNumber = i + 1;
}
/**
...
function addStep(dst, key, element) {
	if (dst.findIndex((it) => it.key === key) !== -1) throw new Error(`An FWizardStep with key "${key.toString()}" is already registered, refusing to register multiple steps with same key.`);
	const step = {
		key,
		element,
		stepNumber: -1,
...
var FWizard_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FWizard",
	provide() {
		const wizard = this;
		return {
	...
	watch: { modelValue: { handler() {
		...
		if (!step) throw new Error(`Failed to open step "${this.modelValue}"`);
		if (!step.isOpen) this.openStep(step);
	} } },
	methods: {
		register(key, element) {
			const step = addStep(this.steps, key, element);
			if (this.modelValue !== null) {
				if (step.key === this.modelValue) this.doOpen(step.stepNumber);
			} else if (this.steps.length === 1) this.doOpen(step.stepNumber);
		...
		async openNext(step) {
			const next = step.stepNumber + 1;
			if (next > this.steps.length) {
				await this.doOpen(-1);
				this.$emit("completed");
			} else await this.doOpen(next);
		},
		async doOpen(open) {
			const stepToClose = this.steps.find((it) => it.isOpen);
			if (stepToClose) stepToClose.isOpen = false;
			/**
...
var _hoisted_1$1$1 = { class: "wizard" };
function _sfc_render$1$1(_ctx, _cache, $props, $setup, $data, $options) {
	return openBlock(), createElementBlock("div", _hoisted_1$1$1, [renderSlot(_ctx.$slots, "default")]);
}
var FWizard_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FWizard_vue_vue_type_script_lang_default, [["render", _sfc_render$1$1]]);
...
var FWizardStep_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "FWizardStep",
	components: {
		IAnimateExpand: IAnimateExpand_default,
		IFlex: IFlex_default,
		IFlexItem: IFlexItem_default,
		FValidationForm: FValidationForm_default,
		FIcon: FIcon_default
	...
	computed: {
		...
		cssClass() {
			if (this.isOpen) return "wizard-step--open";
			if (this.isPending) return "wizard-step--pending";
			return "wizard-step--done";
		}
	},
	mounted() {
		const key = getCurrentInstance()?.vnode?.key;
		if (!key) throw new Error("FWizardStep requires key to be set");
		...
		*/
		async beforeAnimation(open) {
			...
			if (!open) {
				...
				if (!index.isVisibleInViewport(headerElement)) {
					ongoingScrollPromise = index.scrollTo(headerElement, {
		...
		async afterAnimation(open) {
			...
			if (this.isOpenedFirstTime) {
				...
				if (this.inheritedProps.disableInitialFocus && this.stepNumber === 1) return;
			}
			const headerElement = findHTMLElementFromVueRef(this.$refs.header);
			await this.$nextTick();
			if (isSet(headerElement) && !index.isVisibleInViewport(headerElement)) await index.scrollTo(headerElement, {
				duration: SCROLL_DURATION,
				offset: 10
			});
			index.focus(headerElement);
		},
		beforeNextWrapper() {
...
var _hoisted_1$11 = ["aria-current"];
var _hoisted_2$9 = {
	"aria-hidden": "true",
	class: "wizard-step__step-of"
};
var _hoisted_3$5 = { class: "wizard-step__icon-container" };
var _hoisted_4$5 = { class: "wizard-step__icon-container__circle" };
var _hoisted_5$5 = {
...
var _hoisted_7$5 = { class: "sr-only" };
var _hoisted_8$1 = { class: "sr-only" };
var _hoisted_9$1 = { class: "sr-only" };
var _hoisted_10$1 = {
	key: 0,
	class: "sr-only"
};
var _hoisted_11$1 = { class: "button-group wizard-step__buttons" };
var _hoisted_12$1 = ["data-disabled"];
var _hoisted_13$1 = { class: "sr-only" };
function _sfc_render$14(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", {
		...
		_cache[9] || (_cache[9] = createBaseVNode("div", { class: "wizard-step__line-up" }, null, -1)),
		_cache[10] || (_cache[10] = createTextVNode()),
		_ctx.isOpen ? renderSlot(_ctx.$slots, "step-of", normalizeProps(mergeProps({ key: 0 }, {
			headerClass: "wizard-step__step-of",
			stepNumber: _ctx.stepNumber,
			totalSteps: _ctx.totalSteps
		})), () => [createBaseVNode("span", _hoisted_2$9, toDisplayString(_ctx.defaultCurrentStepInformation), 1)]) : createCommentVNode("", true),
		_cache[11] || (_cache[11] = createTextVNode()),
		createBaseVNode("div", _hoisted_3$5, [
			createBaseVNode("div", _hoisted_4$5, [
				createVNode(_component_f_icon, {
					class: "wizard-step__icon-container__success",
					name: "success"
				}),
				_cache[3] || (_cache[3] = createTextVNode()),
				createBaseVNode("div", _hoisted_5$5, toDisplayString(_ctx.stepNumber), 1)
			]),
			_cache[4] || (_cache[4] = createTextVNode()),
			_cache[5] || (_cache[5] = createBaseVNode("div", { class: "wizard-step__icon-container__line-down" }, null, -1))
		]),
		_cache[12] || (_cache[12] = createTextVNode()),
		createBaseVNode("div", _hoisted_6$5, [(openBlock(), createBlock(resolveDynamicComponent(_ctx.inheritedProps.headerTag), { class: "wizard-step__header__title" }, {
			default: withCtx(() => [_ctx.showLink ? (openBlock(), createElementBlock("a", {
				...
				createBaseVNode("span", _hoisted_7$5, toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0", 1),
				createTextVNode(" " + toDisplayString(_ctx.title) + " ", 1),
				createBaseVNode("span", _hoisted_8$1, " \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.finished-step", "Avklarat steg")), 1)
			], 32)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
				createBaseVNode("span", _hoisted_9$1, toDisplayString(_ctx.defaultCurrentStepInformation) + "\xA0", 1),
				createTextVNode(" " + toDisplayString(_ctx.title) + " ", 1),
				_ctx.isPending ? (openBlock(), createElementBlock("span", _hoisted_10$1, "\n                        \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.pending", "Inaktivt")), 1)) : createCommentVNode("", true)
			], 64))]),
			_: 1
		}))], 512),
		_cache[13] || (_cache[13] = createTextVNode()),
		_cache[14] || (_cache[14] = createBaseVNode("div", { class: "wizard-step__line-down" }, null, -1)),
		_cache[15] || (_cache[15] = createTextVNode()),
		(openBlock(), createBlock(_component_i_animate_expand, {
				...
				default: withCtx(() => [
					...
					createBaseVNode("div", _hoisted_11$1, [
						createBaseVNode("button", {
							...
							stepNumber: _ctx.stepNumber,
							totalSteps: _ctx.totalSteps
						})), () => [_ctx.isFinalStep ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(_ctx.$t("fkui.wizard-step.button.next.text-final", "Gå vidare och granska")), 1)], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(_ctx.$t("fkui.wizard-step.button.next.text", "Fortsätt")) + " ", 1), createBaseVNode("span", _hoisted_13$1, "\n                                        \xA0" + toDisplayString(_ctx.$t("fkui.wizard-step.button.next.sr-text", "till nästa steg")), 1)], 64))])], 8, _hoisted_12$1),
						_cache[6] || (_cache[6] = createTextVNode()),
						createBaseVNode("button", {
...
var FWizardStep_default = /* @__PURE__ */ _plugin_vue_export_helper_default$1(FWizardStep_vue_vue_type_script_lang_default, [["render", _sfc_render$14]]);
//#endregion
...
var App_default = /* @__PURE__ */ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render$13]]);
//#endregion
...
var DefaultView_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({ setup() {
	return { prototypes };
} });
//#endregion
//#region src/views/DefaultView.vue
var _hoisted_1$10 = { class: "sandbox-root" };
var _hoisted_2$8 = { class: "prototype-list" };
function _sfc_render$12(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	return openBlock(), createElementBlock("div", _hoisted_1$10, [_cache[0] || (_cache[0] = createBaseVNode("h1", null, "Prototyper", -1)), createBaseVNode("ul", _hoisted_2$8, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.prototypes, (proto) => {
		return openBlock(), createElementBlock("li", { key: proto.path }, [createVNode(_component_router_link, {
			class: "anchor",
			to: proto.path
		}, {
			default: withCtx(() => [createTextVNode(toDisplayString(proto.name), 1)]),
			_: 2
		}, 1032, ["to"])]);
	}), 128))])]);
}
var DefaultView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(DefaultView_vue_vue_type_script_lang_default, [["render", _sfc_render$12]]);
//#endregion
//#region src/views/prototypes/components/PetFormFields.vue?vue&type=script&lang.ts
var PetFormFields_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FFieldset: FFieldset_default,
		FNumericTextField: FNumericTextField_default,
		FRadioField: FRadioField_default,
		FSelectField: FSelectField_default,
...
//#endregion
//#region src/views/prototypes/components/PetFormFields.vue
function _sfc_render$11(_ctx, _cache, $props, $setup, $data, $options) {
	...
	const _component_f_radio_field = resolveComponent("f-radio-field");
	const _component_f_fieldset = resolveComponent("f-fieldset");
	const _component_f_numeric_text_field = resolveComponent("f-numeric-text-field");
	...
	return openBlock(), createElementBlock(Fragment, null, [
		withDirectives((openBlock(), createBlock(_component_f_text_field, {
			"model-value": _ctx.modelValue.name,
			"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.update("name", $event))
		}, {
			default: withCtx(() => [..._cache[9] || (_cache[9] = [createTextVNode(" Namn ", -1)])]),
			_: 1
		}, 8, ["model-value"])), [[
		...
		withDirectives((openBlock(), createBlock(_component_f_select_field, {
			"model-value": _ctx.modelValue.animalType,
			"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.update("animalType", $event))
		}, {
			label: withCtx(() => [..._cache[10] || (_cache[10] = [createTextVNode("Typ av husdjur", -1)])]),
			default: withCtx(() => [
				...
				_cache[12] || (_cache[12] = createBaseVNode("option", { value: "hund" }, "Hund", -1)),
				_cache[13] || (_cache[13] = createBaseVNode("option", { value: "katt" }, "Katt", -1)),
				_cache[14] || (_cache[14] = createBaseVNode("option", { value: "marsvin" }, "Marsvin", -1)),
				_cache[15] || (_cache[15] = createBaseVNode("option", { value: "kanin" }, "Kanin", -1))
			]),
			_: 1
		}, 8, ["model-value"])), [[
			_directive_validation,
		...
		_ctx.variant === "long" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
			withDirectives((openBlock(), createBlock(_component_f_fieldset, { name: `${_ctx.groupId}-age` }, {
				label: withCtx(() => [..._cache[16] || (_cache[16] = [createTextVNode("Hur gammalt är husdjuret?", -1)])]),
				default: withCtx(() => [
					createVNode(_component_f_radio_field, {
						"model-value": _ctx.modelValue.age,
						value: "0-3",
						"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.update("age", $event))
					}, {
						default: withCtx(() => [..._cache[17] || (_cache[17] = [createTextVNode(" 0 till 3 år ", -1)])]),
						_: 1
					}, 8, ["model-value"]),
					createVNode(_component_f_radio_field, {
						"model-value": _ctx.modelValue.age,
						value: "4-7",
						"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.update("age", $event))
					}, {
						default: withCtx(() => [..._cache[18] || (_cache[18] = [createTextVNode(" 4 till 7 år ", -1)])]),
						_: 1
					}, 8, ["model-value"]),
					createVNode(_component_f_radio_field, {
						"model-value": _ctx.modelValue.age,
						value: "over-8",
						"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.update("age", $event))
					}, {
						default: withCtx(() => [..._cache[19] || (_cache[19] = [createTextVNode(" 8 år eller mer ", -1)])]),
						_: 1
					}, 8, ["model-value"])
				]),
				_: 1
			...
			withDirectives((openBlock(), createBlock(_component_f_numeric_text_field, {
				"model-value": _ctx.modelValue.legs,
				"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.update("legs", $event))
			}, {
				default: withCtx(() => [..._cache[20] || (_cache[20] = [createTextVNode(" Hur många ben har husdjuret? ", -1)])]),
				_: 1
			}, 8, ["model-value"])), [[
				_directive_validation,
				void 0,
			...
			withDirectives((openBlock(), createBlock(_component_f_numeric_text_field, {
				"model-value": _ctx.modelValue.weight,
				"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.update("weight", $event))
			}, {
				default: withCtx(() => [..._cache[21] || (_cache[21] = [createTextVNode(" Hur mycket väger husdjuret? ", -1)])]),
				_: 1
			}, 8, ["model-value"])), [[
				_directive_validation,
				void 0,
		...
		withDirectives((openBlock(), createBlock(_component_f_fieldset, {
			name: `${_ctx.groupId}-sole-guardianship`,
			horizontal: ""
		}, {
			label: withCtx(() => [..._cache[22] || (_cache[22] = [createTextVNode("Är det bara du som bor med husdjuret?", -1)])]),
			default: withCtx(() => [createVNode(_component_f_radio_field, {
				"model-value": _ctx.modelValue.soleGuardianship,
				value: "yes",
				"onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => _ctx.update("soleGuardianship", $event))
			}, {
				default: withCtx(() => [..._cache[23] || (_cache[23] = [createTextVNode(" Ja ", -1)])]),
				_: 1
			}, 8, ["model-value"]), createVNode(_component_f_radio_field, {
				"model-value": _ctx.modelValue.soleGuardianship,
				value: "no",
				"onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => _ctx.update("soleGuardianship", $event))
			}, {
				default: withCtx(() => [..._cache[24] || (_cache[24] = [createTextVNode(" Nej ", -1)])]),
				_: 1
			}, 8, ["model-value"])]),
			_: 1
		}, 8, ["name"])), [[
...
var PetFormFields_default = /* @__PURE__ */ _plugin_vue_export_helper_default(PetFormFields_vue_vue_type_script_lang_default, [["render", _sfc_render$11]]);
//#endregion
//#region src/views/prototypes/components/PetFormModal.vue?vue&type=script&lang.ts
function emptyPetFormData() {
	return {
		animalType: "",
		name: "",
		age: "",
...
var PetFormModal_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	name: "PetFormModal",
	components: {
		FFormModal: FFormModal_default,
		PetFormFields: PetFormFields_default
	},
	props: {
		isOpen: {
			type: Boolean,
	...
	setup(props, { emit }) {
		const value = /* @__PURE__ */ reactive({ ...props.initialValue });
...
//#endregion
//#region src/views/prototypes/components/PetFormModal.vue
function _sfc_render$10(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_pet_form_fields = resolveComponent("pet-form-fields");
	const _component_f_form_modal = resolveComponent("f-form-modal");
	return openBlock(), createBlock(_component_f_form_modal, {
		"is-open": _ctx.isOpen,
		...
		header: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode("Husdjur", -1)])]),
		"input-text-fields": withCtx(() => [createVNode(_component_pet_form_fields, {
			"model-value": _ctx.value,
			variant: _ctx.variant,
			"group-id": "modal-pet",
			"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => Object.assign(_ctx.value, $event))
		}, null, 8, ["model-value", "variant"])]),
		_: 1
	}, 8, [
		"is-open",
		"value",
...
var PetFormModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(PetFormModal_vue_vue_type_script_lang_default, [["render", _sfc_render$10]]);
//#endregion
//#region src/views/prototypes/components/EditableCardList.vue?vue&type=script&lang.ts
function capitalize$5(s) {
	return s.charAt(0).toUpperCase() + s.slice(1);
}
function formatAge$2(age) {
	return {
		"0-3": "0 till 3 år",
		"4-7": "4 till 7 år",
...
function formatGuardianship$4(value) {
...
var EditableCardList_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FCard: FCard_default,
		FButton: FButton_default
	},
	props: {
		cards: {
			type: Array,
	...
	setup(props, { emit }) {
		...
		async function addCard() {
			...
			if (!proxy) return;
			try {
				const data = await formModal(proxy, PetFormModal_default, { props: { variant: props.variant } });
				cards.push({
					id: nextId++,
					...data
				});
		...
		async function editCard(card) {
			...
			if (!proxy) return;
			try {
				const data = await formModal(proxy, PetFormModal_default, { props: {
		...
		return {
			...
			formatAge: formatAge$2,
			formatGuardianship: formatGuardianship$4,
			addCard,
			editCard,
			deleteCard
		};
...
//#endregion
//#region src/views/prototypes/components/EditableCardList.vue
var _hoisted_1$9 = { class: "button-group" };
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_f_button = resolveComponent("f-button");
	const _component_f_card = resolveComponent("f-card");
	return openBlock(), createElementBlock("div", null, [
		_cache[8] || (_cache[8] = createBaseVNode("p", null, "Lägg till och fyll i information om minst tre husdjur", -1)),
		(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.cards, (card, index) => {
			return openBlock(), createBlock(_component_f_card, { key: card.id }, {
				header: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, toDisplayString(_ctx.cardTitle(card, index)), 3)]),
				default: withCtx(() => [
					createBaseVNode("p", null, [_cache[0] || (_cache[0] = createBaseVNode("label", { class: "label" }, "Typ av husdjur", -1)), createBaseVNode("span", null, toDisplayString(_ctx.capitalize(card.animalType)), 1)]),
					_ctx.variant === "long" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						createBaseVNode("p", null, [_cache[1] || (_cache[1] = createBaseVNode("label", { class: "label" }, "Ålder", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatAge(card.age)), 1)]),
						createBaseVNode("p", null, [_cache[2] || (_cache[2] = createBaseVNode("label", { class: "label" }, "Antal ben", -1)), createBaseVNode("span", null, toDisplayString(card.legs), 1)]),
						createBaseVNode("p", null, [_cache[3] || (_cache[3] = createBaseVNode("label", { class: "label" }, "Vikt", -1)), createBaseVNode("span", null, toDisplayString(card.weight), 1)])
					], 64)) : createCommentVNode("", true),
					createBaseVNode("p", null, [_cache[4] || (_cache[4] = createBaseVNode("label", { class: "label" }, "Är det bara du som bor med husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatGuardianship(card.soleGuardianship)), 1)])
				]),
				footer: withCtx(() => [createBaseVNode("div", _hoisted_1$9, [createVNode(_component_f_button, {
					variant: "tertiary",
					"align-text": "",
					class: "button-group__item",
					"icon-left": "pen",
					onClick: ($event) => _ctx.editCard(card)
				}, {
					default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode(" Ändra ", -1)])]),
					_: 1
				}, 8, ["onClick"]), createVNode(_component_f_button, {
					variant: "tertiary",
					"align-text": "",
					class: "button-group__item",
					"icon-left": "trashcan",
					onClick: ($event) => _ctx.deleteCard(card)
				}, {
					default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode(" Ta bort ", -1)])]),
					_: 1
				}, 8, ["onClick"])])]),
				_: 2
			}, 1024);
		}), 128)),
		createVNode(_component_f_button, {
			variant: "secondary",
			size: "medium",
			"icon-left": "plus",
			onClick: _ctx.addCard
		}, {
			default: withCtx(() => [..._cache[7] || (_cache[7] = [createTextVNode(" Lägg till ", -1)])]),
			_: 1
		}, 8, ["onClick"])
	]);
}
var EditableCardList_default = /* @__PURE__ */ _plugin_vue_export_helper_default(EditableCardList_vue_vue_type_script_lang_default, [["render", _sfc_render$9]]);
//#endregion
//#region src/views/prototypes/EditableListLong.vue?vue&type=script&lang.ts
function capitalize$4(s) {
	return s.charAt(0).toUpperCase() + s.slice(1);
}
function formatAge$1(age) {
	return {
		"0-3": "0 till 3 år",
		"4-7": "4 till 7 år",
		"over-8": "8 år eller mer"
...
function formatGuardianship$3(value) {
	if (value === "yes") return "Ja";
	if (value === "no") return "Nej";
	return value;
}
var EditableListLong_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default,
		FTextField: FTextField_default,
		FMessageBox: FMessageBox_default,
		FButton: FButton_default,
		FCard: FCard_default,
		EditableCardList: EditableCardList_default
	},
	setup() {
		const instance = getCurrentInstance();
		const router = useRouter();
		const currentStep = /* @__PURE__ */ ref(void 0);
		const firstName = /* @__PURE__ */ ref("");
		const showMinCardsError = /* @__PURE__ */ ref(false);
		const cards = /* @__PURE__ */ reactive([]);
		function beforeNextStep2() {
			if (cards.length < 3) {
		...
		return {
			...
			formatGuardianship: formatGuardianship$3
		};
	}
});
//#endregion
//#region src/views/prototypes/EditableListLong.vue
var _hoisted_1$8 = { class: "prototype-root" };
var _hoisted_2$7 = { key: 0 };
var _hoisted_3$4 = { class: "i-width-md-6" };
var _hoisted_4$4 = { class: "i-width-md-9" };
var _hoisted_5$4 = { class: "summary-group" };
var _hoisted_6$4 = { class: "summary-group" };
var _hoisted_7$4 = { class: "i-width-md-9" };
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	const _component_f_text_field = resolveComponent("f-text-field");
	const _component_f_wizard_step = resolveComponent("f-wizard-step");
	const _component_editable_card_list = resolveComponent("editable-card-list");
	const _component_f_message_box = resolveComponent("f-message-box");
	const _component_f_button = resolveComponent("f-button");
	const _component_f_card = resolveComponent("f-card");
	const _component_f_wizard = resolveComponent("f-wizard");
	const _directive_validation = resolveDirective("validation");
	return openBlock(), createElementBlock("div", _hoisted_1$8, [
		createVNode(_component_router_link, {
			...
			default: withCtx(() => [..._cache[5] || (_cache[5] = [createTextVNode("← Tillbaka", -1)])]),
			_: 1
		}),
		_cache[19] || (_cache[19] = createBaseVNode("h1", null, "Husdjursbidrag", -1)),
		_ctx.submitted ? (openBlock(), createElementBlock("p", _hoisted_2$7, "Tack för din ansökan!")) : (openBlock(), createBlock(_component_f_wizard, {
			key: 1,
			modelValue: _ctx.currentStep,
			"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.currentStep = $event),
			"header-tag": "h2",
			...
			default: withCtx(() => [
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_3$4, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						modelValue: _ctx.firstName,
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.firstName = $event)
					}, {
						default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("Ditt förnamn", -1)])]),
						_: 1
					}, 8, ["modelValue"])), [[
						_directive_validation,
						{ maxLength: { length: 100 } },
				...
				createVNode(_component_f_wizard_step, {
					...
					"use-error-list": false,
					title: "Husdjur",
					"before-next": _ctx.beforeNextStep2
				}, {
					default: withCtx(() => [createBaseVNode("div", _hoisted_4$4, [createVNode(_component_editable_card_list, {
						cards: _ctx.cards,
						onInteract: _cache[1] || (_cache[1] = ($event) => _ctx.showMinCardsError = false)
					}, null, 8, ["cards"])]), _ctx.showMinCardsError ? (openBlock(), createBlock(_component_f_message_box, {
						key: 0,
						type: "error",
						layout: "short",
						class: "i-width-md-9"
					}, {
						default: withCtx(() => [..._cache[7] || (_cache[7] = [createTextVNode(" Du måste lägga till minst tre husdjur innan du kan gå vidare. ", -1)])]),
						_: 1
					})) : createCommentVNode("", true)]),
					_: 1
				}, 8, ["before-next"]),
				createVNode(_component_f_wizard_step, {
					...
					"next-button-text": withCtx(() => [..._cache[18] || (_cache[18] = [createTextVNode("Skicka in", -1)])]),
					default: withCtx(() => [createBaseVNode("div", _hoisted_5$4, [
						_cache[10] || (_cache[10] = createBaseVNode("h3", null, "Dina uppgifter", -1)),
						createBaseVNode("p", null, [_cache[8] || (_cache[8] = createBaseVNode("label", { class: "label" }, "Förnamn", -1)), createBaseVNode("span", null, toDisplayString(_ctx.firstName), 1)]),
						createVNode(_component_f_button, {
							variant: "tertiary",
							"icon-left": "pen",
							"align-text": "",
							onClick: _cache[2] || (_cache[2] = ($event) => _ctx.currentStep = "step1")
						}, {
							default: withCtx(() => [..._cache[9] || (_cache[9] = [createTextVNode("Ändra Dina uppgifter", -1)])]),
							_: 1
						})
					]), createBaseVNode("div", _hoisted_6$4, [
						_cache[17] || (_cache[17] = createBaseVNode("h3", null, "Husdjur", -1)),
						createBaseVNode("div", _hoisted_7$4, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.cards, (card, index) => {
							return openBlock(), createBlock(_component_f_card, { key: card.id }, {
								header: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, toDisplayString(card.name || `Husdjur ${index + 1}`), 3)]),
								default: withCtx(() => [
									createBaseVNode("p", null, [_cache[11] || (_cache[11] = createBaseVNode("label", { class: "label" }, "Typ av husdjur", -1)), createBaseVNode("span", null, toDisplayString(_ctx.capitalize(card.animalType)), 1)]),
									createBaseVNode("p", null, [_cache[12] || (_cache[12] = createBaseVNode("label", { class: "label" }, "Hur gammalt är husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatAge(card.age)), 1)]),
									createBaseVNode("p", null, [_cache[13] || (_cache[13] = createBaseVNode("label", { class: "label" }, "Antal ben", -1)), createBaseVNode("span", null, toDisplayString(card.legs), 1)]),
									createBaseVNode("p", null, [_cache[14] || (_cache[14] = createBaseVNode("label", { class: "label" }, "Hur mycket väger husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(card.weight), 1)]),
									createBaseVNode("p", null, [_cache[15] || (_cache[15] = createBaseVNode("label", { class: "label" }, "Är det bara du som bor med husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatGuardianship(card.soleGuardianship)), 1)])
								]),
								_: 2
							}, 1024);
						}), 128))]),
						createVNode(_component_f_button, {
							...
							"icon-left": "pen",
							"align-text": "",
							onClick: _cache[3] || (_cache[3] = ($event) => _ctx.currentStep = "step2")
						}, {
							default: withCtx(() => [..._cache[16] || (_cache[16] = [createTextVNode("Ändra Husdjur", -1)])]),
							_: 1
						})
					])]),
					_: 1
...
var EditableListLong_default = /* @__PURE__ */ _plugin_vue_export_helper_default(EditableListLong_vue_vue_type_script_lang_default, [["render", _sfc_render$8]]);
//#endregion
//#region src/views/prototypes/EditableListShort.vue?vue&type=script&lang.ts
function capitalize$3(s) {
	return s.charAt(0).toUpperCase() + s.slice(1);
}
function formatGuardianship$2(value) {
	if (value === "yes") return "Ja";
	if (value === "no") return "Nej";
	return value;
}
var EditableListShort_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default,
		FTextField: FTextField_default,
	...
	setup() {
		...
		return {
			...
			formatGuardianship: formatGuardianship$2
		};
	}
});
//#endregion
//#region src/views/prototypes/EditableListShort.vue
var _hoisted_1$7 = { class: "prototype-root" };
var _hoisted_2$6 = { key: 0 };
var _hoisted_3$3 = { class: "i-width-md-6" };
var _hoisted_4$3 = { class: "i-width-md-9" };
var _hoisted_5$3 = { class: "summary-group" };
var _hoisted_6$3 = { class: "summary-group" };
var _hoisted_7$3 = { class: "i-width-md-9" };
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$7, [
		...
		_cache[16] || (_cache[16] = createBaseVNode("h1", null, "Husdjursbidrag", -1)),
		_ctx.submitted ? (openBlock(), createElementBlock("p", _hoisted_2$6, "Tack för din ansökan!")) : (openBlock(), createBlock(_component_f_wizard, {
			key: 1,
			modelValue: _ctx.currentStep,
			"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.currentStep = $event),
			"header-tag": "h2",
			...
			default: withCtx(() => [
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_3$3, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						modelValue: _ctx.firstName,
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.firstName = $event)
					}, {
						default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("Ditt förnamn", -1)])]),
				...
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_4$3, [createVNode(_component_editable_card_list, {
						cards: _ctx.cards,
						variant: "short",
						onInteract: _cache[1] || (_cache[1] = ($event) => _ctx.showMinCardsError = false)
					}, null, 8, ["cards"])]), _ctx.showMinCardsError ? (openBlock(), createBlock(_component_f_message_box, {
				...
				createVNode(_component_f_wizard_step, {
					...
					"next-button-text": withCtx(() => [..._cache[15] || (_cache[15] = [createTextVNode("Skicka in", -1)])]),
					default: withCtx(() => [createBaseVNode("div", _hoisted_5$3, [
						_cache[10] || (_cache[10] = createBaseVNode("h3", null, "Dina uppgifter", -1)),
						createBaseVNode("p", null, [_cache[8] || (_cache[8] = createBaseVNode("label", { class: "label" }, "Förnamn", -1)), createBaseVNode("span", null, toDisplayString(_ctx.firstName), 1)]),
						createVNode(_component_f_button, {
							variant: "tertiary",
						...
						_cache[14] || (_cache[14] = createBaseVNode("h3", null, "Husdjur", -1)),
						createBaseVNode("div", _hoisted_7$3, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.cards, (card, index) => {
							return openBlock(), createBlock(_component_f_card, { key: card.id }, {
								header: withCtx(({ headingSlotClass }) => [createBaseVNode("h3", { class: normalizeClass(headingSlotClass) }, toDisplayString(card.name || `Husdjur ${index + 1}`), 3)]),
								default: withCtx(() => [createBaseVNode("p", null, [_cache[11] || (_cache[11] = createBaseVNode("label", { class: "label" }, "Typ av husdjur", -1)), createBaseVNode("span", null, toDisplayString(_ctx.capitalize(card.animalType)), 1)]), createBaseVNode("p", null, [_cache[12] || (_cache[12] = createBaseVNode("label", { class: "label" }, "Är det bara du som bor med husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatGuardianship(card.soleGuardianship)), 1)])]),
								_: 2
							}, 1024);
						}), 128))]),
						createVNode(_component_f_button, {
							...
							default: withCtx(() => [..._cache[13] || (_cache[13] = [createTextVNode("Ändra Husdjur", -1)])]),
							_: 1
						})
					])]),
					_: 1
...
var EditableListShort_default = /* @__PURE__ */ _plugin_vue_export_helper_default(EditableListShort_vue_vue_type_script_lang_default, [["render", _sfc_render$7]]);
//#endregion
//#region src/views/prototypes/ExamplePrototype.vue?vue&type=script&lang.ts
var ExamplePrototype_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({});
//#endregion
//#region src/views/prototypes/ExamplePrototype.vue
var _hoisted_1$6 = { class: "prototype-root" };
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	return openBlock(), createElementBlock("div", _hoisted_1$6, [
		createVNode(_component_router_link, { to: "/" }, {
			default: withCtx(() => [..._cache[0] || (_cache[0] = [createTextVNode("← Tillbaka", -1)])]),
			_: 1
		}),
		_cache[1] || (_cache[1] = createBaseVNode("h1", null, "Exempelprototyp", -1)),
		_cache[2] || (_cache[2] = createBaseVNode("p", null, "Ersätt det här med din prototyp.", -1))
	]);
}
var ExamplePrototype_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ExamplePrototype_vue_vue_type_script_lang_default, [["render", _sfc_render$6]]);
//#endregion
//#region ../../packages/vue-labs/dist/esm/index.esm.js
var __commonJSMin = (cb, mod) => () => (mod || (cb((mod = { exports: {} }).exports, mod), cb = null), mod.exports);
var FExpandableTextareaField_default = /* @__PURE__ */ defineComponent({
	name: "FExpandableTextareaField",
	extends: FTextareaField_default,
	props: { 
	/**
...
maxRows: {
	...
	methods: {
		...
		scheduleResize(options = {}) {
			var _options$repeat;
			const repeat = (_options$repeat = options.repeat) !== null && _options$repeat !== void 0 ? _options$repeat : 0;
			if (this.animationFrameId) window.cancelAnimationFrame(this.animationFrameId);
			this.animationFrameId = window.requestAnimationFrame(() => {
				this.animationFrameId = void 0;
				this.resizeTextarea();
				if (repeat > 0) this.scheduleResize({ repeat: repeat - 1 });
			});
		},
		resizeTextarea() {
		...
		getMaxHeight(style, borderHeight) {
		...
		getLineHeight(style) {
			...
			if (style.lineHeight.endsWith("px")) return lineHeight;
		...
		observeTextareaResize() {
			...
			this.resizeObserver = new ResizeObserver(() => {
				...
				if (currentWidth === this.observedWidth) return;
...
* @public
*/
var HoursMinutesValidatorUtils = class HoursMinutesValidatorUtils {
...
var validators = [
	...
	},
	{
		...
		validation(value, _element, config) {
			return HoursMinutesValidatorUtils.validate(value, config, "limit", (value, limit) => {
				return value > limit;
			});
		}
	},
	...
	},
	{
		name: "maxTime",
		validation(value, _element, config) {
			return HoursMinutesValidatorUtils.validate(value, config, this.name, (value, limit) => {
				return value <= limit;
			});
		}
	},
...
//#endregion
//#region src/views/prototypes/ExpandableTextareaPrototype.vue?vue&type=script&lang.ts
var ExpandableTextareaPrototype_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FExpandableTextareaField: FExpandableTextareaField_default,
		FFieldset: FFieldset_default,
		FRadioField: FRadioField_default,
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default
	...
	setup() {
		return {
			limitedMessage: /* @__PURE__ */ ref(""),
			maxLength: 200,
			message: /* @__PURE__ */ ref(""),
			softLimit: 20,
			testMode: /* @__PURE__ */ ref("standalone"),
			wizardHasContent: /* @__PURE__ */ ref(""),
			wizardMessage: /* @__PURE__ */ ref("")
		};
	}
});
//#endregion
//#region src/views/prototypes/ExpandableTextareaPrototype.vue
var _hoisted_1$5 = { class: "prototype-root expandable-textarea-prototype" };
var _hoisted_2$5 = { class: "prototype-section" };
var _hoisted_3$2 = { class: "row" };
var _hoisted_4$2 = { class: "col col--md-6" };
var _hoisted_5$2 = {
	key: 0,
	class: "prototype-section"
};
var _hoisted_6$2 = { class: "row" };
var _hoisted_7$2 = { class: "col col--md-6" };
var _hoisted_8 = { class: "row" };
var _hoisted_9 = { class: "col col--md-6" };
var _hoisted_10 = {
	key: 1,
	class: "prototype-section"
};
var _hoisted_11 = { class: "row" };
var _hoisted_12 = { class: "col col--md-6" };
var _hoisted_13 = { class: "row" };
var _hoisted_14 = { class: "col col--md-6" };
var _hoisted_15 = { class: "row" };
var _hoisted_16 = { class: "col col--md-9" };
var _hoisted_17 = { class: "review-list" };
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	const _component_f_radio_field = resolveComponent("f-radio-field");
	const _component_f_fieldset = resolveComponent("f-fieldset");
	const _component_f_expandable_textarea_field = resolveComponent("f-expandable-textarea-field");
	const _component_f_wizard_step = resolveComponent("f-wizard-step");
	const _component_f_wizard = resolveComponent("f-wizard");
	return openBlock(), createElementBlock("div", _hoisted_1$5, [
		createVNode(_component_router_link, {
			...
			default: withCtx(() => [..._cache[7] || (_cache[7] = [createTextVNode("← Tillbaka", -1)])]),
			_: 1
		}),
		_cache[21] || (_cache[21] = createBaseVNode("h1", null, "Expanderande textarea", -1)),
		createBaseVNode("section", _hoisted_2$5, [createBaseVNode("div", _hoisted_3$2, [createBaseVNode("div", _hoisted_4$2, [createVNode(_component_f_fieldset, { name: "test-mode" }, {
			label: withCtx(() => [..._cache[8] || (_cache[8] = [createTextVNode("Testläge", -1)])]),
			default: withCtx(() => [createVNode(_component_f_radio_field, {
				modelValue: _ctx.testMode,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.testMode = $event),
				value: "standalone"
			}, {
				default: withCtx(() => [..._cache[9] || (_cache[9] = [createTextVNode("Fristående", -1)])]),
				_: 1
			}, 8, ["modelValue"]), createVNode(_component_f_radio_field, {
				modelValue: _ctx.testMode,
				"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.testMode = $event),
				value: "wizard"
			}, {
				default: withCtx(() => [..._cache[10] || (_cache[10] = [createTextVNode("Steg-för-steg", -1)])]),
				_: 1
			}, 8, ["modelValue"])]),
			_: 1
		})])])]),
		_ctx.testMode === "standalone" ? (openBlock(), createElementBlock("section", _hoisted_5$2, [createBaseVNode("div", _hoisted_6$2, [createBaseVNode("div", _hoisted_7$2, [createVNode(_component_f_expandable_textarea_field, {
			id: "expandable-limited-message",
			modelValue: _ctx.limitedMessage,
			"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.limitedMessage = $event),
			rows: 3,
			"max-rows": 6
		}, {
			description: withCtx(({ descriptionClass }) => [createBaseVNode("span", { class: normalizeClass(descriptionClass) }, "rows=3 och max-rows=6. Ingen teckenbegränsning.", 2)]),
			default: withCtx(() => [_cache[11] || (_cache[11] = createTextVNode(" Expanderande inmatningsfält med max-rows ", -1))]),
			_: 1
		}, 8, ["modelValue"])])]), createBaseVNode("div", _hoisted_8, [createBaseVNode("div", _hoisted_9, [createVNode(_component_f_expandable_textarea_field, {
			id: "expandable-message",
			modelValue: _ctx.message,
			"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.message = $event),
			maxlength: _ctx.maxLength,
			"soft-limit": _ctx.softLimit
		}, {
			description: withCtx(({ descriptionClass }) => [createBaseVNode("span", { class: normalizeClass(descriptionClass) }, " rows=1 utan max-rows. maxlength=" + toDisplayString(_ctx.maxLength) + " och soft-limit=" + toDisplayString(_ctx.softLimit) + ". ", 3)]),
			default: withCtx(() => [_cache[12] || (_cache[12] = createTextVNode(" Expanderande inmatningsfält med max-length ", -1))]),
			_: 1
		}, 8, [
			"modelValue",
			"maxlength",
		...
		_ctx.testMode === "wizard" ? (openBlock(), createElementBlock("section", _hoisted_10, [_cache[20] || (_cache[20] = createBaseVNode("h2", null, "Inuti FWizard", -1)), createVNode(_component_f_wizard, {
			"header-tag": "h3",
			"disable-initial-focus": ""
		}, {
			default: withCtx(() => [
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_11, [createBaseVNode("div", _hoisted_12, [createVNode(_component_f_expandable_textarea_field, {
						id: "expandable-wizard-message",
						modelValue: _ctx.wizardMessage,
						"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.wizardMessage = $event),
						maxlength: _ctx.maxLength,
						"soft-limit": _ctx.softLimit
					}, {
						description: withCtx(({ descriptionClass }) => [createBaseVNode("span", { class: normalizeClass(descriptionClass) }, " rows=1 utan max-rows. maxlength=" + toDisplayString(_ctx.maxLength) + " och soft-limit=" + toDisplayString(_ctx.softLimit) + ". ", 3)]),
						default: withCtx(() => [_cache[13] || (_cache[13] = createTextVNode(" Expanderande inmatningsfält ", -1))]),
						_: 1
					}, 8, [
						"modelValue",
						"maxlength",
				...
				createVNode(_component_f_wizard_step, {
					...
					"next-button-text": withCtx(() => [..._cache[17] || (_cache[17] = [createTextVNode("Fortsätt", -1)])]),
					default: withCtx(() => [createBaseVNode("div", _hoisted_13, [createBaseVNode("div", _hoisted_14, [createVNode(_component_f_fieldset, { name: "wizard-content-test" }, {
						label: withCtx(() => [..._cache[14] || (_cache[14] = [createTextVNode("Test med innehåll", -1)])]),
						default: withCtx(() => [createVNode(_component_f_radio_field, {
							modelValue: _ctx.wizardHasContent,
							"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => _ctx.wizardHasContent = $event),
							value: "ja"
						}, {
							default: withCtx(() => [..._cache[15] || (_cache[15] = [createTextVNode("Ja", -1)])]),
							_: 1
						}, 8, ["modelValue"]), createVNode(_component_f_radio_field, {
							modelValue: _ctx.wizardHasContent,
							"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => _ctx.wizardHasContent = $event),
							value: "nej"
						}, {
							default: withCtx(() => [..._cache[16] || (_cache[16] = [createTextVNode("Nej", -1)])]),
							_: 1
						}, 8, ["modelValue"])]),
						_: 1
					})])])]),
				...
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_15, [createBaseVNode("div", _hoisted_16, [createBaseVNode("dl", _hoisted_17, [
						_cache[18] || (_cache[18] = createBaseVNode("dt", null, "Expanderande inmatningsfält", -1)),
						createBaseVNode("dd", null, toDisplayString(_ctx.wizardMessage || "Ej ifyllt"), 1),
						_cache[19] || (_cache[19] = createBaseVNode("dt", null, "Test med innehåll", -1)),
						createBaseVNode("dd", null, toDisplayString(_ctx.wizardHasContent || "Ej valt"), 1)
					])])])]),
					_: 1
				})
			]),
...
var ExpandableTextareaPrototype_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ExpandableTextareaPrototype_vue_vue_type_script_lang_default, [["render", _sfc_render$5]]);
//#endregion
//#region src/views/prototypes/components/ExpandablePanelList.vue?vue&type=script&lang.ts
function capitalize$2(s) {
	return s.charAt(0).toUpperCase() + s.slice(1);
}
function updateSavedTitle(panel) {
	panel.savedName = panel.name;
	panel.savedAnimalType = panel.animalType;
}
function panelTitle(panel, index) {
	const parts = [panel.savedName, panel.savedAnimalType ? capitalize$2(panel.savedAnimalType) : ""].filter(Boolean);
...
async function savePanel(panel) {
	...
	if (document.querySelector(`#${containerId}`)?.querySelector("[aria-invalid='true']")) return;
	updateSavedTitle(panel);
	panel.expanded = false;
}
var ExpandablePanelList_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FExpandablePanel: FExpandablePanel_default,
		FButton: FButton_default,
		PetFormFields: PetFormFields_default
	},
	props: {
	...
	setup(props, { emit }) {
		...
		async function togglePanel(panel) {
			...
			if (!opening) {
				...
				await ValidationService.validateAllElements(containerId);
				if (document.querySelector(`#${containerId}`)?.querySelector("[aria-invalid='true']")) return;
				if (panel.name && panel.animalType) updateSavedTitle(panel);
			}
			closeAll();
...
//#endregion
//#region src/views/prototypes/components/ExpandablePanelList.vue
var _hoisted_1$4 = ["id"];
var _hoisted_2$4 = { class: "panel-actions button-group" };
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_pet_form_fields = resolveComponent("pet-form-fields");
	const _component_f_button = resolveComponent("f-button");
	const _component_f_expandable_panel = resolveComponent("f-expandable-panel");
	return openBlock(), createElementBlock("div", null, [
		_cache[3] || (_cache[3] = createBaseVNode("p", null, "Lägg till och fyll i information om minst tre husdjur", -1)),
		(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.panels, (panel, index) => {
			return openBlock(), createBlock(_component_f_expandable_panel, {
				key: panel.id,
				expanded: panel.expanded,
				onToggle: ($event) => _ctx.togglePanel(panel)
			}, {
				title: withCtx(() => [createTextVNode(toDisplayString(_ctx.panelTitle(panel, index)), 1)]),
				default: withCtx(() => [createBaseVNode("div", { id: `panel-content-${panel.id}` }, [createVNode(_component_pet_form_fields, {
					"model-value": panel,
					variant: _ctx.variant,
					"group-id": `panel-${panel.id}`,
					"onUpdate:modelValue": ($event) => Object.assign(panel, $event)
				}, null, 8, [
					"model-value",
					"variant",
					"group-id",
					"onUpdate:modelValue"
				])], 8, _hoisted_1$4), createBaseVNode("div", _hoisted_2$4, [createVNode(_component_f_button, {
					class: "button-group__item",
					variant: "tertiary",
					size: "medium",
					"icon-left": "success",
					"align-text": "",
					onClick: ($event) => _ctx.savePanel(panel)
				}, {
					default: withCtx(() => [..._cache[0] || (_cache[0] = [createTextVNode(" Spara ", -1)])]),
					_: 1
				}, 8, ["onClick"]), createVNode(_component_f_button, {
					class: "button-group__item",
					variant: "tertiary",
					...
					"icon-left": "trashcan",
					"align-text": "",
					onClick: ($event) => _ctx.deletePanel(panel)
				}, {
					default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode(" Ta bort ", -1)])]),
					_: 1
				}, 8, ["onClick"])])]),
				_: 2
			}, 1032, ["expanded", "onToggle"]);
		}), 128)),
		createVNode(_component_f_button, {
			variant: "secondary",
			size: "medium",
			"icon-left": "plus",
			onClick: _ctx.addPanel
		}, {
			default: withCtx(() => [..._cache[2] || (_cache[2] = [createTextVNode(" Lägg till ", -1)])]),
			_: 1
		}, 8, ["onClick"])
	]);
}
var ExpandablePanelList_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ExpandablePanelList_vue_vue_type_script_lang_default, [["render", _sfc_render$4]]);
//#endregion
//#region src/views/prototypes/PanelListLong.vue?vue&type=script&lang.ts
...
function formatGuardianship$1(value) {
	if (value === "yes") return "Ja";
	if (value === "no") return "Nej";
	return value;
}
var PanelListLong_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default,
		FTextField: FTextField_default,
		...
		FButton: FButton_default,
		FExpandablePanel: FExpandablePanel_default,
		ExpandablePanelList: ExpandablePanelList_default
	},
	setup() {
		const instance = getCurrentInstance();
		const router = useRouter();
		const currentStep = /* @__PURE__ */ ref(void 0);
		const firstName = /* @__PURE__ */ ref("");
		const showMinPanelsError = /* @__PURE__ */ ref(false);
		const summaryExpanded = /* @__PURE__ */ reactive({});
		const panels = /* @__PURE__ */ reactive([{
			id: 1,
			savedName: "",
			savedAnimalType: "",
			animalType: "",
		...
		function beforeNextStep2() {
			...
			for (const p of panels) summaryExpanded[p.id] = true;
		}
		async function onCancel() {
			const proxy = instance?.proxy;
			if (!proxy) return;
		...
		return {
			...
			formatAge,
			formatGuardianship: formatGuardianship$1
		};
	}
});
//#endregion
//#region src/views/prototypes/PanelListLong.vue
var _hoisted_1$3 = { class: "prototype-root" };
var _hoisted_2$3 = { key: 0 };
var _hoisted_3$1 = { class: "i-width-md-6" };
var _hoisted_4$1 = { class: "i-width-md-9" };
var _hoisted_5$1 = { class: "summary-group" };
var _hoisted_6$1 = { class: "summary-group" };
var _hoisted_7$1 = { class: "i-width-md-9" };
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
	const _component_router_link = resolveComponent("router-link");
	const _component_f_text_field = resolveComponent("f-text-field");
	const _component_f_wizard_step = resolveComponent("f-wizard-step");
	const _component_expandable_panel_list = resolveComponent("expandable-panel-list");
	const _component_f_message_box = resolveComponent("f-message-box");
	const _component_f_button = resolveComponent("f-button");
	const _component_f_expandable_panel = resolveComponent("f-expandable-panel");
	const _component_f_wizard = resolveComponent("f-wizard");
	...
	return openBlock(), createElementBlock("div", _hoisted_1$3, [
		...
		_cache[19] || (_cache[19] = createBaseVNode("h1", null, "Husdjursbidrag", -1)),
		_ctx.submitted ? (openBlock(), createElementBlock("p", _hoisted_2$3, "Tack för din ansökan!")) : (openBlock(), createBlock(_component_f_wizard, {
			key: 1,
			modelValue: _ctx.currentStep,
			"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.currentStep = $event),
			"header-tag": "h2",
			...
			default: withCtx(() => [
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_3$1, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						modelValue: _ctx.firstName,
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.firstName = $event)
					}, {
						default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("Ditt förnamn", -1)])]),
				...
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_4$1, [createVNode(_component_expandable_panel_list, {
						panels: _ctx.panels,
						onInteract: _cache[1] || (_cache[1] = ($event) => _ctx.showMinPanelsError = false)
					}, null, 8, ["panels"])]), _ctx.showMinPanelsError ? (openBlock(), createBlock(_component_f_message_box, {
						key: 0,
						type: "error",
						layout: "short",
						class: "i-width-md-9"
				...
				createVNode(_component_f_wizard_step, {
					...
					"next-button-text": withCtx(() => [..._cache[18] || (_cache[18] = [createTextVNode("Skicka in", -1)])]),
					default: withCtx(() => [createBaseVNode("div", _hoisted_5$1, [
						_cache[10] || (_cache[10] = createBaseVNode("h3", null, "Dina uppgifter", -1)),
						createBaseVNode("p", null, [_cache[8] || (_cache[8] = createBaseVNode("label", { class: "label" }, "Förnamn", -1)), createBaseVNode("span", null, toDisplayString(_ctx.firstName), 1)]),
						createVNode(_component_f_button, {
							variant: "tertiary",
						...
						_cache[17] || (_cache[17] = createBaseVNode("h3", null, "Husdjur", -1)),
						createBaseVNode("div", _hoisted_7$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.panels, (panel, index) => {
							return openBlock(), createBlock(_component_f_expandable_panel, {
								key: panel.id,
								expanded: _ctx.summaryExpanded[panel.id],
								onToggle: ($event) => _ctx.summaryExpanded[panel.id] = !_ctx.summaryExpanded[panel.id]
							}, {
								title: withCtx(() => [createTextVNode(toDisplayString(panel.name || `Husdjur ${index + 1}`), 1)]),
								default: withCtx(() => [
									createBaseVNode("p", null, [_cache[11] || (_cache[11] = createBaseVNode("label", { class: "label" }, "Typ av husdjur", -1)), createBaseVNode("span", null, toDisplayString(_ctx.capitalize(panel.animalType)), 1)]),
									createBaseVNode("p", null, [_cache[12] || (_cache[12] = createBaseVNode("label", { class: "label" }, "Hur gammalt är husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatAge(panel.age)), 1)]),
									createBaseVNode("p", null, [_cache[13] || (_cache[13] = createBaseVNode("label", { class: "label" }, "Antal ben", -1)), createBaseVNode("span", null, toDisplayString(panel.legs), 1)]),
									createBaseVNode("p", null, [_cache[14] || (_cache[14] = createBaseVNode("label", { class: "label" }, "Hur mycket väger husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(panel.weight), 1)]),
									createBaseVNode("p", null, [_cache[15] || (_cache[15] = createBaseVNode("label", { class: "label" }, "Är det bara du som bor med husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatGuardianship(panel.soleGuardianship)), 1)])
								]),
								_: 2
							}, 1032, ["expanded", "onToggle"]);
						}), 128))]),
...
var PanelListLong_default = /* @__PURE__ */ _plugin_vue_export_helper_default(PanelListLong_vue_vue_type_script_lang_default, [["render", _sfc_render$3]]);
//#endregion
//#region src/views/prototypes/PanelListShort.vue?vue&type=script&lang.ts
function capitalize(s) {
	return s.charAt(0).toUpperCase() + s.slice(1);
}
function formatGuardianship(value) {
	if (value === "yes") return "Ja";
	if (value === "no") return "Nej";
	return value;
}
var PanelListShort_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FWizard: FWizard_default,
		FWizardStep: FWizardStep_default,
		FTextField: FTextField_default,
...
//#endregion
//#region src/views/prototypes/PanelListShort.vue
var _hoisted_1$2 = { class: "prototype-root" };
var _hoisted_2$2 = { key: 0 };
var _hoisted_3 = { class: "i-width-md-6" };
var _hoisted_4 = { class: "i-width-md-9" };
var _hoisted_5 = { class: "summary-group" };
var _hoisted_6 = { class: "summary-group" };
var _hoisted_7 = { class: "i-width-md-9" };
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$2, [
		...
		_cache[16] || (_cache[16] = createBaseVNode("h1", null, "Husdjursbidrag", -1)),
		_ctx.submitted ? (openBlock(), createElementBlock("p", _hoisted_2$2, "Tack för din ansökan!")) : (openBlock(), createBlock(_component_f_wizard, {
			key: 1,
			modelValue: _ctx.currentStep,
			"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _ctx.currentStep = $event),
			"header-tag": "h2",
			...
			default: withCtx(() => [
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_3, [withDirectives((openBlock(), createBlock(_component_f_text_field, {
						modelValue: _ctx.firstName,
						"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.firstName = $event)
					}, {
						default: withCtx(() => [..._cache[6] || (_cache[6] = [createTextVNode("Ditt förnamn", -1)])]),
				...
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_4, [createVNode(_component_expandable_panel_list, {
						panels: _ctx.panels,
						variant: "short",
						onInteract: _cache[1] || (_cache[1] = ($event) => _ctx.showMinPanelsError = false)
					}, null, 8, ["panels"])]), _ctx.showMinPanelsError ? (openBlock(), createBlock(_component_f_message_box, {
				...
				createVNode(_component_f_wizard_step, {
					...
					default: withCtx(() => [createBaseVNode("div", _hoisted_5, [
						...
						_cache[14] || (_cache[14] = createBaseVNode("h3", null, "Husdjur", -1)),
						createBaseVNode("div", _hoisted_7, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.panels, (panel, index) => {
							return openBlock(), createBlock(_component_f_expandable_panel, {
								key: panel.id,
								expanded: _ctx.summaryExpanded[panel.id],
								onToggle: ($event) => _ctx.summaryExpanded[panel.id] = !_ctx.summaryExpanded[panel.id]
								...
								title: withCtx(() => [createTextVNode(toDisplayString(panel.name || `Husdjur ${index + 1}`), 1)]),
								default: withCtx(() => [createBaseVNode("p", null, [_cache[11] || (_cache[11] = createBaseVNode("label", { class: "label" }, "Typ av husdjur", -1)), createBaseVNode("span", null, toDisplayString(_ctx.capitalize(panel.animalType)), 1)]), createBaseVNode("p", null, [_cache[12] || (_cache[12] = createBaseVNode("label", { class: "label" }, "Är det bara du som bor med husdjuret?", -1)), createBaseVNode("span", null, toDisplayString(_ctx.formatGuardianship(panel.soleGuardianship)), 1)])]),
								_: 2
							}, 1032, ["expanded", "onToggle"]);
						}), 128))]),
						createVNode(_component_f_button, {
...
var PanelListShort_default = /* @__PURE__ */ _plugin_vue_export_helper_default(PanelListShort_vue_vue_type_script_lang_default, [["render", _sfc_render$2]]);
//#endregion
//#region src/views/prototypes/PanelerVsKort.vue?vue&type=script&lang.ts
var prototypes$1 = [
	{
...
var PanelerVsKort_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({ setup() {
	return { prototypes: prototypes$1 };
} });
//#endregion
//#region src/views/prototypes/PanelerVsKort.vue
var _hoisted_1$1 = { class: "prototype-root" };
var _hoisted_2$1 = { class: "prototype-list" };
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1$1, [
		...
		_cache[1] || (_cache[1] = createBaseVNode("h1", null, "Paneler vs Kort", -1)),
		createBaseVNode("ul", _hoisted_2$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.prototypes, (proto) => {
			return openBlock(), createElementBlock("li", { key: proto.path }, [createVNode(_component_router_link, {
				class: "anchor",
				to: proto.path
			}, {
...
var PanelerVsKort_default = /* @__PURE__ */ _plugin_vue_export_helper_default(PanelerVsKort_vue_vue_type_script_lang_default, [["render", _sfc_render$1]]);
//#endregion
//#region src/views/prototypes/ResetFields.vue?vue&type=script&lang.ts
var FIELD_CONFIGS = [
	{
		id: "field1",
		label: "Belopp 1",
...
var ResetFields_vue_vue_type_script_lang_default = /* @__PURE__ */ defineComponent({
	components: {
		FNumericTextField: FNumericTextField_default,
		FButton: FButton_default
	},
	setup() {
		const fields = FIELD_CONFIGS.map((config) => ({
			...config,
			value: /* @__PURE__ */ ref(config.defaultValue),
			dirty: /* @__PURE__ */ ref(false)
		}));
		function onInput(field, event) {
			const raw = event.target.value.replaceAll(/\s/g, "");
...
//#endregion
//#region src/views/prototypes/ResetFields.vue
var _hoisted_1 = { class: "prototype-root" };
var _hoisted_2 = { class: "i-width-md-6" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
	...
	return openBlock(), createElementBlock("div", _hoisted_1, [
		...
		_cache[2] || (_cache[2] = createBaseVNode("h1", null, "Återställ belopp", -1)),
		_cache[3] || (_cache[3] = createBaseVNode("ul", { class: "intro-list" }, [
			createBaseVNode("li", null, "Om man ändrar ett förifyllt belopp visas knappen för återställning direkt."),
			createBaseVNode("li", null, "Knappen visas så länge beloppet inte stämmer med det förifyllda."),
			createBaseVNode("li", null, "Knappen försvinner om man klickar på den för att återställa beloppet."),
			createBaseVNode("li", null, "Om man rensar fältet visas \"0\" när man lämnar fältet.")
		], -1)),
		(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.fields, (field) => {
			return openBlock(), createElementBlock("div", {
				key: field.id,
				class: "field-group"
			}, [createBaseVNode("div", _hoisted_2, [createVNode(_component_f_numeric_text_field, {
				id: field.id,
				modelValue: field.value.value,
				"onUpdate:modelValue": ($event) => field.value.value = $event,
				onInput: ($event) => _ctx.onInput(field, $event),
				onBlur: ($event) => _ctx.onBlur(field, $event)
			}, {
				...
				"onInput",
				"onBlur"
			])]), field.dirty.value ? (openBlock(), createBlock(_component_f_button, {
				key: 0,
				variant: "tertiary",
				"icon-left": "arrows-rotate",
				"align-text": "",
				onClick: ($event) => _ctx.reset(field)
			}, {
				default: withCtx(() => [..._cache[1] || (_cache[1] = [createTextVNode(" Återställ förifyllt belopp ", -1)])]),
				_: 1
...
var prototypes = [
	{
		...
		component: ExamplePrototype_default
	},
	{
		path: "/prototyp/aterstall-belopp",
		name: "Återställ belopp",
		component: /* @__PURE__ */ _plugin_vue_export_helper_default(ResetFields_vue_vue_type_script_lang_default, [["render", _sfc_render]])
	},
	{
		path: "/paneler-vs-kort",
		name: "Paneler vs Kort",
		component: PanelerVsKort_default
	},
	{
		path: "/expanderande-textarea",
		name: "Expanderande textarea",
		component: ExpandableTextareaPrototype_default
	}
];
var subRoutes = [
	{
		path: "/paneler-vs-kort/panellista-lang",
		name: "Panellista längre",
		component: PanelListLong_default
	},
	{
		path: "/paneler-vs-kort/panellista-kortare",
		name: "Panellista kortare",
		component: PanelListShort_default
	},
	{
		path: "/paneler-vs-kort/redigerbar-lista-lang",
		name: "Redigerbar lista längre",
		component: EditableListLong_default
	},
	{
		path: "/paneler-vs-kort/redigerbar-lista-kortare",
		name: "Redigerbar lista kortare",
		component: EditableListShort_default
	}
];
