  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        row: withCtx(() => [createElementVNode("span", _hoisted_4, [createElementVNode("span", _hoisted_5, toDisplayString(fileName.value) + " " + toDisplayString(filstorlek.value) + " kb ", 1), _cache[2] || (_cache[2] = createTextVNode()), createElementVNode("span", _hoisted_6, toDisplayString(filstorlek.value) + " KB", 1), _cache[3] || (_cache[3] = createTextVNode()), createVNode(unref(FButton), {
