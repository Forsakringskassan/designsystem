...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-ccbb0e.js
...
exampleComponent.__scopeId = "data-v-ccbb0e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ccbb0e"
});
export {
  render
};
