...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-574b2e.js
...
exampleComponent.__scopeId = "data-v-574b2e";
setup({
  rootComponent: exampleComponent,
  selector: "#example-574b2e"
});
export {
  render
};
