...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-a2d7ce.js
...
exampleComponent.__scopeId = "data-v-a2d7ce";
setup({
  rootComponent: exampleComponent,
  selector: "#example-a2d7ce"
});
export {
  render
};
