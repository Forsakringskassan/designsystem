...
var _hoisted_1$9 = ["checked", "aria-labelledby"];
var _hoisted_2$3 = ["checked", "aria-labelledby"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", {
        ...
        default: withCtx(() => [createVNode(unref(IFlexItem), {
          id: __props.column.labelId,
          shrink: ""
        }, {
          default: withCtx(() => [createTextVNode(toDisplayString(__props.column.header), 1)]),
          _: 1
        }, 8, ["id"]), _cache[0] || (_cache[0] = createTextVNode()), __props.sortEnabled ? (openBlock(), createBlock(unref(IFlexItem), {
          key: 0,
          shrink: "",
          align: "center"
        }, {
...
var _hoisted_1$5 = ["checked", "aria-labelledby"];
...
var _hoisted_2$1 = ["aria-labelledby"];
...
function normalizeTableColumn(column) {
  ...
  const labelId = ElementIdService.generateElementId();
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const multiSelectColumn = {
      ...
      labelId: ElementIdService.generateElementId(),
...
import { ElementIdService as ElementIdService3 } from "@fkui/logic";
...
var ITableCheckbox_default = /* @__PURE__ */ _defineComponent3({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { targetElement, ariaLabelledby, onActivateCell, onChange };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
var _hoisted_14 = ["checked", "aria-labelledby"];
var _hoisted_22 = ["checked", "aria-labelledby"];
  ...
  return $props.column.editable($props.row) ? (_openBlock3(), _createElementBlock3(
    ...
    [
      _createElementVNode3("input", {
        ...
        type: "checkbox",
        "aria-labelledby": $setup.ariaLabelledby,
        tabindex: "-1",
...
var ITableRadio_default = /* @__PURE__ */ _defineComponent4({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { inputElement, ariaLabelledby, onActivateCell, onChange };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
var _hoisted_15 = ["checked", "aria-labelledby"];
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { model, validity, hasError, wrapperClasses, inputClasses, ariaLabelledby, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onActivateCell, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon4;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
var _hoisted_24 = ["aria-labelledby"];
