...
// virtual-entry:virtual:src/components/FTable/examples/FTableRowHeaderExample.vue:FTableRowHeaderExample-8e83ac.js
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const ariaLabel = computed(() => __props.column.label(__props.row));
...
var ITableCheckbox_default = /* @__PURE__ */ _defineComponent3({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed4(() => __props.column.label(__props.row));
    function onActivateCell(e) {
...
var ITableRadio_default = /* @__PURE__ */ _defineComponent4({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed5(() => __props.column.label(__props.row));
    function onActivateCell(e) {
...
import { computed as computed6, nextTick as nextTick3, ref as ref2, useTemplateRef as useTemplateRef7, watchEffect as watchEffect2 } from "vue";
...
var ITableSelect_default = /* @__PURE__ */ _defineComponent6({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed6(() => __props.column.label(__props.row));
    function onActivateCell(e) {
      assertRef6(tdRef);
      tdRef.value.tabIndex = 0;
      if (e.detail.focus) {
...
import { computed as computed7, onMounted as onMounted2, ref as ref3, useTemplateRef as useTemplateRef8 } from "vue";
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed7(() => __props.column.label(__props.row));
