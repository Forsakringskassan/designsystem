...
import { defineComponent, useTemplateRef, computed, toRef, createElementBlock, openBlock, createElementVNode, createVNode, unref, renderSlot, withModifiers, createTextVNode, createCommentVNode, withCtx, createBlock, toDisplayString, normalizeClass, inject, nextTick, ref, watchEffect, withDirectives, vShow, onMounted, vModelText, mergeModels, useModel, useSlots, provide, Fragment, renderList, mergeProps, resolveDynamicComponent } from "vue";
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const ariaLabel = computed(() => {
      const value = toRef(__props.column.label(__props.row)).value;
...
function getLabelFn(fn, defaultLabel) {
  if (fn) {
    return fn;
  }
  return () => defaultLabel;
  ...
  switch (column.type) {
    case "checkbox":
      return {
        ...
        header: toRef(column.header),
        description,
        label: getLabelFn(column.label, ref(null)),
...
import { ref as ref4, toRef as toRef6 } from "vue";
...
import { computed as computed4, toRef as toRef2, useTemplateRef as useTemplateRef4 } from "vue";
...
var ITableCheckbox_default = /* @__PURE__ */ _defineComponent3({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed4(() => {
      const value = toRef2(__props.column.label(__props.row)).value;
      return value ?? void 0;
    });
    function onActivateCell(e) {
...
import { computed as computed5, toRef as toRef3, useTemplateRef as useTemplateRef5 } from "vue";
...
var ITableRadio_default = /* @__PURE__ */ _defineComponent4({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed5(() => {
      const value = toRef3(__props.column.label(__props.row)).value;
      return value ?? void 0;
    });
    function onActivateCell(e) {
...
import { computed as computed6, nextTick as nextTick3, ref as ref2, toRef as toRef4, useTemplateRef as useTemplateRef7, watchEffect as watchEffect2 } from "vue";
...
var ITableSelect_default = /* @__PURE__ */ _defineComponent6({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed6(() => {
      const value = toRef4(__props.column.label(__props.row)).value;
      return value ?? void 0;
    });
    function onActivateCell(e) {
      assertRef6(tdRef);
...
var _hoisted_32 = ["aria-controls", "aria-label"];
...
import { computed as computed7, onMounted as onMounted2, ref as ref3, toRef as toRef5, useTemplateRef as useTemplateRef8 } from "vue";
...
var ITableText_default = /* @__PURE__ */ _defineComponent7({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const ariaLabel = computed7(() => {
      const value = toRef5(__props.column.label(__props.row)).value;
      return value ?? void 0;
    });
    ...
    const __returned__ = { model, validity, hasError, wrapperClasses, inputClasses, ariaLabel, tdElement, viewElement, inputElement, stopEdit: stopEdit2, onActivateCell, onStartEdit, onStopEdit, onClickCell, onViewingKeydown, onEditingKeydown, onKeydown, onBlur, onValidity, get FIcon() {
      return FIcon4;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
