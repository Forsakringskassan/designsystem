...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-afe3e9.js
...
exampleComponent.__scopeId = "data-v-afe3e9";
setup({
  rootComponent: exampleComponent,
  selector: "#example-afe3e9"
});
export {
  render
};
