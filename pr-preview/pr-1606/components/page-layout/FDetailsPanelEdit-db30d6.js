...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-db30d6.js
...
exampleComponent.__scopeId = "data-v-db30d6";
setup({
  rootComponent: exampleComponent,
  selector: "#example-db30d6"
});
export {
  render
};
