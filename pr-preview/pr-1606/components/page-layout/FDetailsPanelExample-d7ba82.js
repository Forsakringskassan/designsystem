...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-d7ba82.js
...
exampleComponent.__scopeId = "data-v-d7ba82";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d7ba82"
});
export {
  render
};
