...
// virtual-entry:virtual:packages/vue/src/components/FTable/docs/FTableColumnLiveExample.vue:FTableColumnLiveExample-c5ff7f.js
import { defineComponent } from "vue";
import { FDate } from "@fkui/date";
import { LiveExample, createElement } from "@forsakringskassan/docs-live-example";

// packages/vue/src/components/FTable/columns/helpers/default-tnum-value.ts
...
// packages/vue/src/components/FTable/input-fields-config.ts
import {
  formatNumber,
  formatPersonnummer,
  formatPostalCode,
...
// packages/vue/src/components/FTable/is-text-column.ts
...
// packages/vue/src/components/FTable/is-editable-column.ts
...
// packages/vue/src/components/FTable/is-enable-column.ts
...
// packages/vue/src/components/FTable/docs/stringify-object.ts
  ...
  return _openBlock(), _createBlock(_component_live_example, {
    ...
    default: _withCtx(() => [
      ...
      _ctx.alignSupport ? (_openBlock(), _createBlock(_component_f_fieldset, {
        ...
        label: _withCtx(() => [..._cache[31] || (_cache[31] = [
          _createTextVNode(
            " Justering ",
            -1
            /* CACHED */
    ...
    _: 1
    /* STABLE */
  }, 8, ["components", "template", "livemethods", "livedata"]);
}
exampleComponent.render = render;
setup({
  rootComponent: exampleComponent,
  selector: "#example-c5ff7f"
});
export {
  render
};
