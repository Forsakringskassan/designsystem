...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4561b4.js
...
exampleComponent.__scopeId = "data-v-4561b4";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4561b4"
});
export {
  render
};
