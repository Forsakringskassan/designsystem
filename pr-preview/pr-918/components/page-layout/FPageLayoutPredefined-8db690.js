...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-8db690.js
...
exampleComponent.__scopeId = "data-v-8db690";
setup({
  rootComponent: exampleComponent,
  selector: "#example-8db690"
});
export {
  render
};
