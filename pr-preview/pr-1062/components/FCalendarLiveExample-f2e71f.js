  ...
  methods: {
    ...
    setArrowOffset() {
      ...
      if (this.arrowAnchor) {
        ...
        arrowEl = anchorEl?.nextElementSibling;
      }
      if (!arrowEl || !wrapper) {
        return;
      }
...
var IPopupListbox_default = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const anchorElement = computed(() => {
      ...
      return "el" in __props.anchor ? __props.anchor.el : __props.anchor;
    });
    ...
    function calculatePosition(options) {
      ...
      const rect = computeListboxRect(resolvedAnchor, { itemHeight: contentItemHeigth, numOfItems: __props.numOfItems, verticalSpacing });
      if (rect) {
    ...
    const __returned__ = { emit, wrapperRef, contentRef, teleportDisabled, popupClasses, teleportTarget, debouncedOnResize, debouncedOnScroll, get guessedItemHeight() {
      ...
      verticalSpacing = v;
    }, anchorElement, addListeners, removeListeners, isElementInsideViewport, onDocumentClickHandler, onResize, onScroll, onKeyEsc, guessItemHeight, calculatePosition };
