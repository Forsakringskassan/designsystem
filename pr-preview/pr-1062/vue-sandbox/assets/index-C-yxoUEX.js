...
const _sfc_main$14 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    function calculatePosition(options) {
      ...
      const rect = computeListboxRect(resolvedAnchor, {
  ...
  setup(props) {
    ...
    const offset2 = useHorizontalOffset({
      ...
      parent: computed(() => {
        ...
        return (_element$parentElemen = element?.parentElement) !== null && _element$parentElemen !== void 0 ? _element$parentElemen : null;
      })
    });
    watchEffect(() => {
