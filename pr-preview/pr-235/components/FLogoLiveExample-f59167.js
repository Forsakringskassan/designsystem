...
(() => {
  ...
  var exampleComponent = (0, import_vue3.defineComponent)({
    ...
    computed: {
      components() {
        return { FLogo: import_vue4.FLogo };
      },
      size() {
        const template = (
          /* HTML */
        ...
        return this.logoSize === "responsive" ? "" : template;
      },
      template() {
        return (
          /* HTML */
          ` <f-logo ${this.size} aria-label="awesome logo"></f-logo> `
        );
      }
    }
  });
    ...
    return (0, import_vue5.openBlock)(), (0, import_vue5.createBlock)(_component_live_example, {
      ...
      default: (0, import_vue5.withCtx)(() => [
        (0, import_vue5.createVNode)(_component_f_select_field, {
          modelValue: _ctx.logoSize,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.logoSize = $event)
        }, {
