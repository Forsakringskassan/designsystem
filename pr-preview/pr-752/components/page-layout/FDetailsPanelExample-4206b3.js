...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelExample.vue:FDetailsPanelExample-4206b3.js
...
exampleComponent.__scopeId = "data-v-4206b3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-4206b3"
});
export {
  render
};
