...
import { getInternalKey, FIcon, IFlex, IFlexItem, useTranslate, IComboboxDropdown, IPopupError, useSlotUtils, setInternalKeys, FSortFilterDatasetInjected, EventBus, FFileSelector, FFileItem, TranslationMixin, FTextField, useTextFieldSetup } from "@fkui/vue";
...
var _sfc_main$4 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props) {
    ...
    const showPopupError = computed3(() => {
      if (hasError.value) {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
        ...
        onBlur,
        onValidity
      }, null, 42, _hoisted_1$3), [[vModelText, model.value]]), _cache[2] || (_cache[2] = createTextVNode()), createVNode(unref3(IPopupError), {
        anchor: tdElement.value,
        "is-open": showPopupError.value,
        "error-message": validity.value.validationMessage,
        "arrow-anchor": tdElement.value,
        "alternative-layout": "",
        onClose: closePopupError
      }, null, 8, ["anchor", "is-open", "error-message", "arrow-anchor"]), _cache[3] || (_cache[3] = createTextVNode()), createVNode(unref3(FIcon), {
        name: "pen",
        class: "table-ng__editable__icon"
...
var _sfc_main$3 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    const keyedRows = computed3(() => setInternalKeys(__props.rows, __props.keyAttribute, __props.expandableAttribute));
