...
import { getItemIdentifier, FIcon, IFlex, IFlexItem, useTranslate, IComboboxDropdown, findItemIdentifier, useSlotUtils, setItemIdentifiers, FSortFilterDatasetInjected, IPopupError, EventBus, FFileSelector, FFileItem, TranslationMixin, FTextField, useTextFieldSetup } from "@fkui/vue";
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("th", {
        ...
        _: 1
      }, 8, ["float"]), _cache[1] || (_cache[1] = createTextVNode()), __props.column.description.value ? (openBlock(), createElementBlock("div", _hoisted_2$9, toDisplayString(__props.column.description), 1)) : createCommentVNode("", true)], 42, _hoisted_1$b);
    };
  }
});
var _hoisted_1$a = {
...
var _sfc_main$7 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, ["name"])) : createCommentVNode("", true), _cache[0] || (_cache[0] = createTextVNode()), createElementVNode("span", _hoisted_2$4, toDisplayString(__props.column.text(__props.row)), 1)], 512)])) : (openBlock(), createElementBlock("td", _hoisted_3$3, null, 512));
    };
  }
});
...
var _sfc_main$5 = /* @__PURE__ */ defineComponent2({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, [withDirectives(createElementVNode("div", _hoisted_1$4, [createElementVNode("span", _hoisted_2$3, toDisplayString(viewValue.value), 1), _cache[2] || (_cache[2] = createTextVNode()), createVNode(unref3(FIcon), {
        name: "pen",
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return __props.column.editable(__props.row) ? (openBlock(), createElementBlock("td", {
        ...
        name: "pen",
        class: "table-ng__editable__icon"
      })], 512)], 2)], 34)) : (openBlock(), createElementBlock("td", {
        key: 1,
        ref: "td",
        tabindex: "-1",
...
function usePopupError() {
  ...
  const openPopupError = ref3(false);
  ...
  async function open(popupError) {
    ...
    openPopupError.value = false;
    errorMessage.value = message;
    errorAnchor.value = anchor;
    errorArrowAnchor.value = arrowAnchor;
    await nextTick3();
    openPopupError.value = true;
  }
  function closePopupError(popupError) {
      ...
      return openBlock(), createElementBlock("table", {
        ...
        return openBlock(), createElementBlock("tr", {
          ...
          return openBlock(), createElementBlock(Fragment2, {
            ...
            row,
            column,
            onCloseError: unref3(closePopupError),
            onOnError: unref3(onPopupError)
          }, null, 40, ["row", "column", "onCloseError", "onOnError"])) : "render" in column ? (openBlock(), createBlock(resolveDynamicComponent(column.render(row)), {
            key: 1,
            row
        ...
        colspan: columnCount.value,
        class: "table-ng__cell--custom"
      }, [renderSlot(_ctx.$slots, "footer")], 8, _hoisted_10)], 8, _hoisted_9)])) : createCommentVNode("", true), _cache[8] || (_cache[8] = createTextVNode()), createVNode(unref3(IPopupError), {
        ...
        layout: "f-table"
      }, null, 8, ["anchor", "is-open", "error-message", "arrow-anchor"])], 42, _hoisted_1$2);
    };
  }
});
