...
function _sfc_render$y(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [_ctx.alternativeLayout ? (openBlock(), createBlock(_component_f_icon, {
    key: 0,
    ref: "icon",
    class: "popup-error__icon",
    name: "error"
  }, null, 512)) : createCommentVNode("", true), _cache[1] || (_cache[1] = createTextVNode()), createBaseVNode("span", null, toDisplayString(_ctx.errorMessage), 1), _cache[2] || (_cache[2] = createTextVNode()), !_ctx.alternativeLayout ? (openBlock(), createElementBlock("button", {
    key: 1,
    tabindex: "-1",
    type: "button",
