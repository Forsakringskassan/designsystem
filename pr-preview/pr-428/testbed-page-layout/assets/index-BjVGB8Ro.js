...
function computedWithControl(source, fn2) {
  ...
  const get = typeof fn2 === "function" ? fn2 : fn2.get;
  const set = typeof fn2 === "function" ? void 0 : fn2.set;
...
/* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function isHeader() {
      ...
      const isValid = el.value instanceof HTMLElement;
      if (!isValid) {
        return false;
      }
      const closest = el.value.closest("thead, tbody");
      if (closest === null || !closest.matches("thead")) {
        return false;
      }
      return true;
    }
