...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelSlots.vue:FDetailsPanelSlots-48d7b8.js
...
exampleComponent.__scopeId = "data-v-48d7b8";
setup({
  rootComponent: exampleComponent,
  selector: "#example-48d7b8"
});
export {
  render
};
