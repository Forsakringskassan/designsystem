...
var IPopupError_default = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { emit, POPUP_SPACING: POPUP_SPACING2, wrapperRef, teleportDisabled: teleportDisabled2, placement, arrowPosition, arrowOffset, popupClasses, arrowClass, errorStyle, teleportTarget, onKeyEsc, onClose, setArrowOffset, toggleIsOpen, onResize, onScroll, get FIcon() {
