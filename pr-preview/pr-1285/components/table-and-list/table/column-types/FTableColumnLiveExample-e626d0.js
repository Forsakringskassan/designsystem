...
// virtual-entry:virtual:packages/vue/src/components/FTable/docs/FTableColumnLiveExample.vue:FTableColumnLiveExample-e626d0.js
...
var exampleComponent = defineComponent({
  ...
  computed: {
    livedata() {
      const rows = useDatasetRef(rowData[this.columnType].map((it, index) => ({ id: index + 1, value: it })));
      return {
        rows
      };
    },
