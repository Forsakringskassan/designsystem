...
// virtual-entry:virtual:packages/vue/src/components/FTable/docs/FTableExpandableLiveExample.vue:FTableExpandableLiveExample-4695bc.js
...
var exampleComponent = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const customSlot = computed(() => {
      ...
      return [createElement("template", { "#expandable": "{ row }" }, ["\n", createElement("pre", ["{{ row }}"]), "\n"])];
    });
