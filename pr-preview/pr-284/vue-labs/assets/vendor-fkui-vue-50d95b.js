...
(() => {
  ...
  var internalKey = Symbol("table-key");
  var internalIndex = 0;
  ...
  var _sfc_main$p = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props) {
      ...
      const internalRows = (0, import_vue.computed)(() => {
        const {
          keyAttribute
        } = props;
        if (keyAttribute) {
      ...
      return (_ctx, _cache) => {
        ...
        }, [(0, import_vue.renderSlot)(_ctx.$slots, "empty", {}, () => [(0, import_vue.createTextVNode)((0, import_vue.toDisplayString)((0, import_vue.unref)($t2)("fkui.data-table.empty", "Tabellen \xE4r tom")), 1)])], 8, _hoisted_8$5)])) : (0, import_vue.createCommentVNode)("", true), _cache[3] || (_cache[3] = (0, import_vue.createTextVNode)()), ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(import_vue.Fragment, null, (0, import_vue.renderList)(internalRows.value, (row) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("tr", {
            key: rowKey(row),
            class: "table__row"
    ...
    setup(__props, {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("div", {
          ...
          ref: "tbodyElement",
          key: tbodyKey.value
        }, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(import_vue.Fragment, null, (0, import_vue.renderList)(internalRows.value, (row, index) => {
  ...
  var _sfc_main$e = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, {
      ...
      return (_ctx, _cache) => {
        return !__props.selectable ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("ul", _hoisted_1$e, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(import_vue.Fragment, null, (0, import_vue.renderList)(internalItems.value, (item) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", {
            key: itemKey(item),
            class: "list__item"
          }, [(0, import_vue.createElementVNode)("div", {
        ...
        }, [((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(import_vue.Fragment, null, (0, import_vue.renderList)(internalItems.value, (item, index) => {
          return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("li", {
            id: getItemId(item),
            key: itemKey(item),
