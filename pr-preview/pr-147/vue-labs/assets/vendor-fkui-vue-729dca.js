...
(() => {
  ...
  function _sfc_render$$(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    }, [(0, import_vue.createElementVNode)("div", (0, import_vue.mergeProps)(_ctx.$attrs, {
      id: _ctx.id,
    ...
    }, null, 32)])])], 2)])], 32)])], 16, _hoisted_1$T)], 8, ["to"])) : (0, import_vue.createCommentVNode)("", true);
  }
  ...
  var _sfc_main$14 = (0, import_vue.defineComponent)({
    ...
    methods: {
      onClose() {
        ...
        import_logic.ValidationService.resetState(form);
        this.$emit("cancel");
        this.$emit("close", {
          reason: "close"
        });
