...
(() => {
  ...
  function render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return _ctx.isOpen ? ((0, import_vue12.openBlock)(), (0, import_vue12.createBlock)(import_vue12.Teleport, {
      key: 0,
      to: _ctx.teleportTarget
    }, [
      (0, import_vue12.createElementVNode)("div", (0, import_vue12.mergeProps)(_ctx.$attrs, {
        id: _ctx.id,
        class: ["modal", _ctx.modalClass]
      }), [
    ...
    ], 8, ["to"])) : (0, import_vue12.createCommentVNode)("v-if", true);
  }
  ...
  var FFormModal_default = (0, import_vue25.defineComponent)({
    ...
    methods: {
      onClose() {
        ...
        import_logic12.ValidationService.resetState(form);
        this.$emit("cancel");
