...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-3db3d3.js
...
exampleComponent.__scopeId = "data-v-3db3d3";
setup({
  rootComponent: exampleComponent,
  selector: "#example-3db3d3"
});
export {
  render
};
