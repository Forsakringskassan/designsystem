...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-2fbe1f.js
...
exampleComponent.__scopeId = "data-v-2fbe1f";
setup({
  rootComponent: exampleComponent,
  selector: "#example-2fbe1f"
});
export {
  render
};
