...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-d5db5c.js
...
exampleComponent.__scopeId = "data-v-d5db5c";
setup({
  rootComponent: exampleComponent,
  selector: "#example-d5db5c"
});
export {
  render
};
