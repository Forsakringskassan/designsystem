...
// virtual-entry:virtual:packages/vue/src/components/FDetailsPanel/examples/FDetailsPanelEdit.vue:FDetailsPanelEdit-fcaabb.js
...
exampleComponent.__scopeId = "data-v-fcaabb";
setup({
  rootComponent: exampleComponent,
  selector: "#example-fcaabb"
});
export {
  render
};
