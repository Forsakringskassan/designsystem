...
// virtual-entry:virtual:docs/components/page-layout/FPageLayoutPredefined.vue:FPageLayoutPredefined-ac6d2d.js
...
exampleComponent.__scopeId = "data-v-ac6d2d";
setup({
  rootComponent: exampleComponent,
  selector: "#example-ac6d2d"
});
export {
  render
};
